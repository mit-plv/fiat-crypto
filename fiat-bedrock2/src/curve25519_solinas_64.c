...
void internal_fiat_curve25519_solinas_mul(br_word_t out0, br_word_t in0, br_word_t in1) {
  ...
  x152 = x149+x151;
  x153 = x152+x125;
  x154 = (br_word_t)0x26*x153;
  x155 = _br_mulhuu((br_word_t)0x26, x153);
  x156 = (br_word_t)0x26*x150;
  x157 = _br_mulhuu((br_word_t)0x26, x150);
  x158 = (br_word_t)0x26*x145;
  x159 = _br_mulhuu((br_word_t)0x26, x145);
  x160 = (br_word_t)0x26*x140;
  x161 = _br_mulhuu((br_word_t)0x26, x140);
  x162 = x126+x158;
  ...
  x202 = (br_word_t)-0x1+((br_word_t)(x201==(br_word_t)0x0));
  x203 = x202^0xffffffffffffffff;
  x204 = ((br_word_t)0x26&x202)|((br_word_t)0x0&x203);
  x205 = x204+x194;
  x206 = x205;
  x207 = x196;
  x208 = x198;
  x209 = x200;
  /*skip*/
  _br_store(out0+0x0, x206);
  _br_store(out0+0x8, x207);
  _br_store(out0+0x10, x208);
  _br_store(out0+0x18, x209);
  /*skip*/
  return;
}
...
void internal_fiat_curve25519_solinas_square(br_word_t out0, br_word_t in0) {
  ...
  x108 = x107+x72;
  x109 = x108+x74;
  x110 = (br_word_t)0x26*x109;
  x111 = _br_mulhuu((br_word_t)0x26, x109);
  x112 = (br_word_t)0x26*x105;
  x113 = _br_mulhuu((br_word_t)0x26, x105);
  x114 = (br_word_t)0x26*x100;
  x115 = _br_mulhuu((br_word_t)0x26, x100);
  x116 = (br_word_t)0x26*x95;
  x117 = _br_mulhuu((br_word_t)0x26, x95);
  x118 = x81+x114;
  ...
  x158 = (br_word_t)-0x1+((br_word_t)(x157==(br_word_t)0x0));
  x159 = x158^0xffffffffffffffff;
  x160 = ((br_word_t)0x26&x158)|((br_word_t)0x0&x159);
  x161 = x160+x150;
  x162 = x161;
  x163 = x152;
  x164 = x154;
  x165 = x156;
  /*skip*/
  _br_store(out0+0x0, x162);
  _br_store(out0+0x8, x163);
  _br_store(out0+0x10, x164);
  _br_store(out0+0x18, x165);
  /*skip*/
  return;
}
