...
void fiat_p384_from_bytes(uintptr_t out0, uintptr_t in0) {
  ...
  x143 = x137;
  /*skip*/
  *(uintptr_t*)((out0)+((uintptr_t)0ULL)) = x138;
  *(uintptr_t*)((out0)+((uintptr_t)8ULL)) = x139;
  *(uintptr_t*)((out0)+((uintptr_t)16ULL)) = x140;
  *(uintptr_t*)((out0)+((uintptr_t)24ULL)) = x141;
  *(uintptr_t*)((out0)+((uintptr_t)32ULL)) = x142;
  *(uintptr_t*)((out0)+((uintptr_t)40ULL)) = x143;
  /*skip*/
  return;
}
