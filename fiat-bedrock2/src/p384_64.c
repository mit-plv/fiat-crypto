/* Autogenerated: src/ExtractionOCaml/bedrock2_word_by_word_montgomery --lang=bedrock2 --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select p384 '2^384 - 2^128 - 2^96 + 2^32 - 1' 64 mul square add sub opp from_montgomery nonzero selectznz to_bytes from_bytes */
...
void fiat_p384_mul(uintptr_t in0, uintptr_t in1, uintptr_t out0) {
  ...
  x17 = x0;
  x18 = (x17)*(x11);
  x19 = sizeof(intptr_t) == 4 ? ((uint64_t)(x17)*(x11))>>32 : ((__uint128_t)(x17)*(x11))>>64 /* TODO this has not been tested */;
  x20 = (x17)*(x10);
  x21 = sizeof(intptr_t) == 4 ? ((uint64_t)(x17)*(x10))>>32 : ((__uint128_t)(x17)*(x10))>>64 /* TODO this has not been tested */;
  x22 = (x17)*(x9);
  x23 = sizeof(intptr_t) == 4 ? ((uint64_t)(x17)*(x9))>>32 : ((__uint128_t)(x17)*(x9))>>64 /* TODO this has not been tested */;
  x24 = (x17)*(x8);
  x25 = sizeof(intptr_t) == 4 ? ((uint64_t)(x17)*(x8))>>32 : ((__uint128_t)(x17)*(x8))>>64 /* TODO this has not been tested */;
  x26 = (x17)*(x7);
  x27 = sizeof(intptr_t) == 4 ? ((uint64_t)(x17)*(x7))>>32 : ((__uint128_t)(x17)*(x7))>>64 /* TODO this has not been tested */;
  x28 = (x17)*(x6);
  x29 = sizeof(intptr_t) == 4 ? ((uint64_t)(x17)*(x6))>>32 : ((__uint128_t)(x17)*(x6))>>64 /* TODO this has not been tested */;
  x30 = (x29)+(x26);
  x31 = (x30)<(x29);
  x32 = (x31)+(x27);
  x33 = (x32)<(x27);
  ...
  x55 = sizeof(intptr_t) == 4 ? ((uint64_t)(x53)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x53)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x56 = (x53)*((uintptr_t)18446744073709551615ULL);
  x57 = sizeof(intptr_t) == 4 ? ((uint64_t)(x53)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x53)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x58 = (x53)*((uintptr_t)18446744073709551615ULL);
  x59 = sizeof(intptr_t) == 4 ? ((uint64_t)(x53)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x53)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x60 = (x53)*((uintptr_t)18446744073709551614ULL);
  x61 = sizeof(intptr_t) == 4 ? ((uint64_t)(x53)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x53)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x62 = (x53)*((uintptr_t)18446744069414584320ULL);
  x63 = sizeof(intptr_t) == 4 ? ((uint64_t)(x53)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x53)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x64 = (x53)*((uintptr_t)4294967295ULL);
  x65 = sizeof(intptr_t) == 4 ? ((uint64_t)(x53)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x53)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x66 = (x65)+(x62);
  x67 = (x66)<(x65);
  x68 = (x67)+(x63);
  x69 = (x68)<(x63);
  ...
  x120 = (x117)+(x119);
  x121 = (x12)*(x11);
  x122 = sizeof(intptr_t) == 4 ? ((uint64_t)(x12)*(x11))>>32 : ((__uint128_t)(x12)*(x11))>>64 /* TODO this has not been tested */;
  x123 = (x12)*(x10);
  x124 = sizeof(intptr_t) == 4 ? ((uint64_t)(x12)*(x10))>>32 : ((__uint128_t)(x12)*(x10))>>64 /* TODO this has not been tested */;
  x125 = (x12)*(x9);
  x126 = sizeof(intptr_t) == 4 ? ((uint64_t)(x12)*(x9))>>32 : ((__uint128_t)(x12)*(x9))>>64 /* TODO this has not been tested */;
  x127 = (x12)*(x8);
  x128 = sizeof(intptr_t) == 4 ? ((uint64_t)(x12)*(x8))>>32 : ((__uint128_t)(x12)*(x8))>>64 /* TODO this has not been tested */;
  x129 = (x12)*(x7);
  x130 = sizeof(intptr_t) == 4 ? ((uint64_t)(x12)*(x7))>>32 : ((__uint128_t)(x12)*(x7))>>64 /* TODO this has not been tested */;
  x131 = (x12)*(x6);
  x132 = sizeof(intptr_t) == 4 ? ((uint64_t)(x12)*(x6))>>32 : ((__uint128_t)(x12)*(x6))>>64 /* TODO this has not been tested */;
  x133 = (x132)+(x129);
  x134 = (x133)<(x132);
  x135 = (x134)+(x130);
  x136 = (x135)<(x130);
  ...
  x190 = sizeof(intptr_t) == 4 ? ((uint64_t)(x188)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x188)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x191 = (x188)*((uintptr_t)18446744073709551615ULL);
  x192 = sizeof(intptr_t) == 4 ? ((uint64_t)(x188)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x188)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x193 = (x188)*((uintptr_t)18446744073709551615ULL);
  x194 = sizeof(intptr_t) == 4 ? ((uint64_t)(x188)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x188)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x195 = (x188)*((uintptr_t)18446744073709551614ULL);
  x196 = sizeof(intptr_t) == 4 ? ((uint64_t)(x188)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x188)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x197 = (x188)*((uintptr_t)18446744069414584320ULL);
  x198 = sizeof(intptr_t) == 4 ? ((uint64_t)(x188)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x188)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x199 = (x188)*((uintptr_t)4294967295ULL);
  x200 = sizeof(intptr_t) == 4 ? ((uint64_t)(x188)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x188)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x201 = (x200)+(x197);
  x202 = (x201)<(x200);
  x203 = (x202)+(x198);
  x204 = (x203)<(x198);
  ...
  x256 = (x255)+(x187);
  x257 = (x13)*(x11);
  x258 = sizeof(intptr_t) == 4 ? ((uint64_t)(x13)*(x11))>>32 : ((__uint128_t)(x13)*(x11))>>64 /* TODO this has not been tested */;
  x259 = (x13)*(x10);
  x260 = sizeof(intptr_t) == 4 ? ((uint64_t)(x13)*(x10))>>32 : ((__uint128_t)(x13)*(x10))>>64 /* TODO this has not been tested */;
  x261 = (x13)*(x9);
  x262 = sizeof(intptr_t) == 4 ? ((uint64_t)(x13)*(x9))>>32 : ((__uint128_t)(x13)*(x9))>>64 /* TODO this has not been tested */;
  x263 = (x13)*(x8);
  x264 = sizeof(intptr_t) == 4 ? ((uint64_t)(x13)*(x8))>>32 : ((__uint128_t)(x13)*(x8))>>64 /* TODO this has not been tested */;
  x265 = (x13)*(x7);
  x266 = sizeof(intptr_t) == 4 ? ((uint64_t)(x13)*(x7))>>32 : ((__uint128_t)(x13)*(x7))>>64 /* TODO this has not been tested */;
  x267 = (x13)*(x6);
  x268 = sizeof(intptr_t) == 4 ? ((uint64_t)(x13)*(x6))>>32 : ((__uint128_t)(x13)*(x6))>>64 /* TODO this has not been tested */;
  x269 = (x268)+(x265);
  x270 = (x269)<(x268);
  x271 = (x270)+(x266);
  x272 = (x271)<(x266);
  ...
  x326 = sizeof(intptr_t) == 4 ? ((uint64_t)(x324)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x324)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x327 = (x324)*((uintptr_t)18446744073709551615ULL);
  x328 = sizeof(intptr_t) == 4 ? ((uint64_t)(x324)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x324)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x329 = (x324)*((uintptr_t)18446744073709551615ULL);
  x330 = sizeof(intptr_t) == 4 ? ((uint64_t)(x324)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x324)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x331 = (x324)*((uintptr_t)18446744073709551614ULL);
  x332 = sizeof(intptr_t) == 4 ? ((uint64_t)(x324)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x324)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x333 = (x324)*((uintptr_t)18446744069414584320ULL);
  x334 = sizeof(intptr_t) == 4 ? ((uint64_t)(x324)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x324)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x335 = (x324)*((uintptr_t)4294967295ULL);
  x336 = sizeof(intptr_t) == 4 ? ((uint64_t)(x324)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x324)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x337 = (x336)+(x333);
  x338 = (x337)<(x336);
  x339 = (x338)+(x334);
  x340 = (x339)<(x334);
  ...
  x392 = (x391)+(x323);
  x393 = (x14)*(x11);
  x394 = sizeof(intptr_t) == 4 ? ((uint64_t)(x14)*(x11))>>32 : ((__uint128_t)(x14)*(x11))>>64 /* TODO this has not been tested */;
  x395 = (x14)*(x10);
  x396 = sizeof(intptr_t) == 4 ? ((uint64_t)(x14)*(x10))>>32 : ((__uint128_t)(x14)*(x10))>>64 /* TODO this has not been tested */;
  x397 = (x14)*(x9);
  x398 = sizeof(intptr_t) == 4 ? ((uint64_t)(x14)*(x9))>>32 : ((__uint128_t)(x14)*(x9))>>64 /* TODO this has not been tested */;
  x399 = (x14)*(x8);
  x400 = sizeof(intptr_t) == 4 ? ((uint64_t)(x14)*(x8))>>32 : ((__uint128_t)(x14)*(x8))>>64 /* TODO this has not been tested */;
  x401 = (x14)*(x7);
  x402 = sizeof(intptr_t) == 4 ? ((uint64_t)(x14)*(x7))>>32 : ((__uint128_t)(x14)*(x7))>>64 /* TODO this has not been tested */;
  x403 = (x14)*(x6);
  x404 = sizeof(intptr_t) == 4 ? ((uint64_t)(x14)*(x6))>>32 : ((__uint128_t)(x14)*(x6))>>64 /* TODO this has not been tested */;
  x405 = (x404)+(x401);
  x406 = (x405)<(x404);
  x407 = (x406)+(x402);
  x408 = (x407)<(x402);
  ...
  x462 = sizeof(intptr_t) == 4 ? ((uint64_t)(x460)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x460)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x463 = (x460)*((uintptr_t)18446744073709551615ULL);
  x464 = sizeof(intptr_t) == 4 ? ((uint64_t)(x460)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x460)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x465 = (x460)*((uintptr_t)18446744073709551615ULL);
  x466 = sizeof(intptr_t) == 4 ? ((uint64_t)(x460)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x460)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x467 = (x460)*((uintptr_t)18446744073709551614ULL);
  x468 = sizeof(intptr_t) == 4 ? ((uint64_t)(x460)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x460)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x469 = (x460)*((uintptr_t)18446744069414584320ULL);
  x470 = sizeof(intptr_t) == 4 ? ((uint64_t)(x460)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x460)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x471 = (x460)*((uintptr_t)4294967295ULL);
  x472 = sizeof(intptr_t) == 4 ? ((uint64_t)(x460)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x460)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x473 = (x472)+(x469);
  x474 = (x473)<(x472);
  x475 = (x474)+(x470);
  x476 = (x475)<(x470);
  ...
  x528 = (x527)+(x459);
  x529 = (x15)*(x11);
  x530 = sizeof(intptr_t) == 4 ? ((uint64_t)(x15)*(x11))>>32 : ((__uint128_t)(x15)*(x11))>>64 /* TODO this has not been tested */;
  x531 = (x15)*(x10);
  x532 = sizeof(intptr_t) == 4 ? ((uint64_t)(x15)*(x10))>>32 : ((__uint128_t)(x15)*(x10))>>64 /* TODO this has not been tested */;
  x533 = (x15)*(x9);
  x534 = sizeof(intptr_t) == 4 ? ((uint64_t)(x15)*(x9))>>32 : ((__uint128_t)(x15)*(x9))>>64 /* TODO this has not been tested */;
  x535 = (x15)*(x8);
  x536 = sizeof(intptr_t) == 4 ? ((uint64_t)(x15)*(x8))>>32 : ((__uint128_t)(x15)*(x8))>>64 /* TODO this has not been tested */;
  x537 = (x15)*(x7);
  x538 = sizeof(intptr_t) == 4 ? ((uint64_t)(x15)*(x7))>>32 : ((__uint128_t)(x15)*(x7))>>64 /* TODO this has not been tested */;
  x539 = (x15)*(x6);
  x540 = sizeof(intptr_t) == 4 ? ((uint64_t)(x15)*(x6))>>32 : ((__uint128_t)(x15)*(x6))>>64 /* TODO this has not been tested */;
  x541 = (x540)+(x537);
  x542 = (x541)<(x540);
  x543 = (x542)+(x538);
  x544 = (x543)<(x538);
  ...
  x598 = sizeof(intptr_t) == 4 ? ((uint64_t)(x596)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x596)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x599 = (x596)*((uintptr_t)18446744073709551615ULL);
  x600 = sizeof(intptr_t) == 4 ? ((uint64_t)(x596)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x596)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x601 = (x596)*((uintptr_t)18446744073709551615ULL);
  x602 = sizeof(intptr_t) == 4 ? ((uint64_t)(x596)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x596)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x603 = (x596)*((uintptr_t)18446744073709551614ULL);
  x604 = sizeof(intptr_t) == 4 ? ((uint64_t)(x596)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x596)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x605 = (x596)*((uintptr_t)18446744069414584320ULL);
  x606 = sizeof(intptr_t) == 4 ? ((uint64_t)(x596)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x596)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x607 = (x596)*((uintptr_t)4294967295ULL);
  x608 = sizeof(intptr_t) == 4 ? ((uint64_t)(x596)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x596)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x609 = (x608)+(x605);
  x610 = (x609)<(x608);
  x611 = (x610)+(x606);
  x612 = (x611)<(x606);
  ...
  x664 = (x663)+(x595);
  x665 = (x16)*(x11);
  x666 = sizeof(intptr_t) == 4 ? ((uint64_t)(x16)*(x11))>>32 : ((__uint128_t)(x16)*(x11))>>64 /* TODO this has not been tested */;
  x667 = (x16)*(x10);
  x668 = sizeof(intptr_t) == 4 ? ((uint64_t)(x16)*(x10))>>32 : ((__uint128_t)(x16)*(x10))>>64 /* TODO this has not been tested */;
  x669 = (x16)*(x9);
  x670 = sizeof(intptr_t) == 4 ? ((uint64_t)(x16)*(x9))>>32 : ((__uint128_t)(x16)*(x9))>>64 /* TODO this has not been tested */;
  x671 = (x16)*(x8);
  x672 = sizeof(intptr_t) == 4 ? ((uint64_t)(x16)*(x8))>>32 : ((__uint128_t)(x16)*(x8))>>64 /* TODO this has not been tested */;
  x673 = (x16)*(x7);
  x674 = sizeof(intptr_t) == 4 ? ((uint64_t)(x16)*(x7))>>32 : ((__uint128_t)(x16)*(x7))>>64 /* TODO this has not been tested */;
  x675 = (x16)*(x6);
  x676 = sizeof(intptr_t) == 4 ? ((uint64_t)(x16)*(x6))>>32 : ((__uint128_t)(x16)*(x6))>>64 /* TODO this has not been tested */;
  x677 = (x676)+(x673);
  x678 = (x677)<(x676);
  x679 = (x678)+(x674);
  x680 = (x679)<(x674);
  ...
  x734 = sizeof(intptr_t) == 4 ? ((uint64_t)(x732)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x732)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x735 = (x732)*((uintptr_t)18446744073709551615ULL);
  x736 = sizeof(intptr_t) == 4 ? ((uint64_t)(x732)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x732)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x737 = (x732)*((uintptr_t)18446744073709551615ULL);
  x738 = sizeof(intptr_t) == 4 ? ((uint64_t)(x732)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x732)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x739 = (x732)*((uintptr_t)18446744073709551614ULL);
  x740 = sizeof(intptr_t) == 4 ? ((uint64_t)(x732)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x732)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x741 = (x732)*((uintptr_t)18446744069414584320ULL);
  x742 = sizeof(intptr_t) == 4 ? ((uint64_t)(x732)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x732)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x743 = (x732)*((uintptr_t)4294967295ULL);
  x744 = sizeof(intptr_t) == 4 ? ((uint64_t)(x732)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x732)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x745 = (x744)+(x741);
  x746 = (x745)<(x744);
  x747 = (x746)+(x742);
  x748 = (x747)<(x742);
...
void fiat_p384_square(uintptr_t in0, uintptr_t out0) {
  ...
  x11 = x0;
  x12 = (x11)*(x5);
  x13 = sizeof(intptr_t) == 4 ? ((uint64_t)(x11)*(x5))>>32 : ((__uint128_t)(x11)*(x5))>>64 /* TODO this has not been tested */;
  x14 = (x11)*(x4);
  x15 = sizeof(intptr_t) == 4 ? ((uint64_t)(x11)*(x4))>>32 : ((__uint128_t)(x11)*(x4))>>64 /* TODO this has not been tested */;
  x16 = (x11)*(x3);
  x17 = sizeof(intptr_t) == 4 ? ((uint64_t)(x11)*(x3))>>32 : ((__uint128_t)(x11)*(x3))>>64 /* TODO this has not been tested */;
  x18 = (x11)*(x2);
  x19 = sizeof(intptr_t) == 4 ? ((uint64_t)(x11)*(x2))>>32 : ((__uint128_t)(x11)*(x2))>>64 /* TODO this has not been tested */;
  x20 = (x11)*(x1);
  x21 = sizeof(intptr_t) == 4 ? ((uint64_t)(x11)*(x1))>>32 : ((__uint128_t)(x11)*(x1))>>64 /* TODO this has not been tested */;
  x22 = (x11)*(x0);
  x23 = sizeof(intptr_t) == 4 ? ((uint64_t)(x11)*(x0))>>32 : ((__uint128_t)(x11)*(x0))>>64 /* TODO this has not been tested */;
  x24 = (x23)+(x20);
  x25 = (x24)<(x23);
  x26 = (x25)+(x21);
  x27 = (x26)<(x21);
  ...
  x49 = sizeof(intptr_t) == 4 ? ((uint64_t)(x47)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x47)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x50 = (x47)*((uintptr_t)18446744073709551615ULL);
  x51 = sizeof(intptr_t) == 4 ? ((uint64_t)(x47)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x47)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x52 = (x47)*((uintptr_t)18446744073709551615ULL);
  x53 = sizeof(intptr_t) == 4 ? ((uint64_t)(x47)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x47)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x54 = (x47)*((uintptr_t)18446744073709551614ULL);
  x55 = sizeof(intptr_t) == 4 ? ((uint64_t)(x47)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x47)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x56 = (x47)*((uintptr_t)18446744069414584320ULL);
  x57 = sizeof(intptr_t) == 4 ? ((uint64_t)(x47)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x47)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x58 = (x47)*((uintptr_t)4294967295ULL);
  x59 = sizeof(intptr_t) == 4 ? ((uint64_t)(x47)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x47)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x60 = (x59)+(x56);
  x61 = (x60)<(x59);
  x62 = (x61)+(x57);
  x63 = (x62)<(x57);
  ...
  x114 = (x111)+(x113);
  x115 = (x6)*(x5);
  x116 = sizeof(intptr_t) == 4 ? ((uint64_t)(x6)*(x5))>>32 : ((__uint128_t)(x6)*(x5))>>64 /* TODO this has not been tested */;
  x117 = (x6)*(x4);
  x118 = sizeof(intptr_t) == 4 ? ((uint64_t)(x6)*(x4))>>32 : ((__uint128_t)(x6)*(x4))>>64 /* TODO this has not been tested */;
  x119 = (x6)*(x3);
  x120 = sizeof(intptr_t) == 4 ? ((uint64_t)(x6)*(x3))>>32 : ((__uint128_t)(x6)*(x3))>>64 /* TODO this has not been tested */;
  x121 = (x6)*(x2);
  x122 = sizeof(intptr_t) == 4 ? ((uint64_t)(x6)*(x2))>>32 : ((__uint128_t)(x6)*(x2))>>64 /* TODO this has not been tested */;
  x123 = (x6)*(x1);
  x124 = sizeof(intptr_t) == 4 ? ((uint64_t)(x6)*(x1))>>32 : ((__uint128_t)(x6)*(x1))>>64 /* TODO this has not been tested */;
  x125 = (x6)*(x0);
  x126 = sizeof(intptr_t) == 4 ? ((uint64_t)(x6)*(x0))>>32 : ((__uint128_t)(x6)*(x0))>>64 /* TODO this has not been tested */;
  x127 = (x126)+(x123);
  x128 = (x127)<(x126);
  x129 = (x128)+(x124);
  x130 = (x129)<(x124);
  ...
  x184 = sizeof(intptr_t) == 4 ? ((uint64_t)(x182)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x182)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x185 = (x182)*((uintptr_t)18446744073709551615ULL);
  x186 = sizeof(intptr_t) == 4 ? ((uint64_t)(x182)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x182)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x187 = (x182)*((uintptr_t)18446744073709551615ULL);
  x188 = sizeof(intptr_t) == 4 ? ((uint64_t)(x182)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x182)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x189 = (x182)*((uintptr_t)18446744073709551614ULL);
  x190 = sizeof(intptr_t) == 4 ? ((uint64_t)(x182)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x182)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x191 = (x182)*((uintptr_t)18446744069414584320ULL);
  x192 = sizeof(intptr_t) == 4 ? ((uint64_t)(x182)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x182)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x193 = (x182)*((uintptr_t)4294967295ULL);
  x194 = sizeof(intptr_t) == 4 ? ((uint64_t)(x182)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x182)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x195 = (x194)+(x191);
  x196 = (x195)<(x194);
  x197 = (x196)+(x192);
  x198 = (x197)<(x192);
  ...
  x250 = (x249)+(x181);
  x251 = (x7)*(x5);
  x252 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*(x5))>>32 : ((__uint128_t)(x7)*(x5))>>64 /* TODO this has not been tested */;
  x253 = (x7)*(x4);
  x254 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*(x4))>>32 : ((__uint128_t)(x7)*(x4))>>64 /* TODO this has not been tested */;
  x255 = (x7)*(x3);
  x256 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*(x3))>>32 : ((__uint128_t)(x7)*(x3))>>64 /* TODO this has not been tested */;
  x257 = (x7)*(x2);
  x258 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*(x2))>>32 : ((__uint128_t)(x7)*(x2))>>64 /* TODO this has not been tested */;
  x259 = (x7)*(x1);
  x260 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*(x1))>>32 : ((__uint128_t)(x7)*(x1))>>64 /* TODO this has not been tested */;
  x261 = (x7)*(x0);
  x262 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*(x0))>>32 : ((__uint128_t)(x7)*(x0))>>64 /* TODO this has not been tested */;
  x263 = (x262)+(x259);
  x264 = (x263)<(x262);
  x265 = (x264)+(x260);
  x266 = (x265)<(x260);
  ...
  x320 = sizeof(intptr_t) == 4 ? ((uint64_t)(x318)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x318)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x321 = (x318)*((uintptr_t)18446744073709551615ULL);
  x322 = sizeof(intptr_t) == 4 ? ((uint64_t)(x318)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x318)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x323 = (x318)*((uintptr_t)18446744073709551615ULL);
  x324 = sizeof(intptr_t) == 4 ? ((uint64_t)(x318)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x318)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x325 = (x318)*((uintptr_t)18446744073709551614ULL);
  x326 = sizeof(intptr_t) == 4 ? ((uint64_t)(x318)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x318)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x327 = (x318)*((uintptr_t)18446744069414584320ULL);
  x328 = sizeof(intptr_t) == 4 ? ((uint64_t)(x318)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x318)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x329 = (x318)*((uintptr_t)4294967295ULL);
  x330 = sizeof(intptr_t) == 4 ? ((uint64_t)(x318)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x318)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x331 = (x330)+(x327);
  x332 = (x331)<(x330);
  x333 = (x332)+(x328);
  x334 = (x333)<(x328);
  ...
  x386 = (x385)+(x317);
  x387 = (x8)*(x5);
  x388 = sizeof(intptr_t) == 4 ? ((uint64_t)(x8)*(x5))>>32 : ((__uint128_t)(x8)*(x5))>>64 /* TODO this has not been tested */;
  x389 = (x8)*(x4);
  x390 = sizeof(intptr_t) == 4 ? ((uint64_t)(x8)*(x4))>>32 : ((__uint128_t)(x8)*(x4))>>64 /* TODO this has not been tested */;
  x391 = (x8)*(x3);
  x392 = sizeof(intptr_t) == 4 ? ((uint64_t)(x8)*(x3))>>32 : ((__uint128_t)(x8)*(x3))>>64 /* TODO this has not been tested */;
  x393 = (x8)*(x2);
  x394 = sizeof(intptr_t) == 4 ? ((uint64_t)(x8)*(x2))>>32 : ((__uint128_t)(x8)*(x2))>>64 /* TODO this has not been tested */;
  x395 = (x8)*(x1);
  x396 = sizeof(intptr_t) == 4 ? ((uint64_t)(x8)*(x1))>>32 : ((__uint128_t)(x8)*(x1))>>64 /* TODO this has not been tested */;
  x397 = (x8)*(x0);
  x398 = sizeof(intptr_t) == 4 ? ((uint64_t)(x8)*(x0))>>32 : ((__uint128_t)(x8)*(x0))>>64 /* TODO this has not been tested */;
  x399 = (x398)+(x395);
  x400 = (x399)<(x398);
  x401 = (x400)+(x396);
  x402 = (x401)<(x396);
  ...
  x456 = sizeof(intptr_t) == 4 ? ((uint64_t)(x454)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x454)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x457 = (x454)*((uintptr_t)18446744073709551615ULL);
  x458 = sizeof(intptr_t) == 4 ? ((uint64_t)(x454)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x454)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x459 = (x454)*((uintptr_t)18446744073709551615ULL);
  x460 = sizeof(intptr_t) == 4 ? ((uint64_t)(x454)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x454)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x461 = (x454)*((uintptr_t)18446744073709551614ULL);
  x462 = sizeof(intptr_t) == 4 ? ((uint64_t)(x454)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x454)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x463 = (x454)*((uintptr_t)18446744069414584320ULL);
  x464 = sizeof(intptr_t) == 4 ? ((uint64_t)(x454)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x454)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x465 = (x454)*((uintptr_t)4294967295ULL);
  x466 = sizeof(intptr_t) == 4 ? ((uint64_t)(x454)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x454)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x467 = (x466)+(x463);
  x468 = (x467)<(x466);
  x469 = (x468)+(x464);
  x470 = (x469)<(x464);
  ...
  x522 = (x521)+(x453);
  x523 = (x9)*(x5);
  x524 = sizeof(intptr_t) == 4 ? ((uint64_t)(x9)*(x5))>>32 : ((__uint128_t)(x9)*(x5))>>64 /* TODO this has not been tested */;
  x525 = (x9)*(x4);
  x526 = sizeof(intptr_t) == 4 ? ((uint64_t)(x9)*(x4))>>32 : ((__uint128_t)(x9)*(x4))>>64 /* TODO this has not been tested */;
  x527 = (x9)*(x3);
  x528 = sizeof(intptr_t) == 4 ? ((uint64_t)(x9)*(x3))>>32 : ((__uint128_t)(x9)*(x3))>>64 /* TODO this has not been tested */;
  x529 = (x9)*(x2);
  x530 = sizeof(intptr_t) == 4 ? ((uint64_t)(x9)*(x2))>>32 : ((__uint128_t)(x9)*(x2))>>64 /* TODO this has not been tested */;
  x531 = (x9)*(x1);
  x532 = sizeof(intptr_t) == 4 ? ((uint64_t)(x9)*(x1))>>32 : ((__uint128_t)(x9)*(x1))>>64 /* TODO this has not been tested */;
  x533 = (x9)*(x0);
  x534 = sizeof(intptr_t) == 4 ? ((uint64_t)(x9)*(x0))>>32 : ((__uint128_t)(x9)*(x0))>>64 /* TODO this has not been tested */;
  x535 = (x534)+(x531);
  x536 = (x535)<(x534);
  x537 = (x536)+(x532);
  x538 = (x537)<(x532);
  ...
  x592 = sizeof(intptr_t) == 4 ? ((uint64_t)(x590)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x590)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x593 = (x590)*((uintptr_t)18446744073709551615ULL);
  x594 = sizeof(intptr_t) == 4 ? ((uint64_t)(x590)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x590)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x595 = (x590)*((uintptr_t)18446744073709551615ULL);
  x596 = sizeof(intptr_t) == 4 ? ((uint64_t)(x590)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x590)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x597 = (x590)*((uintptr_t)18446744073709551614ULL);
  x598 = sizeof(intptr_t) == 4 ? ((uint64_t)(x590)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x590)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x599 = (x590)*((uintptr_t)18446744069414584320ULL);
  x600 = sizeof(intptr_t) == 4 ? ((uint64_t)(x590)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x590)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x601 = (x590)*((uintptr_t)4294967295ULL);
  x602 = sizeof(intptr_t) == 4 ? ((uint64_t)(x590)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x590)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x603 = (x602)+(x599);
  x604 = (x603)<(x602);
  x605 = (x604)+(x600);
  x606 = (x605)<(x600);
  ...
  x658 = (x657)+(x589);
  x659 = (x10)*(x5);
  x660 = sizeof(intptr_t) == 4 ? ((uint64_t)(x10)*(x5))>>32 : ((__uint128_t)(x10)*(x5))>>64 /* TODO this has not been tested */;
  x661 = (x10)*(x4);
  x662 = sizeof(intptr_t) == 4 ? ((uint64_t)(x10)*(x4))>>32 : ((__uint128_t)(x10)*(x4))>>64 /* TODO this has not been tested */;
  x663 = (x10)*(x3);
  x664 = sizeof(intptr_t) == 4 ? ((uint64_t)(x10)*(x3))>>32 : ((__uint128_t)(x10)*(x3))>>64 /* TODO this has not been tested */;
  x665 = (x10)*(x2);
  x666 = sizeof(intptr_t) == 4 ? ((uint64_t)(x10)*(x2))>>32 : ((__uint128_t)(x10)*(x2))>>64 /* TODO this has not been tested */;
  x667 = (x10)*(x1);
  x668 = sizeof(intptr_t) == 4 ? ((uint64_t)(x10)*(x1))>>32 : ((__uint128_t)(x10)*(x1))>>64 /* TODO this has not been tested */;
  x669 = (x10)*(x0);
  x670 = sizeof(intptr_t) == 4 ? ((uint64_t)(x10)*(x0))>>32 : ((__uint128_t)(x10)*(x0))>>64 /* TODO this has not been tested */;
  x671 = (x670)+(x667);
  x672 = (x671)<(x670);
  x673 = (x672)+(x668);
  x674 = (x673)<(x668);
  ...
  x728 = sizeof(intptr_t) == 4 ? ((uint64_t)(x726)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x726)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x729 = (x726)*((uintptr_t)18446744073709551615ULL);
  x730 = sizeof(intptr_t) == 4 ? ((uint64_t)(x726)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x726)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x731 = (x726)*((uintptr_t)18446744073709551615ULL);
  x732 = sizeof(intptr_t) == 4 ? ((uint64_t)(x726)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x726)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x733 = (x726)*((uintptr_t)18446744073709551614ULL);
  x734 = sizeof(intptr_t) == 4 ? ((uint64_t)(x726)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x726)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x735 = (x726)*((uintptr_t)18446744069414584320ULL);
  x736 = sizeof(intptr_t) == 4 ? ((uint64_t)(x726)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x726)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x737 = (x726)*((uintptr_t)4294967295ULL);
  x738 = sizeof(intptr_t) == 4 ? ((uint64_t)(x726)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x726)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  x739 = (x738)+(x735);
  x740 = (x739)<(x738);
  x741 = (x740)+(x736);
  x742 = (x741)<(x736);
...
void fiat_p384_from_montgomery(uintptr_t in0, uintptr_t out0) {
  ...
  x9 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x7)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x10 = (x7)*((uintptr_t)18446744073709551615ULL);
  x11 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x7)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x12 = (x7)*((uintptr_t)18446744073709551615ULL);
  x13 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x7)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x14 = (x7)*((uintptr_t)18446744073709551614ULL);
  x15 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x7)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x16 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x7)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x17 = sizeof(intptr_t) == 4 ? ((uint64_t)(x7)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x7)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  ...
  x43 = (x42)*((uintptr_t)18446744073709551615ULL);
  x44 = sizeof(intptr_t) == 4 ? ((uint64_t)(x42)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x42)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x45 = (x42)*((uintptr_t)18446744073709551615ULL);
  x46 = sizeof(intptr_t) == 4 ? ((uint64_t)(x42)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x42)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x47 = (x42)*((uintptr_t)18446744073709551615ULL);
  x48 = sizeof(intptr_t) == 4 ? ((uint64_t)(x42)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x42)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x49 = (x42)*((uintptr_t)18446744073709551614ULL);
  x50 = sizeof(intptr_t) == 4 ? ((uint64_t)(x42)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x42)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x51 = sizeof(intptr_t) == 4 ? ((uint64_t)(x42)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x42)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x52 = sizeof(intptr_t) == 4 ? ((uint64_t)(x42)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x42)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  ...
  x85 = sizeof(intptr_t) == 4 ? ((uint64_t)(x83)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x83)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x86 = (x83)*((uintptr_t)18446744073709551615ULL);
  x87 = sizeof(intptr_t) == 4 ? ((uint64_t)(x83)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x83)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x88 = (x83)*((uintptr_t)18446744073709551615ULL);
  x89 = sizeof(intptr_t) == 4 ? ((uint64_t)(x83)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x83)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x90 = (x83)*((uintptr_t)18446744073709551614ULL);
  x91 = sizeof(intptr_t) == 4 ? ((uint64_t)(x83)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x83)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x92 = sizeof(intptr_t) == 4 ? ((uint64_t)(x83)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x83)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x93 = sizeof(intptr_t) == 4 ? ((uint64_t)(x83)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x83)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  ...
  x126 = sizeof(intptr_t) == 4 ? ((uint64_t)(x124)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x124)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x127 = (x124)*((uintptr_t)18446744073709551615ULL);
  x128 = sizeof(intptr_t) == 4 ? ((uint64_t)(x124)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x124)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x129 = (x124)*((uintptr_t)18446744073709551615ULL);
  x130 = sizeof(intptr_t) == 4 ? ((uint64_t)(x124)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x124)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x131 = (x124)*((uintptr_t)18446744073709551614ULL);
  x132 = sizeof(intptr_t) == 4 ? ((uint64_t)(x124)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x124)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x133 = sizeof(intptr_t) == 4 ? ((uint64_t)(x124)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x124)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x134 = sizeof(intptr_t) == 4 ? ((uint64_t)(x124)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x124)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  ...
  x167 = sizeof(intptr_t) == 4 ? ((uint64_t)(x165)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x165)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x168 = (x165)*((uintptr_t)18446744073709551615ULL);
  x169 = sizeof(intptr_t) == 4 ? ((uint64_t)(x165)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x165)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x170 = (x165)*((uintptr_t)18446744073709551615ULL);
  x171 = sizeof(intptr_t) == 4 ? ((uint64_t)(x165)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x165)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x172 = (x165)*((uintptr_t)18446744073709551614ULL);
  x173 = sizeof(intptr_t) == 4 ? ((uint64_t)(x165)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x165)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x174 = sizeof(intptr_t) == 4 ? ((uint64_t)(x165)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x165)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x175 = sizeof(intptr_t) == 4 ? ((uint64_t)(x165)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x165)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
  ...
  x208 = sizeof(intptr_t) == 4 ? ((uint64_t)(x206)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x206)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x209 = (x206)*((uintptr_t)18446744073709551615ULL);
  x210 = sizeof(intptr_t) == 4 ? ((uint64_t)(x206)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x206)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x211 = (x206)*((uintptr_t)18446744073709551615ULL);
  x212 = sizeof(intptr_t) == 4 ? ((uint64_t)(x206)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x206)*((uintptr_t)18446744073709551615ULL))>>64 /* TODO this has not been tested */;
  x213 = (x206)*((uintptr_t)18446744073709551614ULL);
  x214 = sizeof(intptr_t) == 4 ? ((uint64_t)(x206)*((uintptr_t)18446744073709551614ULL))>>32 : ((__uint128_t)(x206)*((uintptr_t)18446744073709551614ULL))>>64 /* TODO this has not been tested */;
  x215 = sizeof(intptr_t) == 4 ? ((uint64_t)(x206)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x206)*((uintptr_t)18446744069414584320ULL))>>64 /* TODO this has not been tested */;
  x216 = sizeof(intptr_t) == 4 ? ((uint64_t)(x206)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x206)*((uintptr_t)4294967295ULL))>>64 /* TODO this has not been tested */;
