/* Autogenerated: src/ExtractionOCaml/bedrock2_word_by_word_montgomery --lang bedrock2 --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select p384 64 '2^384 - 2^128 - 2^96 + 2^32 - 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
...
void fiat_p384_mul(uintptr_t out0, uintptr_t in0, uintptr_t in1) {
  ...
  x857 = x851;
  /*skip*/
  _br2_store((out0)+((uintptr_t)0ULL), x852, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)8ULL), x853, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)16ULL), x854, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)24ULL), x855, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)32ULL), x856, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)40ULL), x857, sizeof(uintptr_t));
  /*skip*/
  return;
}
...
void fiat_p384_square(uintptr_t out0, uintptr_t in0) {
  ...
  x851 = x845;
  /*skip*/
  _br2_store((out0)+((uintptr_t)0ULL), x846, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)8ULL), x847, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)16ULL), x848, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)24ULL), x849, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)32ULL), x850, sizeof(uintptr_t));
  _br2_store((out0)+((uintptr_t)40ULL), x851, sizeof(uintptr_t));
  /*skip*/
  return;
}
