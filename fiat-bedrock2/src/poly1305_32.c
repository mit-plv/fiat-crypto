/* Autogenerated: src/ExtractionOCaml/bedrock2_unsaturated_solinas --lang=bedrock2 --no-wide-int --widen-carry --widen-bytes --split-multiret poly1305 5 '2^130 - 5' 32 carry_mul carry_square carry add sub opp from_bytes */
...
void fiat_poly1305_carry_mul(uintptr_t in0, uintptr_t in1, uintptr_t out0) {
  ...
  x11 = sizeof(intptr_t) == 4 ? ((uint64_t)(x4)*((x9)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x4)*((x9)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x12 = (x4)*((x8)*((uintptr_t)5ULL));
  x13 = sizeof(intptr_t) == 4 ? ((uint64_t)(x4)*((x8)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x4)*((x8)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x14 = (x4)*((x7)*((uintptr_t)5ULL));
  x15 = sizeof(intptr_t) == 4 ? ((uint64_t)(x4)*((x7)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x4)*((x7)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x16 = (x4)*((x6)*((uintptr_t)5ULL));
  x17 = sizeof(intptr_t) == 4 ? ((uint64_t)(x4)*((x6)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x4)*((x6)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x18 = (x3)*((x9)*((uintptr_t)5ULL));
  x19 = sizeof(intptr_t) == 4 ? ((uint64_t)(x3)*((x9)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x3)*((x9)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x20 = (x3)*((x8)*((uintptr_t)5ULL));
  x21 = sizeof(intptr_t) == 4 ? ((uint64_t)(x3)*((x8)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x3)*((x8)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x22 = (x3)*((x7)*((uintptr_t)5ULL));
  x23 = sizeof(intptr_t) == 4 ? ((uint64_t)(x3)*((x7)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x3)*((x7)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x24 = (x2)*((x9)*((uintptr_t)5ULL));
  x25 = sizeof(intptr_t) == 4 ? ((uint64_t)(x2)*((x9)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x2)*((x9)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x26 = (x2)*((x8)*((uintptr_t)5ULL));
  x27 = sizeof(intptr_t) == 4 ? ((uint64_t)(x2)*((x8)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x2)*((x8)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x28 = (x1)*((x9)*((uintptr_t)5ULL));
  x29 = sizeof(intptr_t) == 4 ? ((uint64_t)(x1)*((x9)*((uintptr_t)5ULL)))>>32 : ((__uint128_t)(x1)*((x9)*((uintptr_t)5ULL)))>>64 /* TODO this has not been tested */;
  x30 = (x4)*(x5);
  ...
  x171 = sizeof(intptr_t) == 4 ? ((uint64_t)(x168)*((uintptr_t)5ULL))>>32 : ((__uint128_t)(x168)*((uintptr_t)5ULL))>>64 /* TODO this has not been tested */;
  x172 = (x78)+(x170);
  x173 = (x172)<(x78);
  x174 = (x173)+(x171);
...
void fiat_poly1305_carry_square(uintptr_t in0, uintptr_t out0) {
  ...
  x114 = sizeof(intptr_t) == 4 ? ((uint64_t)(x111)*((uintptr_t)5ULL))>>32 : ((__uint128_t)(x111)*((uintptr_t)5ULL))>>64 /* TODO this has not been tested */;
  x115 = (x53)+(x113);
  x116 = (x115)<(x53);
  x117 = (x116)+(x114);
