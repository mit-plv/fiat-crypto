...
void internal_fiat_poly1305_carry_mul(br_word_t out0, br_word_t in0, br_word_t in1) {
  ...
  x3 = _br_load(in1+0x0);
  x4 = _br_load(in1+0x8);
  x5 = _br_load(in1+0x10);
  /*skip*/
  /*skip*/
  x6 = x2*(x5*0x5);
  x7 = _br_mulhuu(x2, x5*0x5);
  x8 = x2*(x4*0xa);
  x9 = _br_mulhuu(x2, x4*0xa);
  x10 = x1*(x5*0xa);
  x11 = _br_mulhuu(x1, x5*0xa);
  x12 = x2*x3;
  x13 = _br_mulhuu(x2, x3);
  x14 = x1*(x4*0x2);
  x15 = _br_mulhuu(x1, x4*0x2);
  x16 = x1*x3;
  ...
  x70 = x67;
  /*skip*/
  _br_store(out0+0x0, x68);
  _br_store(out0+0x8, x69);
  _br_store(out0+0x10, x70);
  /*skip*/
  return;
}
...
void internal_fiat_poly1305_carry_square(br_word_t out0, br_word_t in0) {
  ...
  x8 = _br_mulhuu(x2, x3);
  x9 = x1*(x4*0x2);
  x10 = _br_mulhuu(x1, x4*0x2);
  x11 = x1*(x1*0x2);
  x12 = _br_mulhuu(x1, x1*0x2);
  x13 = x0*x5;
  ...
  x53 = x50;
  /*skip*/
  _br_store(out0+0x0, x51);
  _br_store(out0+0x8, x52);
  _br_store(out0+0x10, x53);
  /*skip*/
  return;
}
...
void internal_fiat_poly1305_carry(br_word_t out0, br_word_t in0) {
  ...
  x4 = (x3>>44)+x1;
  x5 = (x4>>43)+x2;
  x6 = (x3&0xfffffffffff)+((x5>>43)*0x5);
  x7 = (x6>>44)+(x4&0x7ffffffffff);
  x8 = x6&0xfffffffffff;
  x9 = x7&0x7ffffffffff;
  x10 = (x7>>43)+(x5&0x7ffffffffff);
  x11 = x8;
  x12 = x9;
  x13 = x10;
  /*skip*/
  _br_store(out0+0x0, x11);
  _br_store(out0+0x8, x12);
  _br_store(out0+0x10, x13);
  /*skip*/
  return;
}
...
void internal_fiat_poly1305_add(br_word_t out0, br_word_t in0, br_word_t in1) {
  ...
  x11 = x8;
  /*skip*/
  _br_store(out0+0x0, x9);
  _br_store(out0+0x8, x10);
  _br_store(out0+0x10, x11);
  /*skip*/
  return;
}
...
void internal_fiat_poly1305_opp(br_word_t out0, br_word_t in0) {
  ...
  x8 = x5;
  /*skip*/
  _br_store(out0+0x0, x6);
  _br_store(out0+0x8, x7);
  _br_store(out0+0x10, x8);
  /*skip*/
  return;
}
...
void internal_fiat_poly1305_selectznz(br_word_t out0, br_word_t in0, br_word_t in1, br_word_t in2) {
  ...
  x3 = _br_load(in2+0x0);
  x4 = _br_load(in2+0x8);
  x5 = _br_load(in2+0x10);
  /*skip*/
  /*skip*/
  x6 = (br_word_t)-0x1+((br_word_t)(in0==(br_word_t)0x0));
  x7 = x6^0xffffffffffffffff;
  x8 = (x3&x6)|(x0&x7);
  x9 = (br_word_t)-0x1+((br_word_t)(in0==(br_word_t)0x0));
  x10 = x9^0xffffffffffffffff;
  x11 = (x4&x9)|(x1&x10);
  x12 = (br_word_t)-0x1+((br_word_t)(in0==(br_word_t)0x0));
  ...
  x17 = x14;
  /*skip*/
  _br_store(out0+0x0, x15);
  _br_store(out0+0x8, x16);
  _br_store(out0+0x10, x17);
  /*skip*/
  return;
}
...
void internal_fiat_poly1305_to_bytes(br_word_t out0, br_word_t in0) {
  ...
  x20 = (x18<<21)-(x16>>43);
  x21 = (br_word_t)-0x1+((br_word_t)(x20==(br_word_t)0x0));
  ...
  x88 = x71;
  /*skip*/
  _br_store1(out0+0x0, x72);
  _br_store1(out0+0x1, x73);
  _br_store1(out0+0x2, x74);
  _br_store1(out0+0x3, x75);
  _br_store1(out0+0x4, x76);
  _br_store1(out0+0x5, x77);
  _br_store1(out0+0x6, x78);
  _br_store1(out0+0x7, x79);
  _br_store1(out0+0x8, x80);
  _br_store1(out0+0x9, x81);
  _br_store1(out0+0xa, x82);
  _br_store1(out0+0xb, x83);
  _br_store1(out0+0xc, x84);
  _br_store1(out0+0xd, x85);
  _br_store1(out0+0xe, x86);
  _br_store1(out0+0xf, x87);
  _br_store1(out0+0x10, x88);
  /*skip*/
  return;
}
...
void internal_fiat_poly1305_from_bytes(br_word_t out0, br_word_t in0) {
  ...
  x56 = x53;
  /*skip*/
  _br_store(out0+0x0, x54);
  _br_store(out0+0x8, x55);
  _br_store(out0+0x10, x56);
  /*skip*/
  return;
}
