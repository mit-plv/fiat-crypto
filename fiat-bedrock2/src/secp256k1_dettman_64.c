...
void internal_fiat_secp256k1_dettman_mul(br_word_t out0, br_word_t in0, br_word_t in1) {
  ...
  x4 = _br_load(in0+0x20);
  /*skip*/
  x5 = _br_load(in1+0x0);
  x6 = _br_load(in1+0x8);
  x7 = _br_load(in1+0x10);
  x8 = _br_load(in1+0x18);
  x9 = _br_load(in1+0x20);
  /*skip*/
  /*skip*/
  x10 = x4*x9;
  ...
  x200 = x195;
  /*skip*/
  _br_store(out0+0x0, x196);
  _br_store(out0+0x8, x197);
  _br_store(out0+0x10, x198);
  _br_store(out0+0x18, x199);
  _br_store(out0+0x20, x200);
  /*skip*/
  return;
}
...
void internal_fiat_secp256k1_dettman_square(br_word_t out0, br_word_t in0) {
  ...
  x139 = x134;
  /*skip*/
  _br_store(out0+0x0, x135);
  _br_store(out0+0x8, x136);
  _br_store(out0+0x10, x137);
  _br_store(out0+0x18, x138);
  _br_store(out0+0x20, x139);
  /*skip*/
  return;
}
