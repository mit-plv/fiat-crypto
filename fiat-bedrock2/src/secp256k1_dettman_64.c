...
void internal_fiat_secp256k1_dettman_mul(uintptr_t out0, uintptr_t in0, uintptr_t in1) {
  ...
  x77 = (x76)>>_br2_shamt((uintptr_t)(UINTMAX_C(48)));
  x78 = (x76)&((uintptr_t)(UINTMAX_C(281474976710655)));
  x79 = (x4)*(x6);
  x80 = _br2_mulhuu((x4), (x6));
  x81 = (x3)*(x7);
  x82 = _br2_mulhuu((x3), (x7));
  x83 = (x81)+(x79);
  x84 = (uintptr_t)((x83)<(x81));
  x85 = (x84)+(x82);
  x86 = (x85)+(x80);
  x87 = (x2)*(x8);
  x88 = _br2_mulhuu((x2), (x8));
  x89 = (x87)+(x83);
  x90 = (uintptr_t)((x89)<(x87));
  x91 = (x90)+(x88);
  x92 = (x91)+(x86);
  x93 = (x1)*(x9);
  x94 = _br2_mulhuu((x1), (x9));
  x95 = (x93)+(x89);
...
void internal_fiat_secp256k1_dettman_square(uintptr_t out0, uintptr_t in0) {
  ...
  x52 = (x51)>>_br2_shamt((uintptr_t)(UINTMAX_C(48)));
  x53 = (x51)&((uintptr_t)(UINTMAX_C(281474976710655)));
  x54 = (x6)*(x3);
  x55 = _br2_mulhuu((x6), (x3));
  x56 = (x7)*(x4);
  x57 = _br2_mulhuu((x7), (x4));
  x58 = (x56)+(x54);
  x59 = (uintptr_t)((x58)<(x56));
  x60 = (x59)+(x57);
  x61 = (x60)+(x55);
