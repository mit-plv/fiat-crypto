/* Autogenerated: src/ExtractionOCaml/bedrock2_word_by_word_montgomery --lang bedrock2 --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select p224 64 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes scmul2 scmul3 scmul4 scmul8 */
...
void fiat_p224_scmul_2(uintptr_t out0, uintptr_t in0) {
  uintptr_t x8, x11, x13, x9, x14, x6, x15, x17, x18, x7, x19, x4, x20, x22, x23, x5, x28, x31, x33, x29, x34, x26, x35, x37, x38, x27, x25, x40, x10, x41, x12, x42, x30, x43, x45, x46, x16, x47, x32, x48, x50, x51, x21, x52, x36, x53, x55, x56, x24, x39, x62, x65, x67, x63, x68, x60, x69, x71, x72, x61, x73, x58, x74, x76, x77, x59, x64, x44, x80, x49, x81, x66, x82, x84, x85, x54, x86, x70, x87, x89, x90, x57, x91, x75, x92, x94, x95, x78, x101, x104, x106, x102, x107, x99, x108, x110, x111, x100, x98, x113, x79, x114, x83, x115, x103, x116, x118, x119, x88, x120, x105, x121, x123, x124, x93, x125, x109, x126, x128, x129, x96, x130, x112, x131, x133, x134, x97, x3, x2, x1, x0, x139, x117, x141, x122, x142, x138, x143, x145, x146, x127, x147, x137, x148, x150, x151, x132, x152, x136, x153, x155, x156, x135, x161, x164, x166, x162, x167, x159, x168, x170, x171, x160, x158, x173, x140, x174, x144, x175, x163, x176, x178, x179, x149, x180, x165, x181, x183, x184, x154, x185, x169, x186, x188, x189, x157, x172, x194, x197, x199, x195, x200, x192, x201, x203, x204, x193, x191, x206, x177, x207, x182, x208, x196, x209, x211, x212, x187, x213, x198, x214, x216, x217, x190, x218, x202, x219, x221, x222, x205, x225, x226, x227, x228, x229, x231, x232, x233, x234, x236, x237, x238, x239, x241, x242, x210, x244, x224, x245, x215, x247, x230, x248, x220, x250, x235, x251, x243, x223, x253, x240, x254, x246, x249, x252, x255, x256, x257, x258, x259;
  x0 = *(uintptr_t*)((in0)+((uintptr_t)0ULL));
  x1 = *(uintptr_t*)((in0)+((uintptr_t)8ULL));
  x2 = *(uintptr_t*)((in0)+((uintptr_t)16ULL));
  x3 = *(uintptr_t*)((in0)+((uintptr_t)24ULL));
  /*skip*/
  /*skip*/
  x4 = ((uintptr_t)18446744065119617024ULL)*(x3);
  x5 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744065119617024ULL)*(x3))>>32 : ((__uint128_t)((uintptr_t)18446744065119617024ULL)*(x3))>>64;
  x6 = ((uintptr_t)18446744065119617024ULL)*(x2);
  x7 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744065119617024ULL)*(x2))>>32 : ((__uint128_t)((uintptr_t)18446744065119617024ULL)*(x2))>>64;
  x8 = ((uintptr_t)18446744065119617024ULL)*(x1);
  x9 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744065119617024ULL)*(x1))>>32 : ((__uint128_t)((uintptr_t)18446744065119617024ULL)*(x1))>>64;
  x10 = ((uintptr_t)18446744065119617024ULL)*(x0);
  x11 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744065119617024ULL)*(x0))>>32 : ((__uint128_t)((uintptr_t)18446744065119617024ULL)*(x0))>>64;
  x12 = (x11)+(x8);
  x13 = (x12)<(x11);
  x14 = (x13)+(x9);
  x15 = (x14)<(x9);
  ...
  x23 = (x20)+(x22);
  x24 = (x23)+(x5);
  x25 = (x10)*((uintptr_t)18446744073709551615ULL);
  ...
  x28 = (x25)*((uintptr_t)18446744073709551615ULL);
  x29 = sizeof(intptr_t) == 4 ? ((uint64_t)(x25)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x25)*((uintptr_t)18446744073709551615ULL))>>64;
  x30 = (x25)*((uintptr_t)18446744069414584320ULL);
  x31 = sizeof(intptr_t) == 4 ? ((uint64_t)(x25)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x25)*((uintptr_t)18446744069414584320ULL))>>64;
  x32 = (x31)+(x28);
  x33 = (x32)<(x31);
  x34 = (x33)+(x29);
  x35 = (x34)<(x29);
  ...
  x56 = (x53)+(x55);
  x57 = ((x56)+(x24))+(x39);
  x58 = ((uintptr_t)18446744073709551615ULL)*(x3);
  x59 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744073709551615ULL)*(x3))>>32 : ((__uint128_t)((uintptr_t)18446744073709551615ULL)*(x3))>>64;
  x60 = ((uintptr_t)18446744073709551615ULL)*(x2);
  x61 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744073709551615ULL)*(x2))>>32 : ((__uint128_t)((uintptr_t)18446744073709551615ULL)*(x2))>>64;
  x62 = ((uintptr_t)18446744073709551615ULL)*(x1);
  x63 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744073709551615ULL)*(x1))>>32 : ((__uint128_t)((uintptr_t)18446744073709551615ULL)*(x1))>>64;
  x64 = ((uintptr_t)18446744073709551615ULL)*(x0);
  x65 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744073709551615ULL)*(x0))>>32 : ((__uint128_t)((uintptr_t)18446744073709551615ULL)*(x0))>>64;
  x66 = (x65)+(x62);
  x67 = (x66)<(x65);
  x68 = (x67)+(x63);
  x69 = (x68)<(x63);
  ...
  x96 = (x95)+(x78);
  x97 = (x96)<(x78);
  x98 = (x79)*((uintptr_t)18446744073709551615ULL);
  x99 = (x98)*((uintptr_t)4294967295ULL);
  x100 = sizeof(intptr_t) == 4 ? ((uint64_t)(x98)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x98)*((uintptr_t)4294967295ULL))>>64;
  x101 = (x98)*((uintptr_t)18446744073709551615ULL);
  x102 = sizeof(intptr_t) == 4 ? ((uint64_t)(x98)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x98)*((uintptr_t)18446744073709551615ULL))>>64;
  x103 = (x98)*((uintptr_t)18446744069414584320ULL);
  x104 = sizeof(intptr_t) == 4 ? ((uint64_t)(x98)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x98)*((uintptr_t)18446744069414584320ULL))>>64;
  x105 = (x104)+(x101);
  x106 = (x105)<(x104);
  x107 = (x106)+(x102);
  x108 = (x107)<(x102);
  ...
  x156 = (x153)+(x155);
  x157 = (x156)+(x135);
  x158 = (x140)*((uintptr_t)18446744073709551615ULL);
  x159 = (x158)*((uintptr_t)4294967295ULL);
  x160 = sizeof(intptr_t) == 4 ? ((uint64_t)(x158)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x158)*((uintptr_t)4294967295ULL))>>64;
  x161 = (x158)*((uintptr_t)18446744073709551615ULL);
  x162 = sizeof(intptr_t) == 4 ? ((uint64_t)(x158)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x158)*((uintptr_t)18446744073709551615ULL))>>64;
  x163 = (x158)*((uintptr_t)18446744069414584320ULL);
  x164 = sizeof(intptr_t) == 4 ? ((uint64_t)(x158)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x158)*((uintptr_t)18446744069414584320ULL))>>64;
  x165 = (x164)+(x161);
  x166 = (x165)<(x164);
  x167 = (x166)+(x162);
  x168 = (x167)<(x162);
  ...
  x189 = (x186)+(x188);
  x190 = ((x189)+(x157))+(x172);
  x191 = (x177)*((uintptr_t)18446744073709551615ULL);
  x192 = (x191)*((uintptr_t)4294967295ULL);
  x193 = sizeof(intptr_t) == 4 ? ((uint64_t)(x191)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x191)*((uintptr_t)4294967295ULL))>>64;
  x194 = (x191)*((uintptr_t)18446744073709551615ULL);
  x195 = sizeof(intptr_t) == 4 ? ((uint64_t)(x191)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x191)*((uintptr_t)18446744073709551615ULL))>>64;
  x196 = (x191)*((uintptr_t)18446744069414584320ULL);
  x197 = sizeof(intptr_t) == 4 ? ((uint64_t)(x191)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x191)*((uintptr_t)18446744069414584320ULL))>>64;
  x198 = (x197)+(x194);
  x199 = (x198)<(x197);
  x200 = (x199)+(x195);
  x201 = (x200)<(x195);
  ...
  x222 = (x219)+(x221);
  x223 = (x222)+(x205);
  x224 = (x210)-((uintptr_t)1ULL);
  x225 = (x210)<(x224);
  x226 = (x224)<(x224);
  x227 = (x225)+(x226);
  x228 = (x215)-((uintptr_t)18446744069414584320ULL);
  x229 = (x215)<(x228);
  x230 = (x228)-(x227);
  x231 = (x228)<(x230);
  x232 = (x229)+(x231);
  x233 = (x220)-((uintptr_t)18446744073709551615ULL);
  x234 = (x220)<(x233);
  x235 = (x233)-(x232);
  x236 = (x233)<(x235);
  x237 = (x234)+(x236);
  x238 = (x223)-((uintptr_t)4294967295ULL);
  x239 = (x223)<(x238);
  x240 = (x238)-(x237);
  x241 = (x238)<(x240);
  x242 = (x239)+(x241);
  x243 = ((uintptr_t)0ULL)<(((uintptr_t)0ULL)-(x242));
  x244 = ((uintptr_t)-1ULL)+((x243)==((uintptr_t)0ULL));
  x245 = (x244)^((uintptr_t)18446744073709551615ULL);
  x246 = ((x210)&(x244))|((x224)&(x245));
  x247 = ((uintptr_t)-1ULL)+((x243)==((uintptr_t)0ULL));
  x248 = (x247)^((uintptr_t)18446744073709551615ULL);
  x249 = ((x215)&(x247))|((x230)&(x248));
  x250 = ((uintptr_t)-1ULL)+((x243)==((uintptr_t)0ULL));
  x251 = (x250)^((uintptr_t)18446744073709551615ULL);
  x252 = ((x220)&(x250))|((x235)&(x251));
  x253 = ((uintptr_t)-1ULL)+((x243)==((uintptr_t)0ULL));
  x254 = (x253)^((uintptr_t)18446744073709551615ULL);
  x255 = ((x223)&(x253))|((x240)&(x254));
  x256 = x246;
  x257 = x249;
  x258 = x252;
  x259 = x255;
  ...
  *(uintptr_t*)((out0)+((uintptr_t)8ULL)) = x257;
  *(uintptr_t*)((out0)+((uintptr_t)16ULL)) = x258;
  *(uintptr_t*)((out0)+((uintptr_t)24ULL)) = x259;
  /*skip*/
  return;
}
...
void fiat_p224_scmul_3(uintptr_t out0, uintptr_t in0) {
  uintptr_t x8, x11, x13, x9, x14, x6, x15, x17, x18, x7, x19, x4, x20, x22, x23, x5, x28, x31, x33, x29, x34, x26, x35, x37, x38, x27, x25, x40, x10, x41, x12, x42, x30, x43, x45, x46, x16, x47, x32, x48, x50, x51, x21, x52, x36, x53, x55, x56, x24, x39, x62, x65, x67, x63, x68, x60, x69, x71, x72, x61, x73, x58, x74, x76, x77, x59, x64, x44, x80, x49, x81, x66, x82, x84, x85, x54, x86, x70, x87, x89, x90, x57, x91, x75, x92, x94, x95, x78, x101, x104, x106, x102, x107, x99, x108, x110, x111, x100, x98, x113, x79, x114, x83, x115, x103, x116, x118, x119, x88, x120, x105, x121, x123, x124, x93, x125, x109, x126, x128, x129, x96, x130, x112, x131, x133, x134, x97, x3, x2, x1, x0, x140, x143, x145, x141, x146, x138, x147, x149, x150, x139, x151, x136, x152, x154, x155, x137, x142, x117, x158, x122, x159, x144, x160, x162, x163, x127, x164, x148, x165, x167, x168, x132, x169, x153, x170, x172, x173, x135, x156, x178, x181, x183, x179, x184, x176, x185, x187, x188, x177, x175, x190, x157, x191, x161, x192, x180, x193, x195, x196, x166, x197, x182, x198, x200, x201, x171, x202, x186, x203, x205, x206, x174, x189, x211, x214, x216, x212, x217, x209, x218, x220, x221, x210, x208, x223, x194, x224, x199, x225, x213, x226, x228, x229, x204, x230, x215, x231, x233, x234, x207, x235, x219, x236, x238, x239, x222, x242, x243, x244, x245, x246, x248, x249, x250, x251, x253, x254, x255, x256, x258, x259, x227, x261, x241, x262, x232, x264, x247, x265, x237, x267, x252, x268, x260, x240, x270, x257, x271, x263, x266, x269, x272, x273, x274, x275, x276;
  x0 = *(uintptr_t*)((in0)+((uintptr_t)0ULL));
  x1 = *(uintptr_t*)((in0)+((uintptr_t)8ULL));
  x2 = *(uintptr_t*)((in0)+((uintptr_t)16ULL));
  x3 = *(uintptr_t*)((in0)+((uintptr_t)24ULL));
  /*skip*/
  /*skip*/
  x4 = ((uintptr_t)18446744060824649728ULL)*(x3);
  x5 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744060824649728ULL)*(x3))>>32 : ((__uint128_t)((uintptr_t)18446744060824649728ULL)*(x3))>>64;
  x6 = ((uintptr_t)18446744060824649728ULL)*(x2);
  x7 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744060824649728ULL)*(x2))>>32 : ((__uint128_t)((uintptr_t)18446744060824649728ULL)*(x2))>>64;
  x8 = ((uintptr_t)18446744060824649728ULL)*(x1);
  x9 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744060824649728ULL)*(x1))>>32 : ((__uint128_t)((uintptr_t)18446744060824649728ULL)*(x1))>>64;
  x10 = ((uintptr_t)18446744060824649728ULL)*(x0);
  x11 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744060824649728ULL)*(x0))>>32 : ((__uint128_t)((uintptr_t)18446744060824649728ULL)*(x0))>>64;
  x12 = (x11)+(x8);
  x13 = (x12)<(x11);
  x14 = (x13)+(x9);
  x15 = (x14)<(x9);
  ...
  x134 = (x131)+(x133);
  x135 = (x134)+(x97);
  x136 = ((uintptr_t)2ULL)*(x3);
  x137 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)2ULL)*(x3))>>32 : ((__uint128_t)((uintptr_t)2ULL)*(x3))>>64;
  x138 = ((uintptr_t)2ULL)*(x2);
  x139 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)2ULL)*(x2))>>32 : ((__uint128_t)((uintptr_t)2ULL)*(x2))>>64;
  x140 = ((uintptr_t)2ULL)*(x1);
  x141 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)2ULL)*(x1))>>32 : ((__uint128_t)((uintptr_t)2ULL)*(x1))>>64;
  x142 = ((uintptr_t)2ULL)*(x0);
  x143 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)2ULL)*(x0))>>32 : ((__uint128_t)((uintptr_t)2ULL)*(x0))>>64;
  x144 = (x143)+(x140);
  x145 = (x144)<(x143);
  x146 = (x145)+(x141);
  x147 = (x146)<(x141);
  ...
  x173 = (x170)+(x172);
  x174 = ((x173)+(x135))+(x156);
  x175 = (x157)*((uintptr_t)18446744073709551615ULL);
  x176 = (x175)*((uintptr_t)4294967295ULL);
  x177 = sizeof(intptr_t) == 4 ? ((uint64_t)(x175)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x175)*((uintptr_t)4294967295ULL))>>64;
  x178 = (x175)*((uintptr_t)18446744073709551615ULL);
  x179 = sizeof(intptr_t) == 4 ? ((uint64_t)(x175)*((uintptr_t)18446744073709551615ULL))>>32 : ((__uint128_t)(x175)*((uintptr_t)18446744073709551615ULL))>>64;
  x180 = (x175)*((uintptr_t)18446744069414584320ULL);
  x181 = sizeof(intptr_t) == 4 ? ((uint64_t)(x175)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x175)*((uintptr_t)18446744069414584320ULL))>>64;
  x182 = (x181)+(x178);
  x183 = (x182)<(x181);
  x184 = (x183)+(x179);
  x185 = (x184)<(x179);
  ...
  x206 = (x203)+(x205);
  x207 = ((x206)+(x174))+(x189);
  x208 = (x194)*((uintptr_t)18446744073709551615ULL);
  x209 = (x208)*((uintptr_t)4294967295ULL);
  x210 = sizeof(intptr_t) == 4 ? ((uint64_t)(x208)*((uintptr_t)4294967295ULL))>>32 : ((__uint128_t)(x208)*((uintptr_t)4294967295ULL))>>64;
  ...
  x213 = (x208)*((uintptr_t)18446744069414584320ULL);
  x214 = sizeof(intptr_t) == 4 ? ((uint64_t)(x208)*((uintptr_t)18446744069414584320ULL))>>32 : ((__uint128_t)(x208)*((uintptr_t)18446744069414584320ULL))>>64;
  x215 = (x214)+(x211);
  x216 = (x215)<(x214);
  x217 = (x216)+(x212);
  x218 = (x217)<(x212);
  ...
  x239 = (x236)+(x238);
  x240 = (x239)+(x222);
  x241 = (x227)-((uintptr_t)1ULL);
  x242 = (x227)<(x241);
  x243 = (x241)<(x241);
  x244 = (x242)+(x243);
  x245 = (x232)-((uintptr_t)18446744069414584320ULL);
  x246 = (x232)<(x245);
  x247 = (x245)-(x244);
  x248 = (x245)<(x247);
  x249 = (x246)+(x248);
  x250 = (x237)-((uintptr_t)18446744073709551615ULL);
  x251 = (x237)<(x250);
  x252 = (x250)-(x249);
  x253 = (x250)<(x252);
  x254 = (x251)+(x253);
  x255 = (x240)-((uintptr_t)4294967295ULL);
  x256 = (x240)<(x255);
  x257 = (x255)-(x254);
  x258 = (x255)<(x257);
  x259 = (x256)+(x258);
  x260 = ((uintptr_t)0ULL)<(((uintptr_t)0ULL)-(x259));
  x261 = ((uintptr_t)-1ULL)+((x260)==((uintptr_t)0ULL));
  x262 = (x261)^((uintptr_t)18446744073709551615ULL);
  x263 = ((x227)&(x261))|((x241)&(x262));
  x264 = ((uintptr_t)-1ULL)+((x260)==((uintptr_t)0ULL));
  x265 = (x264)^((uintptr_t)18446744073709551615ULL);
  x266 = ((x232)&(x264))|((x247)&(x265));
  x267 = ((uintptr_t)-1ULL)+((x260)==((uintptr_t)0ULL));
  x268 = (x267)^((uintptr_t)18446744073709551615ULL);
  x269 = ((x237)&(x267))|((x252)&(x268));
  x270 = ((uintptr_t)-1ULL)+((x260)==((uintptr_t)0ULL));
  x271 = (x270)^((uintptr_t)18446744073709551615ULL);
  x272 = ((x240)&(x270))|((x257)&(x271));
  x273 = x263;
  x274 = x266;
  x275 = x269;
  x276 = x272;
  /*skip*/
  *(uintptr_t*)((out0)+((uintptr_t)0ULL)) = x273;
  *(uintptr_t*)((out0)+((uintptr_t)8ULL)) = x274;
  *(uintptr_t*)((out0)+((uintptr_t)16ULL)) = x275;
  *(uintptr_t*)((out0)+((uintptr_t)24ULL)) = x276;
  /*skip*/
  return;
}
...
void fiat_p224_scmul_4(uintptr_t out0, uintptr_t in0) {
  ...
  /*skip*/
  /*skip*/
  x4 = ((uintptr_t)18446744056529682432ULL)*(x3);
  x5 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744056529682432ULL)*(x3))>>32 : ((__uint128_t)((uintptr_t)18446744056529682432ULL)*(x3))>>64;
  x6 = ((uintptr_t)18446744056529682432ULL)*(x2);
  x7 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744056529682432ULL)*(x2))>>32 : ((__uint128_t)((uintptr_t)18446744056529682432ULL)*(x2))>>64;
  x8 = ((uintptr_t)18446744056529682432ULL)*(x1);
  x9 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744056529682432ULL)*(x1))>>32 : ((__uint128_t)((uintptr_t)18446744056529682432ULL)*(x1))>>64;
  x10 = ((uintptr_t)18446744056529682432ULL)*(x0);
  x11 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744056529682432ULL)*(x0))>>32 : ((__uint128_t)((uintptr_t)18446744056529682432ULL)*(x0))>>64;
  x12 = (x11)+(x8);
  x13 = (x12)<(x11);
  x14 = (x13)+(x9);
  x15 = (x14)<(x9);
  ...
  x134 = (x131)+(x133);
  x135 = (x134)+(x97);
  x136 = ((uintptr_t)3ULL)*(x3);
  x137 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)3ULL)*(x3))>>32 : ((__uint128_t)((uintptr_t)3ULL)*(x3))>>64;
  x138 = ((uintptr_t)3ULL)*(x2);
  x139 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)3ULL)*(x2))>>32 : ((__uint128_t)((uintptr_t)3ULL)*(x2))>>64;
  x140 = ((uintptr_t)3ULL)*(x1);
  x141 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)3ULL)*(x1))>>32 : ((__uint128_t)((uintptr_t)3ULL)*(x1))>>64;
  x142 = ((uintptr_t)3ULL)*(x0);
  x143 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)3ULL)*(x0))>>32 : ((__uint128_t)((uintptr_t)3ULL)*(x0))>>64;
  x144 = (x143)+(x140);
  x145 = (x144)<(x143);
  x146 = (x145)+(x141);
  x147 = (x146)<(x141);
...
void fiat_p224_scmul_8(uintptr_t out0, uintptr_t in0) {
  ...
  /*skip*/
  /*skip*/
  x4 = ((uintptr_t)18446744039349813248ULL)*(x3);
  x5 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744039349813248ULL)*(x3))>>32 : ((__uint128_t)((uintptr_t)18446744039349813248ULL)*(x3))>>64;
  x6 = ((uintptr_t)18446744039349813248ULL)*(x2);
  x7 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744039349813248ULL)*(x2))>>32 : ((__uint128_t)((uintptr_t)18446744039349813248ULL)*(x2))>>64;
  x8 = ((uintptr_t)18446744039349813248ULL)*(x1);
  x9 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744039349813248ULL)*(x1))>>32 : ((__uint128_t)((uintptr_t)18446744039349813248ULL)*(x1))>>64;
  x10 = ((uintptr_t)18446744039349813248ULL)*(x0);
  x11 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)18446744039349813248ULL)*(x0))>>32 : ((__uint128_t)((uintptr_t)18446744039349813248ULL)*(x0))>>64;
  x12 = (x11)+(x8);
  x13 = (x12)<(x11);
  x14 = (x13)+(x9);
  x15 = (x14)<(x9);
  ...
  x134 = (x131)+(x133);
  x135 = (x134)+(x97);
  x136 = ((uintptr_t)7ULL)*(x3);
  x137 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)7ULL)*(x3))>>32 : ((__uint128_t)((uintptr_t)7ULL)*(x3))>>64;
  x138 = ((uintptr_t)7ULL)*(x2);
  x139 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)7ULL)*(x2))>>32 : ((__uint128_t)((uintptr_t)7ULL)*(x2))>>64;
  x140 = ((uintptr_t)7ULL)*(x1);
  x141 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)7ULL)*(x1))>>32 : ((__uint128_t)((uintptr_t)7ULL)*(x1))>>64;
  x142 = ((uintptr_t)7ULL)*(x0);
  x143 = sizeof(intptr_t) == 4 ? ((uint64_t)((uintptr_t)7ULL)*(x0))>>32 : ((__uint128_t)((uintptr_t)7ULL)*(x0))>>64;
  x144 = (x143)+(x140);
  x145 = (x144)<(x143);
  x146 = (x145)+(x141);
  x147 = (x146)<(x141);
