/* Autogenerated: src/ExtractionOCaml/bedrock2_word_by_word_montgomery --lang=bedrock2 --no-wide-int --widen-carry --widen-bytes --split-multiret --no-select p384 '2^384 - 2^128 - 2^96 + 2^32 - 1' 32 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
...
void fiat_p384_to_montgomery(uintptr_t in0, uintptr_t out0) {
  ...
  x1078 = (x1055)-(((x1054)<(x1077))+((x1077)<(x1077)));
  x1079 = (x1057)-(((x1055)<(x1055))+((x1055)<(x1078)));
  x1080 = (x1059)-((uintptr_t)4294967295ULL);
  x1081 = (x1080)-(((x1057)<(x1057))+((x1057)<(x1079)));
  ...
  x1098 = ((x1076)<(x1076))+((x1076)<((x1076)-(((x1075)<(x1096))+((x1096)<(x1097)))));
  ...
  x1146 = x1134;
  /*skip*/
  *(uintptr_t*)((out0)+((uintptr_t)0ULL)) = x1135;
  *(uintptr_t*)((out0)+((uintptr_t)4ULL)) = x1136;
  *(uintptr_t*)((out0)+((uintptr_t)8ULL)) = x1137;
  *(uintptr_t*)((out0)+((uintptr_t)12ULL)) = x1138;
  *(uintptr_t*)((out0)+((uintptr_t)16ULL)) = x1139;
  *(uintptr_t*)((out0)+((uintptr_t)20ULL)) = x1140;
  *(uintptr_t*)((out0)+((uintptr_t)24ULL)) = x1141;
  *(uintptr_t*)((out0)+((uintptr_t)28ULL)) = x1142;
  *(uintptr_t*)((out0)+((uintptr_t)32ULL)) = x1143;
  *(uintptr_t*)((out0)+((uintptr_t)36ULL)) = x1144;
  *(uintptr_t*)((out0)+((uintptr_t)40ULL)) = x1145;
  *(uintptr_t*)((out0)+((uintptr_t)44ULL)) = x1146;
  /*skip*/
  return;
}
