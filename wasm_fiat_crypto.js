(function(Object_R5W_){typeof
globalThis!=="object"&&(this?get_FwV_():(Object_R5W_.defineProperty(Object_R5W_.prototype,"_T_",{configurable:true,get:get_FwV_}),_T_));function
get_FwV_(){var
global_FwV_=this||self;global_FwV_.globalThis=global_FwV_;delete
Object_R5W_.prototype._T_}}(Object));
(async function (eval_function, js, strings, fragments) {
    "use strict";
    const src = 'wasm_fiat_crypto.wasm';
   ...
   (function(globalThis_R5W_){"use strict";return{}}(globalThis)), ["Undefined_recursive_module","Assert_failure","Sys_blocked_io","Stack_overflow","Match_failure","Not_found","Division_by_zero","End_of_file","Invalid_argument","Failure","Sys_error","Out_of_memory"],
   ((joo_global_object,jsoo_exports,globalThis)=>({get_Array:o=>o.Array,get_Date:o=>o.Date,get_Error:o=>o.Error,get_JSON:o=>o.JSON,get_Math:o=>o.Math,get_Object:o=>o.Object,get_RegExp:o=>o.RegExp,get_String:o=>o.String,js_expr_21711c2a:()=>jsoo_exports,js_expr_2d7ff750:()=>function(exn){throw exn},meth_call_0_toString:o=>o.toString()}))(globalThis,globalThis?.module?.exports||globalThis,globalThis))
