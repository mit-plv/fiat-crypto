...
/// ```
#[inline]
pub const fn fiat_sm2_scalar_addcarryx_u64(out1: &mut u64, out2: &mut fiat_sm2_scalar_u1, arg1: fiat_sm2_scalar_u1, arg2: u64, arg3: u64) {
...
/// ```
#[inline]
pub const fn fiat_sm2_scalar_subborrowx_u64(out1: &mut u64, out2: &mut fiat_sm2_scalar_u1, arg1: fiat_sm2_scalar_u1, arg2: u64, arg3: u64) {
...
pub const fn fiat_sm2_scalar_add(mut out1: &mut fiat_sm2_scalar_montgomery_domain_field_element, arg1: &fiat_sm2_scalar_montgomery_domain_field_element, arg2: &fiat_sm2_scalar_montgomery_domain_field_element) {
  ...
  fiat_sm2_scalar_addcarryx_u64(&mut x1, &mut x2, 0x0, (*IndexConst(arg1).index(0)), (*IndexConst(arg2).index(0)));
  let mut x3: u64 = 0;
  let mut x4: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x3, &mut x4, x2, (*IndexConst(arg1).index(1)), (*IndexConst(arg2).index(1)));
  let mut x5: u64 = 0;
  let mut x6: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg1).index(2)), (*IndexConst(arg2).index(2)));
  let mut x7: u64 = 0;
  let mut x8: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x7, &mut x8, x6, (*IndexConst(arg1).index(3)), (*IndexConst(arg2).index(3)));
  let mut x9: u64 = 0;
...
pub const fn fiat_sm2_scalar_sub(mut out1: &mut fiat_sm2_scalar_montgomery_domain_field_element, arg1: &fiat_sm2_scalar_montgomery_domain_field_element, arg2: &fiat_sm2_scalar_montgomery_domain_field_element) {
  let mut x1: u64 = 0;
  let mut x2: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_subborrowx_u64(&mut x1, &mut x2, 0x0, (*IndexConst(arg1).index(0)), (*IndexConst(arg2).index(0)));
  let mut x3: u64 = 0;
  let mut x4: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_subborrowx_u64(&mut x3, &mut x4, x2, (*IndexConst(arg1).index(1)), (*IndexConst(arg2).index(1)));
  let mut x5: u64 = 0;
  let mut x6: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_subborrowx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg1).index(2)), (*IndexConst(arg2).index(2)));
  let mut x7: u64 = 0;
  let mut x8: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_subborrowx_u64(&mut x7, &mut x8, x6, (*IndexConst(arg1).index(3)), (*IndexConst(arg2).index(3)));
  let mut x9: u64 = 0;
...
pub const fn fiat_sm2_scalar_opp(mut out1: &mut fiat_sm2_scalar_montgomery_domain_field_element, arg1: &fiat_sm2_scalar_montgomery_domain_field_element) {
  let mut x1: u64 = 0;
  let mut x2: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_subborrowx_u64(&mut x1, &mut x2, 0x0, (0x0 as u64), (*IndexConst(arg1).index(0)));
  let mut x3: u64 = 0;
  let mut x4: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_subborrowx_u64(&mut x3, &mut x4, x2, (0x0 as u64), (*IndexConst(arg1).index(1)));
  let mut x5: u64 = 0;
  let mut x6: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_subborrowx_u64(&mut x5, &mut x6, x4, (0x0 as u64), (*IndexConst(arg1).index(2)));
  let mut x7: u64 = 0;
  let mut x8: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_subborrowx_u64(&mut x7, &mut x8, x6, (0x0 as u64), (*IndexConst(arg1).index(3)));
  let mut x9: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x9, x8, (0x0 as u64), 0xffffffffffffffff);
  let mut x10: u64 = 0;
  let mut x11: fiat_sm2_scalar_u1 = 0;
...
pub const fn fiat_sm2_scalar_from_montgomery(mut out1: &mut fiat_sm2_scalar_non_montgomery_domain_field_element, arg1: &fiat_sm2_scalar_montgomery_domain_field_element) {
  ...
  fiat_sm2_scalar_addcarryx_u64(&mut x54, &mut x55, x53, ((x31 as u64) + ((x25 as u64) + ((x17 as u64) + x5))), x46);
  let mut x56: u64 = 0;
  ...
  let mut x84: u64 = 0;
  let mut x85: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x84, &mut x85, x83, ((x61 as u64) + ((x55 as u64) + ((x47 as u64) + x35))), x76);
  let mut x86: u64 = 0;
  let mut x87: fiat_sm2_scalar_u1 = 0;
  ...
  fiat_sm2_scalar_addcarryx_u64(&mut x114, &mut x115, x113, ((x91 as u64) + ((x85 as u64) + ((x77 as u64) + x65))), x106);
...
pub const fn fiat_sm2_scalar_to_montgomery(mut out1: &mut fiat_sm2_scalar_montgomery_domain_field_element, arg1: &fiat_sm2_scalar_non_montgomery_domain_field_element) {
  ...
  let mut x43: u64 = 0;
  let mut x44: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x43, &mut x44, x42, ((x18 as u64) + x6), ((x34 as u64) + x22));
  let mut x45: u64 = 0;
  let mut x46: u64 = 0;
  ...
  let mut x91: u64 = 0;
  let mut x92: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x91, &mut x92, x90, (((x66 as u64) + (x44 as u64)) + ((x58 as u64) + x46)), ((x82 as u64) + x70));
  let mut x93: u64 = 0;
  let mut x94: u64 = 0;
  ...
  let mut x139: u64 = 0;
  let mut x140: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x139, &mut x140, x138, (((x114 as u64) + (x92 as u64)) + ((x106 as u64) + x94)), ((x130 as u64) + x118));
  let mut x141: u64 = 0;
  let mut x142: u64 = 0;
  ...
  fiat_sm2_scalar_addcarryx_u64(&mut x187, &mut x188, x186, (((x162 as u64) + (x140 as u64)) + ((x154 as u64) + x142)), ((x178 as u64) + x166));
  let mut x189: u64 = 0;
...
/// ```
#[inline]
pub const fn fiat_sm2_scalar_selectznz(mut out1: &mut [u64; 4], arg1: fiat_sm2_scalar_u1, arg2: &[u64; 4], arg3: &[u64; 4]) {
  let mut x1: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x1, arg1, (*IndexConst(arg2).index(0)), (*IndexConst(arg3).index(0)));
  let mut x2: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x2, arg1, (*IndexConst(arg2).index(1)), (*IndexConst(arg3).index(1)));
  let mut x3: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x3, arg1, (*IndexConst(arg2).index(2)), (*IndexConst(arg3).index(2)));
  let mut x4: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x4, arg1, (*IndexConst(arg2).index(3)), (*IndexConst(arg3).index(3)));
...
/// ```
#[inline]
pub const fn fiat_sm2_scalar_divstep(out1: &mut u64, mut out2: &mut [u64; 5], mut out3: &mut [u64; 5], mut out4: &mut [u64; 4], mut out5: &mut [u64; 4], arg1: u64, arg2: &[u64; 5], arg3: &[u64; 5], arg4: &[u64; 4], arg5: &[u64; 4]) {
  let mut x1: u64 = 0;
  let mut x2: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x1, &mut x2, 0x0, (!arg1), (0x1 as u64));
  let x3: fiat_sm2_scalar_u1 = (((x1 >> 63) as fiat_sm2_scalar_u1) & (((*IndexConst(arg3).index(0)) & (0x1 as u64)) as fiat_sm2_scalar_u1));
  let mut x4: u64 = 0;
  ...
  let mut x7: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x7, x3, (*IndexConst(arg2).index(0)), (*IndexConst(arg3).index(0)));
  let mut x8: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x8, x3, (*IndexConst(arg2).index(1)), (*IndexConst(arg3).index(1)));
  let mut x9: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x9, x3, (*IndexConst(arg2).index(2)), (*IndexConst(arg3).index(2)));
  let mut x10: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x10, x3, (*IndexConst(arg2).index(3)), (*IndexConst(arg3).index(3)));
  let mut x11: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x11, x3, (*IndexConst(arg2).index(4)), (*IndexConst(arg3).index(4)));
  let mut x12: u64 = 0;
  let mut x13: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x12, &mut x13, 0x0, (0x1 as u64), (!(*IndexConst(arg2).index(0))));
  let mut x14: u64 = 0;
  let mut x15: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x14, &mut x15, x13, (0x0 as u64), (!(*IndexConst(arg2).index(1))));
  let mut x16: u64 = 0;
  let mut x17: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x16, &mut x17, x15, (0x0 as u64), (!(*IndexConst(arg2).index(2))));
  let mut x18: u64 = 0;
  let mut x19: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x18, &mut x19, x17, (0x0 as u64), (!(*IndexConst(arg2).index(3))));
  let mut x20: u64 = 0;
  let mut x21: fiat_sm2_scalar_u1 = 0;
  fiat_sm2_scalar_addcarryx_u64(&mut x20, &mut x21, x19, (0x0 as u64), (!(*IndexConst(arg2).index(4))));
  let mut x22: u64 = 0;
  ...
  let mut x27: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x27, x3, (*IndexConst(arg4).index(0)), (*IndexConst(arg5).index(0)));
  let mut x28: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x28, x3, (*IndexConst(arg4).index(1)), (*IndexConst(arg5).index(1)));
  let mut x29: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x29, x3, (*IndexConst(arg4).index(2)), (*IndexConst(arg5).index(2)));
  let mut x30: u64 = 0;
  fiat_sm2_scalar_cmovznz_u64(&mut x30, x3, (*IndexConst(arg4).index(3)), (*IndexConst(arg5).index(3)));
  let mut x31: u64 = 0;
  let mut x32: fiat_sm2_scalar_u1 = 0;
