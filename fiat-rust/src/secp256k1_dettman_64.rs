...
pub fn fiat_secp256k1_dettman_mul(out1: &mut [u64; 5], arg1: &[u64; 5], arg2: &[u64; 5]) -> () {
  ...
  let x12: u128 = ((x8 as u128) + ((((((arg1[4]) as u128) * ((arg2[1]) as u128)) + (((arg1[3]) as u128) * ((arg2[2]) as u128))) + (((arg1[2]) as u128) * ((arg2[3]) as u128))) + (((arg1[1]) as u128) * ((arg2[4]) as u128))));
  let x13: u64 = ((x12 >> 52) as u64);
  let x14: u64 = ((x12 & (0xfffffffffffff as u128)) as u64);
  let x15: u128 = ((((x10 + (x14 << 4)) as u128) * (0x1000003d1 as u128)) + (((arg1[0]) as u128) * ((arg2[0]) as u128)));
  let x16: u64 = ((x15 >> 52) as u64);
  let x17: u64 = ((x15 & (0xfffffffffffff as u128)) as u64);
  let x18: u128 = ((x13 as u128) + (((((arg1[4]) as u128) * ((arg2[2]) as u128)) + (((arg1[3]) as u128) * ((arg2[3]) as u128))) + (((arg1[2]) as u128) * ((arg2[4]) as u128))));
