...
pub fn fiat_p384_scalar_addcarryx_u64(out1: &mut u64, out2: &mut fiat_p384_scalar_u1, arg1: fiat_p384_scalar_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: fiat_p384_scalar_u1 = ((x1 >> 64) as fiat_p384_scalar_u1);
  *out1 = (x1 as u64);
  *out2 = x2;
}
...
pub fn fiat_p384_scalar_divstep(out1: &mut u64, out2: &mut [u64; 7], out3: &mut [u64; 7], out4: &mut [u64; 6], out5: &mut [u64; 6], arg1: u64, arg2: &[u64; 7], arg3: &[u64; 7], arg4: &[u64; 6], arg5: &[u64; 6]) -> () {
  ...
  let x3: fiat_p384_scalar_u1 = (((x1 >> 63) as fiat_p384_scalar_u1) & ((arg3[0]) as fiat_p384_scalar_u1));
  let mut x4: u64 = 0;
  ...
  let mut x104: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x104, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x7);
  let mut x105: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x105, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x8);
  let mut x106: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x106, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x9);
  let mut x107: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x107, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x10);
  let mut x108: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x108, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x11);
  let mut x109: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x109, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x12);
  let mut x110: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x110, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x13);
  let mut x111: u64 = 0;
  let mut x112: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x111, &mut x112, 0x0, x28, x104);
  let mut x113: u64 = 0;
  let mut x114: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x113, &mut x114, x112, x29, x105);
  let mut x115: u64 = 0;
  let mut x116: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x115, &mut x116, x114, x30, x106);
  let mut x117: u64 = 0;
  let mut x118: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x117, &mut x118, x116, x31, x107);
  let mut x119: u64 = 0;
  let mut x120: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x119, &mut x120, x118, x32, x108);
  let mut x121: u64 = 0;
  let mut x122: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x121, &mut x122, x120, x33, x109);
  let mut x123: u64 = 0;
  let mut x124: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x123, &mut x124, x122, x34, x110);
  let mut x125: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x125, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x35);
  let mut x126: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x126, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x36);
  let mut x127: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x127, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x37);
  let mut x128: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x128, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x38);
  let mut x129: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x129, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x39);
  let mut x130: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x130, (x28 as fiat_p384_scalar_u1), (0x0 as u64), x40);
  let mut x131: u64 = 0;
  let mut x132: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x131, &mut x132, 0x0, x98, x125);
  let mut x133: u64 = 0;
  let mut x134: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x133, &mut x134, x132, x99, x126);
  let mut x135: u64 = 0;
  let mut x136: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x135, &mut x136, x134, x100, x127);
  let mut x137: u64 = 0;
  let mut x138: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x137, &mut x138, x136, x101, x128);
  let mut x139: u64 = 0;
  let mut x140: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x139, &mut x140, x138, x102, x129);
  let mut x141: u64 = 0;
  let mut x142: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x141, &mut x142, x140, x103, x130);
  let mut x143: u64 = 0;
  let mut x144: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x143, &mut x144, 0x0, x131, 0xecec196accc52973);
  let mut x145: u64 = 0;
  let mut x146: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x145, &mut x146, x144, x133, 0x581a0db248b0a77a);
  let mut x147: u64 = 0;
  let mut x148: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x147, &mut x148, x146, x135, 0xc7634d81f4372ddf);
  let mut x149: u64 = 0;
  let mut x150: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x149, &mut x150, x148, x137, 0xffffffffffffffff);
  let mut x151: u64 = 0;
  let mut x152: fiat_p384_scalar_u1 = 0;
  ...
  let mut x155: u64 = 0;
  let mut x156: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x155, &mut x156, x154, (x142 as u64), (0x0 as u64));
  let mut x157: u64 = 0;
  let mut x158: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x157, &mut x158, 0x0, x6, (0x1 as u64));
  let x159: u64 = ((x111 >> 1) | ((x113 << 63) & 0xffffffffffffffff));
  let x160: u64 = ((x113 >> 1) | ((x115 << 63) & 0xffffffffffffffff));
  let x161: u64 = ((x115 >> 1) | ((x117 << 63) & 0xffffffffffffffff));
  let x162: u64 = ((x117 >> 1) | ((x119 << 63) & 0xffffffffffffffff));
  let x163: u64 = ((x119 >> 1) | ((x121 << 63) & 0xffffffffffffffff));
  let x164: u64 = ((x121 >> 1) | ((x123 << 63) & 0xffffffffffffffff));
  let x165: u64 = ((x123 & 0x8000000000000000) | (x123 >> 1));
  let mut x166: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x166, x66, x53, x41);
  let mut x167: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x167, x66, x55, x43);
  let mut x168: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x168, x66, x57, x45);
  let mut x169: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x169, x66, x59, x47);
  let mut x170: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x170, x66, x61, x49);
  let mut x171: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x171, x66, x63, x51);
  let mut x172: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x172, x156, x143, x131);
  let mut x173: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x173, x156, x145, x133);
  let mut x174: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x174, x156, x147, x135);
  let mut x175: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x175, x156, x149, x137);
  let mut x176: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x176, x156, x151, x139);
  let mut x177: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x177, x156, x153, x141);
  *out1 = x157;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
