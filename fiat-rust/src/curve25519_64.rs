...
pub fn fiat_25519_subborrowx_u51(out1: &mut u64, out2: &mut fiat_25519_u1, arg1: fiat_25519_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x3: i128 = (((x1 as i64) as i128) & (0x7ffffffffffff as i128));
  *out1 = (x3 as u64);
...
pub fn fiat_25519_cmovznz_u64(out1: &mut u64, arg1: fiat_25519_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: i128 = ((((0x0 as fiat_25519_i2) - (x1 as fiat_25519_i2)) as i128) & (0xffffffffffffffff as i128));
...
pub fn fiat_25519_carry_mul(out1: &mut [u64; 5], arg1: &[u64; 5], arg2: &[u64; 5]) -> () {
  ...
  let x28: u128 = (x26 & (0x7ffffffffffff as u128));
...
pub fn fiat_25519_carry_square(out1: &mut [u64; 5], arg1: &[u64; 5]) -> () {
  ...
  let x26: u128 = (x24 & (0x7ffffffffffff as u128));
...
pub fn fiat_25519_to_bytes(out1: &mut [u8; 32], arg1: &[u64; 5]) -> () {
  ...
  let x67: u64 = (x66 >> 8);
  let x68: u64 = (x66 & (0xff as u64));
  let x69: u64 = (x67 >> 8);
  let x70: u64 = (x67 & (0xff as u64));
  let x71: u64 = (x69 >> 8);
  let x72: u64 = (x69 & (0xff as u64));
  let x73: u64 = (x71 >> 8);
  let x74: u64 = (x71 & (0xff as u64));
  let x75: u64 = (x73 >> 8);
