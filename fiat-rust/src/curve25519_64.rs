...
pub fn fiat_25519_to_bytes(out1: &mut [u8; 32], arg1: &fiat_25519_tight_field_element) -> () {
  ...
  let x29: u64 = (x28 >> 8);
  let x30: u64 = (x29 >> 8);
  let x31: u8 = ((x30 >> 8) as u8);
  let x32: u64 = (x25 + (x31 as u64));
  let x33: u64 = (x32 >> 8);
  let x34: u64 = (x33 >> 8);
  let x35: u64 = (x34 >> 8);
  let x36: u64 = (x35 >> 8);
  let x37: u64 = (x36 >> 8);
  let x38: u8 = ((x37 >> 8) as u8);
  let x39: u64 = (x24 + (x38 as u64));
  let x40: u64 = (x39 >> 8);
  let x41: u64 = (x40 >> 8);
  let x42: u64 = (x41 >> 8);
  let x43: u64 = (x42 >> 8);
  let x44: u64 = (x43 >> 8);
  let x45: u64 = (x44 >> 8);
  let x46: fiat_25519_u1 = ((x45 >> 8) as fiat_25519_u1);
  let x47: u64 = (x23 + (x46 as u64));
  let x48: u64 = (x47 >> 8);
  let x49: u64 = (x48 >> 8);
  let x50: u64 = (x49 >> 8);
  let x51: u64 = (x50 >> 8);
  let x52: u64 = (x51 >> 8);
  let x53: u8 = ((x52 >> 8) as u8);
  let x54: u64 = (x22 + (x53 as u64));
  let x55: u64 = (x54 >> 8);
  let x56: u64 = (x55 >> 8);
  let x57: u64 = (x56 >> 8);
  let x58: u64 = (x57 >> 8);
