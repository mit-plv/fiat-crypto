...
pub fn fiat_25519_addcarryx_u51(out1: &mut u64, out2: &mut fiat_25519_u1, arg1: fiat_25519_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = (x1 & 0x7ffffffffffff_u64);
...
pub fn fiat_25519_subborrowx_u51(out1: &mut u64, out2: &mut fiat_25519_u1, arg1: fiat_25519_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x3: u64 = (((x1 as i128) & (0x7ffffffffffff_u64 as i128)) as u64);
  *out1 = x3;
...
pub fn fiat_25519_cmovznz_u64(out1: &mut u64, arg1: fiat_25519_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((((0x0_u8 as fiat_25519_i2) - (x1 as fiat_25519_i2)) as fiat_25519_i1) as i128) & (0xffffffffffffffff_u64 as i128)) as u64);
...
pub fn fiat_25519_carry_mul(out1: &mut fiat_25519_tight_field_element, arg1: &fiat_25519_loose_field_element, arg2: &fiat_25519_loose_field_element) -> () {
  let x1: u128 = (((arg1[4]) as u128) * (((arg2[4]) * 0x13_u8) as u128));
  let x2: u128 = (((arg1[4]) as u128) * (((arg2[3]) * 0x13_u8) as u128));
  let x3: u128 = (((arg1[4]) as u128) * (((arg2[2]) * 0x13_u8) as u128));
  let x4: u128 = (((arg1[4]) as u128) * (((arg2[1]) * 0x13_u8) as u128));
  let x5: u128 = (((arg1[3]) as u128) * (((arg2[4]) * 0x13_u8) as u128));
  let x6: u128 = (((arg1[3]) as u128) * (((arg2[3]) * 0x13_u8) as u128));
  let x7: u128 = (((arg1[3]) as u128) * (((arg2[2]) * 0x13_u8) as u128));
  let x8: u128 = (((arg1[2]) as u128) * (((arg2[4]) * 0x13_u8) as u128));
  let x9: u128 = (((arg1[2]) as u128) * (((arg2[3]) * 0x13_u8) as u128));
  let x10: u128 = (((arg1[1]) as u128) * (((arg2[4]) * 0x13_u8) as u128));
  ...
  let x28: u64 = ((x26 & (0x7ffffffffffff_u64 as u128)) as u64);
  ...
  let x35: u64 = ((x33 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x36: u128 = ((x34 as u128) + x31);
  let x37: u64 = ((x36 >> 51) as u64);
  let x38: u64 = ((x36 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x39: u128 = ((x37 as u128) + x30);
  let x40: u64 = ((x39 >> 51) as u64);
  let x41: u64 = ((x39 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x42: u128 = ((x40 as u128) + x29);
  let x43: u64 = ((x42 >> 51) as u64);
  let x44: u64 = ((x42 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x45: u64 = (x43 * 0x13_u8);
  let x46: u64 = (x28 + x45);
  let x47: u64 = (x46 >> 51);
  let x48: u64 = (x46 & 0x7ffffffffffff_u64);
  let x49: u64 = (x47 + x35);
  let x50: fiat_25519_u1 = ((x49 >> 51) as fiat_25519_u1);
  let x51: u64 = (x49 & 0x7ffffffffffff_u64);
...
pub fn fiat_25519_carry_square(out1: &mut fiat_25519_tight_field_element, arg1: &fiat_25519_loose_field_element) -> () {
  let x1: u64 = ((arg1[4]) * 0x13_u8);
  let x2: u64 = (x1 * 0x2_u8);
  let x3: u64 = ((arg1[4]) * 0x2_u8);
  let x4: u64 = ((arg1[3]) * 0x13_u8);
  let x5: u64 = (x4 * 0x2_u8);
  let x6: u64 = ((arg1[3]) * 0x2_u8);
  let x7: u64 = ((arg1[2]) * 0x2_u8);
  let x8: u64 = ((arg1[1]) * 0x2_u8);
  ...
  let x26: u64 = ((x24 & (0x7ffffffffffff_u64 as u128)) as u64);
  ...
  let x33: u64 = ((x31 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x34: u128 = ((x32 as u128) + x29);
  let x35: u64 = ((x34 >> 51) as u64);
  let x36: u64 = ((x34 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x37: u128 = ((x35 as u128) + x28);
  let x38: u64 = ((x37 >> 51) as u64);
  let x39: u64 = ((x37 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x40: u128 = ((x38 as u128) + x27);
  let x41: u64 = ((x40 >> 51) as u64);
  let x42: u64 = ((x40 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x43: u64 = (x41 * 0x13_u8);
  let x44: u64 = (x26 + x43);
  let x45: u64 = (x44 >> 51);
  let x46: u64 = (x44 & 0x7ffffffffffff_u64);
  let x47: u64 = (x45 + x33);
  let x48: fiat_25519_u1 = ((x47 >> 51) as fiat_25519_u1);
  let x49: u64 = (x47 & 0x7ffffffffffff_u64);
...
pub fn fiat_25519_carry(out1: &mut fiat_25519_tight_field_element, arg1: &fiat_25519_loose_field_element) -> () {
  ...
  let x6: u64 = ((x1 & 0x7ffffffffffff_u64) + ((x5 >> 51) * 0x13_u8));
  let x7: u64 = ((((x6 >> 51) as fiat_25519_u1) as u64) + (x2 & 0x7ffffffffffff_u64));
  let x8: u64 = (x6 & 0x7ffffffffffff_u64);
  let x9: u64 = (x7 & 0x7ffffffffffff_u64);
  let x10: u64 = ((((x7 >> 51) as fiat_25519_u1) as u64) + (x3 & 0x7ffffffffffff_u64));
  let x11: u64 = (x4 & 0x7ffffffffffff_u64);
  let x12: u64 = (x5 & 0x7ffffffffffff_u64);
  out1[0] = x8;
  out1[1] = x9;
  out1[2] = x10;
  out1[3] = x11;
...
pub fn fiat_25519_sub(out1: &mut fiat_25519_loose_field_element, arg1: &fiat_25519_tight_field_element, arg2: &fiat_25519_tight_field_element) -> () {
  let x1: u64 = ((0xfffffffffffda_u64 + (arg1[0])) - (arg2[0]));
  let x2: u64 = ((0xffffffffffffe_u64 + (arg1[1])) - (arg2[1]));
  let x3: u64 = ((0xffffffffffffe_u64 + (arg1[2])) - (arg2[2]));
  let x4: u64 = ((0xffffffffffffe_u64 + (arg1[3])) - (arg2[3]));
  let x5: u64 = ((0xffffffffffffe_u64 + (arg1[4])) - (arg2[4]));
  out1[0] = x1;
  out1[1] = x2;
  out1[2] = x3;
  out1[3] = x4;
...
pub fn fiat_25519_opp(out1: &mut fiat_25519_loose_field_element, arg1: &fiat_25519_tight_field_element) -> () {
  let x1: u64 = (0xfffffffffffda_u64 - (arg1[0]));
  let x2: u64 = (0xffffffffffffe_u64 - (arg1[1]));
  let x3: u64 = (0xffffffffffffe_u64 - (arg1[2]));
  let x4: u64 = (0xffffffffffffe_u64 - (arg1[3]));
  let x5: u64 = (0xffffffffffffe_u64 - (arg1[4]));
  out1[0] = x1;
  out1[1] = x2;
  out1[2] = x3;
  out1[3] = x4;
...
pub fn fiat_25519_to_bytes(out1: &mut [u8; 32], arg1: &fiat_25519_tight_field_element) -> () {
  ...
  fiat_25519_subborrowx_u51(&mut x1, &mut x2, 0x0_u8, (arg1[0]), 0x7ffffffffffed_u64);
  let mut x3: u64 = 0;
  let mut x4: fiat_25519_u1 = 0;
  fiat_25519_subborrowx_u51(&mut x3, &mut x4, x2, (arg1[1]), 0x7ffffffffffff_u64);
  let mut x5: u64 = 0;
  let mut x6: fiat_25519_u1 = 0;
  fiat_25519_subborrowx_u51(&mut x5, &mut x6, x4, (arg1[2]), 0x7ffffffffffff_u64);
  let mut x7: u64 = 0;
  let mut x8: fiat_25519_u1 = 0;
  fiat_25519_subborrowx_u51(&mut x7, &mut x8, x6, (arg1[3]), 0x7ffffffffffff_u64);
  let mut x9: u64 = 0;
  let mut x10: fiat_25519_u1 = 0;
  fiat_25519_subborrowx_u51(&mut x9, &mut x10, x8, (arg1[4]), 0x7ffffffffffff_u64);
  let mut x11: u64 = 0;
  fiat_25519_cmovznz_u64(&mut x11, x10, (0x0_u8 as u64), 0xffffffffffffffff_u64);
  let mut x12: u64 = 0;
  let mut x13: fiat_25519_u1 = 0;
  fiat_25519_addcarryx_u51(&mut x12, &mut x13, 0x0_u8, x1, (x11 & 0x7ffffffffffed_u64));
  let mut x14: u64 = 0;
  let mut x15: fiat_25519_u1 = 0;
  fiat_25519_addcarryx_u51(&mut x14, &mut x15, x13, x3, (x11 & 0x7ffffffffffff_u64));
  let mut x16: u64 = 0;
  let mut x17: fiat_25519_u1 = 0;
  fiat_25519_addcarryx_u51(&mut x16, &mut x17, x15, x5, (x11 & 0x7ffffffffffff_u64));
  let mut x18: u64 = 0;
  let mut x19: fiat_25519_u1 = 0;
  fiat_25519_addcarryx_u51(&mut x18, &mut x19, x17, x7, (x11 & 0x7ffffffffffff_u64));
  let mut x20: u64 = 0;
  let mut x21: fiat_25519_u1 = 0;
  fiat_25519_addcarryx_u51(&mut x20, &mut x21, x19, x9, (x11 & 0x7ffffffffffff_u64));
  let x22: u64 = (x20 << 4);
  let x23: u64 = (x18 * (0x2_u8 as u64));
  let x24: u64 = (x16 << 6);
  let x25: u64 = (x14 << 3);
  let x26: u8 = ((x12 & (0xff_u8 as u64)) as u8);
  let x27: u64 = (x12 >> 8);
  ...
  let x76: u64 = (x74 >> 8);
  let x77: u8 = ((x76 & (0xff_u8 as u64)) as u8);
...
pub fn fiat_25519_from_bytes(out1: &mut fiat_25519_tight_field_element, arg1: &[u8; 32]) -> () {
  ...
  let x37: u64 = (x27 + x36);
  let x38: u64 = (x26 + x37);
  let x39: u64 = (x38 & 0x7ffffffffffff_u64);
  ...
  let x45: u64 = (x21 + x44);
  let x46: u64 = (x20 + x45);
  let x47: u64 = (x46 & 0x7ffffffffffff_u64);
  ...
  let x54: u64 = (x14 + x53);
  let x55: u64 = (x13 + x54);
  let x56: u64 = (x55 & 0x7ffffffffffff_u64);
  ...
  let x62: u64 = (x8 + x61);
  let x63: u64 = (x7 + x62);
  let x64: u64 = (x63 & 0x7ffffffffffff_u64);
...
pub fn fiat_25519_carry_scmul_121666(out1: &mut fiat_25519_tight_field_element, arg1: &fiat_25519_loose_field_element) -> () {
  let x1: u128 = ((0x1db42_u32 as u128) * ((arg1[4]) as u128));
  let x2: u128 = ((0x1db42_u32 as u128) * ((arg1[3]) as u128));
  let x3: u128 = ((0x1db42_u32 as u128) * ((arg1[2]) as u128));
  let x4: u128 = ((0x1db42_u32 as u128) * ((arg1[1]) as u128));
  let x5: u128 = ((0x1db42_u32 as u128) * ((arg1[0]) as u128));
  let x6: u64 = ((x5 >> 51) as u64);
  let x7: u64 = ((x5 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x8: u128 = ((x6 as u128) + x4);
  let x9: u64 = ((x8 >> 51) as u64);
  let x10: u64 = ((x8 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x11: u128 = ((x9 as u128) + x3);
  let x12: u64 = ((x11 >> 51) as u64);
  let x13: u64 = ((x11 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x14: u128 = ((x12 as u128) + x2);
  let x15: u64 = ((x14 >> 51) as u64);
  let x16: u64 = ((x14 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x17: u128 = ((x15 as u128) + x1);
  let x18: u64 = ((x17 >> 51) as u64);
  let x19: u64 = ((x17 & (0x7ffffffffffff_u64 as u128)) as u64);
  let x20: u64 = (x18 * 0x13_u8);
  let x21: u64 = (x7 + x20);
  let x22: fiat_25519_u1 = ((x21 >> 51) as fiat_25519_u1);
  let x23: u64 = (x21 & 0x7ffffffffffff_u64);
  let x24: u64 = ((x22 as u64) + x10);
  let x25: fiat_25519_u1 = ((x24 >> 51) as fiat_25519_u1);
  let x26: u64 = (x24 & 0x7ffffffffffff_u64);
