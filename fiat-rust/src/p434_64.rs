...
pub fn fiat_p434_addcarryx_u64(out1: &mut u64, out2: &mut fiat_p434_u1, arg1: fiat_p434_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: fiat_p434_u1 = ((x1 >> 64) as fiat_p434_u1);
  *out1 = (x1 as u64);
  *out2 = x2;
}
...
pub fn fiat_p434_to_bytes(out1: &mut [u8; 55], arg1: &[u64; 7]) -> () {
  ...
  let x47: u64 = (x46 >> 8);
  let x48: u64 = (x47 >> 8);
  let x49: u8 = ((x48 >> 8) as u8);
  let x50: u64 = (x1 >> 8);
  let x51: u64 = (x50 >> 8);
  let x52: u64 = (x51 >> 8);
  let x53: u64 = (x52 >> 8);
  let x54: u64 = (x53 >> 8);
  let x55: u8 = ((x54 >> 8) as u8);
  out1[0] = (x7 as u8);
  out1[1] = (x8 as u8);
  out1[2] = (x9 as u8);
  out1[3] = (x10 as u8);
...
pub fn fiat_p434_divstep(out1: &mut u64, out2: &mut [u64; 8], out3: &mut [u64; 8], out4: &mut [u64; 7], out5: &mut [u64; 7], arg1: u64, arg2: &[u64; 8], arg3: &[u64; 8], arg4: &[u64; 7], arg5: &[u64; 7]) -> () {
  ...
  let x3: fiat_p434_u1 = (((x1 >> 63) as fiat_p434_u1) & ((arg3[0]) as fiat_p434_u1));
  let mut x4: u64 = 0;
  ...
  let mut x119: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x119, (x31 as fiat_p434_u1), (0x0 as u64), x7);
  let mut x120: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x120, (x31 as fiat_p434_u1), (0x0 as u64), x8);
  let mut x121: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x121, (x31 as fiat_p434_u1), (0x0 as u64), x9);
  let mut x122: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x122, (x31 as fiat_p434_u1), (0x0 as u64), x10);
  let mut x123: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x123, (x31 as fiat_p434_u1), (0x0 as u64), x11);
  let mut x124: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x124, (x31 as fiat_p434_u1), (0x0 as u64), x12);
  let mut x125: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x125, (x31 as fiat_p434_u1), (0x0 as u64), x13);
  let mut x126: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x126, (x31 as fiat_p434_u1), (0x0 as u64), x14);
  let mut x127: u64 = 0;
  let mut x128: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x127, &mut x128, 0x0, x31, x119);
  let mut x129: u64 = 0;
  let mut x130: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x129, &mut x130, x128, x32, x120);
  let mut x131: u64 = 0;
  let mut x132: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x131, &mut x132, x130, x33, x121);
  let mut x133: u64 = 0;
  let mut x134: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x133, &mut x134, x132, x34, x122);
  let mut x135: u64 = 0;
  let mut x136: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x135, &mut x136, x134, x35, x123);
  let mut x137: u64 = 0;
  let mut x138: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x137, &mut x138, x136, x36, x124);
  let mut x139: u64 = 0;
  let mut x140: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x139, &mut x140, x138, x37, x125);
  let mut x141: u64 = 0;
  let mut x142: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x141, &mut x142, x140, x38, x126);
  let mut x143: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x143, (x31 as fiat_p434_u1), (0x0 as u64), x39);
  let mut x144: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x144, (x31 as fiat_p434_u1), (0x0 as u64), x40);
  let mut x145: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x145, (x31 as fiat_p434_u1), (0x0 as u64), x41);
  let mut x146: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x146, (x31 as fiat_p434_u1), (0x0 as u64), x42);
  let mut x147: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x147, (x31 as fiat_p434_u1), (0x0 as u64), x43);
  let mut x148: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x148, (x31 as fiat_p434_u1), (0x0 as u64), x44);
  let mut x149: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x149, (x31 as fiat_p434_u1), (0x0 as u64), x45);
  let mut x150: u64 = 0;
  let mut x151: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x150, &mut x151, 0x0, x112, x143);
  let mut x152: u64 = 0;
  let mut x153: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x152, &mut x153, x151, x113, x144);
  let mut x154: u64 = 0;
  let mut x155: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x154, &mut x155, x153, x114, x145);
  let mut x156: u64 = 0;
  let mut x157: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x156, &mut x157, x155, x115, x146);
  let mut x158: u64 = 0;
  let mut x159: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x158, &mut x159, x157, x116, x147);
  let mut x160: u64 = 0;
  let mut x161: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x160, &mut x161, x159, x117, x148);
  let mut x162: u64 = 0;
  let mut x163: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x162, &mut x163, x161, x118, x149);
  let mut x164: u64 = 0;
  let mut x165: fiat_p434_u1 = 0;
  fiat_p434_subborrowx_u64(&mut x164, &mut x165, 0x0, x150, 0xffffffffffffffff);
  let mut x166: u64 = 0;
  ...
  let mut x170: u64 = 0;
  let mut x171: fiat_p434_u1 = 0;
  fiat_p434_subborrowx_u64(&mut x170, &mut x171, x169, x156, 0xfdc1767ae2ffffff);
  let mut x172: u64 = 0;
  let mut x173: fiat_p434_u1 = 0;
  fiat_p434_subborrowx_u64(&mut x172, &mut x173, x171, x158, 0x7bc65c783158aea3);
  let mut x174: u64 = 0;
  let mut x175: fiat_p434_u1 = 0;
  fiat_p434_subborrowx_u64(&mut x174, &mut x175, x173, x160, 0x6cfc5fd681c52056);
  let mut x176: u64 = 0;
  let mut x177: fiat_p434_u1 = 0;
  fiat_p434_subborrowx_u64(&mut x176, &mut x177, x175, x162, 0x2341f27177344);
  let mut x178: u64 = 0;
  let mut x179: fiat_p434_u1 = 0;
  fiat_p434_subborrowx_u64(&mut x178, &mut x179, x177, (x163 as u64), (0x0 as u64));
  let mut x180: u64 = 0;
  let mut x181: fiat_p434_u1 = 0;
  fiat_p434_addcarryx_u64(&mut x180, &mut x181, 0x0, x6, (0x1 as u64));
  let x182: u64 = ((x127 >> 1) | ((x129 << 63) & 0xffffffffffffffff));
  let x183: u64 = ((x129 >> 1) | ((x131 << 63) & 0xffffffffffffffff));
  let x184: u64 = ((x131 >> 1) | ((x133 << 63) & 0xffffffffffffffff));
  let x185: u64 = ((x133 >> 1) | ((x135 << 63) & 0xffffffffffffffff));
  let x186: u64 = ((x135 >> 1) | ((x137 << 63) & 0xffffffffffffffff));
  let x187: u64 = ((x137 >> 1) | ((x139 << 63) & 0xffffffffffffffff));
  let x188: u64 = ((x139 >> 1) | ((x141 << 63) & 0xffffffffffffffff));
  let x189: u64 = ((x141 & 0x8000000000000000) | (x141 >> 1));
  let mut x190: u64 = 0;
  ...
  let mut x197: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x197, x179, x164, x150);
  let mut x198: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x198, x179, x166, x152);
  let mut x199: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x199, x179, x168, x154);
  let mut x200: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x200, x179, x170, x156);
  let mut x201: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x201, x179, x172, x158);
  let mut x202: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x202, x179, x174, x160);
  let mut x203: u64 = 0;
  fiat_p434_cmovznz_u64(&mut x203, x179, x176, x162);
  *out1 = x180;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
