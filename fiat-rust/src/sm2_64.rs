...
///   out1: [0x0 ~> 0xffffffffffffffff]
#[inline]
pub fn fiat_sm2_nonzero(out1: &mut u64, arg1: &[u64; 4]) {
...
#[inline]
pub fn fiat_sm2_selectznz(out1: &mut [u64; 4], arg1: fiat_sm2_u1, arg2: &[u64; 4], arg3: &[u64; 4]) {
  let mut x1: u64 = 0;
...
#[inline]
pub fn fiat_sm2_to_bytes(out1: &mut [u8; 32], arg1: &[u64; 4]) {
  let x1: u64 = (arg1[3]);
  let x2: u64 = (arg1[2]);
  let x3: u64 = (arg1[1]);
  let x4: u64 = (arg1[0]);
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub fn fiat_sm2_from_bytes(out1: &mut [u64; 4], arg1: &[u8; 32]) {
...
#[inline]
pub fn fiat_sm2_msat(out1: &mut [u64; 5]) {
...
#[inline]
pub fn fiat_sm2_divstep(out1: &mut u64, out2: &mut [u64; 5], out3: &mut [u64; 5], out4: &mut [u64; 4], out5: &mut [u64; 4], arg1: u64, arg2: &[u64; 5], arg3: &[u64; 5], arg4: &[u64; 4], arg5: &[u64; 4]) {
  let mut x1: u64 = 0;
  let mut x2: fiat_sm2_u1 = 0;
  fiat_sm2_addcarryx_u64(&mut x1, &mut x2, 0x0, (!arg1), (0x1 as u64));
  let x3: fiat_sm2_u1 = (((x1 >> 63) as fiat_sm2_u1) & (((arg3[0]) & (0x1 as u64)) as fiat_sm2_u1));
  let mut x4: u64 = 0;
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub fn fiat_sm2_divstep_precomp(out1: &mut [u64; 4]) {
