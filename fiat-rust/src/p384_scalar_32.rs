...
pub fn fiat_p384_scalar_addcarryx_u32(out1: &mut u32, out2: &mut fiat_p384_scalar_u1, arg1: fiat_p384_scalar_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x2: fiat_p384_scalar_u1 = ((x1 >> 32) as fiat_p384_scalar_u1);
  *out1 = (x1 as u32);
  *out2 = x2;
}
...
pub fn fiat_p384_scalar_to_bytes(out1: &mut [u8; 48], arg1: &[u32; 12]) -> () {
  ...
  let x13: u32 = (x12 >> 8);
  let x14: u32 = (x13 >> 8);
  let x15: u8 = ((x14 >> 8) as u8);
  let x16: u32 = (x11 >> 8);
  let x17: u32 = (x16 >> 8);
  let x18: u8 = ((x17 >> 8) as u8);
  let x19: u32 = (x10 >> 8);
  let x20: u32 = (x19 >> 8);
  let x21: u8 = ((x20 >> 8) as u8);
  let x22: u32 = (x9 >> 8);
  let x23: u32 = (x22 >> 8);
  let x24: u8 = ((x23 >> 8) as u8);
  let x25: u32 = (x8 >> 8);
  let x26: u32 = (x25 >> 8);
  let x27: u8 = ((x26 >> 8) as u8);
  let x28: u32 = (x7 >> 8);
  let x29: u32 = (x28 >> 8);
  let x30: u8 = ((x29 >> 8) as u8);
  let x31: u32 = (x6 >> 8);
  let x32: u32 = (x31 >> 8);
  let x33: u8 = ((x32 >> 8) as u8);
  let x34: u32 = (x5 >> 8);
  let x35: u32 = (x34 >> 8);
  let x36: u8 = ((x35 >> 8) as u8);
  let x37: u32 = (x4 >> 8);
  let x38: u32 = (x37 >> 8);
  let x39: u8 = ((x38 >> 8) as u8);
  let x40: u32 = (x3 >> 8);
  let x41: u32 = (x40 >> 8);
  let x42: u8 = ((x41 >> 8) as u8);
  let x43: u32 = (x2 >> 8);
  let x44: u32 = (x43 >> 8);
  let x45: u8 = ((x44 >> 8) as u8);
  let x46: u32 = (x1 >> 8);
  let x47: u32 = (x46 >> 8);
  let x48: u8 = ((x47 >> 8) as u8);
  out1[0] = (x12 as u8);
  out1[1] = (x13 as u8);
  out1[2] = (x14 as u8);
  out1[3] = x15;
...
pub fn fiat_p384_scalar_divstep(out1: &mut u32, out2: &mut [u32; 13], out3: &mut [u32; 13], out4: &mut [u32; 12], out5: &mut [u32; 12], arg1: u32, arg2: &[u32; 13], arg3: &[u32; 13], arg4: &[u32; 12], arg5: &[u32; 12]) -> () {
  ...
  let x3: fiat_p384_scalar_u1 = (((x1 >> 31) as fiat_p384_scalar_u1) & ((arg3[0]) as fiat_p384_scalar_u1));
  let mut x4: u32 = 0;
  ...
  let mut x194: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x194, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x7);
  let mut x195: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x195, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x8);
  let mut x196: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x196, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x9);
  let mut x197: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x197, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x10);
  let mut x198: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x198, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x11);
  let mut x199: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x199, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x12);
  let mut x200: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x200, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x13);
  let mut x201: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x201, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x14);
  let mut x202: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x202, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x15);
  let mut x203: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x203, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x16);
  let mut x204: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x204, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x17);
  let mut x205: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x205, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x18);
  let mut x206: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x206, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x19);
  let mut x207: u32 = 0;
  let mut x208: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x207, &mut x208, 0x0, x46, x194);
  let mut x209: u32 = 0;
  let mut x210: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x209, &mut x210, x208, x47, x195);
  let mut x211: u32 = 0;
  let mut x212: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x211, &mut x212, x210, x48, x196);
  let mut x213: u32 = 0;
  let mut x214: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x213, &mut x214, x212, x49, x197);
  let mut x215: u32 = 0;
  let mut x216: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x215, &mut x216, x214, x50, x198);
  let mut x217: u32 = 0;
  let mut x218: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x217, &mut x218, x216, x51, x199);
  let mut x219: u32 = 0;
  let mut x220: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x219, &mut x220, x218, x52, x200);
  let mut x221: u32 = 0;
  let mut x222: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x221, &mut x222, x220, x53, x201);
  let mut x223: u32 = 0;
  let mut x224: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x223, &mut x224, x222, x54, x202);
  let mut x225: u32 = 0;
  let mut x226: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x225, &mut x226, x224, x55, x203);
  let mut x227: u32 = 0;
  let mut x228: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x227, &mut x228, x226, x56, x204);
  let mut x229: u32 = 0;
  let mut x230: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x229, &mut x230, x228, x57, x205);
  let mut x231: u32 = 0;
  let mut x232: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x231, &mut x232, x230, x58, x206);
  let mut x233: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x233, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x59);
  let mut x234: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x234, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x60);
  let mut x235: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x235, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x61);
  let mut x236: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x236, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x62);
  let mut x237: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x237, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x63);
  let mut x238: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x238, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x64);
  let mut x239: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x239, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x65);
  let mut x240: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x240, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x66);
  let mut x241: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x241, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x67);
  let mut x242: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x242, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x68);
  let mut x243: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x243, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x69);
  let mut x244: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x244, (x46 as fiat_p384_scalar_u1), (0x0 as u32), x70);
  let mut x245: u32 = 0;
  let mut x246: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x245, &mut x246, 0x0, x182, x233);
  let mut x247: u32 = 0;
  let mut x248: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x247, &mut x248, x246, x183, x234);
  let mut x249: u32 = 0;
  let mut x250: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x249, &mut x250, x248, x184, x235);
  let mut x251: u32 = 0;
  let mut x252: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x251, &mut x252, x250, x185, x236);
  let mut x253: u32 = 0;
  let mut x254: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x253, &mut x254, x252, x186, x237);
  let mut x255: u32 = 0;
  let mut x256: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x255, &mut x256, x254, x187, x238);
  let mut x257: u32 = 0;
  let mut x258: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x257, &mut x258, x256, x188, x239);
  let mut x259: u32 = 0;
  let mut x260: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x259, &mut x260, x258, x189, x240);
  let mut x261: u32 = 0;
  let mut x262: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x261, &mut x262, x260, x190, x241);
  let mut x263: u32 = 0;
  let mut x264: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x263, &mut x264, x262, x191, x242);
  let mut x265: u32 = 0;
  let mut x266: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x265, &mut x266, x264, x192, x243);
  let mut x267: u32 = 0;
  let mut x268: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x267, &mut x268, x266, x193, x244);
  let mut x269: u32 = 0;
  let mut x270: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u32(&mut x269, &mut x270, 0x0, x245, 0xccc52973);
  let mut x271: u32 = 0;
  let mut x272: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u32(&mut x271, &mut x272, x270, x247, 0xecec196a);
  let mut x273: u32 = 0;
  let mut x274: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u32(&mut x273, &mut x274, x272, x249, 0x48b0a77a);
  let mut x275: u32 = 0;
  let mut x276: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u32(&mut x275, &mut x276, x274, x251, 0x581a0db2);
  let mut x277: u32 = 0;
  let mut x278: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u32(&mut x277, &mut x278, x276, x253, 0xf4372ddf);
  let mut x279: u32 = 0;
  let mut x280: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u32(&mut x279, &mut x280, x278, x255, 0xc7634d81);
  let mut x281: u32 = 0;
  let mut x282: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u32(&mut x281, &mut x282, x280, x257, 0xffffffff);
  let mut x283: u32 = 0;
  ...
  fiat_p384_scalar_subborrowx_u32(&mut x293, &mut x294, x292, (x268 as u32), (0x0 as u32));
  let mut x295: u32 = 0;
  let mut x296: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u32(&mut x295, &mut x296, 0x0, x6, (0x1 as u32));
  let x297: u32 = ((x207 >> 1) | ((x209 << 31) & 0xffffffff));
  let x298: u32 = ((x209 >> 1) | ((x211 << 31) & 0xffffffff));
  let x299: u32 = ((x211 >> 1) | ((x213 << 31) & 0xffffffff));
  let x300: u32 = ((x213 >> 1) | ((x215 << 31) & 0xffffffff));
  let x301: u32 = ((x215 >> 1) | ((x217 << 31) & 0xffffffff));
  let x302: u32 = ((x217 >> 1) | ((x219 << 31) & 0xffffffff));
  let x303: u32 = ((x219 >> 1) | ((x221 << 31) & 0xffffffff));
  let x304: u32 = ((x221 >> 1) | ((x223 << 31) & 0xffffffff));
  let x305: u32 = ((x223 >> 1) | ((x225 << 31) & 0xffffffff));
  let x306: u32 = ((x225 >> 1) | ((x227 << 31) & 0xffffffff));
  let x307: u32 = ((x227 >> 1) | ((x229 << 31) & 0xffffffff));
  let x308: u32 = ((x229 >> 1) | ((x231 << 31) & 0xffffffff));
  let x309: u32 = ((x231 & 0x80000000) | (x231 >> 1));
  let mut x310: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x310, x120, x95, x71);
  let mut x311: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x311, x120, x97, x73);
  let mut x312: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x312, x120, x99, x75);
  let mut x313: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x313, x120, x101, x77);
  let mut x314: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x314, x120, x103, x79);
  let mut x315: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x315, x120, x105, x81);
  let mut x316: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x316, x120, x107, x83);
  let mut x317: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x317, x120, x109, x85);
  let mut x318: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x318, x120, x111, x87);
  let mut x319: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x319, x120, x113, x89);
  let mut x320: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x320, x120, x115, x91);
  let mut x321: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x321, x120, x117, x93);
  let mut x322: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x322, x294, x269, x245);
  let mut x323: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x323, x294, x271, x247);
  let mut x324: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x324, x294, x273, x249);
  let mut x325: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x325, x294, x275, x251);
  let mut x326: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x326, x294, x277, x253);
  let mut x327: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x327, x294, x279, x255);
  let mut x328: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x328, x294, x281, x257);
  let mut x329: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x329, x294, x283, x259);
  let mut x330: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x330, x294, x285, x261);
  let mut x331: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x331, x294, x287, x263);
  let mut x332: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x332, x294, x289, x265);
  let mut x333: u32 = 0;
  fiat_p384_scalar_cmovznz_u32(&mut x333, x294, x291, x267);
  *out1 = x295;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
