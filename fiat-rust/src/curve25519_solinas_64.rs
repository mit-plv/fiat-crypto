...
pub fn fiat_curve25519_solinas_mul(out1: &mut [u64; 4], arg1: &[u64; 4], arg2: &[u64; 4]) -> () {
  ...
  let x131: u128 = ((x130 as u128) + (x122 as u128));
  let x132: u64 = ((x131 & (0xffffffffffffffff as u128)) as u64);
  out1[0] = x132;
  out1[1] = x124;
  out1[2] = x126;
  out1[3] = x128;
...
pub fn fiat_curve25519_solinas_mul2(out1: &mut [u64; 4], out2: &mut [u64; 4], arg1: &[u64; 4], arg2: &[u64; 4], arg3: &[u64; 4], arg4: &[u64; 4]) -> () {
  ...
  let x228: u128 = ((x227 as u128) + (x219 as u128));
  let x229: u64 = ((x228 & (0xffffffffffffffff as u128)) as u64);
  let mut x230: u64 = 0;
  let mut x231: u64 = 0;
  ...
  let x265: u128 = ((x264 as u128) + (x256 as u128));
  let x266: u64 = ((x265 & (0xffffffffffffffff as u128)) as u64);
  out1[0] = x229;
  out1[1] = x221;
  out1[2] = x223;
  out1[3] = x225;
...
pub fn fiat_curve25519_solinas_square(out1: &mut [u64; 4], arg1: &[u64; 4]) -> () {
  ...
  let x100: u128 = ((x99 as u128) + (x91 as u128));
  let x101: u64 = ((x100 & (0xffffffffffffffff as u128)) as u64);
  out1[0] = x101;
  out1[1] = x93;
  out1[2] = x95;
  out1[3] = x97;
