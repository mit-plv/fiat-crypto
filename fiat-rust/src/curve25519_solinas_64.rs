...
pub fn fiat_curve25519_solinas_subborrowx_u64(out1: &mut u64, out2: &mut fiat_curve25519_solinas_u1, arg1: fiat_curve25519_solinas_u1, arg2: u64, arg3: u64) -> () {
  ...
  *out1 = x3;
  *out2 = (((0x0_u8 as fiat_curve25519_solinas_i2) - (x2 as fiat_curve25519_solinas_i2)) as fiat_curve25519_solinas_u1);
}
...
pub fn fiat_curve25519_solinas_cmovznz_u64(out1: &mut u64, arg1: fiat_curve25519_solinas_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((((0x0_u8 as fiat_curve25519_solinas_i2) - (x1 as fiat_curve25519_solinas_i2)) as fiat_curve25519_solinas_i1) as i128) & (0xffffffffffffffff_u64 as i128)) as u64);
...
pub fn fiat_curve25519_solinas_mul(out1: &mut [u64; 4], arg1: &[u64; 4], arg2: &[u64; 4]) -> () {
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x33, &mut x34, 0x0_u8, x28, x7);
  let mut x35: u64 = 0;
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x38, &mut x39, 0x0_u8, x33, x13);
  let mut x40: u64 = 0;
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x42, &mut x43, x41, x37, (0x0_u8 as u64));
  let x44: u64 = ((x43 as u64) + x10);
  let mut x45: u64 = 0;
  let mut x46: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x45, &mut x46, 0x0_u8, x30, x15);
  let mut x47: u64 = 0;
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x53, &mut x54, x52, x44, (0x0_u8 as u64));
  let x55: u64 = ((x54 as u64) + x2);
  let mut x56: u64 = 0;
  let mut x57: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x56, &mut x57, 0x0_u8, x45, x21);
  let mut x58: u64 = 0;
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x64, &mut x65, x63, x53, (0x0_u8 as u64));
  let mut x66: u64 = 0;
  let mut x67: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x66, &mut x67, x65, x55, (0x0_u8 as u64));
  let mut x68: u64 = 0;
  let mut x69: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x68, &mut x69, 0x0_u8, x32, x23);
  let mut x70: u64 = 0;
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x80, &mut x81, x79, x66, (0x0_u8 as u64));
  let mut x82: u64 = 0;
  let mut x83: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x82, &mut x83, 0x0_u8, x68, x29);
  let mut x84: u64 = 0;
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x94, &mut x95, x93, x80, (0x0_u8 as u64));
  let mut x96: u64 = 0;
  let mut x97: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x96, &mut x97, 0x26_u8, x94);
  let mut x98: u64 = 0;
  let mut x99: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x98, &mut x99, 0x26_u8, x92);
  let mut x100: u64 = 0;
  let mut x101: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x100, &mut x101, 0x26_u8, x90);
  let mut x102: u64 = 0;
  let mut x103: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x102, &mut x103, 0x26_u8, x88);
  let mut x104: u64 = 0;
  let mut x105: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x104, &mut x105, 0x0_u8, x82, x100);
  let mut x106: u64 = 0;
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x111, &mut x112, 0x0_u8, x31, x102);
  let mut x113: u64 = 0;
  ...
  let mut x120: u64 = 0;
  let mut x121: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x120, &mut x121, 0x26_u8, x119);
  let mut x122: u64 = 0;
  let mut x123: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x122, &mut x123, 0x0_u8, x111, x120);
  let mut x124: u64 = 0;
  let mut x125: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x124, &mut x125, x123, x113, (0x0_u8 as u64));
  let mut x126: u64 = 0;
  let mut x127: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x126, &mut x127, x125, x115, (0x0_u8 as u64));
  let mut x128: u64 = 0;
  let mut x129: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x128, &mut x129, x127, x117, (0x0_u8 as u64));
  let mut x130: u64 = 0;
  fiat_curve25519_solinas_cmovznz_u64(&mut x130, x129, (0x0_u8 as u64), 0x26_u8);
  let mut x131: u64 = 0;
  let mut x132: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x131, &mut x132, 0x0_u8, x130, x122);
  out1[0] = x131;
  out1[1] = x124;
  out1[2] = x126;
  out1[3] = x128;
...
pub fn fiat_curve25519_solinas_square(out1: &mut [u64; 4], arg1: &[u64; 4]) -> () {
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x11, &mut x12, 0x0_u8, x6, x3);
  let mut x13: u64 = 0;
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x22, &mut x23, 0x0_u8, x13, x20);
  let mut x24: u64 = 0;
  ...
  fiat_curve25519_solinas_addcarryx_u64(&mut x26, &mut x27, x25, x17, (0x0_u8 as u64));
  let mut x28: u64 = 0;
  let mut x29: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x28, &mut x29, x27, x19, (0x0_u8 as u64));
  let mut x30: u64 = 0;
  let mut x31: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x30, &mut x31, 0x0_u8, x5, x5);
  let mut x32: u64 = 0;
  ...
  let mut x51: u64 = 0;
  let mut x52: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x51, &mut x52, 0x0_u8, x30, x50);
  let mut x53: u64 = 0;
  let mut x54: fiat_curve25519_solinas_u1 = 0;
  ...
  let mut x65: u64 = 0;
  let mut x66: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x65, &mut x66, 0x26_u8, x63);
  let mut x67: u64 = 0;
  let mut x68: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x67, &mut x68, 0x26_u8, x61);
  let mut x69: u64 = 0;
  let mut x70: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x69, &mut x70, 0x26_u8, x59);
  let mut x71: u64 = 0;
  let mut x72: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x71, &mut x72, 0x26_u8, x57);
  let mut x73: u64 = 0;
  let mut x74: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x73, &mut x74, 0x0_u8, x51, x69);
  let mut x75: u64 = 0;
  ...
  let mut x80: u64 = 0;
  let mut x81: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x80, &mut x81, 0x0_u8, x49, x71);
  let mut x82: u64 = 0;
  let mut x83: fiat_curve25519_solinas_u1 = 0;
  ...
  let mut x89: u64 = 0;
  let mut x90: u64 = 0;
  fiat_curve25519_solinas_mulx_u64(&mut x89, &mut x90, 0x26_u8, x88);
  let mut x91: u64 = 0;
  let mut x92: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x91, &mut x92, 0x0_u8, x80, x89);
  let mut x93: u64 = 0;
  let mut x94: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x93, &mut x94, x92, x82, (0x0_u8 as u64));
  let mut x95: u64 = 0;
  let mut x96: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x95, &mut x96, x94, x84, (0x0_u8 as u64));
  let mut x97: u64 = 0;
  let mut x98: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x97, &mut x98, x96, x86, (0x0_u8 as u64));
  let mut x99: u64 = 0;
  fiat_curve25519_solinas_cmovznz_u64(&mut x99, x98, (0x0_u8 as u64), 0x26_u8);
  let mut x100: u64 = 0;
  let mut x101: fiat_curve25519_solinas_u1 = 0;
  fiat_curve25519_solinas_addcarryx_u64(&mut x100, &mut x101, 0x0_u8, x99, x91);
  out1[0] = x100;
  out1[1] = x93;
  out1[2] = x95;
  out1[3] = x97;
