//! Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --lang Rust secp256k1 64 '2^256 - 2^32 - 977' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub fn fiat_secp256k1_one(out1: &mut [u64; 4]) -> () {
  out1[0] = 0x1000003d1;
  out1[1] = (0x0 as u64);
  out1[2] = (0x0 as u64);
  out1[3] = (0x0 as u64);
...
pub fn fiat_secp256k1_divstep(out1: &mut u64, out2: &mut [u64; 5], out3: &mut [u64; 5], out4: &mut [u64; 4], out5: &mut [u64; 4], arg1: u64, arg2: &[u64; 5], arg3: &[u64; 5], arg4: &[u64; 4], arg5: &[u64; 4]) -> () {
  ...
  let x2: fiat_secp256k1_u1 = (((x1 >> 63) as fiat_secp256k1_u1) & (((arg3[0]) & (0x1 as u64)) as fiat_secp256k1_u1));
  let mut x3: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x3, x2, arg1, (((((!arg1) as u128) + (0x1 as u128)) & (0xffffffffffffffff as u128)) as u64));
  let mut x4: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x4, x2, (arg2[0]), (arg3[0]));
  let mut x5: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x5, x2, (arg2[1]), (arg3[1]));
  let mut x6: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x6, x2, (arg2[2]), (arg3[2]));
  let mut x7: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x7, x2, (arg2[3]), (arg3[3]));
  let mut x8: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x8, x2, (arg2[4]), (arg3[4]));
  let mut x9: u64 = 0;
  let mut x10: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x9, &mut x10, 0x0, (0x1 as u64), (!(arg2[0])));
  let mut x11: u64 = 0;
  let mut x12: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x11, &mut x12, x10, (0x0 as u64), (!(arg2[1])));
  let mut x13: u64 = 0;
  let mut x14: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x13, &mut x14, x12, (0x0 as u64), (!(arg2[2])));
  let mut x15: u64 = 0;
  let mut x16: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x15, &mut x16, x14, (0x0 as u64), (!(arg2[3])));
  let mut x17: u64 = 0;
  let mut x18: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x17, &mut x18, x16, (0x0 as u64), (!(arg2[4])));
  let mut x19: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x19, x2, (arg3[0]), x9);
  let mut x20: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x20, x2, (arg3[1]), x11);
  let mut x21: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x21, x2, (arg3[2]), x13);
  let mut x22: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x22, x2, (arg3[3]), x15);
  let mut x23: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x23, x2, (arg3[4]), x17);
  let mut x24: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x24, x2, (arg4[0]), (arg5[0]));
  let mut x25: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x25, x2, (arg4[1]), (arg5[1]));
  let mut x26: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x26, x2, (arg4[2]), (arg5[2]));
  let mut x27: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x27, x2, (arg4[3]), (arg5[3]));
  let mut x28: u64 = 0;
  let mut x29: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x28, &mut x29, 0x0, x24, x24);
  let mut x30: u64 = 0;
  let mut x31: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x30, &mut x31, x29, x25, x25);
  let mut x32: u64 = 0;
  let mut x33: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x32, &mut x33, x31, x26, x26);
  let mut x34: u64 = 0;
  let mut x35: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x34, &mut x35, x33, x27, x27);
  let mut x36: u64 = 0;
  let mut x37: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x36, &mut x37, 0x0, x28, 0xfffffffefffffc2f);
  let mut x38: u64 = 0;
  let mut x39: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x38, &mut x39, x37, x30, 0xffffffffffffffff);
  let mut x40: u64 = 0;
  let mut x41: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x40, &mut x41, x39, x32, 0xffffffffffffffff);
  let mut x42: u64 = 0;
  let mut x43: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x42, &mut x43, x41, x34, 0xffffffffffffffff);
  let mut x44: u64 = 0;
  let mut x45: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x44, &mut x45, x43, (x35 as u64), (0x0 as u64));
  let x46: u64 = (arg4[3]);
  let x47: u64 = (arg4[2]);
  let x48: u64 = (arg4[1]);
  let x49: u64 = (arg4[0]);
  let mut x50: u64 = 0;
  let mut x51: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x50, &mut x51, 0x0, (0x0 as u64), x49);
  let mut x52: u64 = 0;
  let mut x53: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x52, &mut x53, x51, (0x0 as u64), x48);
  let mut x54: u64 = 0;
  let mut x55: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x54, &mut x55, x53, (0x0 as u64), x47);
  let mut x56: u64 = 0;
  let mut x57: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x56, &mut x57, x55, (0x0 as u64), x46);
  let mut x58: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x58, x57, (0x0 as u64), 0xffffffffffffffff);
  let mut x59: u64 = 0;
  let mut x60: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x59, &mut x60, 0x0, x50, (x58 & 0xfffffffefffffc2f));
  let mut x61: u64 = 0;
  let mut x62: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x61, &mut x62, x60, x52, x58);
  let mut x63: u64 = 0;
  let mut x64: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x63, &mut x64, x62, x54, x58);
  let mut x65: u64 = 0;
  let mut x66: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x65, &mut x66, x64, x56, x58);
  let mut x67: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x67, x2, (arg5[0]), x59);
  let mut x68: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x68, x2, (arg5[1]), x61);
  let mut x69: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x69, x2, (arg5[2]), x63);
  let mut x70: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x70, x2, (arg5[3]), x65);
  let x71: fiat_secp256k1_u1 = ((x19 & (0x1 as u64)) as fiat_secp256k1_u1);
  let mut x72: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x72, x71, (0x0 as u64), x4);
  let mut x73: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x73, x71, (0x0 as u64), x5);
  let mut x74: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x74, x71, (0x0 as u64), x6);
  let mut x75: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x75, x71, (0x0 as u64), x7);
  let mut x76: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x76, x71, (0x0 as u64), x8);
  let mut x77: u64 = 0;
  let mut x78: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x77, &mut x78, 0x0, x19, x72);
  let mut x79: u64 = 0;
  let mut x80: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x79, &mut x80, x78, x20, x73);
  let mut x81: u64 = 0;
  let mut x82: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x81, &mut x82, x80, x21, x74);
  let mut x83: u64 = 0;
  let mut x84: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x83, &mut x84, x82, x22, x75);
  let mut x85: u64 = 0;
  let mut x86: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x85, &mut x86, x84, x23, x76);
  let mut x87: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x87, x71, (0x0 as u64), x24);
  let mut x88: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x88, x71, (0x0 as u64), x25);
  let mut x89: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x89, x71, (0x0 as u64), x26);
  let mut x90: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x90, x71, (0x0 as u64), x27);
  let mut x91: u64 = 0;
  let mut x92: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x91, &mut x92, 0x0, x67, x87);
  let mut x93: u64 = 0;
  let mut x94: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x93, &mut x94, x92, x68, x88);
  let mut x95: u64 = 0;
  let mut x96: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x95, &mut x96, x94, x69, x89);
  let mut x97: u64 = 0;
  let mut x98: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_addcarryx_u64(&mut x97, &mut x98, x96, x70, x90);
  let mut x99: u64 = 0;
  let mut x100: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x99, &mut x100, 0x0, x91, 0xfffffffefffffc2f);
  let mut x101: u64 = 0;
  let mut x102: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x101, &mut x102, x100, x93, 0xffffffffffffffff);
  let mut x103: u64 = 0;
  let mut x104: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x103, &mut x104, x102, x95, 0xffffffffffffffff);
  let mut x105: u64 = 0;
  let mut x106: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x105, &mut x106, x104, x97, 0xffffffffffffffff);
  let mut x107: u64 = 0;
  let mut x108: fiat_secp256k1_u1 = 0;
  fiat_secp256k1_subborrowx_u64(&mut x107, &mut x108, x106, (x98 as u64), (0x0 as u64));
  let x109: u64 = ((((x3 as u128) + (0x1 as u128)) & (0xffffffffffffffff as u128)) as u64);
  let x110: u64 = ((x77 >> 1) | ((x79 << 63) & 0xffffffffffffffff));
  let x111: u64 = ((x79 >> 1) | ((x81 << 63) & 0xffffffffffffffff));
  let x112: u64 = ((x81 >> 1) | ((x83 << 63) & 0xffffffffffffffff));
  let x113: u64 = ((x83 >> 1) | ((x85 << 63) & 0xffffffffffffffff));
  let x114: u64 = ((x85 & 0x8000000000000000) | (x85 >> 1));
  let mut x115: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x115, x45, x36, x28);
  let mut x116: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x116, x45, x38, x30);
  let mut x117: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x117, x45, x40, x32);
  let mut x118: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x118, x45, x42, x34);
  let mut x119: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x119, x108, x99, x91);
  let mut x120: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x120, x108, x101, x93);
  let mut x121: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x121, x108, x103, x95);
  let mut x122: u64 = 0;
  fiat_secp256k1_cmovznz_u64(&mut x122, x108, x105, x97);
  *out1 = x109;
  out2[0] = x4;
  out2[1] = x5;
  out2[2] = x6;
