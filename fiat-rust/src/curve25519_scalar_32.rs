...
pub fn fiat_25519_scalar_addcarryx_u32(out1: &mut u32, out2: &mut fiat_25519_scalar_u1, arg1: fiat_25519_scalar_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x2: fiat_25519_scalar_u1 = ((x1 >> 32) as fiat_25519_scalar_u1);
  *out1 = (x1 as u32);
  *out2 = x2;
}
...
pub fn fiat_25519_scalar_divstep(out1: &mut u32, out2: &mut [u32; 9], out3: &mut [u32; 9], out4: &mut [u32; 8], out5: &mut [u32; 8], arg1: u32, arg2: &[u32; 9], arg3: &[u32; 9], arg4: &[u32; 8], arg5: &[u32; 8]) -> () {
  ...
  let x3: fiat_25519_scalar_u1 = (((x1 >> 31) as fiat_25519_scalar_u1) & ((arg3[0]) as fiat_25519_scalar_u1));
  let mut x4: u32 = 0;
  ...
  let mut x134: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x134, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x7);
  let mut x135: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x135, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x8);
  let mut x136: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x136, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x9);
  let mut x137: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x137, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x10);
  let mut x138: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x138, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x11);
  let mut x139: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x139, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x12);
  let mut x140: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x140, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x13);
  let mut x141: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x141, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x14);
  let mut x142: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x142, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x15);
  let mut x143: u32 = 0;
  let mut x144: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x143, &mut x144, 0x0, x34, x134);
  let mut x145: u32 = 0;
  let mut x146: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x145, &mut x146, x144, x35, x135);
  let mut x147: u32 = 0;
  let mut x148: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x147, &mut x148, x146, x36, x136);
  let mut x149: u32 = 0;
  let mut x150: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x149, &mut x150, x148, x37, x137);
  let mut x151: u32 = 0;
  let mut x152: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x151, &mut x152, x150, x38, x138);
  let mut x153: u32 = 0;
  let mut x154: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x153, &mut x154, x152, x39, x139);
  let mut x155: u32 = 0;
  let mut x156: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x155, &mut x156, x154, x40, x140);
  let mut x157: u32 = 0;
  let mut x158: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x157, &mut x158, x156, x41, x141);
  let mut x159: u32 = 0;
  let mut x160: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x159, &mut x160, x158, x42, x142);
  let mut x161: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x161, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x43);
  let mut x162: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x162, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x44);
  let mut x163: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x163, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x45);
  let mut x164: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x164, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x46);
  let mut x165: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x165, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x47);
  let mut x166: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x166, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x48);
  let mut x167: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x167, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x49);
  let mut x168: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x168, (x34 as fiat_25519_scalar_u1), (0x0 as u32), x50);
  let mut x169: u32 = 0;
  let mut x170: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x169, &mut x170, 0x0, x126, x161);
  let mut x171: u32 = 0;
  let mut x172: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x171, &mut x172, x170, x127, x162);
  let mut x173: u32 = 0;
  let mut x174: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x173, &mut x174, x172, x128, x163);
  let mut x175: u32 = 0;
  let mut x176: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x175, &mut x176, x174, x129, x164);
  let mut x177: u32 = 0;
  let mut x178: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x177, &mut x178, x176, x130, x165);
  let mut x179: u32 = 0;
  let mut x180: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x179, &mut x180, x178, x131, x166);
  let mut x181: u32 = 0;
  let mut x182: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x181, &mut x182, x180, x132, x167);
  let mut x183: u32 = 0;
  let mut x184: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x183, &mut x184, x182, x133, x168);
  let mut x185: u32 = 0;
  let mut x186: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u32(&mut x185, &mut x186, 0x0, x169, 0x5cf5d3ed);
  let mut x187: u32 = 0;
  let mut x188: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u32(&mut x187, &mut x188, x186, x171, 0x5812631a);
  let mut x189: u32 = 0;
  let mut x190: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u32(&mut x189, &mut x190, x188, x173, 0xa2f79cd6);
  let mut x191: u32 = 0;
  let mut x192: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u32(&mut x191, &mut x192, x190, x175, 0x14def9de);
  let mut x193: u32 = 0;
  let mut x194: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u32(&mut x193, &mut x194, x192, x177, (0x0 as u32));
  let mut x195: u32 = 0;
  let mut x196: fiat_25519_scalar_u1 = 0;
  ...
  let mut x199: u32 = 0;
  let mut x200: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u32(&mut x199, &mut x200, x198, x183, 0x10000000);
  let mut x201: u32 = 0;
  let mut x202: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u32(&mut x201, &mut x202, x200, (x184 as u32), (0x0 as u32));
  let mut x203: u32 = 0;
  let mut x204: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u32(&mut x203, &mut x204, 0x0, x6, (0x1 as u32));
  ...
  let mut x214: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x214, x84, x67, x51);
  let mut x215: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x215, x84, x69, x53);
  let mut x216: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x216, x84, x71, x55);
  let mut x217: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x217, x84, x73, x57);
  let mut x218: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x218, x84, x75, x59);
  let mut x219: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x219, x84, x77, x61);
  let mut x220: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x220, x84, x79, x63);
  let mut x221: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x221, x84, x81, x65);
  let mut x222: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x222, x202, x185, x169);
  let mut x223: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x223, x202, x187, x171);
  let mut x224: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x224, x202, x189, x173);
  let mut x225: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x225, x202, x191, x175);
  let mut x226: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x226, x202, x193, x177);
  let mut x227: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x227, x202, x195, x179);
  let mut x228: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x228, x202, x197, x181);
  let mut x229: u32 = 0;
  fiat_25519_scalar_cmovznz_u32(&mut x229, x202, x199, x183);
  *out1 = x203;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
