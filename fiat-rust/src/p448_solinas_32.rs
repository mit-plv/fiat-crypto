...
pub fn fiat_p448_to_bytes(out1: &mut [u8; 56], arg1: &fiat_p448_tight_field_element) -> () {
  ...
  let x74: u32 = (x34 >> 8);
  let x75: u32 = (x74 >> 8);
  let x76: u8 = ((x75 >> 8) as u8);
  let x77: u32 = (x73 + (x76 as u32));
  let x78: u32 = (x77 >> 8);
  let x79: u32 = (x78 >> 8);
  let x80: u8 = ((x79 >> 8) as u8);
  let x81: u32 = (x38 >> 8);
  let x82: u32 = (x81 >> 8);
  let x83: u8 = ((x82 >> 8) as u8);
  let x84: u32 = (x72 + (x83 as u32));
  let x85: u32 = (x84 >> 8);
  let x86: u32 = (x85 >> 8);
  let x87: u8 = ((x86 >> 8) as u8);
  let x88: u32 = (x42 >> 8);
  let x89: u32 = (x88 >> 8);
  let x90: u8 = ((x89 >> 8) as u8);
  let x91: u32 = (x71 + (x90 as u32));
  let x92: u32 = (x91 >> 8);
  let x93: u32 = (x92 >> 8);
  let x94: u8 = ((x93 >> 8) as u8);
  let x95: u32 = (x46 >> 8);
  let x96: u32 = (x95 >> 8);
  let x97: u8 = ((x96 >> 8) as u8);
  let x98: u32 = (x70 + (x97 as u32));
  let x99: u32 = (x98 >> 8);
  let x100: u32 = (x99 >> 8);
  let x101: u8 = ((x100 >> 8) as u8);
  let x102: u32 = (x50 >> 8);
  let x103: u32 = (x102 >> 8);
  let x104: u8 = ((x103 >> 8) as u8);
  let x105: u32 = (x69 + (x104 as u32));
  let x106: u32 = (x105 >> 8);
  let x107: u32 = (x106 >> 8);
  let x108: u8 = ((x107 >> 8) as u8);
  let x109: u32 = (x54 >> 8);
  let x110: u32 = (x109 >> 8);
  let x111: u8 = ((x110 >> 8) as u8);
  let x112: u32 = (x68 + (x111 as u32));
  let x113: u32 = (x112 >> 8);
  let x114: u32 = (x113 >> 8);
  let x115: u8 = ((x114 >> 8) as u8);
  let x116: u32 = (x58 >> 8);
  let x117: u32 = (x116 >> 8);
  let x118: u8 = ((x117 >> 8) as u8);
  let x119: u32 = (x67 + (x118 as u32));
  let x120: u32 = (x119 >> 8);
  let x121: u32 = (x120 >> 8);
