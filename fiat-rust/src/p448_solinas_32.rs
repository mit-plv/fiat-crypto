//! Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang Rust p448 32 16 '2^448 - 2^224 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes
...
pub fn fiat_p448_carry_mul(out1: &mut [u32; 16], arg1: &[u32; 16], arg2: &[u32; 16]) -> () {
  ...
  let x408: u128 = ((x389 as u128) + ((x374 + (x360 + (x347 + (x335 + (x324 + (x314 + (x305 + (x297 + (x290 + (x284 + (x279 + (x275 + (x272 + (x270 + (x269 + (x233 + (x225 + (x217 + (x209 + (x201 + (x193 + (x185 + x177)))))))))))))))))))))) as u128));
  let x409: u128 = ((x390 as u128) + ((x375 as u128) + ((x361 as u128) + ((x348 + (x336 + (x325 + (x315 + (x306 + (x298 + (x291 + (x285 + (x280 + (x276 + (x273 + (x271 + (x241 + (x234 + (x226 + (x218 + (x210 + (x202 + (x194 + (x186 + (x178 + (x57 + x29)))))))))))))))))))))) as u128))));
  let x410: u128 = ((x391 as u128) + ((x376 as u128) + ((x362 as u128) + ((x349 as u128) + ((x337 as u128) + ((x326 + (x316 + (x307 + (x299 + (x292 + (x286 + (x281 + (x277 + (x274 + (x248 + (x242 + (x235 + (x227 + (x219 + (x211 + (x203 + (x195 + (x187 + (x179 + (x72 + (x58 + (x36 + x30)))))))))))))))))))))) as u128))))));
  let x411: u128 = ((x392 as u128) + ((x377 as u128) + ((x363 as u128) + ((x350 as u128) + ((x338 as u128) + ((x327 as u128) + ((x317 as u128) + ((x308 + (x300 + (x293 + (x287 + (x282 + (x278 + (x254 + (x249 + (x243 + (x236 + (x228 + (x220 + (x212 + (x204 + (x196 + (x188 + (x180 + (x86 + (x73 + (x59 + (x42 + (x37 + x31)))))))))))))))))))))) as u128))))))));
  let x412: u128 = ((x393 as u128) + ((x378 as u128) + ((x364 as u128) + ((x351 as u128) + ((x339 as u128) + ((x328 as u128) + ((x318 as u128) + ((x309 as u128) + ((x301 as u128) + ((x294 + (x288 + (x283 + (x259 + (x255 + (x250 + (x244 + (x237 + (x229 + (x221 + (x213 + (x205 + (x197 + (x189 + (x181 + (x99 + (x87 + (x74 + (x60 + (x47 + (x43 + (x38 + x32)))))))))))))))))))))) as u128))))))))));
  let x413: u128 = ((x394 as u128) + ((x379 as u128) + ((x365 as u128) + ((x352 as u128) + ((x340 as u128) + ((x329 as u128) + ((x319 as u128) + ((x310 as u128) + ((x302 as u128) + ((x295 as u128) + ((x289 as u128) + ((x263 + (x260 + (x256 + (x251 + (x245 + (x238 + (x230 + (x222 + (x214 + (x206 + (x198 + (x190 + (x182 + (x111 + (x100 + (x88 + (x75 + (x61 + (x51 + (x48 + (x44 + (x39 + x33)))))))))))))))))))))) as u128))))))))))));
  let x414: u128 = ((x395 as u128) + ((x380 as u128) + ((x366 as u128) + ((x353 as u128) + ((x341 as u128) + ((x330 as u128) + ((x320 as u128) + ((x311 as u128) + ((x303 as u128) + ((x296 as u128) + ((x266 as u128) + ((x264 as u128) + ((x261 as u128) + ((x257 + (x252 + (x246 + (x239 + (x231 + (x223 + (x215 + (x207 + (x199 + (x191 + (x183 + (x122 + (x112 + (x101 + (x89 + (x76 + (x62 + (x54 + (x52 + (x49 + (x45 + (x40 + x34)))))))))))))))))))))) as u128))))))))))))));
  let x415: u128 = ((x396 as u128) + ((x381 as u128) + ((x367 as u128) + ((x354 as u128) + ((x342 as u128) + ((x331 as u128) + ((x321 as u128) + ((x312 as u128) + ((x304 as u128) + ((x268 as u128) + ((x267 as u128) + ((x265 as u128) + ((x262 as u128) + ((x258 as u128) + ((x253 as u128) + ((x247 + (x240 + (x232 + (x224 + (x216 + (x208 + (x200 + (x192 + (x184 + (x132 + (x123 + (x113 + (x102 + (x90 + (x77 + (x63 + (x56 + (x55 + (x53 + (x50 + (x46 + (x41 + x35)))))))))))))))))))))) as u128))))))))))))))));
  ...
  let x424: u64 = ((x408 >> 28) as u64);
  let x425: u32 = ((x408 & (0xfffffff as u128)) as u32);
  ...
  let x460: u128 = ((x458 as u128) + x409);
  let x461: u64 = (x457 >> 28);
  let x462: u32 = ((x457 & (0xfffffff as u64)) as u32);
  let x463: u64 = (x461 + x416);
  let x464: u64 = ((x460 >> 28) as u64);
  let x465: u32 = ((x460 & (0xfffffff as u128)) as u32);
...
pub fn fiat_p448_carry_square(out1: &mut [u32; 16], arg1: &[u32; 16]) -> () {
  ...
  let x265: u128 = ((x246 as u128) + ((x232 + (x218 + (x204 + (x190 + (x176 + (x162 + (x148 + (x119 + (x107 + (x98 + x92)))))))))) as u128));
  let x266: u128 = ((x247 as u128) + ((x233 as u128) + ((x219 + (x205 + (x191 + (x177 + (x163 + (x149 + (x135 + (x121 + (x109 + (x100 + (x94 + (x78 + x62)))))))))))) as u128)));
  let x267: u128 = ((x248 as u128) + ((x234 as u128) + ((x220 as u128) + ((x206 + (x192 + (x178 + (x164 + (x151 + (x137 + (x123 + (x111 + (x102 + (x79 + x63)))))))))) as u128))));
  let x268: u128 = ((x249 as u128) + ((x235 as u128) + ((x221 as u128) + ((x207 as u128) + ((x193 + (x179 + (x167 + (x165 + (x153 + (x139 + (x125 + (x113 + (x104 + (x81 + (x80 + (x65 + x64)))))))))))) as u128)))));
  let x269: u128 = ((x250 as u128) + ((x236 as u128) + ((x222 as u128) + ((x208 as u128) + ((x194 as u128) + ((x183 + (x180 + (x169 + (x155 + (x141 + (x127 + (x115 + (x84 + (x82 + (x68 + x66)))))))))) as u128))))));
  let x270: u128 = ((x251 as u128) + ((x237 as u128) + ((x223 as u128) + ((x209 as u128) + ((x199 as u128) + ((x195 as u128) + ((x185 + (x181 + (x171 + (x157 + (x143 + (x129 + (x117 + (x88 + (x85 + (x83 + (x72 + (x69 + x67)))))))))))) as u128)))))));
  let x271: u128 = ((x252 as u128) + ((x238 as u128) + ((x224 as u128) + ((x215 as u128) + ((x210 as u128) + ((x201 as u128) + ((x196 as u128) + ((x187 + (x173 + (x159 + (x145 + (x131 + (x95 + (x89 + (x86 + (x75 + (x73 + x70)))))))))) as u128))))))));
  let x272: u128 = ((x253 as u128) + ((x239 as u128) + ((x231 as u128) + ((x225 as u128) + ((x217 as u128) + ((x211 as u128) + ((x203 as u128) + ((x197 as u128) + ((x189 + (x175 + (x161 + (x147 + (x133 + (x105 + (x96 + (x90 + (x87 + (x77 + (x76 + (x74 + x71)))))))))))) as u128)))))))));
  ...
  let x281: u64 = ((x265 >> 28) as u64);
  let x282: u32 = ((x265 & (0xfffffff as u128)) as u32);
  ...
  let x317: u128 = ((x315 as u128) + x266);
  let x318: u64 = (x314 >> 28);
  let x319: u32 = ((x314 & (0xfffffff as u64)) as u32);
  let x320: u64 = (x318 + x273);
  let x321: u64 = ((x317 >> 28) as u64);
  let x322: u32 = ((x317 & (0xfffffff as u128)) as u32);
