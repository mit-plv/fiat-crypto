...
pub fn fiat_p521_to_bytes(out1: &mut [u8; 66], arg1: &fiat_p521_tight_field_element) -> () {
  ...
  let x48: u64 = (x47 >> 8);
  let x49: u64 = (x48 >> 8);
  let x50: u8 = ((x49 >> 8) as u8);
  let x51: u64 = (x43 + (x50 as u64));
  let x52: u64 = (x51 >> 8);
  let x53: u64 = (x52 >> 8);
  let x54: u64 = (x53 >> 8);
  let x55: u64 = (x54 >> 8);
  let x56: u64 = (x55 >> 8);
  let x57: u64 = (x56 >> 8);
  let x58: u8 = ((x57 >> 8) as u8);
  let x59: u64 = (x42 + (x58 as u64));
  let x60: u64 = (x59 >> 8);
  let x61: u64 = (x60 >> 8);
  let x62: u64 = (x61 >> 8);
  let x63: u64 = (x62 >> 8);
  let x64: u64 = (x63 >> 8);
  let x65: u64 = (x64 >> 8);
  let x66: u8 = ((x65 >> 8) as u8);
  let x67: u64 = (x41 + (x66 as u64));
  let x68: u64 = (x67 >> 8);
  let x69: u64 = (x68 >> 8);
  let x70: u64 = (x69 >> 8);
  let x71: u64 = (x70 >> 8);
  ...
  let x79: u64 = (x78 >> 8);
  let x80: u64 = (x79 >> 8);
  let x81: u8 = ((x80 >> 8) as u8);
  let x82: u64 = (x40 + (x81 as u64));
  let x83: u64 = (x82 >> 8);
  let x84: u64 = (x83 >> 8);
  let x85: u64 = (x84 >> 8);
  let x86: u64 = (x85 >> 8);
  let x87: u64 = (x86 >> 8);
  let x88: u64 = (x87 >> 8);
  let x89: u8 = ((x88 >> 8) as u8);
  let x90: u64 = (x39 + (x89 as u64));
  let x91: u64 = (x90 >> 8);
  let x92: u64 = (x91 >> 8);
  let x93: u64 = (x92 >> 8);
  let x94: u64 = (x93 >> 8);
  ...
  let x110: u64 = (x109 >> 8);
  let x111: u64 = (x110 >> 8);
  let x112: fiat_p521_u1 = ((x111 >> 8) as fiat_p521_u1);
  out1[0] = (x20 as u8);
  out1[1] = (x44 as u8);
  out1[2] = (x45 as u8);
  out1[3] = (x46 as u8);
