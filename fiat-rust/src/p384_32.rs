...
pub fn fiat_p384_addcarryx_u32(out1: &mut u32, out2: &mut fiat_p384_u1, arg1: fiat_p384_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x2: fiat_p384_u1 = ((x1 >> 32) as fiat_p384_u1);
  *out1 = (x1 as u32);
  *out2 = x2;
}
...
pub fn fiat_p384_divstep(out1: &mut u32, out2: &mut [u32; 13], out3: &mut [u32; 13], out4: &mut [u32; 12], out5: &mut [u32; 12], arg1: u32, arg2: &[u32; 13], arg3: &[u32; 13], arg4: &[u32; 12], arg5: &[u32; 12]) -> () {
  ...
  let x3: fiat_p384_u1 = (((x1 >> 31) as fiat_p384_u1) & ((arg3[0]) as fiat_p384_u1));
  let mut x4: u32 = 0;
  ...
  let mut x194: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x194, (x46 as fiat_p384_u1), (0x0 as u32), x7);
  let mut x195: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x195, (x46 as fiat_p384_u1), (0x0 as u32), x8);
  let mut x196: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x196, (x46 as fiat_p384_u1), (0x0 as u32), x9);
  let mut x197: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x197, (x46 as fiat_p384_u1), (0x0 as u32), x10);
  let mut x198: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x198, (x46 as fiat_p384_u1), (0x0 as u32), x11);
  let mut x199: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x199, (x46 as fiat_p384_u1), (0x0 as u32), x12);
  let mut x200: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x200, (x46 as fiat_p384_u1), (0x0 as u32), x13);
  let mut x201: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x201, (x46 as fiat_p384_u1), (0x0 as u32), x14);
  let mut x202: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x202, (x46 as fiat_p384_u1), (0x0 as u32), x15);
  let mut x203: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x203, (x46 as fiat_p384_u1), (0x0 as u32), x16);
  let mut x204: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x204, (x46 as fiat_p384_u1), (0x0 as u32), x17);
  let mut x205: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x205, (x46 as fiat_p384_u1), (0x0 as u32), x18);
  let mut x206: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x206, (x46 as fiat_p384_u1), (0x0 as u32), x19);
  let mut x207: u32 = 0;
  let mut x208: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x207, &mut x208, 0x0, x46, x194);
  let mut x209: u32 = 0;
  let mut x210: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x209, &mut x210, x208, x47, x195);
  let mut x211: u32 = 0;
  let mut x212: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x211, &mut x212, x210, x48, x196);
  let mut x213: u32 = 0;
  let mut x214: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x213, &mut x214, x212, x49, x197);
  let mut x215: u32 = 0;
  let mut x216: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x215, &mut x216, x214, x50, x198);
  let mut x217: u32 = 0;
  let mut x218: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x217, &mut x218, x216, x51, x199);
  let mut x219: u32 = 0;
  let mut x220: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x219, &mut x220, x218, x52, x200);
  let mut x221: u32 = 0;
  let mut x222: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x221, &mut x222, x220, x53, x201);
  let mut x223: u32 = 0;
  let mut x224: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x223, &mut x224, x222, x54, x202);
  let mut x225: u32 = 0;
  let mut x226: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x225, &mut x226, x224, x55, x203);
  let mut x227: u32 = 0;
  let mut x228: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x227, &mut x228, x226, x56, x204);
  let mut x229: u32 = 0;
  let mut x230: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x229, &mut x230, x228, x57, x205);
  let mut x231: u32 = 0;
  let mut x232: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x231, &mut x232, x230, x58, x206);
  let mut x233: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x233, (x46 as fiat_p384_u1), (0x0 as u32), x59);
  let mut x234: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x234, (x46 as fiat_p384_u1), (0x0 as u32), x60);
  let mut x235: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x235, (x46 as fiat_p384_u1), (0x0 as u32), x61);
  let mut x236: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x236, (x46 as fiat_p384_u1), (0x0 as u32), x62);
  let mut x237: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x237, (x46 as fiat_p384_u1), (0x0 as u32), x63);
  let mut x238: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x238, (x46 as fiat_p384_u1), (0x0 as u32), x64);
  let mut x239: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x239, (x46 as fiat_p384_u1), (0x0 as u32), x65);
  let mut x240: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x240, (x46 as fiat_p384_u1), (0x0 as u32), x66);
  let mut x241: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x241, (x46 as fiat_p384_u1), (0x0 as u32), x67);
  let mut x242: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x242, (x46 as fiat_p384_u1), (0x0 as u32), x68);
  let mut x243: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x243, (x46 as fiat_p384_u1), (0x0 as u32), x69);
  let mut x244: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x244, (x46 as fiat_p384_u1), (0x0 as u32), x70);
  let mut x245: u32 = 0;
  let mut x246: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x245, &mut x246, 0x0, x182, x233);
  let mut x247: u32 = 0;
  let mut x248: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x247, &mut x248, x246, x183, x234);
  let mut x249: u32 = 0;
  let mut x250: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x249, &mut x250, x248, x184, x235);
  let mut x251: u32 = 0;
  let mut x252: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x251, &mut x252, x250, x185, x236);
  let mut x253: u32 = 0;
  let mut x254: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x253, &mut x254, x252, x186, x237);
  let mut x255: u32 = 0;
  let mut x256: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x255, &mut x256, x254, x187, x238);
  let mut x257: u32 = 0;
  let mut x258: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x257, &mut x258, x256, x188, x239);
  let mut x259: u32 = 0;
  let mut x260: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x259, &mut x260, x258, x189, x240);
  let mut x261: u32 = 0;
  let mut x262: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x261, &mut x262, x260, x190, x241);
  let mut x263: u32 = 0;
  let mut x264: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x263, &mut x264, x262, x191, x242);
  let mut x265: u32 = 0;
  let mut x266: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x265, &mut x266, x264, x192, x243);
  let mut x267: u32 = 0;
  let mut x268: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x267, &mut x268, x266, x193, x244);
  let mut x269: u32 = 0;
  let mut x270: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u32(&mut x269, &mut x270, 0x0, x245, 0xffffffff);
  let mut x271: u32 = 0;
  let mut x272: fiat_p384_u1 = 0;
  ...
  fiat_p384_subborrowx_u32(&mut x275, &mut x276, x274, x251, 0xffffffff);
  let mut x277: u32 = 0;
  let mut x278: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u32(&mut x277, &mut x278, x276, x253, 0xfffffffe);
  let mut x279: u32 = 0;
  ...
  let mut x293: u32 = 0;
  let mut x294: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u32(&mut x293, &mut x294, x292, (x268 as u32), (0x0 as u32));
  let mut x295: u32 = 0;
  let mut x296: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u32(&mut x295, &mut x296, 0x0, x6, (0x1 as u32));
  ...
  let mut x310: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x310, x120, x95, x71);
  let mut x311: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x311, x120, x97, x73);
  let mut x312: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x312, x120, x99, x75);
  let mut x313: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x313, x120, x101, x77);
  let mut x314: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x314, x120, x103, x79);
  let mut x315: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x315, x120, x105, x81);
  let mut x316: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x316, x120, x107, x83);
  let mut x317: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x317, x120, x109, x85);
  let mut x318: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x318, x120, x111, x87);
  let mut x319: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x319, x120, x113, x89);
  let mut x320: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x320, x120, x115, x91);
  let mut x321: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x321, x120, x117, x93);
  let mut x322: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x322, x294, x269, x245);
  let mut x323: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x323, x294, x271, x247);
  let mut x324: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x324, x294, x273, x249);
  let mut x325: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x325, x294, x275, x251);
  let mut x326: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x326, x294, x277, x253);
  let mut x327: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x327, x294, x279, x255);
  let mut x328: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x328, x294, x281, x257);
  let mut x329: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x329, x294, x283, x259);
  let mut x330: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x330, x294, x285, x261);
  let mut x331: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x331, x294, x287, x263);
  let mut x332: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x332, x294, x289, x265);
  let mut x333: u32 = 0;
  fiat_p384_cmovznz_u32(&mut x333, x294, x291, x267);
  *out1 = x295;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
