...
pub fn fiat_p256_cmovznz_u64(out1: &mut u64, arg1: fiat_p256_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((0x0 as fiat_p256_i1) - (x1 as fiat_p256_i1)) as u64) & 0xffffffffffffffff);
...
pub fn fiat_p256_mul(out1: &mut [u64; 4], arg1: &[u64; 4], arg2: &[u64; 4]) -> () {
  ...
  fiat_p256_addcarryx_u64(&mut x19, &mut x20, x18, x6, 0x0);
  let mut x21: u64 = 0;
  let mut x22: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x29, &mut x30, x28, x24, 0x0);
  let mut x31: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x41, &mut x42, x40, 0x0, 0x0);
  let mut x43: u64 = 0;
  let mut x44: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x57, &mut x58, x56, x44, 0x0);
  let mut x59: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x67, &mut x68, x66, (x41 as fiat_p256_u1), x57);
  let mut x69: u64 = 0;
  let mut x70: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x77, &mut x78, x76, x72, 0x0);
  let mut x79: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x89, &mut x90, x88, x68, 0x0);
  let mut x91: u64 = 0;
  let mut x92: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x105, &mut x106, x104, x92, 0x0);
  let mut x107: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x125, &mut x126, x124, x120, 0x0);
  let mut x127: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x137, &mut x138, x136, x116, 0x0);
  let mut x139: u64 = 0;
  let mut x140: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x153, &mut x154, x152, x140, 0x0);
  let mut x155: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x173, &mut x174, x172, x168, 0x0);
  let mut x175: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x185, &mut x186, x184, x164, 0x0);
  let mut x187: u64 = 0;
  ...
  fiat_p256_subborrowx_u64(&mut x191, &mut x192, x190, x181, 0x0);
  let mut x193: u64 = 0;
  ...
  fiat_p256_subborrowx_u64(&mut x195, &mut x196, x194, x185, 0x0);
  let mut x197: u64 = 0;
...
pub fn fiat_p256_add(out1: &mut [u64; 4], arg1: &[u64; 4], arg2: &[u64; 4]) -> () {
  ...
  let mut x13: u64 = 0;
  let mut x14: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x13, &mut x14, x12, x5, 0x0);
  let mut x15: u64 = 0;
  let mut x16: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x15, &mut x16, x14, x7, 0xffffffff00000001);
  let mut x17: u64 = 0;
  let mut x18: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x17, &mut x18, x16, x8, 0x0);
  let mut x19: u64 = 0;
...
pub fn fiat_p256_sub(out1: &mut [u64; 4], arg1: &[u64; 4], arg2: &[u64; 4]) -> () {
  ...
  fiat_p256_addcarryx_u64(&mut x14, &mut x15, x13, x5, 0x0);
  let mut x16: u64 = 0;
...
pub fn fiat_p256_opp(out1: &mut [u64; 4], arg1: &[u64; 4]) -> () {
  let mut x1: u64 = 0;
  let mut x2: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x1, &mut x2, 0x0, 0x0, (arg1[0]));
  let mut x3: u64 = 0;
  let mut x4: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x3, &mut x4, x2, 0x0, (arg1[1]));
  let mut x5: u64 = 0;
  let mut x6: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x5, &mut x6, x4, 0x0, (arg1[2]));
  let mut x7: u64 = 0;
  let mut x8: fiat_p256_u1 = 0;
  fiat_p256_subborrowx_u64(&mut x7, &mut x8, x6, 0x0, (arg1[3]));
  let mut x9: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x9, x8, (0x0 as u64), 0xffffffffffffffff);
  let mut x10: u64 = 0;
  let mut x11: fiat_p256_u1 = 0;
...
pub fn fiat_p256_from_montgomery(out1: &mut [u64; 4], arg1: &[u64; 4]) -> () {
  ...
  let mut x12: u64 = 0;
  let mut x13: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x12, &mut x13, x11, 0x0, x8);
  let mut x14: u64 = 0;
  let mut x15: fiat_p256_u1 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x24, &mut x25, x9, x5, 0x0);
  let mut x26: u64 = 0;
  let mut x27: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x26, &mut x27, x13, 0x0, x24);
  let mut x28: u64 = 0;
  let mut x29: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x28, &mut x29, x15, x26, 0x0);
  let mut x30: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x34, &mut x35, x23, x19, 0x0);
  let mut x36: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x42, &mut x43, x41, x36, 0x0);
  let mut x44: u64 = 0;
  let mut x45: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x44, &mut x45, x43, x38, 0x0);
  let mut x46: u64 = 0;
  let mut x47: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x58, &mut x59, x53, x49, 0x0);
  let mut x60: u64 = 0;
  let mut x61: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x60, &mut x61, x57, x44, x58);
  let mut x62: u64 = 0;
  let mut x63: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x62, &mut x63, x39, 0x0, x17);
  let mut x64: u64 = 0;
  let mut x65: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x64, &mut x65, x45, x62, 0x0);
  let mut x66: u64 = 0;
  ...
  fiat_p256_addcarryx_u64(&mut x70, &mut x71, x69, x60, 0x0);
  let mut x72: u64 = 0;
  let mut x73: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x72, &mut x73, x71, x66, 0x0);
  let mut x74: u64 = 0;
  let mut x75: u64 = 0;
  ...
  fiat_p256_subborrowx_u64(&mut x102, &mut x103, x101, x94, 0x0);
  let mut x104: u64 = 0;
  ...
  fiat_p256_subborrowx_u64(&mut x106, &mut x107, x105, 0x0, 0x0);
  let mut x108: u64 = 0;
