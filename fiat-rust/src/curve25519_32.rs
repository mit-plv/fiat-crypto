...
pub fn fiat_25519_subborrowx_u26(out1: &mut u32, out2: &mut fiat_25519_u1, arg1: fiat_25519_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x3: i64 = (((x1 as i32) as i64) & (0x3ffffff as i64));
  *out1 = (x3 as u32);
...
pub fn fiat_25519_subborrowx_u25(out1: &mut u32, out2: &mut fiat_25519_u1, arg1: fiat_25519_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x3: i64 = (((x1 as i32) as i64) & (0x1ffffff as i64));
  *out1 = (x3 as u32);
  *out2 = (((0x0 as fiat_25519_i2) - (x2 as fiat_25519_i2)) as fiat_25519_u1);
}
...
pub fn fiat_25519_cmovznz_u32(out1: &mut u32, arg1: fiat_25519_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x2: i64 = ((((0x0 as fiat_25519_i2) - (x1 as fiat_25519_i2)) as i64) & (0xffffffff as i64));
...
pub fn fiat_25519_carry_mul(out1: &mut [u32; 10], arg1: &[u32; 10], arg2: &[u32; 10]) -> () {
  ...
  let x103: u64 = (x101 & (0x3ffffff as u64));
...
pub fn fiat_25519_carry_square(out1: &mut [u32; 10], arg1: &[u32; 10]) -> () {
  ...
  let x75: u64 = (x74 >> 26);
  let x76: u64 = (x74 & (0x3ffffff as u64));
  ...
  let x86: u64 = (x75 + x85);
  let x87: u64 = (x86 >> 25);
  let x88: u64 = (x86 & (0x1ffffff as u64));
  let x89: u64 = (x87 + x84);
  let x90: u64 = (x89 >> 26);
  let x91: u64 = (x89 & (0x3ffffff as u64));
  let x92: u64 = (x90 + x83);
  let x93: u64 = (x92 >> 25);
  let x94: u64 = (x92 & (0x1ffffff as u64));
  let x95: u64 = (x93 + x82);
  let x96: u64 = (x95 >> 26);
  let x97: u64 = (x95 & (0x3ffffff as u64));
  let x98: u64 = (x96 + x81);
  let x99: u64 = (x98 >> 25);
  let x100: u64 = (x98 & (0x1ffffff as u64));
  let x101: u64 = (x99 + x80);
  let x102: u64 = (x101 >> 26);
  let x103: u64 = (x101 & (0x3ffffff as u64));
  let x104: u64 = (x102 + x79);
  let x105: u64 = (x104 >> 25);
  let x106: u64 = (x104 & (0x1ffffff as u64));
  let x107: u64 = (x105 + x78);
  let x108: u64 = (x107 >> 26);
  let x109: u64 = (x107 & (0x3ffffff as u64));
  let x110: u64 = (x108 + x77);
  let x111: u64 = (x110 >> 25);
  let x112: u64 = (x110 & (0x1ffffff as u64));
  let x113: u64 = (x111 * (0x13 as u64));
  let x114: u64 = (((x76 as u32) as u64) + x113);
  let x115: u32 = ((x114 >> 26) as u32);
  let x116: u64 = (x114 & (0x3ffffff as u64));
  let x117: u32 = (x115 + (x88 as u32));
  let x118: fiat_25519_u1 = ((x117 >> 25) as fiat_25519_u1);
  let x119: u32 = (x117 & 0x1ffffff);
  let x120: u32 = ((x118 as u32) + (x91 as u32));
  out1[0] = (x116 as u32);
  out1[1] = x119;
  out1[2] = x120;
  out1[3] = (x94 as u32);
...
pub fn fiat_25519_to_bytes(out1: &mut [u8; 32], arg1: &[u32; 10]) -> () {
  ...
  let x57: u32 = (x56 >> 8);
  let x58: u32 = (x56 & (0xff as u32));
  let x59: u32 = (x57 >> 8);
  let x60: u32 = (x57 & (0xff as u32));
  let x61: u8 = ((x59 >> 8) as u8);
  let x62: u32 = (x59 & (0xff as u32));
  let x63: u32 = ((x61 as u32) + x48);
  let x64: u32 = (x63 >> 8);
  let x65: u32 = (x63 & (0xff as u32));
  let x66: u32 = (x64 >> 8);
  let x67: u32 = (x64 & (0xff as u32));
  let x68: u8 = ((x66 >> 8) as u8);
  let x69: u32 = (x66 & (0xff as u32));
  let x70: u32 = ((x68 as u32) + x47);
  let x71: u32 = (x70 >> 8);
  let x72: u32 = (x70 & (0xff as u32));
  let x73: u32 = (x71 >> 8);
  let x74: u32 = (x71 & (0xff as u32));
  let x75: u8 = ((x73 >> 8) as u8);
  let x76: u32 = (x73 & (0xff as u32));
  let x77: u32 = ((x75 as u32) + x46);
  let x78: u32 = (x77 >> 8);
  let x79: u32 = (x77 & (0xff as u32));
  let x80: u32 = (x78 >> 8);
  let x81: u32 = (x78 & (0xff as u32));
  let x82: u8 = ((x80 >> 8) as u8);
  let x83: u32 = (x80 & (0xff as u32));
  let x84: u8 = (x82 & 0xff);
  let x85: u32 = (x32 >> 8);
  let x86: u32 = (x32 & (0xff as u32));
  let x87: u32 = (x85 >> 8);
  let x88: u32 = (x85 & (0xff as u32));
  let x89: fiat_25519_u1 = ((x87 >> 8) as fiat_25519_u1);
  let x90: u32 = (x87 & (0xff as u32));
  let x91: u32 = ((x89 as u32) + x45);
  let x92: u32 = (x91 >> 8);
  let x93: u32 = (x91 & (0xff as u32));
  let x94: u32 = (x92 >> 8);
  let x95: u32 = (x92 & (0xff as u32));
  let x96: u8 = ((x94 >> 8) as u8);
  let x97: u32 = (x94 & (0xff as u32));
  let x98: u32 = ((x96 as u32) + x44);
  let x99: u32 = (x98 >> 8);
  let x100: u32 = (x98 & (0xff as u32));
  let x101: u32 = (x99 >> 8);
  let x102: u32 = (x99 & (0xff as u32));
  let x103: u8 = ((x101 >> 8) as u8);
  let x104: u32 = (x101 & (0xff as u32));
  let x105: u32 = ((x103 as u32) + x43);
  let x106: u32 = (x105 >> 8);
  let x107: u32 = (x105 & (0xff as u32));
  let x108: u32 = (x106 >> 8);
  let x109: u32 = (x106 & (0xff as u32));
  let x110: u8 = ((x108 >> 8) as u8);
  let x111: u32 = (x108 & (0xff as u32));
  let x112: u32 = ((x110 as u32) + x42);
  let x113: u32 = (x112 >> 8);
  let x114: u32 = (x112 & (0xff as u32));
  let x115: u32 = (x113 >> 8);
  let x116: u32 = (x113 & (0xff as u32));
  let x117: u8 = ((x115 >> 8) as u8);
  let x118: u32 = (x115 & (0xff as u32));
  out1[0] = (x51 as u8);
  out1[1] = (x53 as u8);
  out1[2] = (x55 as u8);
  out1[3] = (x58 as u8);
