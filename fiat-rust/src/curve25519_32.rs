...
pub fn fiat_25519_to_bytes(out1: &mut [u8; 32], arg1: &fiat_25519_tight_field_element) -> () {
  ...
  let x50: u32 = (x22 >> 8);
  let x51: u32 = (x50 >> 8);
  let x52: u8 = ((x51 >> 8) as u8);
  let x53: u32 = (x49 + (x52 as u32));
  let x54: u32 = (x53 >> 8);
  let x55: u32 = (x54 >> 8);
  let x56: u8 = ((x55 >> 8) as u8);
  let x57: u32 = (x48 + (x56 as u32));
  let x58: u32 = (x57 >> 8);
  let x59: u32 = (x58 >> 8);
  let x60: u8 = ((x59 >> 8) as u8);
  let x61: u32 = (x47 + (x60 as u32));
  let x62: u32 = (x61 >> 8);
  let x63: u32 = (x62 >> 8);
  let x64: u8 = ((x63 >> 8) as u8);
  let x65: u32 = (x46 + (x64 as u32));
  let x66: u32 = (x65 >> 8);
  let x67: u32 = (x66 >> 8);
  let x68: u8 = ((x67 >> 8) as u8);
  let x69: u32 = (x32 >> 8);
  let x70: u32 = (x69 >> 8);
  let x71: fiat_25519_u1 = ((x70 >> 8) as fiat_25519_u1);
  let x72: u32 = (x45 + (x71 as u32));
  let x73: u32 = (x72 >> 8);
  let x74: u32 = (x73 >> 8);
  let x75: u8 = ((x74 >> 8) as u8);
  let x76: u32 = (x44 + (x75 as u32));
  let x77: u32 = (x76 >> 8);
  let x78: u32 = (x77 >> 8);
  let x79: u8 = ((x78 >> 8) as u8);
  let x80: u32 = (x43 + (x79 as u32));
  let x81: u32 = (x80 >> 8);
  let x82: u32 = (x81 >> 8);
  let x83: u8 = ((x82 >> 8) as u8);
  let x84: u32 = (x42 + (x83 as u32));
  let x85: u32 = (x84 >> 8);
  let x86: u32 = (x85 >> 8);
