//! Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Rust 25519 32 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax carry_scmul121666
