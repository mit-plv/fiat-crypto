...
pub fn fiat_25519_scalar_addcarryx_u64(out1: &mut u64, out2: &mut fiat_25519_scalar_u1, arg1: fiat_25519_scalar_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: fiat_25519_scalar_u1 = ((x1 >> 64) as fiat_25519_scalar_u1);
  *out1 = (x1 as u64);
  *out2 = x2;
}
...
pub fn fiat_25519_scalar_divstep(out1: &mut u64, out2: &mut [u64; 5], out3: &mut [u64; 5], out4: &mut [u64; 4], out5: &mut [u64; 4], arg1: u64, arg2: &[u64; 5], arg3: &[u64; 5], arg4: &[u64; 4], arg5: &[u64; 4]) -> () {
  ...
  let x3: fiat_25519_scalar_u1 = (((x1 >> 63) as fiat_25519_scalar_u1) & ((arg3[0]) as fiat_25519_scalar_u1));
  let mut x4: u64 = 0;
  ...
  let mut x74: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x74, (x22 as fiat_25519_scalar_u1), (0x0 as u64), x7);
  let mut x75: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x75, (x22 as fiat_25519_scalar_u1), (0x0 as u64), x8);
  let mut x76: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x76, (x22 as fiat_25519_scalar_u1), (0x0 as u64), x9);
  let mut x77: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x77, (x22 as fiat_25519_scalar_u1), (0x0 as u64), x10);
  let mut x78: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x78, (x22 as fiat_25519_scalar_u1), (0x0 as u64), x11);
  let mut x79: u64 = 0;
  let mut x80: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x79, &mut x80, 0x0, x22, x74);
  let mut x81: u64 = 0;
  let mut x82: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x81, &mut x82, x80, x23, x75);
  let mut x83: u64 = 0;
  let mut x84: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x83, &mut x84, x82, x24, x76);
  let mut x85: u64 = 0;
  let mut x86: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x85, &mut x86, x84, x25, x77);
  let mut x87: u64 = 0;
  let mut x88: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x87, &mut x88, x86, x26, x78);
  let mut x89: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x89, (x22 as fiat_25519_scalar_u1), (0x0 as u64), x27);
  let mut x90: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x90, (x22 as fiat_25519_scalar_u1), (0x0 as u64), x28);
  let mut x91: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x91, (x22 as fiat_25519_scalar_u1), (0x0 as u64), x29);
  let mut x92: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x92, (x22 as fiat_25519_scalar_u1), (0x0 as u64), x30);
  let mut x93: u64 = 0;
  let mut x94: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x93, &mut x94, 0x0, x70, x89);
  let mut x95: u64 = 0;
  let mut x96: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x95, &mut x96, x94, x71, x90);
  let mut x97: u64 = 0;
  let mut x98: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x97, &mut x98, x96, x72, x91);
  let mut x99: u64 = 0;
  let mut x100: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x99, &mut x100, x98, x73, x92);
  let mut x101: u64 = 0;
  let mut x102: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x101, &mut x102, 0x0, x93, 0x5812631a5cf5d3ed);
  let mut x103: u64 = 0;
  let mut x104: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x103, &mut x104, x102, x95, 0x14def9dea2f79cd6);
  let mut x105: u64 = 0;
  let mut x106: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x105, &mut x106, x104, x97, (0x0 as u64));
  let mut x107: u64 = 0;
  let mut x108: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x107, &mut x108, x106, x99, 0x1000000000000000);
  let mut x109: u64 = 0;
  let mut x110: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x109, &mut x110, x108, (x100 as u64), (0x0 as u64));
  let mut x111: u64 = 0;
  let mut x112: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x111, &mut x112, 0x0, x6, (0x1 as u64));
  ...
  let mut x118: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x118, x48, x39, x31);
  let mut x119: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x119, x48, x41, x33);
  let mut x120: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x120, x48, x43, x35);
  let mut x121: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x121, x48, x45, x37);
  let mut x122: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x122, x110, x101, x93);
  let mut x123: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x123, x110, x103, x95);
  let mut x124: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x124, x110, x105, x97);
  let mut x125: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x125, x110, x107, x99);
  *out1 = x111;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
