//! Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang Rust poly1305 32 5 '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes
