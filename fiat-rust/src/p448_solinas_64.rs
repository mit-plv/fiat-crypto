...
pub fn fiat_p448_subborrowx_u56(out1: &mut u64, out2: &mut fiat_p448_u1, arg1: fiat_p448_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x3: u64 = ((x1 as u64) & 0xffffffffffffff);
  *out1 = x3;
  *out2 = (((0x0 as fiat_p448_i1) - x2) as fiat_p448_u1);
}
...
pub fn fiat_p448_cmovznz_u64(out1: &mut u64, arg1: fiat_p448_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((0x0 as fiat_p448_i1) - (x1 as fiat_p448_i1)) as u64) & 0xffffffffffffffff);
...
pub fn fiat_p448_carry_mul(out1: &mut [u64; 8], arg1: &[u64; 8], arg2: &[u64; 8]) -> () {
  ...
  let x101: u64 = ((x99 & 0xffffffffffffff) as u64);
  ...
  let x111: u64 = ((x102 & 0xffffffffffffff) as u64);
  let x112: fiat_p448_u128 = (x109 + (x110 as fiat_p448_u128));
  let x113: u64 = ((x112 >> 56) as u64);
  let x114: u64 = ((x112 & 0xffffffffffffff) as u64);
...
pub fn fiat_p448_carry_square(out1: &mut [u64; 8], arg1: &[u64; 8]) -> () {
  ...
  let x80: u64 = ((x78 & 0xffffffffffffff) as u64);
  ...
  let x90: u64 = ((x81 & 0xffffffffffffff) as u64);
  let x91: fiat_p448_u128 = (x88 + (x89 as fiat_p448_u128));
  let x92: u64 = ((x91 >> 56) as u64);
  let x93: u64 = ((x91 & 0xffffffffffffff) as u64);
...
pub fn fiat_p448_carry(out1: &mut [u64; 8], arg1: &[u64; 8]) -> () {
  ...
  let x12: u64 = (x10 >> 56);
  let x13: u64 = ((x5 & 0xffffffffffffff) + x12);
  let x14: u64 = ((x11 >> 56) + ((x4 & 0xffffffffffffff) + x12));
  let x15: u64 = (x13 & 0xffffffffffffff);
  let x16: u64 = ((x13 >> 56) + (x7 & 0xffffffffffffff));
  let x17: u64 = (x9 & 0xffffffffffffff);
  let x18: u64 = (x11 & 0xffffffffffffff);
  let x19: u64 = (x14 & 0xffffffffffffff);
  let x20: u64 = ((x14 >> 56) + (x6 & 0xffffffffffffff));
...
pub fn fiat_p448_to_bytes(out1: &mut [u8; 56], arg1: &[u64; 8]) -> () {
  ...
  let x46: u8 = (x44 & 0xff);
  let x47: u64 = (x20 >> 8);
  let x48: u8 = ((x20 & 0xff) as u8);
  let x49: u64 = (x47 >> 8);
  let x50: u8 = ((x47 & 0xff) as u8);
  let x51: u64 = (x49 >> 8);
  let x52: u8 = ((x49 & 0xff) as u8);
  let x53: u64 = (x51 >> 8);
  ...
  let x81: u64 = (x79 >> 8);
  let x82: u8 = ((x79 & 0xff) as u8);
  let x83: u8 = ((x81 >> 8) as u8);
  let x84: u8 = ((x81 & 0xff) as u8);
  let x85: u8 = (x83 & 0xff);
  let x86: u64 = (x26 >> 8);
  let x87: u8 = ((x26 & 0xff) as u8);
  let x88: u64 = (x86 >> 8);
  ...
  let x98: u8 = (x96 & 0xff);
  let x99: u64 = (x28 >> 8);
  let x100: u8 = ((x28 & 0xff) as u8);
  let x101: u64 = (x99 >> 8);
  let x102: u8 = ((x99 & 0xff) as u8);
  let x103: u64 = (x101 >> 8);
  let x104: u8 = ((x101 & 0xff) as u8);
  let x105: u64 = (x103 >> 8);
  let x106: u8 = ((x103 & 0xff) as u8);
  let x107: u64 = (x105 >> 8);
  let x108: u8 = ((x105 & 0xff) as u8);
  let x109: u8 = ((x107 >> 8) as u8);
  let x110: u8 = ((x107 & 0xff) as u8);
  let x111: u8 = (x109 & 0xff);
  let x112: u64 = (x30 >> 8);
  let x113: u8 = ((x30 & 0xff) as u8);
  let x114: u64 = (x112 >> 8);
  let x115: u8 = ((x112 & 0xff) as u8);
  let x116: u64 = (x114 >> 8);
  let x117: u8 = ((x114 & 0xff) as u8);
  let x118: u64 = (x116 >> 8);
  let x119: u8 = ((x116 & 0xff) as u8);
  let x120: u64 = (x118 >> 8);
  ...
  let x133: u64 = (x131 >> 8);
  let x134: u8 = ((x131 & 0xff) as u8);
  let x135: u8 = ((x133 >> 8) as u8);
  let x136: u8 = ((x133 & 0xff) as u8);
  out1[0] = x35;
  out1[1] = x37;
  out1[2] = x39;
  out1[3] = x41;
