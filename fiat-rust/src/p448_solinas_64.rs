...
pub fn fiat_p448_addcarryx_u56(out1: &mut u64, out2: &mut fiat_p448_u1, arg1: fiat_p448_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = (x1 & 0xffffffffffffff_u64);
...
pub fn fiat_p448_subborrowx_u56(out1: &mut u64, out2: &mut fiat_p448_u1, arg1: fiat_p448_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x3: u64 = (((x1 as i128) & (0xffffffffffffff_u64 as i128)) as u64);
  *out1 = x3;
...
pub fn fiat_p448_cmovznz_u64(out1: &mut u64, arg1: fiat_p448_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((((0x0_u8 as fiat_p448_i2) - (x1 as fiat_p448_i2)) as fiat_p448_i1) as i128) & (0xffffffffffffffff_u64 as i128)) as u64);
...
pub fn fiat_p448_carry_mul(out1: &mut fiat_p448_tight_field_element, arg1: &fiat_p448_loose_field_element, arg2: &fiat_p448_loose_field_element) -> () {
  ...
  let x101: u64 = ((x99 & (0xffffffffffffff_u64 as u128)) as u64);
...
pub fn fiat_p448_carry_square(out1: &mut fiat_p448_tight_field_element, arg1: &fiat_p448_loose_field_element) -> () {
  let x1: u64 = (arg1[7]);
  let x2: u64 = (arg1[7]);
  let x3: u64 = (x1 * 0x2_u8);
  let x4: u64 = (x2 * 0x2_u8);
  let x5: u64 = ((arg1[7]) * 0x2_u8);
  let x6: u64 = (arg1[6]);
  let x7: u64 = (arg1[6]);
  let x8: u64 = (x6 * 0x2_u8);
  let x9: u64 = (x7 * 0x2_u8);
  let x10: u64 = ((arg1[6]) * 0x2_u8);
  let x11: u64 = (arg1[5]);
  let x12: u64 = (arg1[5]);
  let x13: u64 = (x11 * 0x2_u8);
  let x14: u64 = (x12 * 0x2_u8);
  let x15: u64 = ((arg1[5]) * 0x2_u8);
  let x16: u64 = (arg1[4]);
  let x17: u64 = (arg1[4]);
  let x18: u64 = ((arg1[4]) * 0x2_u8);
  let x19: u64 = ((arg1[3]) * 0x2_u8);
  let x20: u64 = ((arg1[2]) * 0x2_u8);
  let x21: u64 = ((arg1[1]) * 0x2_u8);
  ...
  let x80: u64 = ((x78 & (0xffffffffffffff_u64 as u128)) as u64);
...
pub fn fiat_p448_carry(out1: &mut fiat_p448_tight_field_element, arg1: &fiat_p448_loose_field_element) -> () {
  ...
  let x10: u64 = ((x8 >> 56) + (x2 & 0xffffffffffffff_u64));
  let x11: u64 = ((x9 >> 56) + (x1 & 0xffffffffffffff_u64));
  let x12: fiat_p448_u1 = ((x10 >> 56) as fiat_p448_u1);
  let x13: u64 = ((x5 & 0xffffffffffffff_u64) + (x12 as u64));
  let x14: u64 = ((((x11 >> 56) as fiat_p448_u1) as u64) + ((x4 & 0xffffffffffffff_u64) + (x12 as u64)));
  let x15: u64 = (x13 & 0xffffffffffffff_u64);
  let x16: u64 = ((((x13 >> 56) as fiat_p448_u1) as u64) + (x7 & 0xffffffffffffff_u64));
  let x17: u64 = (x9 & 0xffffffffffffff_u64);
  let x18: u64 = (x11 & 0xffffffffffffff_u64);
  let x19: u64 = (x14 & 0xffffffffffffff_u64);
  let x20: u64 = ((((x14 >> 56) as fiat_p448_u1) as u64) + (x6 & 0xffffffffffffff_u64));
  let x21: u64 = (x8 & 0xffffffffffffff_u64);
  let x22: u64 = (x10 & 0xffffffffffffff_u64);
  out1[0] = x15;
  out1[1] = x16;
  out1[2] = x17;
  out1[3] = x18;
...
pub fn fiat_p448_sub(out1: &mut fiat_p448_loose_field_element, arg1: &fiat_p448_tight_field_element, arg2: &fiat_p448_tight_field_element) -> () {
  let x1: u64 = ((0x1fffffffffffffe_u64 + (arg1[0])) - (arg2[0]));
  let x2: u64 = ((0x1fffffffffffffe_u64 + (arg1[1])) - (arg2[1]));
  let x3: u64 = ((0x1fffffffffffffe_u64 + (arg1[2])) - (arg2[2]));
  let x4: u64 = ((0x1fffffffffffffe_u64 + (arg1[3])) - (arg2[3]));
  let x5: u64 = ((0x1fffffffffffffc_u64 + (arg1[4])) - (arg2[4]));
  let x6: u64 = ((0x1fffffffffffffe_u64 + (arg1[5])) - (arg2[5]));
  let x7: u64 = ((0x1fffffffffffffe_u64 + (arg1[6])) - (arg2[6]));
  let x8: u64 = ((0x1fffffffffffffe_u64 + (arg1[7])) - (arg2[7]));
  out1[0] = x1;
  out1[1] = x2;
  out1[2] = x3;
  out1[3] = x4;
...
pub fn fiat_p448_opp(out1: &mut fiat_p448_loose_field_element, arg1: &fiat_p448_tight_field_element) -> () {
  let x1: u64 = (0x1fffffffffffffe_u64 - (arg1[0]));
  let x2: u64 = (0x1fffffffffffffe_u64 - (arg1[1]));
  let x3: u64 = (0x1fffffffffffffe_u64 - (arg1[2]));
  let x4: u64 = (0x1fffffffffffffe_u64 - (arg1[3]));
  let x5: u64 = (0x1fffffffffffffc_u64 - (arg1[4]));
  let x6: u64 = (0x1fffffffffffffe_u64 - (arg1[5]));
  let x7: u64 = (0x1fffffffffffffe_u64 - (arg1[6]));
  let x8: u64 = (0x1fffffffffffffe_u64 - (arg1[7]));
  out1[0] = x1;
  out1[1] = x2;
  out1[2] = x3;
  out1[3] = x4;
...
pub fn fiat_p448_to_bytes(out1: &mut [u8; 56], arg1: &fiat_p448_tight_field_element) -> () {
  ...
  fiat_p448_subborrowx_u56(&mut x1, &mut x2, 0x0_u8, (arg1[0]), 0xffffffffffffff_u64);
  let mut x3: u64 = 0;
  let mut x4: fiat_p448_u1 = 0;
  fiat_p448_subborrowx_u56(&mut x3, &mut x4, x2, (arg1[1]), 0xffffffffffffff_u64);
  let mut x5: u64 = 0;
  let mut x6: fiat_p448_u1 = 0;
  fiat_p448_subborrowx_u56(&mut x5, &mut x6, x4, (arg1[2]), 0xffffffffffffff_u64);
  let mut x7: u64 = 0;
  let mut x8: fiat_p448_u1 = 0;
  fiat_p448_subborrowx_u56(&mut x7, &mut x8, x6, (arg1[3]), 0xffffffffffffff_u64);
  let mut x9: u64 = 0;
  let mut x10: fiat_p448_u1 = 0;
  fiat_p448_subborrowx_u56(&mut x9, &mut x10, x8, (arg1[4]), 0xfffffffffffffe_u64);
  let mut x11: u64 = 0;
  let mut x12: fiat_p448_u1 = 0;
  fiat_p448_subborrowx_u56(&mut x11, &mut x12, x10, (arg1[5]), 0xffffffffffffff_u64);
  let mut x13: u64 = 0;
  let mut x14: fiat_p448_u1 = 0;
  fiat_p448_subborrowx_u56(&mut x13, &mut x14, x12, (arg1[6]), 0xffffffffffffff_u64);
  let mut x15: u64 = 0;
  let mut x16: fiat_p448_u1 = 0;
  fiat_p448_subborrowx_u56(&mut x15, &mut x16, x14, (arg1[7]), 0xffffffffffffff_u64);
  let mut x17: u64 = 0;
  fiat_p448_cmovznz_u64(&mut x17, x16, (0x0_u8 as u64), 0xffffffffffffffff_u64);
  let mut x18: u64 = 0;
  let mut x19: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u56(&mut x18, &mut x19, 0x0_u8, x1, (x17 & 0xffffffffffffff_u64));
  let mut x20: u64 = 0;
  let mut x21: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u56(&mut x20, &mut x21, x19, x3, (x17 & 0xffffffffffffff_u64));
  let mut x22: u64 = 0;
  let mut x23: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u56(&mut x22, &mut x23, x21, x5, (x17 & 0xffffffffffffff_u64));
  let mut x24: u64 = 0;
  let mut x25: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u56(&mut x24, &mut x25, x23, x7, (x17 & 0xffffffffffffff_u64));
  let mut x26: u64 = 0;
  let mut x27: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u56(&mut x26, &mut x27, x25, x9, (x17 & 0xfffffffffffffe_u64));
  let mut x28: u64 = 0;
  let mut x29: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u56(&mut x28, &mut x29, x27, x11, (x17 & 0xffffffffffffff_u64));
  let mut x30: u64 = 0;
  let mut x31: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u56(&mut x30, &mut x31, x29, x13, (x17 & 0xffffffffffffff_u64));
  let mut x32: u64 = 0;
  let mut x33: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u56(&mut x32, &mut x33, x31, x15, (x17 & 0xffffffffffffff_u64));
  let x34: u8 = ((x18 & (0xff_u8 as u64)) as u8);
  let x35: u64 = (x18 >> 8);
  let x36: u8 = ((x35 & (0xff_u8 as u64)) as u8);
  let x37: u64 = (x35 >> 8);
  ...
  let x46: u8 = ((x20 & (0xff_u8 as u64)) as u8);
  let x47: u64 = (x20 >> 8);
  ...
  let x82: u8 = ((x26 & (0xff_u8 as u64)) as u8);
  let x83: u64 = (x26 >> 8);
  ...
  let x91: u64 = (x89 >> 8);
  let x92: u8 = ((x91 & (0xff_u8 as u64)) as u8);
  let x93: u8 = ((x91 >> 8) as u8);
  let x94: u8 = ((x28 & (0xff_u8 as u64)) as u8);
  let x95: u64 = (x28 >> 8);
  ...
  let x103: u64 = (x101 >> 8);
  let x104: u8 = ((x103 & (0xff_u8 as u64)) as u8);
  let x105: u8 = ((x103 >> 8) as u8);
  let x106: u8 = ((x30 & (0xff_u8 as u64)) as u8);
  let x107: u64 = (x30 >> 8);
  let x108: u8 = ((x107 & (0xff_u8 as u64)) as u8);
  let x109: u64 = (x107 >> 8);
  let x110: u8 = ((x109 & (0xff_u8 as u64)) as u8);
  let x111: u64 = (x109 >> 8);
  let x112: u8 = ((x111 & (0xff_u8 as u64)) as u8);
  let x113: u64 = (x111 >> 8);
  let x114: u8 = ((x113 & (0xff_u8 as u64)) as u8);
  let x115: u64 = (x113 >> 8);
  let x116: u8 = ((x115 & (0xff_u8 as u64)) as u8);
  let x117: u8 = ((x115 >> 8) as u8);
  let x118: u8 = ((x32 & (0xff_u8 as u64)) as u8);
  let x119: u64 = (x32 >> 8);
