...
pub fn fiat_p521_subborrowx_u30(out1: &mut u32, out2: &mut fiat_p521_u1, arg1: fiat_p521_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x3: u32 = ((x1 as u32) & 0x3fffffff);
  *out1 = x3;
...
pub fn fiat_p521_subborrowx_u31(out1: &mut u32, out2: &mut fiat_p521_u1, arg1: fiat_p521_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x3: u32 = ((x1 as u32) & 0x7fffffff);
  *out1 = x3;
  *out2 = (((0x0 as fiat_p521_i1) - x2) as fiat_p521_u1);
}
...
pub fn fiat_p521_cmovznz_u32(out1: &mut u32, arg1: fiat_p521_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x2: u32 = ((((0x0 as fiat_p521_i1) - (x1 as fiat_p521_i1)) as u32) & 0xffffffff);
...
pub fn fiat_p521_carry_mul(out1: &mut [u32; 17], arg1: &[u64; 17], arg2: &[u64; 17]) -> () {
  ...
  let x292: u32 = ((x290 & 0x7fffffff) as u32);
...
pub fn fiat_p521_carry_square(out1: &mut [u32; 17], arg1: &[u64; 17]) -> () {
  ...
  let x188: u32 = ((x186 & 0x7fffffff) as u32);
...
pub fn fiat_p521_carry(out1: &mut [u32; 17], arg1: &[u64; 17]) -> () {
  ...
  let x18: u32 = (((x1 & 0x7fffffff) as u32) + (x17 >> 30));
  let x19: u32 = ((x18 >> 31) + ((x2 & 0x7fffffff) as u32));
  let x20: u32 = (x18 & 0x7fffffff);
  let x21: u32 = (x19 & 0x7fffffff);
  let x22: u32 = ((x19 >> 31) + (x3 & 0x3fffffff));
  let x23: u32 = ((x4 & 0x7fffffff) as u32);
  let x24: u32 = ((x5 & 0x7fffffff) as u32);
  let x25: u32 = (x6 & 0x3fffffff);
  let x26: u32 = ((x7 & 0x7fffffff) as u32);
  let x27: u32 = ((x8 & 0x7fffffff) as u32);
  let x28: u32 = (x9 & 0x3fffffff);
  let x29: u32 = ((x10 & 0x7fffffff) as u32);
  let x30: u32 = ((x11 & 0x7fffffff) as u32);
  let x31: u32 = (x12 & 0x3fffffff);
  let x32: u32 = ((x13 & 0x7fffffff) as u32);
  let x33: u32 = ((x14 & 0x7fffffff) as u32);
  let x34: u32 = (x15 & 0x3fffffff);
  let x35: u32 = ((x16 & 0x7fffffff) as u32);
...
pub fn fiat_p521_to_bytes(out1: &mut [u8; 66], arg1: &[u32; 17]) -> () {
  ...
  let x110: u8 = ((x108 & 0xff) as u8);
  let x111: u32 = (x109 >> 8);
  let x112: u8 = ((x109 & 0xff) as u8);
  let x113: u32 = (x111 >> 8);
  let x114: u8 = ((x111 & 0xff) as u8);
  let x115: u8 = ((x113 >> 8) as u8);
  let x116: u8 = ((x113 & 0xff) as u8);
  let x117: u64 = ((x115 as u64) + x80);
  let x118: u32 = ((x117 >> 8) as u32);
  let x119: u8 = ((x117 & 0xff) as u8);
  let x120: u32 = (x118 >> 8);
  let x121: u8 = ((x118 & 0xff) as u8);
  let x122: u32 = (x120 >> 8);
  let x123: u8 = ((x120 & 0xff) as u8);
  let x124: u8 = ((x122 >> 8) as u8);
  let x125: u8 = ((x122 & 0xff) as u8);
  let x126: u32 = ((x124 as u32) + x79);
  let x127: u32 = (x126 >> 8);
  let x128: u8 = ((x126 & 0xff) as u8);
  let x129: u32 = (x127 >> 8);
  ...
  let x142: u8 = ((x140 & 0xff) as u8);
  let x143: u32 = (x141 >> 8);
  let x144: u8 = ((x141 & 0xff) as u8);
  let x145: u32 = (x143 >> 8);
  let x146: u8 = ((x143 & 0xff) as u8);
  let x147: u8 = ((x145 >> 8) as u8);
  let x148: u8 = ((x145 & 0xff) as u8);
  let x149: u64 = ((x147 as u64) + x77);
  let x150: u32 = ((x149 >> 8) as u32);
  let x151: u8 = ((x149 & 0xff) as u8);
  let x152: u32 = (x150 >> 8);
  let x153: u8 = ((x150 & 0xff) as u8);
  let x154: u32 = (x152 >> 8);
  let x155: u8 = ((x152 & 0xff) as u8);
  let x156: u8 = ((x154 >> 8) as u8);
  let x157: u8 = ((x154 & 0xff) as u8);
  let x158: u64 = ((x156 as u64) + x76);
  let x159: u32 = ((x158 >> 8) as u32);
  let x160: u8 = ((x158 & 0xff) as u8);
  let x161: u32 = (x159 >> 8);
  let x162: u8 = ((x159 & 0xff) as u8);
  let x163: u32 = (x161 >> 8);
  let x164: u8 = ((x161 & 0xff) as u8);
  let x165: u8 = ((x163 >> 8) as u8);
  let x166: u8 = ((x163 & 0xff) as u8);
  let x167: u64 = ((x165 as u64) + x75);
  let x168: u32 = ((x167 >> 8) as u32);
  let x169: u8 = ((x167 & 0xff) as u8);
  let x170: u32 = (x168 >> 8);
  ...
  let x177: u32 = (x176 >> 8);
  let x178: u8 = ((x176 & 0xff) as u8);
  let x179: u32 = (x177 >> 8);
  let x180: u8 = ((x177 & 0xff) as u8);
  let x181: u8 = ((x179 >> 8) as u8);
  let x182: u8 = ((x179 & 0xff) as u8);
  let x183: u8 = (x181 & 0xff);
  let x184: u32 = (x60 >> 8);
  let x185: u8 = ((x60 & 0xff) as u8);
  let x186: u32 = (x184 >> 8);
  let x187: u8 = ((x184 & 0xff) as u8);
  let x188: u8 = ((x186 >> 8) as u8);
  let x189: u8 = ((x186 & 0xff) as u8);
  let x190: u64 = ((x188 as u64) + x73);
  let x191: u32 = ((x190 >> 8) as u32);
  let x192: u8 = ((x190 & 0xff) as u8);
  let x193: u32 = (x191 >> 8);
  let x194: u8 = ((x191 & 0xff) as u8);
  let x195: u32 = (x193 >> 8);
  let x196: u8 = ((x193 & 0xff) as u8);
  let x197: u8 = ((x195 >> 8) as u8);
  let x198: u8 = ((x195 & 0xff) as u8);
  let x199: u64 = ((x197 as u64) + x72);
  let x200: u32 = ((x199 >> 8) as u32);
  let x201: u8 = ((x199 & 0xff) as u8);
  let x202: u32 = (x200 >> 8);
  let x203: u8 = ((x200 & 0xff) as u8);
  let x204: u32 = (x202 >> 8);
  let x205: u8 = ((x202 & 0xff) as u8);
  let x206: u8 = ((x204 >> 8) as u8);
  let x207: u8 = ((x204 & 0xff) as u8);
  let x208: u64 = ((x206 as u64) + x71);
  let x209: u32 = ((x208 >> 8) as u32);
  let x210: u8 = ((x208 & 0xff) as u8);
  let x211: u32 = (x209 >> 8);
  let x212: u8 = ((x209 & 0xff) as u8);
  let x213: u32 = (x211 >> 8);
  let x214: u8 = ((x211 & 0xff) as u8);
  let x215: u8 = ((x213 >> 8) as u8);
  let x216: u8 = ((x213 & 0xff) as u8);
  let x217: u64 = ((x215 as u64) + x70);
  let x218: u32 = ((x217 >> 8) as u32);
  let x219: u8 = ((x217 & 0xff) as u8);
  let x220: u32 = (x218 >> 8);
  let x221: u8 = ((x218 & 0xff) as u8);
  let x222: u32 = (x220 >> 8);
  let x223: u8 = ((x220 & 0xff) as u8);
  let x224: fiat_p521_u1 = ((x222 >> 8) as fiat_p521_u1);
  let x225: u8 = ((x222 & 0xff) as u8);
  out1[0] = x85;
  out1[1] = x87;
  out1[2] = x89;
  out1[3] = x92;
