...
pub fn fiat_p521_to_bytes(out1: &mut [u8; 66], arg1: &fiat_p521_tight_field_element) -> () {
  ...
  let x94: u32 = (x40 >> 8);
  let x95: u32 = (x94 >> 8);
  let x96: u8 = ((x95 >> 8) as u8);
  let x97: u32 = (x93 + (x96 as u32));
  let x98: u32 = (x97 >> 8);
  let x99: u32 = (x98 >> 8);
  let x100: u8 = ((x99 >> 8) as u8);
  let x101: u64 = (x92 + (x100 as u64));
  let x102: u32 = ((x101 >> 8) as u32);
  let x103: u32 = (x102 >> 8);
  let x104: u32 = (x103 >> 8);
  let x105: u8 = ((x104 >> 8) as u8);
  let x106: u32 = (x91 + (x105 as u32));
  let x107: u32 = (x106 >> 8);
  let x108: u32 = (x107 >> 8);
  let x109: u8 = ((x108 >> 8) as u8);
  let x110: u64 = (x90 + (x109 as u64));
  let x111: u32 = ((x110 >> 8) as u32);
  let x112: u32 = (x111 >> 8);
  let x113: u32 = (x112 >> 8);
  let x114: u8 = ((x113 >> 8) as u8);
  let x115: u32 = (x89 + (x114 as u32));
  let x116: u32 = (x115 >> 8);
  let x117: u32 = (x116 >> 8);
  let x118: u8 = ((x117 >> 8) as u8);
  let x119: u32 = (x88 + (x118 as u32));
  let x120: u32 = (x119 >> 8);
  let x121: u32 = (x120 >> 8);
  let x122: u8 = ((x121 >> 8) as u8);
  let x123: u32 = (x54 >> 8);
  let x124: u32 = (x123 >> 8);
  let x125: u8 = ((x124 >> 8) as u8);
  let x126: u32 = (x87 + (x125 as u32));
  let x127: u32 = (x126 >> 8);
  let x128: u32 = (x127 >> 8);
  let x129: u8 = ((x128 >> 8) as u8);
  let x130: u64 = (x86 + (x129 as u64));
  let x131: u32 = ((x130 >> 8) as u32);
  let x132: u32 = (x131 >> 8);
  let x133: u32 = (x132 >> 8);
  let x134: u8 = ((x133 >> 8) as u8);
  let x135: u32 = (x85 + (x134 as u32));
  let x136: u32 = (x135 >> 8);
  let x137: u32 = (x136 >> 8);
  let x138: u8 = ((x137 >> 8) as u8);
  let x139: u64 = (x84 + (x138 as u64));
  let x140: u32 = ((x139 >> 8) as u32);
  let x141: u32 = (x140 >> 8);
  let x142: u32 = (x141 >> 8);
  let x143: u8 = ((x142 >> 8) as u8);
  let x144: u32 = (x83 + (x143 as u32));
  let x145: u32 = (x144 >> 8);
  let x146: u32 = (x145 >> 8);
  let x147: u8 = ((x146 >> 8) as u8);
  let x148: u32 = (x82 + (x147 as u32));
  let x149: u32 = (x148 >> 8);
  let x150: u32 = (x149 >> 8);
  let x151: u8 = ((x150 >> 8) as u8);
  let x152: u32 = (x68 >> 8);
  let x153: u32 = (x152 >> 8);
  let x154: u8 = ((x153 >> 8) as u8);
  let x155: u32 = (x81 + (x154 as u32));
  let x156: u32 = (x155 >> 8);
  let x157: u32 = (x156 >> 8);
  let x158: u8 = ((x157 >> 8) as u8);
  let x159: u64 = (x80 + (x158 as u64));
  let x160: u32 = ((x159 >> 8) as u32);
  let x161: u32 = (x160 >> 8);
  let x162: u32 = (x161 >> 8);
  let x163: u8 = ((x162 >> 8) as u8);
  let x164: u32 = (x79 + (x163 as u32));
  let x165: u32 = (x164 >> 8);
  let x166: u32 = (x165 >> 8);
  let x167: u8 = ((x166 >> 8) as u8);
  let x168: u64 = (x78 + (x167 as u64));
  let x169: u32 = ((x168 >> 8) as u32);
  let x170: u32 = (x169 >> 8);
  let x171: u32 = (x170 >> 8);
  let x172: fiat_p521_u1 = ((x171 >> 8) as fiat_p521_u1);
  out1[0] = (x40 as u8);
  out1[1] = (x94 as u8);
  out1[2] = (x95 as u8);
  out1[3] = (x97 as u8);
