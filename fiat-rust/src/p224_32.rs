...
pub fn fiat_p224_addcarryx_u32(out1: &mut u32, out2: &mut fiat_p224_u1, arg1: fiat_p224_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x2: fiat_p224_u1 = ((x1 >> 32) as fiat_p224_u1);
  *out1 = (x1 as u32);
  *out2 = x2;
}
...
pub fn fiat_p224_sub(out1: &mut fiat_p224_montgomery_domain_field_element, arg1: &fiat_p224_montgomery_domain_field_element, arg2: &fiat_p224_montgomery_domain_field_element) -> () {
  ...
  fiat_p224_addcarryx_u32(&mut x16, &mut x17, 0x0, x1, ((x15 as fiat_p224_u1) as u32));
  let mut x18: u32 = 0;
...
pub fn fiat_p224_to_bytes(out1: &mut [u8; 28], arg1: &[u32; 7]) -> () {
  ...
  let x8: u32 = (x7 >> 8);
  let x9: u32 = (x8 >> 8);
  let x10: u8 = ((x9 >> 8) as u8);
  let x11: u32 = (x6 >> 8);
  let x12: u32 = (x11 >> 8);
  let x13: u8 = ((x12 >> 8) as u8);
  let x14: u32 = (x5 >> 8);
  let x15: u32 = (x14 >> 8);
  let x16: u8 = ((x15 >> 8) as u8);
  let x17: u32 = (x4 >> 8);
  let x18: u32 = (x17 >> 8);
  let x19: u8 = ((x18 >> 8) as u8);
  let x20: u32 = (x3 >> 8);
  let x21: u32 = (x20 >> 8);
  let x22: u8 = ((x21 >> 8) as u8);
  let x23: u32 = (x2 >> 8);
  let x24: u32 = (x23 >> 8);
...
pub fn fiat_p224_divstep(out1: &mut u32, out2: &mut [u32; 8], out3: &mut [u32; 8], out4: &mut [u32; 7], out5: &mut [u32; 7], arg1: u32, arg2: &[u32; 8], arg3: &[u32; 8], arg4: &[u32; 7], arg5: &[u32; 7]) -> () {
  ...
  let x3: fiat_p224_u1 = (((x1 >> 31) as fiat_p224_u1) & ((arg3[0]) as fiat_p224_u1));
  let mut x4: u32 = 0;
  ...
  let mut x98: u32 = 0;
  let mut x99: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x98, &mut x99, 0x0, x83, ((x97 as fiat_p224_u1) as u32));
  let mut x100: u32 = 0;
  let mut x101: fiat_p224_u1 = 0;
  ...
  let mut x119: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x119, (x31 as fiat_p224_u1), (0x0 as u32), x7);
  let mut x120: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x120, (x31 as fiat_p224_u1), (0x0 as u32), x8);
  let mut x121: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x121, (x31 as fiat_p224_u1), (0x0 as u32), x9);
  let mut x122: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x122, (x31 as fiat_p224_u1), (0x0 as u32), x10);
  let mut x123: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x123, (x31 as fiat_p224_u1), (0x0 as u32), x11);
  let mut x124: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x124, (x31 as fiat_p224_u1), (0x0 as u32), x12);
  let mut x125: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x125, (x31 as fiat_p224_u1), (0x0 as u32), x13);
  let mut x126: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x126, (x31 as fiat_p224_u1), (0x0 as u32), x14);
  let mut x127: u32 = 0;
  let mut x128: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x127, &mut x128, 0x0, x31, x119);
  let mut x129: u32 = 0;
  let mut x130: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x129, &mut x130, x128, x32, x120);
  let mut x131: u32 = 0;
  let mut x132: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x131, &mut x132, x130, x33, x121);
  let mut x133: u32 = 0;
  let mut x134: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x133, &mut x134, x132, x34, x122);
  let mut x135: u32 = 0;
  let mut x136: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x135, &mut x136, x134, x35, x123);
  let mut x137: u32 = 0;
  let mut x138: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x137, &mut x138, x136, x36, x124);
  let mut x139: u32 = 0;
  let mut x140: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x139, &mut x140, x138, x37, x125);
  let mut x141: u32 = 0;
  let mut x142: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x141, &mut x142, x140, x38, x126);
  let mut x143: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x143, (x31 as fiat_p224_u1), (0x0 as u32), x39);
  let mut x144: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x144, (x31 as fiat_p224_u1), (0x0 as u32), x40);
  let mut x145: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x145, (x31 as fiat_p224_u1), (0x0 as u32), x41);
  let mut x146: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x146, (x31 as fiat_p224_u1), (0x0 as u32), x42);
  let mut x147: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x147, (x31 as fiat_p224_u1), (0x0 as u32), x43);
  let mut x148: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x148, (x31 as fiat_p224_u1), (0x0 as u32), x44);
  let mut x149: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x149, (x31 as fiat_p224_u1), (0x0 as u32), x45);
  let mut x150: u32 = 0;
  let mut x151: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x150, &mut x151, 0x0, x112, x143);
  let mut x152: u32 = 0;
  let mut x153: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x152, &mut x153, x151, x113, x144);
  let mut x154: u32 = 0;
  let mut x155: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x154, &mut x155, x153, x114, x145);
  let mut x156: u32 = 0;
  let mut x157: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x156, &mut x157, x155, x115, x146);
  let mut x158: u32 = 0;
  let mut x159: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x158, &mut x159, x157, x116, x147);
  let mut x160: u32 = 0;
  let mut x161: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x160, &mut x161, x159, x117, x148);
  let mut x162: u32 = 0;
  let mut x163: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x162, &mut x163, x161, x118, x149);
  let mut x164: u32 = 0;
  let mut x165: fiat_p224_u1 = 0;
  fiat_p224_subborrowx_u32(&mut x164, &mut x165, 0x0, x150, (0x1 as u32));
  let mut x166: u32 = 0;
  let mut x167: fiat_p224_u1 = 0;
  ...
  let mut x178: u32 = 0;
  let mut x179: fiat_p224_u1 = 0;
  fiat_p224_subborrowx_u32(&mut x178, &mut x179, x177, (x163 as u32), (0x0 as u32));
  let mut x180: u32 = 0;
  let mut x181: fiat_p224_u1 = 0;
  fiat_p224_addcarryx_u32(&mut x180, &mut x181, 0x0, x6, (0x1 as u32));
  let x182: u32 = ((x127 >> 1) | ((x129 << 31) & 0xffffffff));
  let x183: u32 = ((x129 >> 1) | ((x131 << 31) & 0xffffffff));
  let x184: u32 = ((x131 >> 1) | ((x133 << 31) & 0xffffffff));
  let x185: u32 = ((x133 >> 1) | ((x135 << 31) & 0xffffffff));
  let x186: u32 = ((x135 >> 1) | ((x137 << 31) & 0xffffffff));
  let x187: u32 = ((x137 >> 1) | ((x139 << 31) & 0xffffffff));
  let x188: u32 = ((x139 >> 1) | ((x141 << 31) & 0xffffffff));
  let x189: u32 = ((x141 & 0x80000000) | (x141 >> 1));
  let mut x190: u32 = 0;
  ...
  let mut x197: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x197, x179, x164, x150);
  let mut x198: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x198, x179, x166, x152);
  let mut x199: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x199, x179, x168, x154);
  let mut x200: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x200, x179, x170, x156);
  let mut x201: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x201, x179, x172, x158);
  let mut x202: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x202, x179, x174, x160);
  let mut x203: u32 = 0;
  fiat_p224_cmovznz_u32(&mut x203, x179, x176, x162);
  *out1 = x180;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
