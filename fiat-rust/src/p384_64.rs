...
pub fn fiat_p384_mul(out1: &mut [u64; 6], arg1: &[u64; 6], arg2: &[u64; 6]) -> () {
  ...
  fiat_p384_addcarryx_u64(&mut x29, &mut x30, x28, x8, 0x0);
  let mut x31: u64 = 0;
  let mut x32: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x55, &mut x56, x54, x34, 0x0);
  let mut x57: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x71, &mut x72, x70, 0x0, 0x0);
  let mut x73: u64 = 0;
  let mut x74: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x95, &mut x96, x94, x74, 0x0);
  let mut x97: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x109, &mut x110, x108, (x71 as fiat_p384_u1), x95);
  let mut x111: u64 = 0;
  let mut x112: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x135, &mut x136, x134, x114, 0x0);
  let mut x137: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x151, &mut x152, x150, x110, 0x0);
  let mut x153: u64 = 0;
  let mut x154: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x175, &mut x176, x174, x154, 0x0);
  let mut x177: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x215, &mut x216, x214, x194, 0x0);
  let mut x217: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x231, &mut x232, x230, x190, 0x0);
  let mut x233: u64 = 0;
  let mut x234: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x255, &mut x256, x254, x234, 0x0);
  let mut x257: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x295, &mut x296, x294, x274, 0x0);
  let mut x297: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x311, &mut x312, x310, x270, 0x0);
  let mut x313: u64 = 0;
  let mut x314: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x335, &mut x336, x334, x314, 0x0);
  let mut x337: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x375, &mut x376, x374, x354, 0x0);
  let mut x377: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x391, &mut x392, x390, x350, 0x0);
  let mut x393: u64 = 0;
  let mut x394: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x415, &mut x416, x414, x394, 0x0);
  let mut x417: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x455, &mut x456, x454, x434, 0x0);
  let mut x457: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x471, &mut x472, x470, x430, 0x0);
  let mut x473: u64 = 0;
  ...
  fiat_p384_subborrowx_u64(&mut x485, &mut x486, x484, x471, 0x0);
  let mut x487: u64 = 0;
...
pub fn fiat_p384_add(out1: &mut [u64; 6], arg1: &[u64; 6], arg2: &[u64; 6]) -> () {
  ...
  let mut x25: u64 = 0;
  let mut x26: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x25, &mut x26, x24, x12, 0x0);
  let mut x27: u64 = 0;
...
pub fn fiat_p384_opp(out1: &mut [u64; 6], arg1: &[u64; 6]) -> () {
  let mut x1: u64 = 0;
  let mut x2: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x1, &mut x2, 0x0, 0x0, (arg1[0]));
  let mut x3: u64 = 0;
  let mut x4: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x3, &mut x4, x2, 0x0, (arg1[1]));
  let mut x5: u64 = 0;
  let mut x6: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x5, &mut x6, x4, 0x0, (arg1[2]));
  let mut x7: u64 = 0;
  let mut x8: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x7, &mut x8, x6, 0x0, (arg1[3]));
  let mut x9: u64 = 0;
  let mut x10: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x9, &mut x10, x8, 0x0, (arg1[4]));
  let mut x11: u64 = 0;
  let mut x12: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x11, &mut x12, x10, 0x0, (arg1[5]));
  let mut x13: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x13, x12, (0x0 as u64), 0xffffffffffffffff);
  let mut x14: u64 = 0;
  let mut x15: fiat_p384_u1 = 0;
...
pub fn fiat_p384_from_montgomery(out1: &mut [u64; 6], arg1: &[u64; 6]) -> () {
  ...
  fiat_p384_addcarryx_u64(&mut x28, &mut x29, x27, 0x0, x16);
  let mut x30: u64 = 0;
  let mut x31: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x30, &mut x31, x29, 0x0, x18);
  let mut x32: u64 = 0;
  let mut x33: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x32, &mut x33, x31, 0x0, x20);
  let mut x34: u64 = 0;
  let mut x35: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x34, &mut x35, x33, 0x0, x22);
  let mut x36: u64 = 0;
  let mut x37: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x36, &mut x37, x35, 0x0, x24);
  let mut x38: u64 = 0;
  let mut x39: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x38, &mut x39, x25, x5, 0x0);
  let mut x40: u64 = 0;
  let mut x41: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x40, &mut x41, x37, 0x0, x38);
  let mut x42: u64 = 0;
  let mut x43: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x42, &mut x43, 0x0, x28, (arg1[1]));
  let mut x44: u64 = 0;
  let mut x45: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x44, &mut x45, x43, x30, 0x0);
  let mut x46: u64 = 0;
  let mut x47: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x46, &mut x47, x45, x32, 0x0);
  let mut x48: u64 = 0;
  let mut x49: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x48, &mut x49, x47, x34, 0x0);
  let mut x50: u64 = 0;
  let mut x51: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x50, &mut x51, x49, x36, 0x0);
  let mut x52: u64 = 0;
  let mut x53: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x52, &mut x53, x51, x40, 0x0);
  let mut x54: u64 = 0;
  let mut x55: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x90, &mut x91, x77, x57, 0x0);
  let mut x92: u64 = 0;
  let mut x93: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x92, &mut x93, x41, 0x0, 0x0);
  let mut x94: u64 = 0;
  let mut x95: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x94, &mut x95, x53, (x92 as fiat_p384_u1), 0x0);
  let mut x96: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x100, &mut x101, x99, x82, 0x0);
  let mut x102: u64 = 0;
  let mut x103: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x102, &mut x103, x101, x84, 0x0);
  let mut x104: u64 = 0;
  let mut x105: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x104, &mut x105, x103, x86, 0x0);
  let mut x106: u64 = 0;
  let mut x107: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x106, &mut x107, x105, x88, 0x0);
  let mut x108: u64 = 0;
  let mut x109: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x108, &mut x109, x107, x96, 0x0);
  let mut x110: u64 = 0;
  let mut x111: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x146, &mut x147, x133, x113, 0x0);
  let mut x148: u64 = 0;
  let mut x149: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x148, &mut x149, x97, 0x0, 0x0);
  let mut x150: u64 = 0;
  let mut x151: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x150, &mut x151, x109, (x148 as fiat_p384_u1), 0x0);
  let mut x152: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x156, &mut x157, x155, x138, 0x0);
  let mut x158: u64 = 0;
  let mut x159: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x158, &mut x159, x157, x140, 0x0);
  let mut x160: u64 = 0;
  let mut x161: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x160, &mut x161, x159, x142, 0x0);
  let mut x162: u64 = 0;
  let mut x163: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x162, &mut x163, x161, x144, 0x0);
  let mut x164: u64 = 0;
  let mut x165: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x164, &mut x165, x163, x152, 0x0);
  let mut x166: u64 = 0;
  let mut x167: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x202, &mut x203, x189, x169, 0x0);
  let mut x204: u64 = 0;
  let mut x205: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x204, &mut x205, x153, 0x0, 0x0);
  let mut x206: u64 = 0;
  let mut x207: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x206, &mut x207, x165, (x204 as fiat_p384_u1), 0x0);
  let mut x208: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x212, &mut x213, x211, x194, 0x0);
  let mut x214: u64 = 0;
  let mut x215: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x214, &mut x215, x213, x196, 0x0);
  let mut x216: u64 = 0;
  let mut x217: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x216, &mut x217, x215, x198, 0x0);
  let mut x218: u64 = 0;
  let mut x219: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x218, &mut x219, x217, x200, 0x0);
  let mut x220: u64 = 0;
  let mut x221: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x220, &mut x221, x219, x208, 0x0);
  let mut x222: u64 = 0;
  let mut x223: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x258, &mut x259, x245, x225, 0x0);
  let mut x260: u64 = 0;
  let mut x261: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x260, &mut x261, x209, 0x0, 0x0);
  let mut x262: u64 = 0;
  let mut x263: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x262, &mut x263, x221, (x260 as fiat_p384_u1), 0x0);
  let mut x264: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x268, &mut x269, x267, x250, 0x0);
  let mut x270: u64 = 0;
  let mut x271: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x270, &mut x271, x269, x252, 0x0);
  let mut x272: u64 = 0;
  let mut x273: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x272, &mut x273, x271, x254, 0x0);
  let mut x274: u64 = 0;
  let mut x275: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x274, &mut x275, x273, x256, 0x0);
  let mut x276: u64 = 0;
  let mut x277: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x276, &mut x277, x275, x264, 0x0);
  let mut x278: u64 = 0;
  let mut x279: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x314, &mut x315, x301, x281, 0x0);
  let mut x316: u64 = 0;
  let mut x317: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x316, &mut x317, x265, 0x0, 0x0);
  let mut x318: u64 = 0;
  let mut x319: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x318, &mut x319, x277, (x316 as fiat_p384_u1), 0x0);
  let mut x320: u64 = 0;
  ...
  fiat_p384_addcarryx_u64(&mut x334, &mut x335, x321, 0x0, 0x0);
  let mut x336: u64 = 0;
  let mut x337: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x336, &mut x337, x333, (x334 as fiat_p384_u1), 0x0);
  let mut x338: u64 = 0;
...
pub fn fiat_p384_to_bytes(out1: &mut [u8; 48], arg1: &[u64; 6]) -> () {
  ...
  let x80: u8 = ((x77 & 0xff) as u8);
  let x81: u8 = (x79 & 0xff);
  let x82: u64 = (x1 >> 8);
  let x83: u8 = ((x1 & 0xff) as u8);
  let x84: u64 = (x82 >> 8);
