//! Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --lang Rust p384 64 '2^384 - 2^128 - 2^96 + 2^32 - 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub fn fiat_p384_one(out1: &mut [u64; 6]) -> () {
...
pub fn fiat_p384_divstep(out1: &mut u64, out2: &mut [u64; 7], out3: &mut [u64; 7], out4: &mut [u64; 6], out5: &mut [u64; 6], arg1: u64, arg2: &[u64; 7], arg3: &[u64; 7], arg4: &[u64; 6], arg5: &[u64; 6]) -> () {
  ...
  let x2: fiat_p384_u1 = (((x1 >> 63) as fiat_p384_u1) & (((arg3[0]) & (0x1 as u64)) as fiat_p384_u1));
  let mut x3: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x3, x2, arg1, (((((!arg1) as u128) + (0x1 as u128)) & (0xffffffffffffffff as u128)) as u64));
  let mut x4: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x4, x2, (arg2[0]), (arg3[0]));
  let mut x5: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x5, x2, (arg2[1]), (arg3[1]));
  let mut x6: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x6, x2, (arg2[2]), (arg3[2]));
  let mut x7: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x7, x2, (arg2[3]), (arg3[3]));
  let mut x8: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x8, x2, (arg2[4]), (arg3[4]));
  let mut x9: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x9, x2, (arg2[5]), (arg3[5]));
  let mut x10: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x10, x2, (arg2[6]), (arg3[6]));
  let mut x11: u64 = 0;
  let mut x12: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x11, &mut x12, 0x0, (0x1 as u64), (!(arg2[0])));
  let mut x13: u64 = 0;
  let mut x14: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x13, &mut x14, x12, (0x0 as u64), (!(arg2[1])));
  let mut x15: u64 = 0;
  let mut x16: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x15, &mut x16, x14, (0x0 as u64), (!(arg2[2])));
  let mut x17: u64 = 0;
  let mut x18: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x17, &mut x18, x16, (0x0 as u64), (!(arg2[3])));
  let mut x19: u64 = 0;
  let mut x20: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x19, &mut x20, x18, (0x0 as u64), (!(arg2[4])));
  let mut x21: u64 = 0;
  let mut x22: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x21, &mut x22, x20, (0x0 as u64), (!(arg2[5])));
  let mut x23: u64 = 0;
  let mut x24: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x23, &mut x24, x22, (0x0 as u64), (!(arg2[6])));
  let mut x25: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x25, x2, (arg3[0]), x11);
  let mut x26: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x26, x2, (arg3[1]), x13);
  let mut x27: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x27, x2, (arg3[2]), x15);
  let mut x28: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x28, x2, (arg3[3]), x17);
  let mut x29: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x29, x2, (arg3[4]), x19);
  let mut x30: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x30, x2, (arg3[5]), x21);
  let mut x31: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x31, x2, (arg3[6]), x23);
  let mut x32: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x32, x2, (arg4[0]), (arg5[0]));
  let mut x33: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x33, x2, (arg4[1]), (arg5[1]));
  let mut x34: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x34, x2, (arg4[2]), (arg5[2]));
  let mut x35: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x35, x2, (arg4[3]), (arg5[3]));
  let mut x36: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x36, x2, (arg4[4]), (arg5[4]));
  let mut x37: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x37, x2, (arg4[5]), (arg5[5]));
  let mut x38: u64 = 0;
  let mut x39: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x38, &mut x39, 0x0, x32, x32);
  let mut x40: u64 = 0;
  let mut x41: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x40, &mut x41, x39, x33, x33);
  let mut x42: u64 = 0;
  let mut x43: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x42, &mut x43, x41, x34, x34);
  let mut x44: u64 = 0;
  let mut x45: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x44, &mut x45, x43, x35, x35);
  let mut x46: u64 = 0;
  let mut x47: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x46, &mut x47, x45, x36, x36);
  let mut x48: u64 = 0;
  let mut x49: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x48, &mut x49, x47, x37, x37);
  let mut x50: u64 = 0;
  let mut x51: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x50, &mut x51, 0x0, x38, 0xffffffff);
  let mut x52: u64 = 0;
  let mut x53: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x52, &mut x53, x51, x40, 0xffffffff00000000);
  let mut x54: u64 = 0;
  let mut x55: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x54, &mut x55, x53, x42, 0xfffffffffffffffe);
  let mut x56: u64 = 0;
  let mut x57: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x56, &mut x57, x55, x44, 0xffffffffffffffff);
  let mut x58: u64 = 0;
  let mut x59: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x58, &mut x59, x57, x46, 0xffffffffffffffff);
  let mut x60: u64 = 0;
  let mut x61: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x60, &mut x61, x59, x48, 0xffffffffffffffff);
  let mut x62: u64 = 0;
  let mut x63: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x62, &mut x63, x61, (x49 as u64), (0x0 as u64));
  let x64: u64 = (arg4[5]);
  let x65: u64 = (arg4[4]);
  let x66: u64 = (arg4[3]);
  let x67: u64 = (arg4[2]);
  ...
  let mut x70: u64 = 0;
  let mut x71: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x70, &mut x71, 0x0, (0x0 as u64), x69);
  let mut x72: u64 = 0;
  let mut x73: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x72, &mut x73, x71, (0x0 as u64), x68);
  let mut x74: u64 = 0;
  let mut x75: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x74, &mut x75, x73, (0x0 as u64), x67);
  let mut x76: u64 = 0;
  let mut x77: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x76, &mut x77, x75, (0x0 as u64), x66);
  let mut x78: u64 = 0;
  let mut x79: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x78, &mut x79, x77, (0x0 as u64), x65);
  let mut x80: u64 = 0;
  let mut x81: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x80, &mut x81, x79, (0x0 as u64), x64);
  let mut x82: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x82, x81, (0x0 as u64), 0xffffffffffffffff);
  let mut x83: u64 = 0;
  let mut x84: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x83, &mut x84, 0x0, x70, (x82 & 0xffffffff));
  let mut x85: u64 = 0;
  let mut x86: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x85, &mut x86, x84, x72, (x82 & 0xffffffff00000000));
  let mut x87: u64 = 0;
  let mut x88: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x87, &mut x88, x86, x74, (x82 & 0xfffffffffffffffe));
  let mut x89: u64 = 0;
  let mut x90: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x89, &mut x90, x88, x76, x82);
  let mut x91: u64 = 0;
  let mut x92: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x91, &mut x92, x90, x78, x82);
  let mut x93: u64 = 0;
  let mut x94: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x93, &mut x94, x92, x80, x82);
  let mut x95: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x95, x2, (arg5[0]), x83);
  let mut x96: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x96, x2, (arg5[1]), x85);
  let mut x97: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x97, x2, (arg5[2]), x87);
  let mut x98: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x98, x2, (arg5[3]), x89);
  let mut x99: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x99, x2, (arg5[4]), x91);
  let mut x100: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x100, x2, (arg5[5]), x93);
  let x101: fiat_p384_u1 = ((x25 & (0x1 as u64)) as fiat_p384_u1);
  let mut x102: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x102, x101, (0x0 as u64), x4);
  let mut x103: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x103, x101, (0x0 as u64), x5);
  let mut x104: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x104, x101, (0x0 as u64), x6);
  let mut x105: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x105, x101, (0x0 as u64), x7);
  let mut x106: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x106, x101, (0x0 as u64), x8);
  let mut x107: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x107, x101, (0x0 as u64), x9);
  let mut x108: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x108, x101, (0x0 as u64), x10);
  let mut x109: u64 = 0;
  let mut x110: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x109, &mut x110, 0x0, x25, x102);
  let mut x111: u64 = 0;
  let mut x112: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x111, &mut x112, x110, x26, x103);
  let mut x113: u64 = 0;
  let mut x114: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x113, &mut x114, x112, x27, x104);
  let mut x115: u64 = 0;
  let mut x116: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x115, &mut x116, x114, x28, x105);
  let mut x117: u64 = 0;
  let mut x118: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x117, &mut x118, x116, x29, x106);
  let mut x119: u64 = 0;
  let mut x120: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x119, &mut x120, x118, x30, x107);
  let mut x121: u64 = 0;
  let mut x122: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x121, &mut x122, x120, x31, x108);
  let mut x123: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x123, x101, (0x0 as u64), x32);
  let mut x124: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x124, x101, (0x0 as u64), x33);
  let mut x125: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x125, x101, (0x0 as u64), x34);
  let mut x126: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x126, x101, (0x0 as u64), x35);
  let mut x127: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x127, x101, (0x0 as u64), x36);
  let mut x128: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x128, x101, (0x0 as u64), x37);
  let mut x129: u64 = 0;
  let mut x130: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x129, &mut x130, 0x0, x95, x123);
  let mut x131: u64 = 0;
  let mut x132: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x131, &mut x132, x130, x96, x124);
  let mut x133: u64 = 0;
  let mut x134: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x133, &mut x134, x132, x97, x125);
  let mut x135: u64 = 0;
  let mut x136: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x135, &mut x136, x134, x98, x126);
  let mut x137: u64 = 0;
  let mut x138: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x137, &mut x138, x136, x99, x127);
  let mut x139: u64 = 0;
  let mut x140: fiat_p384_u1 = 0;
  fiat_p384_addcarryx_u64(&mut x139, &mut x140, x138, x100, x128);
  let mut x141: u64 = 0;
  let mut x142: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x141, &mut x142, 0x0, x129, 0xffffffff);
  let mut x143: u64 = 0;
  let mut x144: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x143, &mut x144, x142, x131, 0xffffffff00000000);
  let mut x145: u64 = 0;
  let mut x146: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x145, &mut x146, x144, x133, 0xfffffffffffffffe);
  let mut x147: u64 = 0;
  let mut x148: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x147, &mut x148, x146, x135, 0xffffffffffffffff);
  let mut x149: u64 = 0;
  let mut x150: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x149, &mut x150, x148, x137, 0xffffffffffffffff);
  let mut x151: u64 = 0;
  let mut x152: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x151, &mut x152, x150, x139, 0xffffffffffffffff);
  let mut x153: u64 = 0;
  let mut x154: fiat_p384_u1 = 0;
  fiat_p384_subborrowx_u64(&mut x153, &mut x154, x152, (x140 as u64), (0x0 as u64));
  let x155: u64 = ((((x3 as u128) + (0x1 as u128)) & (0xffffffffffffffff as u128)) as u64);
  let x156: u64 = ((x109 >> 1) | ((x111 << 63) & 0xffffffffffffffff));
  let x157: u64 = ((x111 >> 1) | ((x113 << 63) & 0xffffffffffffffff));
  let x158: u64 = ((x113 >> 1) | ((x115 << 63) & 0xffffffffffffffff));
  let x159: u64 = ((x115 >> 1) | ((x117 << 63) & 0xffffffffffffffff));
  let x160: u64 = ((x117 >> 1) | ((x119 << 63) & 0xffffffffffffffff));
  let x161: u64 = ((x119 >> 1) | ((x121 << 63) & 0xffffffffffffffff));
  let x162: u64 = ((x121 & 0x8000000000000000) | (x121 >> 1));
  let mut x163: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x163, x63, x50, x38);
  let mut x164: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x164, x63, x52, x40);
  let mut x165: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x165, x63, x54, x42);
  let mut x166: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x166, x63, x56, x44);
  let mut x167: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x167, x63, x58, x46);
  let mut x168: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x168, x63, x60, x48);
  let mut x169: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x169, x154, x141, x129);
  let mut x170: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x170, x154, x143, x131);
  let mut x171: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x171, x154, x145, x133);
  let mut x172: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x172, x154, x147, x135);
  let mut x173: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x173, x154, x149, x137);
  let mut x174: u64 = 0;
  fiat_p384_cmovznz_u64(&mut x174, x154, x151, x139);
  *out1 = x155;
  out2[0] = x4;
  out2[1] = x5;
  out2[2] = x6;
