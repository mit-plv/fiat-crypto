...
pub fn fiat_p384_cmovznz_u64(out1: &mut u64, arg1: fiat_p384_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: i128 = ((((0x0 as fiat_p384_i2) - (x1 as fiat_p384_i2)) as i128) & (0xffffffffffffffff as i128));
...
pub fn fiat_p384_to_bytes(out1: &mut [u8; 48], arg1: &[u64; 6]) -> () {
  ...
  let x20: u64 = (x17 & (0xff as u64));
  let x21: u8 = (x19 & 0xff);
  let x22: u64 = (x5 >> 8);
  let x23: u64 = (x5 & (0xff as u64));
  let x24: u64 = (x22 >> 8);
