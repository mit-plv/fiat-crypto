...
FUNCTIONS_FOR_P224 := $(WORD_BY_WORD_MONTGOMERY_FUNCTIONS) scmul2 scmul3 scmul4 scmul8
...
$(foreach bw,64 32,$(eval $(call add_curve_keys,p224_$(bw),WORD_BY_WORD_MONTGOMERY,'p224',$(bw),'2^224 - 2^96 + 1',$(FUNCTIONS_FOR_P224))))
