...
UNSATURATED_SOLINAS_BEDROCK2_FILES := $(patsubst %,$(BEDROCK2_DIR)%_64.c,$(UNSATURATED_SOLINAS_BASE_FILES))
WORD_BY_WORD_MONTGOMERY_BEDROCK2_FILES := $(patsubst %,$(BEDROCK2_DIR)%_64.c,$(WORD_BY_WORD_MONTGOMERY_BASE_FILES))
ALL_BEDROCK2_FILES := $(patsubst %,$(BEDROCK2_DIR)%_64.c,$(ALL_BASE_FILES))
