...
.PHONY: coq clean update-_CoqProject cleanall install \
	...
	print-nonautogenerated-specific print-nonautogenerated-specific-display \
	print-old-pipeline-lite-hardcoded old-pipeline-lite-hardcoded lite-display-hardcoded \
	print-old-pipeline-nobigmem-hardcoded old-pipeline-nobigmem-hardcoded nonautogenerated-specific-hardcoded nonautogenerated-specific-display-hardcoded \
	regenerate-curves
...
print-nonautogenerated-specific::
	@echo 'Files Made:'
	@for i in $(sort $(NONAUTOGENERATED_SPECIFIC_VOFILES)); do echo $$i; done
