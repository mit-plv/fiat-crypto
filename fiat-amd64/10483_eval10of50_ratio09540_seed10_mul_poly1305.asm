...
; using shlx + lea to multiply by 2 and then by 5
; imul r11, [ rdx + 0x8 ], 0xa; x10001 <- arg2[1] * 0xa
mov r11, 0x1
shlx r11, [ rdx + 0x8 ], r11   ; tmp    <- arg2[1] * 2 
lea r11,  [ r11 + 4 * r11 ]    ; x10001 <- tmp * 5 


;imul rcx, [ rdx + 0x8 ], 0x2; x10003 <- arg2[1] * 0x2
mov rcx, [ rdx + 0x8 ]         ; reg    <- arg2[1]
shl rcx, 0x01                  ; x10003 <- arg2[1] << 1

; or to get x10003 <- arg2[1] * 2
mov rcx, [ rdx + 0x8 ]         ; reg    <- arg2[1]
lea rcx, [ rcx + rcx ]         ; x10003 <- arg2[1] + arg2[1]
