        .globl  _Z20fiat_p448_from_bytesPmPKh
_Z20fiat_p448_from_bytesPmPKh:
        push    rbp
        mov     rbp, rsp
        sub     rsp, 720
        ...
        movzx   ecx, byte ptr [rbp - 289]
        add     rax, rcx
        mov     qword ptr [rbp - 616], rax
        mov     rax, qword ptr [rbp - 280]
        add     rax, qword ptr [rbp - 616]
        ...
        add     rax, qword ptr [rbp - 688]
        mov     qword ptr [rbp - 696], rax
        mov     rax, qword ptr [rbp - 192]
        add     rax, qword ptr [rbp - 696]
        mov     qword ptr [rbp - 704], rax
        mov     rax, qword ptr [rbp - 176]
        movzx   ecx, byte ptr [rbp - 177]
        add     rax, rcx
