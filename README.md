...
dependency graph:
```
GenerateIdentifiersWithoutTypes.v ←──────── GENERATEDIdentifiersWithoutTypes.v
    ↑ ↑                                                                ↑
    │ └──────────────── GenerateIdentifiersWithoutTypesProofs.v        └─── GENERATEDIdentifiersWithoutTypesProofs.v
    │                                     ↑                                                        ↑
...
- GenerateIdentifiersWithoutTypes.v: Tactics to generate definitions
  about untyped and pattern versions of identifiers for the rewriter.
  Also contains some definitions that take the generated definitions
  as arguments.  Also defines a package record to hold all of the
  definitions.

- GenerateIdentifiersWithoutTypesProofs.v: proofs about definitions in
  GenerateIdentifiersWithoutTypes, as well as tactics to prove a
  couple of lemmas that depend on the specific inductive types (the
  proofs need to destruct the inductive).  Also defines a package
  record to hold the proofs.

- GENERATEDIdentifiersWithoutTypes.v: identifiers and definitions
  generated by GenerateIdentifiersWithoutTypes.v
