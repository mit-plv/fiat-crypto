...
PreLanguage.v
    ↑
Language.v ←─────────── Identifier.v ←─────────── IdentifierExtra.v
    ↑                                                    ↑
    ├─────────────────────┐                       ┌──────┴────────────────────────────────────────┐
MiscCompilerPasses.v   UnderLets.v                │                          PushButtonSynthesis/ReificationCache.v
      ...
      AbstractInterpretation.v                                                   "Rewriter"
               ↑
      LanguageStringification.v
               ↑
               ├───────────────────────────────────────────────────────────┐
              IR.v
               ↑
               ├───────────────────────┐
      CStringification.v   RustStringification.v
               ↑                       ↑
               └──────────────┬────────┘
...
- PreLanguage.v: A few definitions which are used in writing out
...
- IdentifierExtra.v: Specializes the type of PHOAS expressions to the
...
- RustStringification.v: conversion to Rust code as strings.
  Instantiates the API defined in LanguageStringification.
