/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang Go --cmovznz-by-mul --widen-carry 25519 32 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes carry_scmul121666 */
...
func fiat_25519_to_bytes(out1 *[32]uint8, arg1 *[10]uint32) {
  var x1 uint32
  var x2 uint8
  fiat_25519_subborrowx_u26(&x1, &x2, uint8(0x0), (arg1[0]), 0x3ffffed)
  var x3 uint32
  var x4 uint8
...
func fiat_25519_from_bytes(out1 *[10]uint32, arg1 *[32]uint8) {
  ...
  var x40 uint32 = (uint32(x16) + (x15 + (x14 + x13)))
  var x41 uint32 = (x19 + (x18 + x17))
  var x42 uint32 = (x22 + (x21 + x20))
  var x43 uint32 = (x25 + (x24 + x23))
  var x44 uint32 = (x28 + (x27 + x26))
  var x45 uint32 = (uint32(x34) + x44)
  var x46 uint8 = uint8((x45 >> 25))
  var x47 uint32 = (x45 & 0x1ffffff)
  var x48 uint32 = (uint32(x46) + x43)
  var x49 uint8 = uint8((x48 >> 26))
  var x50 uint32 = (x48 & 0x3ffffff)
  var x51 uint32 = (uint32(x49) + x42)
  var x52 uint8 = uint8((x51 >> 25))
  var x53 uint32 = (x51 & 0x1ffffff)
  var x54 uint32 = (uint32(x52) + x41)
  var x55 uint32 = (x54 & 0x3ffffff)
  var x56 uint8 = uint8((x40 >> 25))
  var x57 uint32 = (x40 & 0x1ffffff)
  var x58 uint32 = (uint32(x56) + x39)
  var x59 uint8 = uint8((x58 >> 26))
  var x60 uint32 = (x58 & 0x3ffffff)
  var x61 uint32 = (uint32(x59) + x38)
  var x62 uint8 = uint8((x61 >> 25))
  var x63 uint32 = (x61 & 0x1ffffff)
  var x64 uint32 = (uint32(x62) + x37)
  var x65 uint8 = uint8((x64 >> 26))
  var x66 uint32 = (x64 & 0x3ffffff)
  var x67 uint32 = (uint32(x65) + x36)
  out1[0] = x35
  out1[1] = x47
  out1[2] = x50
  out1[3] = x53
