/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --lang=Go --no-wide-int --cmovznz-by-mul --widen-carry --widen-bytes secp256k1 '2^256 - 2^32 - 977' 64 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
...
func fiat_secp256k1_to_montgomery(out1 *[4]uint64, arg1 *[4]uint64) {
  ...
  var x5 uint64
  var x6 uint64
  x5, x6 = bits.Mul64(x4, 0x7a2000e90a1)
  var x7 uint64
  var x8 uint64
  x7, x8 = bits.Add64(x6, x4, 0x0)
  var x9 uint64
  x9, _ = bits.Mul64(x5, 0xd838091dd2253531)
  var x11 uint64
  var x12 uint64
  x11, x12 = bits.Mul64(x9, 0xffffffffffffffff)
  var x13 uint64
  var x14 uint64
  x13, x14 = bits.Mul64(x9, 0xffffffffffffffff)
  var x15 uint64
  var x16 uint64
  x15, x16 = bits.Mul64(x9, 0xffffffffffffffff)
  var x17 uint64
  var x18 uint64
  x17, x18 = bits.Mul64(x9, 0xfffffffefffffc2f)
  var x19 uint64
  var x20 uint64
  ...
  var x31 uint64
  var x32 uint64
  x31, x32 = bits.Add64(uint64(0x0), x23, x30)
  var x33 uint64
  var x34 uint64
  x33, x34 = bits.Add64(uint64(0x0), (x24 + x12), x32)
  var x35 uint64
  var x36 uint64
  x35, x36 = bits.Mul64(x1, 0x7a2000e90a1)
  var x37 uint64
  var x38 uint64
  x37, x38 = bits.Add64(x36, x1, 0x0)
  var x39 uint64
  var x40 uint64
  x39, x40 = bits.Add64(x27, x35, 0x0)
  var x41 uint64
  var x42 uint64
  ...
  var x45 uint64
  var x46 uint64
  x45, x46 = bits.Add64(x33, uint64(0x0), x44)
  var x47 uint64
  x47, _ = bits.Mul64(x39, 0xd838091dd2253531)
  var x49 uint64
  var x50 uint64
  x49, x50 = bits.Mul64(x47, 0xffffffffffffffff)
  var x51 uint64
  var x52 uint64
  x51, x52 = bits.Mul64(x47, 0xffffffffffffffff)
  var x53 uint64
  var x54 uint64
  x53, x54 = bits.Mul64(x47, 0xffffffffffffffff)
  var x55 uint64
  var x56 uint64
  x55, x56 = bits.Mul64(x47, 0xfffffffefffffc2f)
  var x57 uint64
  var x58 uint64
  x57, x58 = bits.Add64(x56, x53, 0x0)
  var x59 uint64
  var x60 uint64
  ...
  var x73 uint64
  var x74 uint64
  x73, x74 = bits.Mul64(x2, 0x7a2000e90a1)
  var x75 uint64
  var x76 uint64
  x75, x76 = bits.Add64(x74, x2, 0x0)
  var x77 uint64
  var x78 uint64
  x77, x78 = bits.Add64(x65, x73, 0x0)
  var x79 uint64
  var x80 uint64
  ...
  var x83 uint64
  var x84 uint64
  x83, x84 = bits.Add64(x71, uint64(0x0), x82)
  var x85 uint64
  x85, _ = bits.Mul64(x77, 0xd838091dd2253531)
  var x87 uint64
  var x88 uint64
  x87, x88 = bits.Mul64(x85, 0xffffffffffffffff)
  var x89 uint64
  var x90 uint64
  x89, x90 = bits.Mul64(x85, 0xffffffffffffffff)
  var x91 uint64
  var x92 uint64
  x91, x92 = bits.Mul64(x85, 0xffffffffffffffff)
  var x93 uint64
  var x94 uint64
  x93, x94 = bits.Mul64(x85, 0xfffffffefffffc2f)
  var x95 uint64
  var x96 uint64
  ...
  var x111 uint64
  var x112 uint64
  x111, x112 = bits.Mul64(x3, 0x7a2000e90a1)
  var x113 uint64
  var x114 uint64
  x113, x114 = bits.Add64(x112, x3, 0x0)
  var x115 uint64
  var x116 uint64
  x115, x116 = bits.Add64(x103, x111, 0x0)
  var x117 uint64
  var x118 uint64
  ...
  var x121 uint64
  var x122 uint64
  x121, x122 = bits.Add64(x109, uint64(0x0), x120)
  var x123 uint64
  x123, _ = bits.Mul64(x115, 0xd838091dd2253531)
  var x125 uint64
  var x126 uint64
  x125, x126 = bits.Mul64(x123, 0xffffffffffffffff)
  var x127 uint64
  var x128 uint64
  x127, x128 = bits.Mul64(x123, 0xffffffffffffffff)
  var x129 uint64
  var x130 uint64
  x129, x130 = bits.Mul64(x123, 0xffffffffffffffff)
  var x131 uint64
  var x132 uint64
  x131, x132 = bits.Mul64(x123, 0xfffffffefffffc2f)
  var x133 uint64
  var x134 uint64
  ...
  var x140 uint64
  _, x140 = bits.Add64(x115, x131, 0x0)
  var x141 uint64
  var x142 uint64
  ...
  var x158 uint64
  _, x158 = bits.Sub64(x148, uint64(0x0), x156)
  var x159 uint64
