...
func fiat_secp256k1_sub(out1 *[4]uint64, arg1 *[4]uint64, arg2 *[4]uint64) {
  ...
  x12, x13 = fiat_secp256k1_addcarryx_u64(x3, (x9 & 0xffffffffffffffff), x11)
  var x14 uint64
  var x15 fiat_secp256k1_uint1
  x14, x15 = fiat_secp256k1_addcarryx_u64(x5, (x9 & 0xffffffffffffffff), x13)
  var x16 uint64
  x16, _ = fiat_secp256k1_addcarryx_u64(x7, (x9 & 0xffffffffffffffff), x15)
  out1[0] = x10
  out1[1] = x12
  out1[2] = x14
  out1[3] = x16
