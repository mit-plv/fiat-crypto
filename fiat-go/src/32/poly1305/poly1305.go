/* Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Go --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --package-name fiatpoly1305 '' 32 '(auto)' '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
 ...
 */
/*inline*/
func CarryMul(out1 *[5]uint32, arg1 *[5]uint32, arg2 *[5]uint32) {
 ...
 */
/*inline*/
func CarrySquare(out1 *[5]uint32, arg1 *[5]uint32) {
 ...
 */
/*inline*/
func Carry(out1 *[5]uint32, arg1 *[5]uint32) {
  ...
  var x7 uint32 = (uint32(uint1((x6 >> 26))) + (x2 & 0x3ffffff))
  var x8 uint32 = (x6 & 0x3ffffff)
  var x9 uint32 = (x7 & 0x3ffffff)
  var x10 uint32 = (uint32(uint1((x7 >> 26))) + (x3 & 0x3ffffff))
 ...
 */
/*inline*/
func Add(out1 *[5]uint32, arg1 *[5]uint32, arg2 *[5]uint32) {
 ...
 */
/*inline*/
func Sub(out1 *[5]uint32, arg1 *[5]uint32, arg2 *[5]uint32) {
 ...
 */
/*inline*/
func Opp(out1 *[5]uint32, arg1 *[5]uint32) {
 ...
 */
/*inline*/
func ToBytes(out1 *[17]uint8, arg1 *[5]uint32) {
  var x1 uint32
  var x2 uint1
 ...
 */
/*inline*/
func FromBytes(out1 *[5]uint32, arg1 *[17]uint8) {
