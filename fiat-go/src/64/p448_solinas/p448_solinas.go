/* Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Go --no-wide-int --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --package-name p448_solinas '' 64 8 '2^448 - 2^224 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
/* curve description (via package name): p448_solinas */
 ...
 */
/*inline*/
func CarryMul(out1 *[8]uint64, arg1 *[8]uint64, arg2 *[8]uint64) {
  var x1 uint64
  var x2 uint64
  ...
  var x197 uint64
  var x198 uint1
  x197, x198 = addcarryxU64(x43, x31, 0x0)
  var x199 uint64
  x199, _ = addcarryxU64(x44, x32, x198)
  var x201 uint64
  var x202 uint1
  x201, x202 = addcarryxU64(x53, x197, 0x0)
  var x203 uint64
  x203, _ = addcarryxU64(x54, x199, x202)
  var x205 uint64
  var x206 uint1
  x205, x206 = addcarryxU64(x61, x201, 0x0)
  var x207 uint64
  x207, _ = addcarryxU64(x62, x203, x206)
  var x209 uint64
  var x210 uint1
  x209, x210 = addcarryxU64(x153, x205, 0x0)
  var x211 uint64
  x211, _ = addcarryxU64(x154, x207, x210)
  var x213 uint64
  var x214 uint1
  x213, x214 = addcarryxU64(x163, x209, 0x0)
  var x215 uint64
  x215, _ = addcarryxU64(x164, x211, x214)
  var x217 uint64
  var x218 uint1
  x217, x218 = addcarryxU64(x175, x213, 0x0)
  var x219 uint64
  x219, _ = addcarryxU64(x176, x215, x218)
  var x221 uint64
  var x222 uint1
  x221, x222 = addcarryxU64(x189, x217, 0x0)
  var x223 uint64
  x223, _ = addcarryxU64(x190, x219, x222)
  var x225 uint64 = ((x221 >> 56) | ((x223 << 8) & 0xffffffffffffffff))
  var x226 uint64 = (x221 & 0xffffffffffffff)
  var x227 uint64
  var x228 uint1
  x227, x228 = addcarryxU64(x89, x81, 0x0)
  var x229 uint64
  x229, _ = addcarryxU64(x90, x82, x228)
  var x231 uint64
  var x232 uint1
  x231, x232 = addcarryxU64(x97, x227, 0x0)
  var x233 uint64
  x233, _ = addcarryxU64(x98, x229, x232)
  var x235 uint64
  var x236 uint1
  x235, x236 = addcarryxU64(x105, x231, 0x0)
  var x237 uint64
  x237, _ = addcarryxU64(x106, x233, x236)
  var x239 uint64
  var x240 uint1
  x239, x240 = addcarryxU64(x125, x235, 0x0)
  var x241 uint64
  x241, _ = addcarryxU64(x126, x237, x240)
  var x243 uint64
  var x244 uint1
  x243, x244 = addcarryxU64(x127, x239, 0x0)
  var x245 uint64
  x245, _ = addcarryxU64(x128, x241, x244)
  var x247 uint64
  var x248 uint1
  x247, x248 = addcarryxU64(x131, x243, 0x0)
  var x249 uint64
  x249, _ = addcarryxU64(x132, x245, x248)
  var x251 uint64
  var x252 uint1
  x251, x252 = addcarryxU64(x137, x247, 0x0)
  var x253 uint64
  x253, _ = addcarryxU64(x138, x249, x252)
  var x255 uint64
  var x256 uint1
  x255, x256 = addcarryxU64(x145, x251, 0x0)
  var x257 uint64
  x257, _ = addcarryxU64(x146, x253, x256)
  var x259 uint64
  var x260 uint1
  x259, x260 = addcarryxU64(x155, x255, 0x0)
  var x261 uint64
  x261, _ = addcarryxU64(x156, x257, x260)
  var x263 uint64
  var x264 uint1
  x263, x264 = addcarryxU64(x167, x259, 0x0)
  var x265 uint64
  x265, _ = addcarryxU64(x168, x261, x264)
  var x267 uint64
  var x268 uint1
  x267, x268 = addcarryxU64(x181, x263, 0x0)
  var x269 uint64
  x269, _ = addcarryxU64(x182, x265, x268)
  var x271 uint64
  var x272 uint1
  x271, x272 = addcarryxU64(x25, x13, 0x0)
  var x273 uint64
  x273, _ = addcarryxU64(x26, x14, x272)
  var x275 uint64
  var x276 uint1
  x275, x276 = addcarryxU64(x83, x271, 0x0)
  var x277 uint64
  x277, _ = addcarryxU64(x84, x273, x276)
  var x279 uint64
  var x280 uint1
  x279, x280 = addcarryxU64(x91, x275, 0x0)
  var x281 uint64
  x281, _ = addcarryxU64(x92, x277, x280)
  var x283 uint64
  var x284 uint1
  x283, x284 = addcarryxU64(x99, x279, 0x0)
  var x285 uint64
  x285, _ = addcarryxU64(x100, x281, x284)
  var x287 uint64
  var x288 uint1
  x287, x288 = addcarryxU64(x107, x283, 0x0)
  var x289 uint64
  x289, _ = addcarryxU64(x108, x285, x288)
  var x291 uint64
  var x292 uint1
  x291, x292 = addcarryxU64(x113, x287, 0x0)
  var x293 uint64
  x293, _ = addcarryxU64(x114, x289, x292)
  var x295 uint64
  var x296 uint1
  x295, x296 = addcarryxU64(x129, x291, 0x0)
  var x297 uint64
  x297, _ = addcarryxU64(x130, x293, x296)
  var x299 uint64
  var x300 uint1
  x299, x300 = addcarryxU64(x133, x295, 0x0)
  var x301 uint64
  x301, _ = addcarryxU64(x134, x297, x300)
  var x303 uint64
  var x304 uint1
  x303, x304 = addcarryxU64(x139, x299, 0x0)
  var x305 uint64
  x305, _ = addcarryxU64(x140, x301, x304)
  var x307 uint64
  var x308 uint1
  x307, x308 = addcarryxU64(x147, x303, 0x0)
  var x309 uint64
  x309, _ = addcarryxU64(x148, x305, x308)
  var x311 uint64
  var x312 uint1
  x311, x312 = addcarryxU64(x157, x307, 0x0)
  var x313 uint64
  x313, _ = addcarryxU64(x158, x309, x312)
  var x315 uint64
  var x316 uint1
  x315, x316 = addcarryxU64(x169, x311, 0x0)
  var x317 uint64
  x317, _ = addcarryxU64(x170, x313, x316)
  var x319 uint64
  var x320 uint1
  x319, x320 = addcarryxU64(x183, x315, 0x0)
  var x321 uint64
  x321, _ = addcarryxU64(x184, x317, x320)
  var x323 uint64
  var x324 uint1
  x323, x324 = addcarryxU64(x19, x15, 0x0)
  var x325 uint64
  x325, _ = addcarryxU64(x20, x16, x324)
  var x327 uint64
  var x328 uint1
  x327, x328 = addcarryxU64(x27, x323, 0x0)
  var x329 uint64
  x329, _ = addcarryxU64(x28, x325, x328)
  var x331 uint64
  var x332 uint1
  x331, x332 = addcarryxU64(x39, x327, 0x0)
  var x333 uint64
  x333, _ = addcarryxU64(x40, x329, x332)
  var x335 uint64
  var x336 uint1
  x335, x336 = addcarryxU64(x85, x331, 0x0)
  var x337 uint64
  x337, _ = addcarryxU64(x86, x333, x336)
  var x339 uint64
  var x340 uint1
  x339, x340 = addcarryxU64(x93, x335, 0x0)
  var x341 uint64
  x341, _ = addcarryxU64(x94, x337, x340)
  var x343 uint64
  var x344 uint1
  x343, x344 = addcarryxU64(x101, x339, 0x0)
  var x345 uint64
  x345, _ = addcarryxU64(x102, x341, x344)
  var x347 uint64
  var x348 uint1
  x347, x348 = addcarryxU64(x109, x343, 0x0)
  var x349 uint64
  x349, _ = addcarryxU64(x110, x345, x348)
  var x351 uint64
  var x352 uint1
  x351, x352 = addcarryxU64(x115, x347, 0x0)
  var x353 uint64
  x353, _ = addcarryxU64(x116, x349, x352)
  var x355 uint64
  var x356 uint1
  x355, x356 = addcarryxU64(x119, x351, 0x0)
  var x357 uint64
  x357, _ = addcarryxU64(x120, x353, x356)
  var x359 uint64
  var x360 uint1
  x359, x360 = addcarryxU64(x135, x355, 0x0)
  var x361 uint64
  x361, _ = addcarryxU64(x136, x357, x360)
  var x363 uint64
  var x364 uint1
  x363, x364 = addcarryxU64(x141, x359, 0x0)
  var x365 uint64
  x365, _ = addcarryxU64(x142, x361, x364)
  var x367 uint64
  var x368 uint1
  x367, x368 = addcarryxU64(x149, x363, 0x0)
  var x369 uint64
  x369, _ = addcarryxU64(x150, x365, x368)
  var x371 uint64
  var x372 uint1
  x371, x372 = addcarryxU64(x159, x367, 0x0)
  var x373 uint64
  x373, _ = addcarryxU64(x160, x369, x372)
  var x375 uint64
  var x376 uint1
  x375, x376 = addcarryxU64(x171, x371, 0x0)
  var x377 uint64
  x377, _ = addcarryxU64(x172, x373, x376)
  var x379 uint64
  var x380 uint1
  x379, x380 = addcarryxU64(x185, x375, 0x0)
  var x381 uint64
  x381, _ = addcarryxU64(x186, x377, x380)
  var x383 uint64
  var x384 uint1
  x383, x384 = addcarryxU64(x21, x17, 0x0)
  var x385 uint64
  x385, _ = addcarryxU64(x22, x18, x384)
  var x387 uint64
  var x388 uint1
  x387, x388 = addcarryxU64(x23, x383, 0x0)
  var x389 uint64
  x389, _ = addcarryxU64(x24, x385, x388)
  var x391 uint64
  var x392 uint1
  x391, x392 = addcarryxU64(x29, x387, 0x0)
  var x393 uint64
  x393, _ = addcarryxU64(x30, x389, x392)
  var x395 uint64
  var x396 uint1
  x395, x396 = addcarryxU64(x41, x391, 0x0)
  var x397 uint64
  x397, _ = addcarryxU64(x42, x393, x396)
  var x399 uint64
  var x400 uint1
  x399, x400 = addcarryxU64(x51, x395, 0x0)
  var x401 uint64
  x401, _ = addcarryxU64(x52, x397, x400)
  var x403 uint64
  var x404 uint1
  x403, x404 = addcarryxU64(x87, x399, 0x0)
  var x405 uint64
  x405, _ = addcarryxU64(x88, x401, x404)
  var x407 uint64
  var x408 uint1
  x407, x408 = addcarryxU64(x95, x403, 0x0)
  var x409 uint64
  x409, _ = addcarryxU64(x96, x405, x408)
  var x411 uint64
  var x412 uint1
  x411, x412 = addcarryxU64(x103, x407, 0x0)
  var x413 uint64
  x413, _ = addcarryxU64(x104, x409, x412)
  var x415 uint64
  var x416 uint1
  x415, x416 = addcarryxU64(x111, x411, 0x0)
  var x417 uint64
  x417, _ = addcarryxU64(x112, x413, x416)
  var x419 uint64
  var x420 uint1
  x419, x420 = addcarryxU64(x117, x415, 0x0)
  var x421 uint64
  x421, _ = addcarryxU64(x118, x417, x420)
  var x423 uint64
  var x424 uint1
  x423, x424 = addcarryxU64(x121, x419, 0x0)
  var x425 uint64
  x425, _ = addcarryxU64(x122, x421, x424)
  var x427 uint64
  var x428 uint1
  x427, x428 = addcarryxU64(x123, x423, 0x0)
  var x429 uint64
  x429, _ = addcarryxU64(x124, x425, x428)
  var x431 uint64
  var x432 uint1
  x431, x432 = addcarryxU64(x143, x427, 0x0)
  var x433 uint64
  x433, _ = addcarryxU64(x144, x429, x432)
  var x435 uint64
  var x436 uint1
  x435, x436 = addcarryxU64(x151, x431, 0x0)
  var x437 uint64
  x437, _ = addcarryxU64(x152, x433, x436)
  var x439 uint64
  var x440 uint1
  x439, x440 = addcarryxU64(x161, x435, 0x0)
  var x441 uint64
  x441, _ = addcarryxU64(x162, x437, x440)
  var x443 uint64
  var x444 uint1
  x443, x444 = addcarryxU64(x173, x439, 0x0)
  var x445 uint64
  x445, _ = addcarryxU64(x174, x441, x444)
  var x447 uint64
  var x448 uint1
  x447, x448 = addcarryxU64(x187, x443, 0x0)
  var x449 uint64
  x449, _ = addcarryxU64(x188, x445, x448)
  var x451 uint64
  var x452 uint1
  x451, x452 = addcarryxU64(x33, x1, 0x0)
  var x453 uint64
  x453, _ = addcarryxU64(x34, x2, x452)
  var x455 uint64
  var x456 uint1
  x455, x456 = addcarryxU64(x45, x451, 0x0)
  var x457 uint64
  x457, _ = addcarryxU64(x46, x453, x456)
  var x459 uint64
  var x460 uint1
  x459, x460 = addcarryxU64(x55, x455, 0x0)
  var x461 uint64
  x461, _ = addcarryxU64(x56, x457, x460)
  var x463 uint64
  var x464 uint1
  x463, x464 = addcarryxU64(x63, x459, 0x0)
  var x465 uint64
  x465, _ = addcarryxU64(x64, x461, x464)
  var x467 uint64
  var x468 uint1
  x467, x468 = addcarryxU64(x69, x463, 0x0)
  var x469 uint64
  x469, _ = addcarryxU64(x70, x465, x468)
  var x471 uint64
  var x472 uint1
  x471, x472 = addcarryxU64(x165, x467, 0x0)
  var x473 uint64
  x473, _ = addcarryxU64(x166, x469, x472)
  var x475 uint64
  var x476 uint1
  x475, x476 = addcarryxU64(x177, x471, 0x0)
  var x477 uint64
  x477, _ = addcarryxU64(x178, x473, x476)
  var x479 uint64
  var x480 uint1
  x479, x480 = addcarryxU64(x191, x475, 0x0)
  var x481 uint64
  x481, _ = addcarryxU64(x192, x477, x480)
  var x483 uint64
  var x484 uint1
  x483, x484 = addcarryxU64(x7, x3, 0x0)
  var x485 uint64
  x485, _ = addcarryxU64(x8, x4, x484)
  var x487 uint64
  var x488 uint1
  x487, x488 = addcarryxU64(x35, x483, 0x0)
  var x489 uint64
  x489, _ = addcarryxU64(x36, x485, x488)
  var x491 uint64
  var x492 uint1
  x491, x492 = addcarryxU64(x47, x487, 0x0)
  var x493 uint64
  x493, _ = addcarryxU64(x48, x489, x492)
  var x495 uint64
  var x496 uint1
  x495, x496 = addcarryxU64(x57, x491, 0x0)
  var x497 uint64
  x497, _ = addcarryxU64(x58, x493, x496)
  var x499 uint64
  var x500 uint1
  x499, x500 = addcarryxU64(x65, x495, 0x0)
  var x501 uint64
  x501, _ = addcarryxU64(x66, x497, x500)
  var x503 uint64
  var x504 uint1
  x503, x504 = addcarryxU64(x71, x499, 0x0)
  var x505 uint64
  x505, _ = addcarryxU64(x72, x501, x504)
  var x507 uint64
  var x508 uint1
  x507, x508 = addcarryxU64(x75, x503, 0x0)
  var x509 uint64
  x509, _ = addcarryxU64(x76, x505, x508)
  var x511 uint64
  var x512 uint1
  x511, x512 = addcarryxU64(x179, x507, 0x0)
  var x513 uint64
  x513, _ = addcarryxU64(x180, x509, x512)
  var x515 uint64
  var x516 uint1
  x515, x516 = addcarryxU64(x193, x511, 0x0)
  var x517 uint64
  x517, _ = addcarryxU64(x194, x513, x516)
  var x519 uint64
  var x520 uint1
  x519, x520 = addcarryxU64(x9, x5, 0x0)
  var x521 uint64
  x521, _ = addcarryxU64(x10, x6, x520)
  var x523 uint64
  var x524 uint1
  x523, x524 = addcarryxU64(x11, x519, 0x0)
  var x525 uint64
  x525, _ = addcarryxU64(x12, x521, x524)
  var x527 uint64
  var x528 uint1
  x527, x528 = addcarryxU64(x37, x523, 0x0)
  var x529 uint64
  x529, _ = addcarryxU64(x38, x525, x528)
  var x531 uint64
  var x532 uint1
  x531, x532 = addcarryxU64(x49, x527, 0x0)
  var x533 uint64
  x533, _ = addcarryxU64(x50, x529, x532)
  var x535 uint64
  var x536 uint1
  x535, x536 = addcarryxU64(x59, x531, 0x0)
  var x537 uint64
  x537, _ = addcarryxU64(x60, x533, x536)
  var x539 uint64
  var x540 uint1
  x539, x540 = addcarryxU64(x67, x535, 0x0)
  var x541 uint64
  x541, _ = addcarryxU64(x68, x537, x540)
  var x543 uint64
  var x544 uint1
  x543, x544 = addcarryxU64(x73, x539, 0x0)
  var x545 uint64
  x545, _ = addcarryxU64(x74, x541, x544)
  var x547 uint64
  var x548 uint1
  x547, x548 = addcarryxU64(x77, x543, 0x0)
  var x549 uint64
  x549, _ = addcarryxU64(x78, x545, x548)
  var x551 uint64
  var x552 uint1
  x551, x552 = addcarryxU64(x79, x547, 0x0)
  var x553 uint64
  x553, _ = addcarryxU64(x80, x549, x552)
  var x555 uint64
  var x556 uint1
  x555, x556 = addcarryxU64(x195, x551, 0x0)
  var x557 uint64
  x557, _ = addcarryxU64(x196, x553, x556)
  var x559 uint64
  var x560 uint1
  x559, x560 = addcarryxU64(x225, x447, 0x0)
  var x561 uint64 = (uint64(x560) + x449)
  var x562 uint64 = ((x267 >> 56) | ((x269 << 8) & 0xffffffffffffffff))
  var x563 uint64 = (x267 & 0xffffffffffffff)
  var x564 uint64
  var x565 uint1
  x564, x565 = addcarryxU64(x559, x562, 0x0)
  var x566 uint64 = (uint64(x565) + x561)
  var x567 uint64 = ((x564 >> 56) | ((x566 << 8) & 0xffffffffffffffff))
  var x568 uint64 = (x564 & 0xffffffffffffff)
  var x569 uint64
  var x570 uint1
  x569, x570 = addcarryxU64(x555, x562, 0x0)
  var x571 uint64 = (uint64(x570) + x557)
  var x572 uint64
  var x573 uint1
  x572, x573 = addcarryxU64(x567, x379, 0x0)
  var x574 uint64 = (uint64(x573) + x381)
  var x575 uint64 = ((x569 >> 56) | ((x571 << 8) & 0xffffffffffffffff))
  var x576 uint64 = (x569 & 0xffffffffffffff)
  var x577 uint64
  var x578 uint1
  x577, x578 = addcarryxU64(x575, x515, 0x0)
  var x579 uint64 = (uint64(x578) + x517)
  var x580 uint64 = ((x572 >> 56) | ((x574 << 8) & 0xffffffffffffffff))
  var x581 uint64 = (x572 & 0xffffffffffffff)
  var x582 uint64
  var x583 uint1
  x582, x583 = addcarryxU64(x580, x319, 0x0)
  var x584 uint64 = (uint64(x583) + x321)
  var x585 uint64 = ((x577 >> 56) | ((x579 << 8) & 0xffffffffffffffff))
  var x586 uint64 = (x577 & 0xffffffffffffff)
  var x587 uint64
  var x588 uint1
  x587, x588 = addcarryxU64(x585, x479, 0x0)
 ...
 */
/*inline*/
func CarrySquare(out1 *[8]uint64, arg1 *[8]uint64) {
  ...
  var x134 uint64
  var x135 uint1
  x134, x135 = addcarryxU64(x54, x46, 0x0)
  var x136 uint64
  x136, _ = addcarryxU64(x55, x47, x135)
  var x138 uint64
  var x139 uint1
  x138, x139 = addcarryxU64(x114, x134, 0x0)
  var x140 uint64
  x140, _ = addcarryxU64(x115, x136, x139)
  var x142 uint64
  var x143 uint1
  x142, x143 = addcarryxU64(x126, x138, 0x0)
  var x144 uint64
  x144, _ = addcarryxU64(x127, x140, x143)
  var x146 uint64 = ((x142 >> 56) | ((x144 << 8) & 0xffffffffffffffff))
  var x147 uint64 = (x142 & 0xffffffffffffff)
  var x148 uint64
  var x149 uint1
  x148, x149 = addcarryxU64(x56, x48, 0x0)
  var x150 uint64
  x150, _ = addcarryxU64(x57, x49, x149)
  var x152 uint64
  var x153 uint1
  x152, x153 = addcarryxU64(x82, x148, 0x0)
  var x154 uint64
  x154, _ = addcarryxU64(x83, x150, x153)
  var x156 uint64
  var x157 uint1
  x156, x157 = addcarryxU64(x94, x152, 0x0)
  var x158 uint64
  x158, _ = addcarryxU64(x95, x154, x157)
  var x160 uint64
  var x161 uint1
  x160, x161 = addcarryxU64(x106, x156, 0x0)
  var x162 uint64
  x162, _ = addcarryxU64(x107, x158, x161)
  var x164 uint64
  var x165 uint1
  x164, x165 = addcarryxU64(x118, x160, 0x0)
  var x166 uint64
  x166, _ = addcarryxU64(x119, x162, x165)
  var x168 uint64
  var x169 uint1
  x168, x169 = addcarryxU64(x38, x30, 0x0)
  var x170 uint64
  x170, _ = addcarryxU64(x39, x31, x169)
  var x172 uint64
  var x173 uint1
  x172, x173 = addcarryxU64(x52, x168, 0x0)
  var x174 uint64
  x174, _ = addcarryxU64(x53, x170, x173)
  var x176 uint64
  var x177 uint1
  x176, x177 = addcarryxU64(x60, x172, 0x0)
  var x178 uint64
  x178, _ = addcarryxU64(x61, x174, x177)
  var x180 uint64
  var x181 uint1
  x180, x181 = addcarryxU64(x72, x176, 0x0)
  var x182 uint64
  x182, _ = addcarryxU64(x73, x178, x181)
  var x184 uint64
  var x185 uint1
  x184, x185 = addcarryxU64(x84, x180, 0x0)
  var x186 uint64
  x186, _ = addcarryxU64(x85, x182, x185)
  var x188 uint64
  var x189 uint1
  x188, x189 = addcarryxU64(x96, x184, 0x0)
  var x190 uint64
  x190, _ = addcarryxU64(x97, x186, x189)
  var x192 uint64
  var x193 uint1
  x192, x193 = addcarryxU64(x108, x188, 0x0)
  var x194 uint64
  x194, _ = addcarryxU64(x109, x190, x193)
  var x196 uint64
  var x197 uint1
  x196, x197 = addcarryxU64(x120, x192, 0x0)
  var x198 uint64
  x198, _ = addcarryxU64(x121, x194, x197)
  var x200 uint64
  var x201 uint1
  x200, x201 = addcarryxU64(x40, x32, 0x0)
  var x202 uint64
  x202, _ = addcarryxU64(x41, x33, x201)
  var x204 uint64
  var x205 uint1
  x204, x205 = addcarryxU64(x64, x200, 0x0)
  var x206 uint64
  x206, _ = addcarryxU64(x65, x202, x205)
  var x208 uint64
  var x209 uint1
  x208, x209 = addcarryxU64(x76, x204, 0x0)
  var x210 uint64
  x210, _ = addcarryxU64(x77, x206, x209)
  var x212 uint64
  var x213 uint1
  x212, x213 = addcarryxU64(x88, x208, 0x0)
  var x214 uint64
  x214, _ = addcarryxU64(x89, x210, x213)
  var x216 uint64
  var x217 uint1
  x216, x217 = addcarryxU64(x98, x212, 0x0)
  var x218 uint64
  x218, _ = addcarryxU64(x99, x214, x217)
  var x220 uint64
  var x221 uint1
  x220, x221 = addcarryxU64(x110, x216, 0x0)
  var x222 uint64
  x222, _ = addcarryxU64(x111, x218, x221)
  var x224 uint64
  var x225 uint1
  x224, x225 = addcarryxU64(x122, x220, 0x0)
  var x226 uint64
  x226, _ = addcarryxU64(x123, x222, x225)
  var x228 uint64
  var x229 uint1
  x228, x229 = addcarryxU64(x36, x34, 0x0)
  var x230 uint64
  x230, _ = addcarryxU64(x37, x35, x229)
  var x232 uint64
  var x233 uint1
  x232, x233 = addcarryxU64(x42, x228, 0x0)
  var x234 uint64
  x234, _ = addcarryxU64(x43, x230, x233)
  var x236 uint64
  var x237 uint1
  x236, x237 = addcarryxU64(x44, x232, 0x0)
  var x238 uint64
  x238, _ = addcarryxU64(x45, x234, x237)
  var x240 uint64
  var x241 uint1
  x240, x241 = addcarryxU64(x68, x236, 0x0)
  var x242 uint64
  x242, _ = addcarryxU64(x69, x238, x241)
  var x244 uint64
  var x245 uint1
  x244, x245 = addcarryxU64(x80, x240, 0x0)
  var x246 uint64
  x246, _ = addcarryxU64(x81, x242, x245)
  var x248 uint64
  var x249 uint1
  x248, x249 = addcarryxU64(x92, x244, 0x0)
  var x250 uint64
  x250, _ = addcarryxU64(x93, x246, x249)
  var x252 uint64
  var x253 uint1
  x252, x253 = addcarryxU64(x100, x248, 0x0)
  var x254 uint64
  x254, _ = addcarryxU64(x101, x250, x253)
  var x256 uint64
  var x257 uint1
  x256, x257 = addcarryxU64(x104, x252, 0x0)
  var x258 uint64
  x258, _ = addcarryxU64(x105, x254, x257)
  var x260 uint64
  var x261 uint1
  x260, x261 = addcarryxU64(x112, x256, 0x0)
  var x262 uint64
  x262, _ = addcarryxU64(x113, x258, x261)
  var x264 uint64
  var x265 uint1
  x264, x265 = addcarryxU64(x124, x260, 0x0)
  var x266 uint64
  x266, _ = addcarryxU64(x125, x262, x265)
  var x268 uint64
  var x269 uint1
  x268, x269 = addcarryxU64(x50, x22, 0x0)
  var x270 uint64
  x270, _ = addcarryxU64(x51, x23, x269)
  var x272 uint64
  var x273 uint1
  x272, x273 = addcarryxU64(x58, x268, 0x0)
  var x274 uint64
  x274, _ = addcarryxU64(x59, x270, x273)
  var x276 uint64
  var x277 uint1
  x276, x277 = addcarryxU64(x70, x272, 0x0)
  var x278 uint64
  x278, _ = addcarryxU64(x71, x274, x277)
  var x280 uint64
  var x281 uint1
  x280, x281 = addcarryxU64(x116, x276, 0x0)
  var x282 uint64
  x282, _ = addcarryxU64(x117, x278, x281)
  var x284 uint64
  var x285 uint1
  x284, x285 = addcarryxU64(x128, x280, 0x0)
  var x286 uint64
  x286, _ = addcarryxU64(x129, x282, x285)
  var x288 uint64
  var x289 uint1
  x288, x289 = addcarryxU64(x62, x24, 0x0)
  var x290 uint64
  x290, _ = addcarryxU64(x63, x25, x289)
  var x292 uint64
  var x293 uint1
  x292, x293 = addcarryxU64(x74, x288, 0x0)
  var x294 uint64
  x294, _ = addcarryxU64(x75, x290, x293)
  var x296 uint64
  var x297 uint1
  x296, x297 = addcarryxU64(x86, x292, 0x0)
  var x298 uint64
  x298, _ = addcarryxU64(x87, x294, x297)
  var x300 uint64
  var x301 uint1
  x300, x301 = addcarryxU64(x130, x296, 0x0)
  var x302 uint64
  x302, _ = addcarryxU64(x131, x298, x301)
  var x304 uint64
  var x305 uint1
  x304, x305 = addcarryxU64(x28, x26, 0x0)
  var x306 uint64
  x306, _ = addcarryxU64(x29, x27, x305)
  var x308 uint64
  var x309 uint1
  x308, x309 = addcarryxU64(x66, x304, 0x0)
  var x310 uint64
  x310, _ = addcarryxU64(x67, x306, x309)
  var x312 uint64
  var x313 uint1
  x312, x313 = addcarryxU64(x78, x308, 0x0)
  var x314 uint64
  x314, _ = addcarryxU64(x79, x310, x313)
  var x316 uint64
  var x317 uint1
  x316, x317 = addcarryxU64(x90, x312, 0x0)
  var x318 uint64
  x318, _ = addcarryxU64(x91, x314, x317)
  var x320 uint64
  var x321 uint1
  x320, x321 = addcarryxU64(x102, x316, 0x0)
  var x322 uint64
  x322, _ = addcarryxU64(x103, x318, x321)
  var x324 uint64
  var x325 uint1
  x324, x325 = addcarryxU64(x132, x320, 0x0)
  var x326 uint64
  x326, _ = addcarryxU64(x133, x322, x325)
  var x328 uint64
  var x329 uint1
  x328, x329 = addcarryxU64(x146, x264, 0x0)
  var x330 uint64 = (uint64(x329) + x266)
  var x331 uint64 = ((x164 >> 56) | ((x166 << 8) & 0xffffffffffffffff))
  var x332 uint64 = (x164 & 0xffffffffffffff)
  var x333 uint64
  var x334 uint1
  x333, x334 = addcarryxU64(x328, x331, 0x0)
  var x335 uint64 = (uint64(x334) + x330)
  var x336 uint64 = ((x333 >> 56) | ((x335 << 8) & 0xffffffffffffffff))
  var x337 uint64 = (x333 & 0xffffffffffffff)
  var x338 uint64
  var x339 uint1
  x338, x339 = addcarryxU64(x324, x331, 0x0)
  var x340 uint64 = (uint64(x339) + x326)
  var x341 uint64
  var x342 uint1
  x341, x342 = addcarryxU64(x336, x224, 0x0)
  var x343 uint64 = (uint64(x342) + x226)
  var x344 uint64 = ((x338 >> 56) | ((x340 << 8) & 0xffffffffffffffff))
  var x345 uint64 = (x338 & 0xffffffffffffff)
  var x346 uint64
  var x347 uint1
  x346, x347 = addcarryxU64(x344, x300, 0x0)
  var x348 uint64 = (uint64(x347) + x302)
  var x349 uint64 = ((x341 >> 56) | ((x343 << 8) & 0xffffffffffffffff))
  var x350 uint64 = (x341 & 0xffffffffffffff)
  var x351 uint64
  var x352 uint1
  x351, x352 = addcarryxU64(x349, x196, 0x0)
  var x353 uint64 = (uint64(x352) + x198)
  var x354 uint64 = ((x346 >> 56) | ((x348 << 8) & 0xffffffffffffffff))
  var x355 uint64 = (x346 & 0xffffffffffffff)
  var x356 uint64
  var x357 uint1
  x356, x357 = addcarryxU64(x354, x284, 0x0)
 ...
 */
/*inline*/
func Carry(out1 *[8]uint64, arg1 *[8]uint64) {
  ...
  var x12 uint1 = uint1((x10 >> 56))
  var x13 uint64 = ((x5 & 0xffffffffffffff) + uint64(x12))
  var x14 uint64 = (uint64(uint1((x11 >> 56))) + ((x4 & 0xffffffffffffff) + uint64(x12)))
  var x15 uint64 = (x13 & 0xffffffffffffff)
  var x16 uint64 = (uint64(uint1((x13 >> 56))) + (x7 & 0xffffffffffffff))
  var x17 uint64 = (x9 & 0xffffffffffffff)
  var x18 uint64 = (x11 & 0xffffffffffffff)
  var x19 uint64 = (x14 & 0xffffffffffffff)
  var x20 uint64 = (uint64(uint1((x14 >> 56))) + (x6 & 0xffffffffffffff))
 ...
 */
/*inline*/
func Add(out1 *[8]uint64, arg1 *[8]uint64, arg2 *[8]uint64) {
 ...
 */
/*inline*/
func Sub(out1 *[8]uint64, arg1 *[8]uint64, arg2 *[8]uint64) {
 ...
 */
/*inline*/
func Opp(out1 *[8]uint64, arg1 *[8]uint64) {
 ...
 */
/*inline*/
func ToBytes(out1 *[56]uint8, arg1 *[8]uint64) {
  var x1 uint64
  var x2 uint1
 ...
 */
/*inline*/
func FromBytes(out1 *[8]uint64, arg1 *[56]uint8) {
