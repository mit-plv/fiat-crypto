/* Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Go --no-wide-int --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --package-name fiat25519 '' 64 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes carry_scmul121666 */
/* curve description (via package name): fiat25519 */
...
func CarryMul(out1 *[5]uint64, arg1 *[5]uint64, arg2 *[5]uint64) {
  ...
  var x55 uint64
  var x56 uint1
  x55, x56 = addcarryxU64(x17, x51, 0x0)
  var x57 uint64
  x57, _ = addcarryxU64(x18, x53, x56)
  var x59 uint64
  var x60 uint1
  x59, x60 = addcarryxU64(x19, x55, 0x0)
  var x61 uint64
  x61, _ = addcarryxU64(x20, x57, x60)
  var x63 uint64
  var x64 uint1
  x63, x64 = addcarryxU64(x49, x59, 0x0)
  var x65 uint64
  x65, _ = addcarryxU64(x50, x61, x64)
  var x67 uint64 = ((x63 >> 51) | ((x65 << 13) & 0xffffffffffffffff))
  var x68 uint64 = (x63 & 0x7ffffffffffff)
  var x69 uint64
  var x70 uint1
  x69, x70 = addcarryxU64(x23, x21, 0x0)
  var x71 uint64
  x71, _ = addcarryxU64(x24, x22, x70)
  var x73 uint64
  var x74 uint1
  x73, x74 = addcarryxU64(x27, x69, 0x0)
  var x75 uint64
  x75, _ = addcarryxU64(x28, x71, x74)
  var x77 uint64
  var x78 uint1
  x77, x78 = addcarryxU64(x33, x73, 0x0)
  var x79 uint64
  x79, _ = addcarryxU64(x34, x75, x78)
  var x81 uint64
  var x82 uint1
  x81, x82 = addcarryxU64(x41, x77, 0x0)
  var x83 uint64
  x83, _ = addcarryxU64(x42, x79, x82)
  var x85 uint64
  var x86 uint1
  x85, x86 = addcarryxU64(x25, x1, 0x0)
  var x87 uint64
  x87, _ = addcarryxU64(x26, x2, x86)
  var x89 uint64
  var x90 uint1
  x89, x90 = addcarryxU64(x29, x85, 0x0)
  var x91 uint64
  x91, _ = addcarryxU64(x30, x87, x90)
  var x93 uint64
  var x94 uint1
  x93, x94 = addcarryxU64(x35, x89, 0x0)
  var x95 uint64
  x95, _ = addcarryxU64(x36, x91, x94)
  var x97 uint64
  var x98 uint1
  x97, x98 = addcarryxU64(x43, x93, 0x0)
  var x99 uint64
  x99, _ = addcarryxU64(x44, x95, x98)
  var x101 uint64
  var x102 uint1
  x101, x102 = addcarryxU64(x9, x3, 0x0)
  var x103 uint64
  x103, _ = addcarryxU64(x10, x4, x102)
  var x105 uint64
  var x106 uint1
  x105, x106 = addcarryxU64(x31, x101, 0x0)
  var x107 uint64
  x107, _ = addcarryxU64(x32, x103, x106)
  var x109 uint64
  var x110 uint1
  x109, x110 = addcarryxU64(x37, x105, 0x0)
  var x111 uint64
  x111, _ = addcarryxU64(x38, x107, x110)
  var x113 uint64
  var x114 uint1
  x113, x114 = addcarryxU64(x45, x109, 0x0)
  var x115 uint64
  x115, _ = addcarryxU64(x46, x111, x114)
  var x117 uint64
  var x118 uint1
  x117, x118 = addcarryxU64(x11, x5, 0x0)
  var x119 uint64
  x119, _ = addcarryxU64(x12, x6, x118)
  var x121 uint64
  var x122 uint1
  x121, x122 = addcarryxU64(x15, x117, 0x0)
  var x123 uint64
  x123, _ = addcarryxU64(x16, x119, x122)
  var x125 uint64
  var x126 uint1
  x125, x126 = addcarryxU64(x39, x121, 0x0)
  var x127 uint64
  x127, _ = addcarryxU64(x40, x123, x126)
  var x129 uint64
  var x130 uint1
  x129, x130 = addcarryxU64(x47, x125, 0x0)
  var x131 uint64
  x131, _ = addcarryxU64(x48, x127, x130)
  var x133 uint64
  var x134 uint1
  x133, x134 = addcarryxU64(x67, x129, 0x0)
  var x135 uint64 = (uint64(x134) + x131)
  var x136 uint64 = ((x133 >> 51) | ((x135 << 13) & 0xffffffffffffffff))
  var x137 uint64 = (x133 & 0x7ffffffffffff)
  var x138 uint64
  var x139 uint1
  x138, x139 = addcarryxU64(x136, x113, 0x0)
  var x140 uint64 = (uint64(x139) + x115)
  var x141 uint64 = ((x138 >> 51) | ((x140 << 13) & 0xffffffffffffffff))
  var x142 uint64 = (x138 & 0x7ffffffffffff)
  var x143 uint64
  var x144 uint1
  x143, x144 = addcarryxU64(x141, x97, 0x0)
  var x145 uint64 = (uint64(x144) + x99)
  var x146 uint64 = ((x143 >> 51) | ((x145 << 13) & 0xffffffffffffffff))
  var x147 uint64 = (x143 & 0x7ffffffffffff)
  var x148 uint64
  var x149 uint1
  x148, x149 = addcarryxU64(x146, x81, 0x0)
...
func CarrySquare(out1 *[5]uint64, arg1 *[5]uint64) {
  ...
  var x39 uint64
  var x40 uint1
  x39, x40 = addcarryxU64(x21, x17, 0x0)
  var x41 uint64
  x41, _ = addcarryxU64(x22, x18, x40)
  var x43 uint64
  var x44 uint1
  x43, x44 = addcarryxU64(x37, x39, 0x0)
  var x45 uint64
  x45, _ = addcarryxU64(x38, x41, x44)
  var x47 uint64 = ((x43 >> 51) | ((x45 << 13) & 0xffffffffffffffff))
  var x48 uint64 = (x43 & 0x7ffffffffffff)
  var x49 uint64
  var x50 uint1
  x49, x50 = addcarryxU64(x23, x19, 0x0)
  var x51 uint64
  x51, _ = addcarryxU64(x24, x20, x50)
  var x53 uint64
  var x54 uint1
  x53, x54 = addcarryxU64(x29, x49, 0x0)
  var x55 uint64
  x55, _ = addcarryxU64(x30, x51, x54)
  var x57 uint64
  var x58 uint1
  x57, x58 = addcarryxU64(x25, x9, 0x0)
  var x59 uint64
  x59, _ = addcarryxU64(x26, x10, x58)
  var x61 uint64
  var x62 uint1
  x61, x62 = addcarryxU64(x31, x57, 0x0)
  var x63 uint64
  x63, _ = addcarryxU64(x32, x59, x62)
  var x65 uint64
  var x66 uint1
  x65, x66 = addcarryxU64(x27, x11, 0x0)
  var x67 uint64
  x67, _ = addcarryxU64(x28, x12, x66)
  var x69 uint64
  var x70 uint1
  x69, x70 = addcarryxU64(x33, x65, 0x0)
  var x71 uint64
  x71, _ = addcarryxU64(x34, x67, x70)
  var x73 uint64
  var x74 uint1
  x73, x74 = addcarryxU64(x15, x13, 0x0)
  var x75 uint64
  x75, _ = addcarryxU64(x16, x14, x74)
  var x77 uint64
  var x78 uint1
  x77, x78 = addcarryxU64(x35, x73, 0x0)
  var x79 uint64
  x79, _ = addcarryxU64(x36, x75, x78)
  var x81 uint64
  var x82 uint1
  x81, x82 = addcarryxU64(x47, x77, 0x0)
  var x83 uint64 = (uint64(x82) + x79)
  var x84 uint64 = ((x81 >> 51) | ((x83 << 13) & 0xffffffffffffffff))
  var x85 uint64 = (x81 & 0x7ffffffffffff)
  var x86 uint64
  var x87 uint1
  x86, x87 = addcarryxU64(x84, x69, 0x0)
  var x88 uint64 = (uint64(x87) + x71)
  var x89 uint64 = ((x86 >> 51) | ((x88 << 13) & 0xffffffffffffffff))
  var x90 uint64 = (x86 & 0x7ffffffffffff)
  var x91 uint64
  var x92 uint1
  x91, x92 = addcarryxU64(x89, x61, 0x0)
  var x93 uint64 = (uint64(x92) + x63)
  var x94 uint64 = ((x91 >> 51) | ((x93 << 13) & 0xffffffffffffffff))
  var x95 uint64 = (x91 & 0x7ffffffffffff)
  var x96 uint64
  var x97 uint1
  x96, x97 = addcarryxU64(x94, x53, 0x0)
...
func Carry(out1 *[5]uint64, arg1 *[5]uint64) {
  ...
  var x7 uint64 = (uint64(uint1((x6 >> 51))) + (x2 & 0x7ffffffffffff))
  var x8 uint64 = (x6 & 0x7ffffffffffff)
  var x9 uint64 = (x7 & 0x7ffffffffffff)
  var x10 uint64 = (uint64(uint1((x7 >> 51))) + (x3 & 0x7ffffffffffff))
