/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --lang=Go --no-wide-int --cmovznz-by-mul --widen-carry --widen-bytes p256 '2^256 - 2^224 + 2^192 + 2^96 - 1' 64 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
...
func fiat_p256_to_montgomery(out1 *[4]uint64, arg1 *[4]uint64) {
  ...
  var x5 uint64
  var x6 uint64
  x5, x6 = bits.Mul64(x4, 0x4fffffffd)
  var x7 uint64
  var x8 uint64
  x7, x8 = bits.Mul64(x4, 0xfffffffffffffffe)
  var x9 uint64
  var x10 uint64
  x9, x10 = bits.Mul64(x4, 0xfffffffbffffffff)
  var x11 uint64
  var x12 uint64
  x11, x12 = bits.Mul64(x4, 0x3)
  var x13 uint64
  var x14 uint64
  x13, x14 = bits.Add64(x12, x9, 0x0)
  var x15 uint64
  ...
  var x19 uint64
  var x20 uint64
  x19, x20 = bits.Mul64(x11, 0xffffffff00000001)
  var x21 uint64
  var x22 uint64
  x21, x22 = bits.Mul64(x11, 0xffffffff)
  var x23 uint64
  var x24 uint64
  x23, x24 = bits.Mul64(x11, 0xffffffffffffffff)
  var x25 uint64
  var x26 uint64
  x25, x26 = bits.Add64(x24, x21, 0x0)
  var x28 uint64
  _, x28 = bits.Add64(x11, x23, 0x0)
  var x29 uint64
  var x30 uint64
  x29, x30 = bits.Add64(x13, x25, x28)
  var x31 uint64
  var x32 uint64
  x31, x32 = bits.Add64(x15, (x26 + x22), x30)
  var x33 uint64
  var x34 uint64
  x33, x34 = bits.Add64(x17, x19, x32)
  var x35 uint64
  var x36 uint64
  x35, x36 = bits.Add64((x18 + x6), x20, x34)
  var x37 uint64
  var x38 uint64
  x37, x38 = bits.Mul64(x1, 0x4fffffffd)
  var x39 uint64
  var x40 uint64
  x39, x40 = bits.Mul64(x1, 0xfffffffffffffffe)
  var x41 uint64
  var x42 uint64
  x41, x42 = bits.Mul64(x1, 0xfffffffbffffffff)
  var x43 uint64
  var x44 uint64
  x43, x44 = bits.Mul64(x1, 0x3)
  var x45 uint64
  var x46 uint64
  ...
  var x51 uint64
  var x52 uint64
  x51, x52 = bits.Add64(x29, x43, 0x0)
  var x53 uint64
  var x54 uint64
  x53, x54 = bits.Add64(x31, x45, x52)
  var x55 uint64
  var x56 uint64
  x55, x56 = bits.Add64(x33, x47, x54)
  var x57 uint64
  var x58 uint64
  x57, x58 = bits.Add64(x35, x49, x56)
  var x59 uint64
  var x60 uint64
  x59, x60 = bits.Mul64(x51, 0xffffffff00000001)
  var x61 uint64
  var x62 uint64
  x61, x62 = bits.Mul64(x51, 0xffffffff)
  var x63 uint64
  var x64 uint64
  x63, x64 = bits.Mul64(x51, 0xffffffffffffffff)
  var x65 uint64
  var x66 uint64
  x65, x66 = bits.Add64(x64, x61, 0x0)
  var x68 uint64
  _, x68 = bits.Add64(x51, x63, 0x0)
  var x69 uint64
  var x70 uint64
  x69, x70 = bits.Add64(x53, x65, x68)
  var x71 uint64
  var x72 uint64
  x71, x72 = bits.Add64(x55, (x66 + x62), x70)
  var x73 uint64
  var x74 uint64
  x73, x74 = bits.Add64(x57, x59, x72)
  var x75 uint64
  var x76 uint64
  x75, x76 = bits.Add64(((x58 + x36) + (x50 + x38)), x60, x74)
  var x77 uint64
  var x78 uint64
  x77, x78 = bits.Mul64(x2, 0x4fffffffd)
  var x79 uint64
  var x80 uint64
  x79, x80 = bits.Mul64(x2, 0xfffffffffffffffe)
  var x81 uint64
  var x82 uint64
  x81, x82 = bits.Mul64(x2, 0xfffffffbffffffff)
  var x83 uint64
  var x84 uint64
  x83, x84 = bits.Mul64(x2, 0x3)
  var x85 uint64
  var x86 uint64
  ...
  var x91 uint64
  var x92 uint64
  x91, x92 = bits.Add64(x69, x83, 0x0)
  var x93 uint64
  var x94 uint64
  x93, x94 = bits.Add64(x71, x85, x92)
  var x95 uint64
  var x96 uint64
  x95, x96 = bits.Add64(x73, x87, x94)
  var x97 uint64
  var x98 uint64
  x97, x98 = bits.Add64(x75, x89, x96)
  var x99 uint64
  var x100 uint64
  x99, x100 = bits.Mul64(x91, 0xffffffff00000001)
  var x101 uint64
  var x102 uint64
  x101, x102 = bits.Mul64(x91, 0xffffffff)
  var x103 uint64
  var x104 uint64
  x103, x104 = bits.Mul64(x91, 0xffffffffffffffff)
  var x105 uint64
  var x106 uint64
  x105, x106 = bits.Add64(x104, x101, 0x0)
  var x108 uint64
  _, x108 = bits.Add64(x91, x103, 0x0)
  var x109 uint64
  var x110 uint64
  x109, x110 = bits.Add64(x93, x105, x108)
  var x111 uint64
  var x112 uint64
  x111, x112 = bits.Add64(x95, (x106 + x102), x110)
  var x113 uint64
  var x114 uint64
  x113, x114 = bits.Add64(x97, x99, x112)
  var x115 uint64
  var x116 uint64
  x115, x116 = bits.Add64(((x98 + x76) + (x90 + x78)), x100, x114)
  var x117 uint64
  var x118 uint64
  x117, x118 = bits.Mul64(x3, 0x4fffffffd)
  var x119 uint64
  var x120 uint64
  x119, x120 = bits.Mul64(x3, 0xfffffffffffffffe)
  var x121 uint64
  var x122 uint64
  x121, x122 = bits.Mul64(x3, 0xfffffffbffffffff)
  var x123 uint64
  var x124 uint64
  x123, x124 = bits.Mul64(x3, 0x3)
  var x125 uint64
  var x126 uint64
  ...
  var x131 uint64
  var x132 uint64
  x131, x132 = bits.Add64(x109, x123, 0x0)
  var x133 uint64
  var x134 uint64
  x133, x134 = bits.Add64(x111, x125, x132)
  var x135 uint64
  var x136 uint64
  x135, x136 = bits.Add64(x113, x127, x134)
  var x137 uint64
  var x138 uint64
  x137, x138 = bits.Add64(x115, x129, x136)
  var x139 uint64
  var x140 uint64
  x139, x140 = bits.Mul64(x131, 0xffffffff00000001)
  var x141 uint64
  var x142 uint64
  x141, x142 = bits.Mul64(x131, 0xffffffff)
  var x143 uint64
  var x144 uint64
  x143, x144 = bits.Mul64(x131, 0xffffffffffffffff)
  var x145 uint64
  var x146 uint64
  x145, x146 = bits.Add64(x144, x141, 0x0)
  var x148 uint64
  _, x148 = bits.Add64(x131, x143, 0x0)
  var x149 uint64
  var x150 uint64
  x149, x150 = bits.Add64(x133, x145, x148)
  var x151 uint64
  var x152 uint64
  x151, x152 = bits.Add64(x135, (x146 + x142), x150)
  var x153 uint64
  var x154 uint64
  x153, x154 = bits.Add64(x137, x139, x152)
  var x155 uint64
  var x156 uint64
  x155, x156 = bits.Add64(((x138 + x116) + (x130 + x118)), x140, x154)
  var x157 uint64
  var x158 uint64
  x157, x158 = bits.Sub64(x149, 0xffffffffffffffff, uint64(0x0))
  var x159 uint64
  var x160 uint64
  x159, x160 = bits.Sub64(x151, 0xffffffff, x158)
  var x161 uint64
  var x162 uint64
  x161, x162 = bits.Sub64(x153, uint64(0x0), x160)
  var x163 uint64
  var x164 uint64
  x163, x164 = bits.Sub64(x155, 0xffffffff00000001, x162)
  var x166 uint64
  _, x166 = bits.Sub64(x156, uint64(0x0), x164)
  var x167 uint64
