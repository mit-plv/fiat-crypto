/* Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Go --no-wide-int --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --package-name fiatpoly1305 '' 64 3 '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
/* curve description (via package name): fiatpoly1305 */
 ...
 */
/*inline*/
func CarryMul(out1 *[3]uint64, arg1 *[3]uint64, arg2 *[3]uint64) {
  var x1 uint64
  var x2 uint64
  ...
  var x19 uint64
  var x20 uint1
  x19, x20 = addcarryxU64(x5, x3, 0x0)
  var x21 uint64
  x21, _ = addcarryxU64(x6, x4, x20)
  var x23 uint64
  var x24 uint1
  x23, x24 = addcarryxU64(x17, x19, 0x0)
  var x25 uint64
  x25, _ = addcarryxU64(x18, x21, x24)
  var x27 uint64 = ((x23 >> 44) | ((x25 << 20) & 0xffffffffffffffff))
  var x28 uint64 = (x23 & 0xfffffffffff)
  var x29 uint64
  var x30 uint1
  x29, x30 = addcarryxU64(x9, x7, 0x0)
  var x31 uint64
  x31, _ = addcarryxU64(x10, x8, x30)
  var x33 uint64
  var x34 uint1
  x33, x34 = addcarryxU64(x13, x29, 0x0)
  var x35 uint64
  x35, _ = addcarryxU64(x14, x31, x34)
  var x37 uint64
  var x38 uint1
  x37, x38 = addcarryxU64(x11, x1, 0x0)
  var x39 uint64
  x39, _ = addcarryxU64(x12, x2, x38)
  var x41 uint64
  var x42 uint1
  x41, x42 = addcarryxU64(x15, x37, 0x0)
  var x43 uint64
  x43, _ = addcarryxU64(x16, x39, x42)
  var x45 uint64
  var x46 uint1
  x45, x46 = addcarryxU64(x27, x41, 0x0)
  var x47 uint64 = (uint64(x46) + x43)
  var x48 uint64 = ((x45 >> 43) | ((x47 << 21) & 0xffffffffffffffff))
  var x49 uint64 = (x45 & 0x7ffffffffff)
  var x50 uint64
  var x51 uint1
  x50, x51 = addcarryxU64(x48, x33, 0x0)
 ...
 */
/*inline*/
func CarrySquare(out1 *[3]uint64, arg1 *[3]uint64) {
  ...
  var x17 uint64
  var x18 uint1
  x17, x18 = addcarryxU64(x15, x7, 0x0)
  var x19 uint64
  x19, _ = addcarryxU64(x16, x8, x18)
  var x21 uint64 = ((x17 >> 44) | ((x19 << 20) & 0xffffffffffffffff))
  var x22 uint64 = (x17 & 0xfffffffffff)
  var x23 uint64
  var x24 uint1
  x23, x24 = addcarryxU64(x11, x9, 0x0)
  var x25 uint64
  x25, _ = addcarryxU64(x12, x10, x24)
  var x27 uint64
  var x28 uint1
  x27, x28 = addcarryxU64(x13, x5, 0x0)
  var x29 uint64
  x29, _ = addcarryxU64(x14, x6, x28)
  var x31 uint64
  var x32 uint1
  x31, x32 = addcarryxU64(x21, x27, 0x0)
  var x33 uint64 = (uint64(x32) + x29)
  var x34 uint64 = ((x31 >> 43) | ((x33 << 21) & 0xffffffffffffffff))
  var x35 uint64 = (x31 & 0x7ffffffffff)
  var x36 uint64
  var x37 uint1
  x36, x37 = addcarryxU64(x34, x23, 0x0)
 ...
 */
/*inline*/
func Add(out1 *[3]uint64, arg1 *[3]uint64, arg2 *[3]uint64) {
 ...
 */
/*inline*/
func Sub(out1 *[3]uint64, arg1 *[3]uint64, arg2 *[3]uint64) {
 ...
 */
/*inline*/
func Opp(out1 *[3]uint64, arg1 *[3]uint64) {
 ...
 */
/*inline*/
func ToBytes(out1 *[17]uint8, arg1 *[3]uint64) {
  var x1 uint64
  var x2 uint1
 ...
 */
/*inline*/
func FromBytes(out1 *[3]uint64, arg1 *[17]uint8) {
