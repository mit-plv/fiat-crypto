...
func fiat_poly1305_to_bytes(out1 *[17]uint8, arg1 *[3]uint64) {
  ...
  var x26 uint64 = (uint64(x24) + x15)
  var x27 uint64 = (x26 >> 8)
  var x28 uint8 = (uint8(x26) & 0xff)
  ...
  var x37 uint64 = (uint64(x35) + x14)
  var x38 uint64 = (x37 >> 8)
  var x39 uint8 = (uint8(x37) & 0xff)
...
func fiat_poly1305_from_bytes(out1 *[3]uint64, arg1 *[17]uint8) {
  ...
  var x18 uint64 = (uint64(x17) + (x16 + (x15 + (x14 + (x13 + x12)))))
  var x19 uint8 = uint8((x18 >> 44))
  var x20 uint64 = (x18 & 0xfffffffffff)
  var x21 uint64 = (x6 + (x5 + (x4 + (x3 + (x2 + x1)))))
  var x22 uint64 = (x11 + (x10 + (x9 + (x8 + x7))))
  var x23 uint64 = (uint64(x19) + x22)
  var x24 fiat_poly1305_uint1 = fiat_poly1305_uint1((x23 >> 43))
  var x25 uint64 = (x23 & 0x7ffffffffff)
  var x26 uint64 = (uint64(x24) + x21)
  out1[0] = x20
  out1[1] = x25
  out1[2] = x26
}
