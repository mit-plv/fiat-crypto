/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang Go --cmovznz-by-mul --widen-carry poly1305 32 '(auto)' '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
 ...
 */
/*inline*/
func fiat_poly1305_addcarryx_u26(out1 *uint32, out2 *uint8, arg1 uint8, arg2 uint32, arg3 uint32) {
 ...
 */
/*inline*/
func fiat_poly1305_subborrowx_u26(out1 *uint32, out2 *uint8, arg1 uint8, arg2 uint32, arg3 uint32) {
 ...
 */
/*inline*/
func fiat_poly1305_cmovznz_u32(out1 *uint32, arg1 uint8, arg2 uint32, arg3 uint32) {
 ...
 */
/*inline*/
func fiat_poly1305_selectznz(out1 *[5]uint32, arg1 uint8, arg2 *[5]uint32, arg3 *[5]uint32) {
  var x1 uint32
...
func fiat_poly1305_to_bytes(out1 *[17]uint8, arg1 *[5]uint32) {
  var x1 uint32
  var x2 uint8
  fiat_poly1305_subborrowx_u26(&x1, &x2, uint8(0x0), (arg1[0]), 0x3fffffb)
  var x3 uint32
  var x4 uint8
  ...
  var x45 uint32 = (uint32(x43) + x22)
  var x46 uint32 = (x45 >> 8)
  var x47 uint8 = (uint8(x45) & 0xff)
...
func fiat_poly1305_from_bytes(out1 *[5]uint32, arg1 *[17]uint8) {
  ...
  var x18 uint32 = (uint32(x17) + (x16 + (x15 + x14)))
  var x19 uint8 = uint8((x18 >> 26))
  var x20 uint32 = (x18 & 0x3ffffff)
  var x21 uint32 = (uint32(x4) + (x3 + (x2 + x1)))
  var x22 uint32 = (x7 + (x6 + x5))
  var x23 uint32 = (x10 + (x9 + x8))
  var x24 uint32 = (x13 + (x12 + x11))
  var x25 uint32 = (uint32(x19) + x24)
  var x26 uint8 = uint8((x25 >> 26))
  var x27 uint32 = (x25 & 0x3ffffff)
  var x28 uint32 = (uint32(x26) + x23)
  var x29 uint8 = uint8((x28 >> 26))
  var x30 uint32 = (x28 & 0x3ffffff)
  var x31 uint32 = (uint32(x29) + x22)
