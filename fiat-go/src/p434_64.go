/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --lang Go --no-wide-int --cmovznz-by-mul --widen-carry p434 64 '2^216 * 3^137 - 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
 ...
 */
/*inline*/
func fiat_p434_cmovznz_u64(out1 *uint64, arg1 uint8, arg2 uint64, arg3 uint64) {
 ...
 */
/*inline*/
func fiat_p434_selectznz(out1 *[7]uint64, arg1 uint8, arg2 *[7]uint64, arg3 *[7]uint64) {
  var x1 uint64
 ...
 */
/*inline*/
func fiat_p434_to_bytes(out1 *[56]uint8, arg1 *[7]uint64) {
  ...
  var x15 uint8 = (uint8(x12) & 0xff)
  var x16 uint64 = (x14 >> 8)
  var x17 uint8 = (uint8(x14) & 0xff)
  ...
  var x36 uint8 = (uint8(x33) & 0xff)
  var x37 uint8 = (x35 & 0xff)
  var x38 uint64 = (x5 >> 8)
  var x39 uint8 = (uint8(x5) & 0xff)
  var x40 uint64 = (x38 >> 8)
  var x41 uint8 = (uint8(x38) & 0xff)
  var x42 uint64 = (x40 >> 8)
  var x43 uint8 = (uint8(x40) & 0xff)
  var x44 uint64 = (x42 >> 8)
  var x45 uint8 = (uint8(x42) & 0xff)
  ...
  var x52 uint8 = (x50 & 0xff)
  var x53 uint64 = (x4 >> 8)
  var x54 uint8 = (uint8(x4) & 0xff)
  ...
  var x62 uint8 = (uint8(x59) & 0xff)
  var x63 uint64 = (x61 >> 8)
  var x64 uint8 = (uint8(x61) & 0xff)
  var x65 uint8 = uint8((x63 >> 8))
  var x66 uint8 = (uint8(x63) & 0xff)
  var x67 uint8 = (x65 & 0xff)
  var x68 uint64 = (x3 >> 8)
  var x69 uint8 = (uint8(x3) & 0xff)
  var x70 uint64 = (x68 >> 8)
  var x71 uint8 = (uint8(x68) & 0xff)
  var x72 uint64 = (x70 >> 8)
  var x73 uint8 = (uint8(x70) & 0xff)
  var x74 uint64 = (x72 >> 8)
  var x75 uint8 = (uint8(x72) & 0xff)
  var x76 uint64 = (x74 >> 8)
  var x77 uint8 = (uint8(x74) & 0xff)
  ...
  var x90 uint8 = (uint8(x87) & 0xff)
  var x91 uint64 = (x89 >> 8)
  var x92 uint8 = (uint8(x89) & 0xff)
  var x93 uint64 = (x91 >> 8)
  var x94 uint8 = (uint8(x91) & 0xff)
  var x95 uint8 = uint8((x93 >> 8))
  var x96 uint8 = (uint8(x93) & 0xff)
  var x97 uint8 = (x95 & 0xff)
  var x98 uint64 = (x1 >> 8)
  var x99 uint8 = (uint8(x1) & 0xff)
  var x100 uint64 = (x98 >> 8)
  var x101 uint8 = (uint8(x98) & 0xff)
  var x102 uint64 = (x100 >> 8)
  var x103 uint8 = (uint8(x100) & 0xff)
  var x104 uint64 = (x102 >> 8)
  var x105 uint8 = (uint8(x102) & 0xff)
  var x106 uint64 = (x104 >> 8)
  var x107 uint8 = (uint8(x104) & 0xff)
  var x108 uint8 = uint8((x106 >> 8))
  var x109 uint8 = (uint8(x106) & 0xff)
  var x110 uint8 = (x108 & 0xff)
  out1[0] = x9
  out1[1] = x11
  out1[2] = x13
  out1[3] = x15
 ...
 */
/*inline*/
func fiat_p434_from_bytes(out1 *[7]uint64, arg1 *[56]uint8) {
  ...
  var x56 uint64 = (uint64(x55) + (x54 + (x53 + (x52 + (x51 + (x50 + (x49 + x48)))))))
  var x57 uint64 = (x56 & 0xffffffffffffffff)
  var x58 uint64 = (uint64(x7) + (x6 + (x5 + (x4 + (x3 + (x2 + x1))))))
  var x59 uint64 = (uint64(x15) + (x14 + (x13 + (x12 + (x11 + (x10 + (x9 + x8)))))))
  var x60 uint64 = (uint64(x23) + (x22 + (x21 + (x20 + (x19 + (x18 + (x17 + x16)))))))
  var x61 uint64 = (uint64(x31) + (x30 + (x29 + (x28 + (x27 + (x26 + (x25 + x24)))))))
  var x62 uint64 = (uint64(x39) + (x38 + (x37 + (x36 + (x35 + (x34 + (x33 + x32)))))))
  var x63 uint64 = (uint64(x47) + (x46 + (x45 + (x44 + (x43 + (x42 + (x41 + x40)))))))
