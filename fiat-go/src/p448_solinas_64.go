/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang Go --no-wide-int --cmovznz-by-mul --widen-carry p448 64 8 '2^448 - 2^224 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
 ...
 */
/*inline*/
func fiat_p448_addcarryx_u56(out1 *uint64, out2 *uint8, arg1 uint8, arg2 uint64, arg3 uint64) {
  var x1 uint64 = ((uint64(arg1) + arg2) + arg3)
  var x2 uint64 = (x1 & 0xffffffffffffff)
  var x3 uint8 = uint8((x1 >> 56))
  *out1 = x2
  *out2 = x3
}
 ...
 */
/*inline*/
func fiat_p448_subborrowx_u56(out1 *uint64, out2 *uint8, arg1 uint8, arg2 uint64, arg3 uint64) {
  var x1 int64 = ((int64(arg2) - int64(arg1)) - int64(arg3))
  var x2 int8 = int8((x1 >> 56))
 ...
 */
/*inline*/
func fiat_p448_cmovznz_u64(out1 *uint64, arg1 uint8, arg2 uint64, arg3 uint64) {
 ...
 */
/*inline*/
func fiat_p448_selectznz(out1 *[8]uint64, arg1 uint8, arg2 *[8]uint64, arg3 *[8]uint64) {
  var x1 uint64
...
func fiat_p448_to_bytes(out1 *[56]uint8, arg1 *[8]uint64) {
  var x1 uint64
  var x2 uint8
  fiat_p448_subborrowx_u56(&x1, &x2, uint8(0x0), (arg1[0]), 0xffffffffffffff)
  var x3 uint64
  var x4 uint8
  ...
  var x59 uint8 = (x57 & 0xff)
  var x60 uint64 = (x22 >> 8)
  var x61 uint8 = (uint8(x22) & 0xff)
  ...
  var x69 uint8 = (uint8(x66) & 0xff)
  var x70 uint8 = uint8((x68 >> 8))
  var x71 uint8 = (uint8(x68) & 0xff)
  var x72 uint8 = (x70 & 0xff)
  var x73 uint64 = (x24 >> 8)
  var x74 uint8 = (uint8(x24) & 0xff)
  ...
  var x82 uint8 = (uint8(x79) & 0xff)
  var x83 uint8 = uint8((x81 >> 8))
  var x84 uint8 = (uint8(x81) & 0xff)
  var x85 uint8 = (x83 & 0xff)
  var x86 uint64 = (x26 >> 8)
  var x87 uint8 = (uint8(x26) & 0xff)
  ...
  var x97 uint8 = (uint8(x94) & 0xff)
  var x98 uint8 = (x96 & 0xff)
  var x99 uint64 = (x28 >> 8)
  var x100 uint8 = (uint8(x28) & 0xff)
  var x101 uint64 = (x99 >> 8)
  var x102 uint8 = (uint8(x99) & 0xff)
  var x103 uint64 = (x101 >> 8)
  var x104 uint8 = (uint8(x101) & 0xff)
  var x105 uint64 = (x103 >> 8)
  var x106 uint8 = (uint8(x103) & 0xff)
  var x107 uint64 = (x105 >> 8)
  var x108 uint8 = (uint8(x105) & 0xff)
  var x109 uint8 = uint8((x107 >> 8))
  var x110 uint8 = (uint8(x107) & 0xff)
  var x111 uint8 = (x109 & 0xff)
  var x112 uint64 = (x30 >> 8)
  var x113 uint8 = (uint8(x30) & 0xff)
  ...
  var x119 uint8 = (uint8(x116) & 0xff)
  var x120 uint64 = (x118 >> 8)
  var x121 uint8 = (uint8(x118) & 0xff)
  var x122 uint8 = uint8((x120 >> 8))
  var x123 uint8 = (uint8(x120) & 0xff)
  var x124 uint8 = (x122 & 0xff)
  var x125 uint64 = (x32 >> 8)
  var x126 uint8 = (uint8(x32) & 0xff)
  ...
  var x134 uint8 = (uint8(x131) & 0xff)
  var x135 uint8 = uint8((x133 >> 8))
  var x136 uint8 = (uint8(x133) & 0xff)
  out1[0] = x35
  out1[1] = x37
  out1[2] = x39
  out1[3] = x41
...
func fiat_p448_from_bytes(out1 *[8]uint64, arg1 *[56]uint8) {
  ...
  var x57 uint64 = (uint64(x56) + (x55 + (x54 + (x53 + (x52 + (x51 + x50))))))
  var x58 uint64 = (x57 & 0xffffffffffffff)
  var x59 uint64 = (uint64(x7) + (x6 + (x5 + (x4 + (x3 + (x2 + x1))))))
  var x60 uint64 = (uint64(x14) + (x13 + (x12 + (x11 + (x10 + (x9 + x8))))))
  var x61 uint64 = (uint64(x21) + (x20 + (x19 + (x18 + (x17 + (x16 + x15))))))
  var x62 uint64 = (uint64(x28) + (x27 + (x26 + (x25 + (x24 + (x23 + x22))))))
  var x63 uint64 = (uint64(x35) + (x34 + (x33 + (x32 + (x31 + (x30 + x29))))))
  var x64 uint64 = (uint64(x42) + (x41 + (x40 + (x39 + (x38 + (x37 + x36))))))
  var x65 uint64 = (uint64(x49) + (x48 + (x47 + (x46 + (x45 + (x44 + x43))))))
