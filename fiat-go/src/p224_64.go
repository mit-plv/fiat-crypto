/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --lang Go --no-wide-int --cmovznz-by-mul --widen-carry --widen-bytes p224 64 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes scmul2 scmul3 scmul4 scmul8 */
...
func fiat_p224_to_montgomery(out1 *[4]uint64, arg1 *[4]uint64) {
  ...
  var x29 uint64
  var x30 uint64
  x29, x30 = bits.Add64(x24, x21, x28)
  var x32 uint64
  _, x32 = bits.Add64(x11, x19, 0x0)
  var x33 uint64
  var x34 uint64
  x33, x34 = bits.Add64(x13, x25, x32)
  var x35 uint64
  var x36 uint64
  x35, x36 = bits.Add64(x15, x27, x34)
  var x37 uint64
  var x38 uint64
  ...
  var x53 uint64
  var x54 uint64
  x53, x54 = bits.Add64(x33, x45, 0x0)
  var x55 uint64
  var x56 uint64
  x55, x56 = bits.Add64(x35, x47, x54)
  var x57 uint64
  var x58 uint64
  x57, x58 = bits.Add64(x37, x49, x56)
  var x59 uint64
  var x60 uint64
  ...
  var x71 uint64
  var x72 uint64
  x71, x72 = bits.Add64(x66, x63, x70)
  var x74 uint64
  _, x74 = bits.Add64(x53, x61, 0x0)
  var x75 uint64
  var x76 uint64
  x75, x76 = bits.Add64(x55, x67, x74)
  var x77 uint64
  var x78 uint64
  x77, x78 = bits.Add64(x57, x69, x76)
  var x79 uint64
  var x80 uint64
  ...
  var x91 uint64
  var x92 uint64
  x91, x92 = bits.Add64(x86, x83, x90)
  var x93 uint64
  var x94 uint64
  x93, x94 = bits.Add64(x84, x81, x92)
  var x95 uint64
  var x96 uint64
  x95, x96 = bits.Add64(x75, x87, 0x0)
  var x97 uint64
  var x98 uint64
  x97, x98 = bits.Add64(x77, x89, x96)
  var x99 uint64
  var x100 uint64
  x99, x100 = bits.Add64(x79, x91, x98)
  var x101 uint64
  var x102 uint64
  ...
  var x113 uint64
  var x114 uint64
  x113, x114 = bits.Add64(x108, x105, x112)
  var x116 uint64
  _, x116 = bits.Add64(x95, x103, 0x0)
  var x117 uint64
  var x118 uint64
  x117, x118 = bits.Add64(x97, x109, x116)
  var x119 uint64
  var x120 uint64
  x119, x120 = bits.Add64(x99, x111, x118)
  var x121 uint64
  var x122 uint64
  ...
  var x133 uint64
  var x134 uint64
  x133, x134 = bits.Add64(x128, x125, x132)
  var x135 uint64
  var x136 uint64
  x135, x136 = bits.Add64(x126, x123, x134)
  var x137 uint64
  var x138 uint64
  x137, x138 = bits.Add64(x117, x129, 0x0)
  var x139 uint64
  var x140 uint64
  x139, x140 = bits.Add64(x119, x131, x138)
  var x141 uint64
  var x142 uint64
  x141, x142 = bits.Add64(x121, x133, x140)
  var x143 uint64
  var x144 uint64
  ...
  var x155 uint64
  var x156 uint64
  x155, x156 = bits.Add64(x150, x147, x154)
  var x158 uint64
  _, x158 = bits.Add64(x137, x145, 0x0)
  var x159 uint64
  var x160 uint64
  x159, x160 = bits.Add64(x139, x151, x158)
  var x161 uint64
  var x162 uint64
  x161, x162 = bits.Add64(x141, x153, x160)
  var x163 uint64
  var x164 uint64
  x163, x164 = bits.Add64(x143, x155, x162)
  var x165 uint64 = ((x164 + (x144 + (x136 + x124))) + (x156 + x148))
  var x166 uint64
  var x167 uint64
  x166, x167 = bits.Sub64(x159, 0x1, uint64(0x0))
  var x168 uint64
  var x169 uint64
  x168, x169 = bits.Sub64(x161, 0xffffffff00000000, x167)
  var x170 uint64
  var x171 uint64
  x170, x171 = bits.Sub64(x163, 0xffffffffffffffff, x169)
  var x172 uint64
  var x173 uint64
  x172, x173 = bits.Sub64(x165, 0xffffffff, x171)
  var x175 uint64
  _, x175 = bits.Sub64(uint64(0x0), uint64(0x0), x173)
  var x176 uint64
 ...
 */
/*inline*/
func fiat_p224_scmul_2(out1 *[4]uint64, arg1 *[4]uint64) {
  var x1 uint64
  var x2 uint64
  x2, x1 = bits.Mul64(0xfffffffe00000000, (arg1[3]))
  var x3 uint64
  var x4 uint64
  x4, x3 = bits.Mul64(0xfffffffe00000000, (arg1[2]))
  var x5 uint64
  var x6 uint64
  x6, x5 = bits.Mul64(0xfffffffe00000000, (arg1[1]))
  var x7 uint64
  var x8 uint64
  x8, x7 = bits.Mul64(0xfffffffe00000000, (arg1[0]))
  var x9 uint64
  var x10 uint64
  x9, x10 = bits.Add64(x8, x5, 0x0)
  var x11 uint64
  var x12 uint64
  x11, x12 = bits.Add64(x6, x3, x10)
  var x13 uint64
  var x14 uint64
  x13, x14 = bits.Add64(x4, x1, x12)
  var x15 uint64 = (x14 + x2)
  var x16 uint64
  _, x16 = bits.Mul64(x7, 0xffffffffffffffff)
  var x18 uint64
  var x19 uint64
  x19, x18 = bits.Mul64(x16, 0xffffffff)
  var x20 uint64
  var x21 uint64
  x21, x20 = bits.Mul64(x16, 0xffffffffffffffff)
  var x22 uint64
  var x23 uint64
  x23, x22 = bits.Mul64(x16, 0xffffffff00000000)
  var x24 uint64
  var x25 uint64
  x24, x25 = bits.Add64(x23, x20, 0x0)
  var x26 uint64
  var x27 uint64
  x26, x27 = bits.Add64(x21, x18, x25)
  var x28 uint64 = (x27 + x19)
  var x30 uint64
  _, x30 = bits.Add64(x7, x16, 0x0)
  var x31 uint64
  var x32 uint64
  x31, x32 = bits.Add64(x9, x22, x30)
  var x33 uint64
  var x34 uint64
  x33, x34 = bits.Add64(x11, x24, x32)
  var x35 uint64
  var x36 uint64
  x35, x36 = bits.Add64(x13, x26, x34)
  var x37 uint64 = ((x36 + x15) + x28)
  var x38 uint64
  var x39 uint64
  x39, x38 = bits.Mul64(0xffffffffffffffff, (arg1[3]))
  var x40 uint64
  var x41 uint64
  x41, x40 = bits.Mul64(0xffffffffffffffff, (arg1[2]))
  var x42 uint64
  var x43 uint64
  x43, x42 = bits.Mul64(0xffffffffffffffff, (arg1[1]))
  var x44 uint64
  var x45 uint64
  x45, x44 = bits.Mul64(0xffffffffffffffff, (arg1[0]))
  var x46 uint64
  var x47 uint64
  ...
  var x52 uint64 = (x51 + x39)
  var x53 uint64
  var x54 uint64
  x53, x54 = bits.Add64(x31, x44, 0x0)
  var x55 uint64
  var x56 uint64
  x55, x56 = bits.Add64(x33, x46, x54)
  var x57 uint64
  var x58 uint64
  x57, x58 = bits.Add64(x35, x48, x56)
  var x59 uint64
  var x60 uint64
  x59, x60 = bits.Add64(x37, x50, x58)
  var x61 uint64
  var x62 uint64
  x61, x62 = bits.Add64(uint64(0x0), x52, x60)
  var x63 uint64
  _, x63 = bits.Mul64(x53, 0xffffffffffffffff)
  var x65 uint64
  var x66 uint64
  x66, x65 = bits.Mul64(x63, 0xffffffff)
  var x67 uint64
  var x68 uint64
  x68, x67 = bits.Mul64(x63, 0xffffffffffffffff)
  var x69 uint64
  var x70 uint64
  x70, x69 = bits.Mul64(x63, 0xffffffff00000000)
  var x71 uint64
  var x72 uint64
  x71, x72 = bits.Add64(x70, x67, 0x0)
  var x73 uint64
  var x74 uint64
  x73, x74 = bits.Add64(x68, x65, x72)
  var x75 uint64 = (x74 + x66)
  var x77 uint64
  _, x77 = bits.Add64(x53, x63, 0x0)
  var x78 uint64
  var x79 uint64
  x78, x79 = bits.Add64(x55, x69, x77)
  var x80 uint64
  var x81 uint64
  x80, x81 = bits.Add64(x57, x71, x79)
  var x82 uint64
  var x83 uint64
  x82, x83 = bits.Add64(x59, x73, x81)
  var x84 uint64
  var x85 uint64
  x84, x85 = bits.Add64(x61, x75, x83)
  var x86 uint64 = (x85 + x62)
  var x87 uint64 = (arg1[3])
  var x88 uint64 = (arg1[2])
  var x89 uint64 = (arg1[1])
  var x90 uint64 = (arg1[0])
  var x91 uint64
  var x92 uint64
  x91, x92 = bits.Add64(x78, x90, 0x0)
  var x93 uint64
  var x94 uint64
  x93, x94 = bits.Add64(x80, x89, x92)
  var x95 uint64
  var x96 uint64
  x95, x96 = bits.Add64(x82, x88, x94)
  var x97 uint64
  var x98 uint64
  x97, x98 = bits.Add64(x84, x87, x96)
  var x99 uint64 = (x98 + x86)
  var x100 uint64
  _, x100 = bits.Mul64(x91, 0xffffffffffffffff)
  var x102 uint64
  var x103 uint64
  x103, x102 = bits.Mul64(x100, 0xffffffff)
  var x104 uint64
  var x105 uint64
  x105, x104 = bits.Mul64(x100, 0xffffffffffffffff)
  var x106 uint64
  var x107 uint64
  x107, x106 = bits.Mul64(x100, 0xffffffff00000000)
  var x108 uint64
  var x109 uint64
  ...
  var x112 uint64 = (x111 + x103)
  var x114 uint64
  _, x114 = bits.Add64(x91, x100, 0x0)
  var x115 uint64
  var x116 uint64
  x115, x116 = bits.Add64(x93, x106, x114)
  var x117 uint64
  var x118 uint64
  x117, x118 = bits.Add64(x95, x108, x116)
  var x119 uint64
  var x120 uint64
  x119, x120 = bits.Add64(x97, x110, x118)
  var x121 uint64 = ((x120 + x99) + x112)
  var x122 uint64
  _, x122 = bits.Mul64(x115, 0xffffffffffffffff)
  var x124 uint64
  var x125 uint64
  x125, x124 = bits.Mul64(x122, 0xffffffff)
  var x126 uint64
  var x127 uint64
  x127, x126 = bits.Mul64(x122, 0xffffffffffffffff)
  var x128 uint64
  var x129 uint64
  x129, x128 = bits.Mul64(x122, 0xffffffff00000000)
  var x130 uint64
  var x131 uint64
  x130, x131 = bits.Add64(x129, x126, 0x0)
  var x132 uint64
  var x133 uint64
  x132, x133 = bits.Add64(x127, x124, x131)
  var x134 uint64 = (x133 + x125)
  var x136 uint64
  _, x136 = bits.Add64(x115, x122, 0x0)
  var x137 uint64
  var x138 uint64
  x137, x138 = bits.Add64(x117, x128, x136)
  var x139 uint64
  var x140 uint64
  x139, x140 = bits.Add64(x119, x130, x138)
  var x141 uint64
  var x142 uint64
  x141, x142 = bits.Add64(x121, x132, x140)
  var x143 uint64 = (x142 + x134)
  var x144 uint64
  var x145 uint64
  x144, x145 = bits.Sub64(x137, 0x1, uint64(0x0))
  var x146 uint64
  var x147 uint64
  x146, x147 = bits.Sub64(x139, 0xffffffff00000000, x145)
  var x148 uint64
  var x149 uint64
  x148, x149 = bits.Sub64(x141, 0xffffffffffffffff, x147)
  var x150 uint64
  var x151 uint64
  x150, x151 = bits.Sub64(x143, 0xffffffff, x149)
  var x153 uint64
  _, x153 = bits.Sub64(uint64(0x0), uint64(0x0), x151)
  var x154 uint64
  fiat_p224_cmovznz_u64(&x154, x153, x144, x137)
  var x155 uint64
  fiat_p224_cmovznz_u64(&x155, x153, x146, x139)
  var x156 uint64
  fiat_p224_cmovznz_u64(&x156, x153, x148, x141)
  var x157 uint64
  fiat_p224_cmovznz_u64(&x157, x153, x150, x143)
  out1[0] = x154
  out1[1] = x155
  out1[2] = x156
  out1[3] = x157
 ...
 */
/*inline*/
func fiat_p224_scmul_3(out1 *[4]uint64, arg1 *[4]uint64) {
  var x1 uint64
  var x2 uint64
  x2, x1 = bits.Mul64(0xfffffffd00000000, (arg1[3]))
  var x3 uint64
  var x4 uint64
  x4, x3 = bits.Mul64(0xfffffffd00000000, (arg1[2]))
  var x5 uint64
  var x6 uint64
  x6, x5 = bits.Mul64(0xfffffffd00000000, (arg1[1]))
  var x7 uint64
  var x8 uint64
  x8, x7 = bits.Mul64(0xfffffffd00000000, (arg1[0]))
  var x9 uint64
  var x10 uint64
  x9, x10 = bits.Add64(x8, x5, 0x0)
  var x11 uint64
  ...
  var x87 uint64
  var x88 uint64
  x88, x87 = bits.Mul64(0x2, (arg1[3]))
  var x89 uint64
  var x90 uint64
  x90, x89 = bits.Mul64(0x2, (arg1[2]))
  var x91 uint64
  var x92 uint64
  x92, x91 = bits.Mul64(0x2, (arg1[1]))
  var x93 uint64
  var x94 uint64
  x94, x93 = bits.Mul64(0x2, (arg1[0]))
  var x95 uint64
  var x96 uint64
  x95, x96 = bits.Add64(x94, x91, 0x0)
  var x97 uint64
  var x98 uint64
  ...
  var x101 uint64 = (x100 + x88)
  var x102 uint64
  var x103 uint64
  x102, x103 = bits.Add64(x78, x93, 0x0)
  var x104 uint64
  var x105 uint64
  x104, x105 = bits.Add64(x80, x95, x103)
  var x106 uint64
  var x107 uint64
  x106, x107 = bits.Add64(x82, x97, x105)
  var x108 uint64
  var x109 uint64
  x108, x109 = bits.Add64(x84, x99, x107)
  var x110 uint64 = ((x109 + x86) + x101)
  var x111 uint64
  _, x111 = bits.Mul64(x102, 0xffffffffffffffff)
  var x113 uint64
  var x114 uint64
  x114, x113 = bits.Mul64(x111, 0xffffffff)
  var x115 uint64
  var x116 uint64
  x116, x115 = bits.Mul64(x111, 0xffffffffffffffff)
  var x117 uint64
  var x118 uint64
  x118, x117 = bits.Mul64(x111, 0xffffffff00000000)
  var x119 uint64
  var x120 uint64
  x119, x120 = bits.Add64(x118, x115, 0x0)
  var x121 uint64
  var x122 uint64
  x121, x122 = bits.Add64(x116, x113, x120)
  var x123 uint64 = (x122 + x114)
  var x125 uint64
  _, x125 = bits.Add64(x102, x111, 0x0)
  var x126 uint64
  var x127 uint64
  x126, x127 = bits.Add64(x104, x117, x125)
  var x128 uint64
  var x129 uint64
  x128, x129 = bits.Add64(x106, x119, x127)
  var x130 uint64
  var x131 uint64
  x130, x131 = bits.Add64(x108, x121, x129)
  var x132 uint64 = ((x131 + x110) + x123)
  var x133 uint64
  _, x133 = bits.Mul64(x126, 0xffffffffffffffff)
  var x135 uint64
  var x136 uint64
  x136, x135 = bits.Mul64(x133, 0xffffffff)
  var x137 uint64
  var x138 uint64
  x138, x137 = bits.Mul64(x133, 0xffffffffffffffff)
  var x139 uint64
  var x140 uint64
  x140, x139 = bits.Mul64(x133, 0xffffffff00000000)
  var x141 uint64
  var x142 uint64
  x141, x142 = bits.Add64(x140, x137, 0x0)
  var x143 uint64
  var x144 uint64
  x143, x144 = bits.Add64(x138, x135, x142)
  var x145 uint64 = (x144 + x136)
  var x147 uint64
  _, x147 = bits.Add64(x126, x133, 0x0)
  var x148 uint64
  var x149 uint64
  x148, x149 = bits.Add64(x128, x139, x147)
  var x150 uint64
  var x151 uint64
  x150, x151 = bits.Add64(x130, x141, x149)
  var x152 uint64
  var x153 uint64
  x152, x153 = bits.Add64(x132, x143, x151)
  var x154 uint64 = (x153 + x145)
  var x155 uint64
  var x156 uint64
  x155, x156 = bits.Sub64(x148, 0x1, uint64(0x0))
  var x157 uint64
  var x158 uint64
  x157, x158 = bits.Sub64(x150, 0xffffffff00000000, x156)
  var x159 uint64
  var x160 uint64
  x159, x160 = bits.Sub64(x152, 0xffffffffffffffff, x158)
  var x161 uint64
  var x162 uint64
  x161, x162 = bits.Sub64(x154, 0xffffffff, x160)
  var x164 uint64
  _, x164 = bits.Sub64(uint64(0x0), uint64(0x0), x162)
  var x165 uint64
  fiat_p224_cmovznz_u64(&x165, x164, x155, x148)
  var x166 uint64
  fiat_p224_cmovznz_u64(&x166, x164, x157, x150)
  var x167 uint64
  fiat_p224_cmovznz_u64(&x167, x164, x159, x152)
  var x168 uint64
  fiat_p224_cmovznz_u64(&x168, x164, x161, x154)
  out1[0] = x165
  out1[1] = x166
  out1[2] = x167
  out1[3] = x168
 ...
 */
/*inline*/
func fiat_p224_scmul_4(out1 *[4]uint64, arg1 *[4]uint64) {
  var x1 uint64
  var x2 uint64
  x2, x1 = bits.Mul64(0xfffffffc00000000, (arg1[3]))
  var x3 uint64
  var x4 uint64
  x4, x3 = bits.Mul64(0xfffffffc00000000, (arg1[2]))
  var x5 uint64
  var x6 uint64
  x6, x5 = bits.Mul64(0xfffffffc00000000, (arg1[1]))
  var x7 uint64
  var x8 uint64
  x8, x7 = bits.Mul64(0xfffffffc00000000, (arg1[0]))
  var x9 uint64
  var x10 uint64
  x9, x10 = bits.Add64(x8, x5, 0x0)
  var x11 uint64
  ...
  var x87 uint64
  var x88 uint64
  x88, x87 = bits.Mul64(0x3, (arg1[3]))
  var x89 uint64
  var x90 uint64
  x90, x89 = bits.Mul64(0x3, (arg1[2]))
  var x91 uint64
  var x92 uint64
  x92, x91 = bits.Mul64(0x3, (arg1[1]))
  var x93 uint64
  var x94 uint64
  x94, x93 = bits.Mul64(0x3, (arg1[0]))
  var x95 uint64
  var x96 uint64
  x95, x96 = bits.Add64(x94, x91, 0x0)
  var x97 uint64
...
func fiat_p224_scmul_8(out1 *[4]uint64, arg1 *[4]uint64) {
  var x1 uint64
  var x2 uint64
  x2, x1 = bits.Mul64(0xfffffff800000000, (arg1[3]))
  var x3 uint64
  var x4 uint64
  x4, x3 = bits.Mul64(0xfffffff800000000, (arg1[2]))
  var x5 uint64
  var x6 uint64
  x6, x5 = bits.Mul64(0xfffffff800000000, (arg1[1]))
  var x7 uint64
  var x8 uint64
  x8, x7 = bits.Mul64(0xfffffff800000000, (arg1[0]))
  var x9 uint64
  var x10 uint64
  x9, x10 = bits.Add64(x8, x5, 0x0)
  var x11 uint64
  ...
  var x87 uint64
  var x88 uint64
  x88, x87 = bits.Mul64(0x7, (arg1[3]))
  var x89 uint64
  var x90 uint64
  x90, x89 = bits.Mul64(0x7, (arg1[2]))
  var x91 uint64
  var x92 uint64
  x92, x91 = bits.Mul64(0x7, (arg1[1]))
  var x93 uint64
  var x94 uint64
  x94, x93 = bits.Mul64(0x7, (arg1[0]))
  var x95 uint64
  var x96 uint64
  x95, x96 = bits.Add64(x94, x91, 0x0)
  var x97 uint64
