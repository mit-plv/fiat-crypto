/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --lang Go --no-wide-int --cmovznz-by-mul --widen-carry p224 64 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
 ...
 */
/*inline*/
func fiat_p224_cmovznz_u64(out1 *uint64, arg1 uint8, arg2 uint64, arg3 uint64) {
 ...
 */
/*inline*/
func fiat_p224_selectznz(out1 *[4]uint64, arg1 uint8, arg2 *[4]uint64, arg3 *[4]uint64) {
  var x1 uint64
 ...
 */
/*inline*/
func fiat_p224_to_bytes(out1 *[32]uint8, arg1 *[4]uint64) {
 ...
 */
/*inline*/
func fiat_p224_from_bytes(out1 *[4]uint64, arg1 *[32]uint8) {
  ...
  var x29 uint64 = (uint64(x28) + (x27 + (x26 + (x25 + (x24 + (x23 + (x22 + x21)))))))
  var x30 uint64 = (x29 & 0xffffffffffffffff)
  var x31 uint64 = (uint64(x4) + (x3 + (x2 + x1)))
  var x32 uint64 = (uint64(x12) + (x11 + (x10 + (x9 + (x8 + (x7 + (x6 + x5)))))))
  var x33 uint64 = (uint64(x20) + (x19 + (x18 + (x17 + (x16 + (x15 + (x14 + x13)))))))
