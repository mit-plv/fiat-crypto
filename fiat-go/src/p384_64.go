/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --lang Go --no-wide-int --cmovznz-by-mul --widen-carry p384 64 '2^384 - 2^128 - 2^96 + 2^32 - 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
 ...
 */
/*inline*/
func fiat_p384_cmovznz_u64(out1 *uint64, arg1 uint8, arg2 uint64, arg3 uint64) {
...
func fiat_p384_to_montgomery(out1 *[6]uint64, arg1 *[6]uint64) {
  ...
  var x15 uint64
  var x16 uint64
  x15, x16 = bits.Add64(x14, x11, 0x0)
  var x17 uint64
  var x18 uint64
  x17, x18 = bits.Add64(x12, x9, x16)
  var x19 uint64
  var x20 uint64
  x19, x20 = bits.Add64(x10, x7, x18)
  var x21 uint64
  var x22 uint64
  x21, x22 = bits.Add64(x8, x6, x20)
  var x23 uint64
  ...
  var x37 uint64
  var x38 uint64
  x37, x38 = bits.Add64(x36, x33, 0x0)
  var x39 uint64
  var x40 uint64
  x39, x40 = bits.Add64(x34, x31, x38)
  var x41 uint64
  var x42 uint64
  x41, x42 = bits.Add64(x32, x29, x40)
  var x43 uint64
  var x44 uint64
  x43, x44 = bits.Add64(x30, x27, x42)
  var x45 uint64
  var x46 uint64
  x45, x46 = bits.Add64(x28, x25, x44)
  var x48 uint64
  _, x48 = bits.Add64(x13, x35, 0x0)
  var x49 uint64
  var x50 uint64
  x49, x50 = bits.Add64(x15, x37, x48)
  var x51 uint64
  var x52 uint64
  x51, x52 = bits.Add64(x17, x39, x50)
  var x53 uint64
  var x54 uint64
  x53, x54 = bits.Add64(x19, x41, x52)
  var x55 uint64
  var x56 uint64
  x55, x56 = bits.Add64(x21, x43, x54)
  var x57 uint64
  var x58 uint64
  x57, x58 = bits.Add64(x22, x45, x56)
  var x59 uint64
  var x60 uint64
  x59, x60 = bits.Add64(uint64(0x0), (x46 + x26), x58)
  var x61 uint64
  var x62 uint64
  ...
  var x73 uint64
  var x74 uint64
  x73, x74 = bits.Add64(x64, x61, x72)
  var x75 uint64
  var x76 uint64
  x75, x76 = bits.Add64(x62, x1, x74)
  var x77 uint64
  var x78 uint64
  x77, x78 = bits.Add64(x49, x67, 0x0)
  var x79 uint64
  var x80 uint64
  x79, x80 = bits.Add64(x51, x69, x78)
  var x81 uint64
  var x82 uint64
  x81, x82 = bits.Add64(x53, x71, x80)
  var x83 uint64
  var x84 uint64
  x83, x84 = bits.Add64(x55, x73, x82)
  var x85 uint64
  var x86 uint64
  x85, x86 = bits.Add64(x57, x75, x84)
  var x87 uint64
  var x88 uint64
  x87, x88 = bits.Add64(x59, x76, x86)
  var x89 uint64
  ...
  var x103 uint64
  var x104 uint64
  x103, x104 = bits.Add64(x102, x99, 0x0)
  var x105 uint64
  var x106 uint64
  x105, x106 = bits.Add64(x100, x97, x104)
  var x107 uint64
  var x108 uint64
  x107, x108 = bits.Add64(x98, x95, x106)
  var x109 uint64
  var x110 uint64
  x109, x110 = bits.Add64(x96, x93, x108)
  var x111 uint64
  var x112 uint64
  x111, x112 = bits.Add64(x94, x91, x110)
  var x114 uint64
  _, x114 = bits.Add64(x77, x101, 0x0)
  var x115 uint64
  var x116 uint64
  x115, x116 = bits.Add64(x79, x103, x114)
  var x117 uint64
  var x118 uint64
  x117, x118 = bits.Add64(x81, x105, x116)
  var x119 uint64
  var x120 uint64
  x119, x120 = bits.Add64(x83, x107, x118)
  var x121 uint64
  var x122 uint64
  x121, x122 = bits.Add64(x85, x109, x120)
  var x123 uint64
  var x124 uint64
  x123, x124 = bits.Add64(x87, x111, x122)
  var x125 uint64
  var x126 uint64
  x125, x126 = bits.Add64((x88 + x60), (x112 + x92), x124)
  var x127 uint64
  var x128 uint64
  ...
  var x141 uint64
  var x142 uint64
  x141, x142 = bits.Add64(x128, x2, x140)
  var x143 uint64
  var x144 uint64
  x143, x144 = bits.Add64(x115, x133, 0x0)
  var x145 uint64
  var x146 uint64
  x145, x146 = bits.Add64(x117, x135, x144)
  var x147 uint64
  var x148 uint64
  x147, x148 = bits.Add64(x119, x137, x146)
  var x149 uint64
  var x150 uint64
  x149, x150 = bits.Add64(x121, x139, x148)
  var x151 uint64
  var x152 uint64
  x151, x152 = bits.Add64(x123, x141, x150)
  var x153 uint64
  var x154 uint64
  x153, x154 = bits.Add64(x125, x142, x152)
  var x155 uint64
  ...
  var x169 uint64
  var x170 uint64
  x169, x170 = bits.Add64(x168, x165, 0x0)
  var x171 uint64
  var x172 uint64
  x171, x172 = bits.Add64(x166, x163, x170)
  var x173 uint64
  var x174 uint64
  x173, x174 = bits.Add64(x164, x161, x172)
  var x175 uint64
  var x176 uint64
  x175, x176 = bits.Add64(x162, x159, x174)
  var x177 uint64
  var x178 uint64
  x177, x178 = bits.Add64(x160, x157, x176)
  var x180 uint64
  _, x180 = bits.Add64(x143, x167, 0x0)
  var x181 uint64
  var x182 uint64
  x181, x182 = bits.Add64(x145, x169, x180)
  var x183 uint64
  var x184 uint64
  x183, x184 = bits.Add64(x147, x171, x182)
  var x185 uint64
  var x186 uint64
  x185, x186 = bits.Add64(x149, x173, x184)
  var x187 uint64
  var x188 uint64
  x187, x188 = bits.Add64(x151, x175, x186)
  var x189 uint64
  var x190 uint64
  x189, x190 = bits.Add64(x153, x177, x188)
  var x191 uint64
  var x192 uint64
  x191, x192 = bits.Add64((x154 + x126), (x178 + x158), x190)
  var x193 uint64
  var x194 uint64
  ...
  var x201 uint64
  var x202 uint64
  x201, x202 = bits.Add64(x200, x197, 0x0)
  var x203 uint64
  var x204 uint64
  x203, x204 = bits.Add64(x198, x195, x202)
  var x205 uint64
  var x206 uint64
  x205, x206 = bits.Add64(x196, x193, x204)
  var x207 uint64
  var x208 uint64
  x207, x208 = bits.Add64(x194, x3, x206)
  var x209 uint64
  var x210 uint64
  x209, x210 = bits.Add64(x181, x199, 0x0)
  var x211 uint64
  var x212 uint64
  ...
  var x217 uint64
  var x218 uint64
  x217, x218 = bits.Add64(x189, x207, x216)
  var x219 uint64
  var x220 uint64
  x219, x220 = bits.Add64(x191, x208, x218)
  var x221 uint64
  ...
  x243, x244 = bits.Add64(x226, x223, x242)
  var x246 uint64
  _, x246 = bits.Add64(x209, x233, 0x0)
  var x247 uint64
  var x248 uint64
  x247, x248 = bits.Add64(x211, x235, x246)
  var x249 uint64
  var x250 uint64
  x249, x250 = bits.Add64(x213, x237, x248)
  var x251 uint64
  var x252 uint64
  x251, x252 = bits.Add64(x215, x239, x250)
  var x253 uint64
  var x254 uint64
  x253, x254 = bits.Add64(x217, x241, x252)
  var x255 uint64
  var x256 uint64
  x255, x256 = bits.Add64(x219, x243, x254)
  var x257 uint64
  var x258 uint64
  x257, x258 = bits.Add64((x220 + x192), (x244 + x224), x256)
  var x259 uint64
  var x260 uint64
  ...
  var x267 uint64
  var x268 uint64
  x267, x268 = bits.Add64(x266, x263, 0x0)
  var x269 uint64
  var x270 uint64
  x269, x270 = bits.Add64(x264, x261, x268)
  var x271 uint64
  var x272 uint64
  x271, x272 = bits.Add64(x262, x259, x270)
  var x273 uint64
  var x274 uint64
  x273, x274 = bits.Add64(x260, x4, x272)
  var x275 uint64
  var x276 uint64
  x275, x276 = bits.Add64(x247, x265, 0x0)
  var x277 uint64
  var x278 uint64
  x277, x278 = bits.Add64(x249, x267, x276)
  var x279 uint64
  var x280 uint64
  x279, x280 = bits.Add64(x251, x269, x278)
  var x281 uint64
  var x282 uint64
  x281, x282 = bits.Add64(x253, x271, x280)
  var x283 uint64
  var x284 uint64
  x283, x284 = bits.Add64(x255, x273, x282)
  var x285 uint64
  var x286 uint64
  x285, x286 = bits.Add64(x257, x274, x284)
  var x287 uint64
  ...
  var x301 uint64
  var x302 uint64
  x301, x302 = bits.Add64(x300, x297, 0x0)
  var x303 uint64
  var x304 uint64
  x303, x304 = bits.Add64(x298, x295, x302)
  var x305 uint64
  var x306 uint64
  x305, x306 = bits.Add64(x296, x293, x304)
  var x307 uint64
  var x308 uint64
  x307, x308 = bits.Add64(x294, x291, x306)
  var x309 uint64
  var x310 uint64
  x309, x310 = bits.Add64(x292, x289, x308)
  var x312 uint64
  _, x312 = bits.Add64(x275, x299, 0x0)
  var x313 uint64
  var x314 uint64
  x313, x314 = bits.Add64(x277, x301, x312)
  var x315 uint64
  var x316 uint64
  x315, x316 = bits.Add64(x279, x303, x314)
  var x317 uint64
  var x318 uint64
  x317, x318 = bits.Add64(x281, x305, x316)
  var x319 uint64
  var x320 uint64
  x319, x320 = bits.Add64(x283, x307, x318)
  var x321 uint64
  var x322 uint64
  x321, x322 = bits.Add64(x285, x309, x320)
  var x323 uint64
  var x324 uint64
  x323, x324 = bits.Add64((x286 + x258), (x310 + x290), x322)
  var x325 uint64
  var x326 uint64
  ...
  var x333 uint64
  var x334 uint64
  x333, x334 = bits.Add64(x332, x329, 0x0)
  var x335 uint64
  var x336 uint64
  x335, x336 = bits.Add64(x330, x327, x334)
  var x337 uint64
  var x338 uint64
  x337, x338 = bits.Add64(x328, x325, x336)
  var x339 uint64
  var x340 uint64
  x339, x340 = bits.Add64(x326, x5, x338)
  var x341 uint64
  var x342 uint64
  x341, x342 = bits.Add64(x313, x331, 0x0)
  var x343 uint64
  var x344 uint64
  x343, x344 = bits.Add64(x315, x333, x342)
  var x345 uint64
  var x346 uint64
  x345, x346 = bits.Add64(x317, x335, x344)
  var x347 uint64
  var x348 uint64
  x347, x348 = bits.Add64(x319, x337, x346)
  var x349 uint64
  var x350 uint64
  x349, x350 = bits.Add64(x321, x339, x348)
  var x351 uint64
  var x352 uint64
  x351, x352 = bits.Add64(x323, x340, x350)
  var x353 uint64
  ...
  var x367 uint64
  var x368 uint64
  x367, x368 = bits.Add64(x366, x363, 0x0)
  var x369 uint64
  var x370 uint64
  x369, x370 = bits.Add64(x364, x361, x368)
  var x371 uint64
  var x372 uint64
  x371, x372 = bits.Add64(x362, x359, x370)
  var x373 uint64
  var x374 uint64
  x373, x374 = bits.Add64(x360, x357, x372)
  var x375 uint64
  var x376 uint64
  x375, x376 = bits.Add64(x358, x355, x374)
  var x378 uint64
  _, x378 = bits.Add64(x341, x365, 0x0)
  var x379 uint64
  var x380 uint64
  x379, x380 = bits.Add64(x343, x367, x378)
  var x381 uint64
  var x382 uint64
  x381, x382 = bits.Add64(x345, x369, x380)
  var x383 uint64
  var x384 uint64
  x383, x384 = bits.Add64(x347, x371, x382)
  var x385 uint64
  var x386 uint64
  x385, x386 = bits.Add64(x349, x373, x384)
  var x387 uint64
  var x388 uint64
  x387, x388 = bits.Add64(x351, x375, x386)
  var x389 uint64
  var x390 uint64
  x389, x390 = bits.Add64((x352 + x324), (x376 + x356), x388)
  var x391 uint64
  var x392 uint64
  x391, x392 = bits.Sub64(x379, 0xffffffff, uint64(0x0))
  var x393 uint64
  var x394 uint64
  x393, x394 = bits.Sub64(x381, 0xffffffff00000000, x392)
  var x395 uint64
  var x396 uint64
  x395, x396 = bits.Sub64(x383, 0xfffffffffffffffe, x394)
  var x397 uint64
  var x398 uint64
  x397, x398 = bits.Sub64(x385, 0xffffffffffffffff, x396)
  var x399 uint64
  var x400 uint64
  x399, x400 = bits.Sub64(x387, 0xffffffffffffffff, x398)
  var x401 uint64
  var x402 uint64
  x401, x402 = bits.Sub64(x389, 0xffffffffffffffff, x400)
  var x404 uint64
  _, x404 = bits.Sub64(x390, uint64(0x0), x402)
  var x405 uint64
 ...
 */
/*inline*/
func fiat_p384_selectznz(out1 *[6]uint64, arg1 uint8, arg2 *[6]uint64, arg3 *[6]uint64) {
  var x1 uint64
