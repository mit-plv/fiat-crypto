/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --lang=Go --no-wide-int --cmovznz-by-mul --widen-carry --widen-bytes p384 '2^384 - 2^128 - 2^96 + 2^32 - 1' 64 */
...
func fiat_p384_mul(out1 *[6]uint64, arg1 *[6]uint64, arg2 *[6]uint64) {
  ...
  var x473 uint64
  var x474 uint64
  x473, x474 = bits.Sub64(x459, uint64(0xffffffff), uint64(0x0))
  var x475 uint64
  var x476 uint64
...
func fiat_p384_add(out1 *[6]uint64, arg1 *[6]uint64, arg2 *[6]uint64) {
  ...
  var x13 uint64
  var x14 uint64
  x13, x14 = bits.Sub64(x1, uint64(0xffffffff), uint64(0x0))
  var x15 uint64
  var x16 uint64
...
func fiat_p384_sub(out1 *[6]uint64, arg1 *[6]uint64, arg2 *[6]uint64) {
  ...
  var x14 uint64
  var x15 uint64
  x14, x15 = bits.Add64(x1, (x13 & uint64(0xffffffff)), 0x0)
  var x16 uint64
  var x17 uint64
...
func fiat_p384_from_montgomery(out1 *[6]uint64, arg1 *[6]uint64) {
  ...
  var x322 uint64
  var x323 uint64
  x322, x323 = bits.Sub64(x304, uint64(0xffffffff), uint64(0x0))
  var x324 uint64
  var x325 uint64
...
func fiat_p384_to_bytes(out1 *[48]uint64, arg1 *[6]uint64) {
  ...
  var x20 uint64 = (x17 & uint64(0xff))
  var x21 uint64 = (x19 & uint64(0xff))
  var x22 uint64 = (x5 >> 8)
  var x23 uint64 = (x5 & uint64(0xff))
  ...
  var x35 uint64 = (x32 & uint64(0xff))
  var x36 uint64 = (x34 & uint64(0xff))
  var x37 uint64 = (x4 >> 8)
  var x38 uint64 = (x4 & uint64(0xff))
  ...
  var x50 uint64 = (x47 & uint64(0xff))
  var x51 uint64 = (x49 & uint64(0xff))
  var x52 uint64 = (x3 >> 8)
  var x53 uint64 = (x3 & uint64(0xff))
  ...
  var x65 uint64 = (x62 & uint64(0xff))
  var x66 uint64 = (x64 & uint64(0xff))
  var x67 uint64 = (x2 >> 8)
  var x68 uint64 = (x2 & uint64(0xff))
  var x69 uint64 = (x67 >> 8)
  var x70 uint64 = (x67 & uint64(0xff))
  var x71 uint64 = (x69 >> 8)
  var x72 uint64 = (x69 & uint64(0xff))
  var x73 uint64 = (x71 >> 8)
  var x74 uint64 = (x71 & uint64(0xff))
  var x75 uint64 = (x73 >> 8)
  var x76 uint64 = (x73 & uint64(0xff))
  var x77 uint64 = (x75 >> 8)
  var x78 uint64 = (x75 & uint64(0xff))
  var x79 uint64 = (x77 >> 8)
  var x80 uint64 = (x77 & uint64(0xff))
  var x81 uint64 = (x79 & uint64(0xff))
  var x82 uint64 = (x1 >> 8)
  var x83 uint64 = (x1 & uint64(0xff))
  var x84 uint64 = (x82 >> 8)
  var x85 uint64 = (x82 & uint64(0xff))
  var x86 uint64 = (x84 >> 8)
  var x87 uint64 = (x84 & uint64(0xff))
  var x88 uint64 = (x86 >> 8)
  var x89 uint64 = (x86 & uint64(0xff))
  var x90 uint64 = (x88 >> 8)
  var x91 uint64 = (x88 & uint64(0xff))
  var x92 uint64 = (x90 >> 8)
  var x93 uint64 = (x90 & uint64(0xff))
  var x94 uint64 = (x92 >> 8)
  var x95 uint64 = (x92 & uint64(0xff))
  out1[0] = x8
  out1[1] = x10
  out1[2] = x12
  out1[3] = x14
