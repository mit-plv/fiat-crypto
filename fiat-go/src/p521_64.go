/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang Go --no-wide-int --cmovznz-by-mul --widen-carry p521 64 9 '2^521 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
...
func fiat_p521_to_bytes(out1 *[66]uint8, arg1 *[9]uint64) {
  var x1 uint64
  var x2 uint8
  fiat_p521_subborrowx_u58(&x1, &x2, uint8(0x0), (arg1[0]), 0x3ffffffffffffff)
  var x3 uint64
  var x4 uint8
...
func fiat_p521_from_bytes(out1 *[9]uint64, arg1 *[66]uint8) {
  var x1 uint64 = (uint64((arg1[65])) << 56)
