/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang Go --no-wide-int --cmovznz-by-mul --widen-carry 25519 64 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes carry_scmul121666 */
...
func fiat_25519_to_bytes(out1 *[32]uint8, arg1 *[5]uint64) {
  var x1 uint64
  var x2 uint8
  fiat_25519_subborrowx_u51(&x1, &x2, uint8(0x0), (arg1[0]), 0x7ffffffffffed)
  var x3 uint64
  var x4 uint8
  ...
  var x38 uint64 = (uint64(x36) + x25)
  var x39 uint64 = (x38 >> 8)
  var x40 uint8 = (uint8(x38) & 0xff)
  ...
  var x51 uint64 = (uint64(x49) + x24)
  var x52 uint64 = (x51 >> 8)
  var x53 uint8 = (uint8(x51) & 0xff)
  ...
  var x66 uint64 = (uint64(x64) + x23)
  var x67 uint64 = (x66 >> 8)
  var x68 uint8 = (uint8(x66) & 0xff)
  ...
  var x79 uint64 = (uint64(x77) + x22)
  var x80 uint64 = (x79 >> 8)
  var x81 uint8 = (uint8(x79) & 0xff)
...
func fiat_25519_from_bytes(out1 *[5]uint64, arg1 *[32]uint8) {
  ...
  var x33 uint64 = (uint64(x32) + (x31 + (x30 + (x29 + (x28 + (x27 + x26))))))
  var x34 uint8 = uint8((x33 >> 51))
  ...
  var x40 uint64 = (uint64(x34) + x39)
  var x41 uint8 = uint8((x40 >> 51))
  var x42 uint64 = (x40 & 0x7ffffffffffff)
  var x43 uint64 = (uint64(x41) + x38)
  var x44 uint8 = uint8((x43 >> 51))
  var x45 uint64 = (x43 & 0x7ffffffffffff)
  var x46 uint64 = (uint64(x44) + x37)
  var x47 uint8 = uint8((x46 >> 51))
  var x48 uint64 = (x46 & 0x7ffffffffffff)
  var x49 uint64 = (uint64(x47) + x36)
  out1[0] = x35
  out1[1] = x42
  out1[2] = x45
  out1[3] = x48
