/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang=Go --no-wide-int --cmovznz-by-mul --widen-carry --widen-bytes 25519 5 '2^255 - 19' 64 carry_mul carry_square carry_scmul121666 carry add sub opp selectznz from_bytes */
