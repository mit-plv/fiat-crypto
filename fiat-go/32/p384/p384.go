...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x27 uint32
	var x28 uint32
	x27, x28 = bits.Add32(x1, x25, uint32(0x0))
	var x29 uint32
	var x30 uint32
	x29, x30 = bits.Add32(x3, uint32(0x0), uint32(uint1(x28)))
	var x31 uint32
	var x32 uint32
	x31, x32 = bits.Add32(x5, uint32(0x0), uint32(uint1(x30)))
	var x33 uint32
	var x34 uint32
	x33, x34 = bits.Add32(x7, x25, uint32(uint1(x32)))
	var x35 uint32
	var x36 uint32
	x35, x36 = bits.Add32(x9, (x25 & 0xfffffffe), uint32(uint1(x34)))
	var x37 uint32
	var x38 uint32
	x37, x38 = bits.Add32(x11, x25, uint32(uint1(x36)))
	var x39 uint32
	var x40 uint32
...
func Divstep(out1 *uint32, out2 *[13]uint32, out3 *[13]uint32, out4 *[12]uint32, out5 *[12]uint32, arg1 uint32, arg2 *[13]uint32, arg3 *[13]uint32, arg4 *[12]uint32, arg5 *[12]uint32) {
	...
	var x159 uint32
	var x160 uint32
	x159, x160 = bits.Add32(x133, x157, uint32(0x0))
	var x161 uint32
	var x162 uint32
	x161, x162 = bits.Add32(x135, uint32(0x0), uint32(uint1(x160)))
	var x163 uint32
	var x164 uint32
	x163, x164 = bits.Add32(x137, uint32(0x0), uint32(uint1(x162)))
	var x165 uint32
	var x166 uint32
	x165, x166 = bits.Add32(x139, x157, uint32(uint1(x164)))
	var x167 uint32
	var x168 uint32
	x167, x168 = bits.Add32(x141, (x157 & 0xfffffffe), uint32(uint1(x166)))
	var x169 uint32
	var x170 uint32
	x169, x170 = bits.Add32(x143, x157, uint32(uint1(x168)))
	var x171 uint32
	var x172 uint32
	...
	var x271 uint32
	var x272 uint32
	x271, x272 = bits.Sub32(x247, 0xffffffff, uint32(0x0))
	var x273 uint32
	var x274 uint32
	x273, x274 = bits.Sub32(x249, uint32(0x0), uint32(uint1(x272)))
	var x275 uint32
	var x276 uint32
	x275, x276 = bits.Sub32(x251, uint32(0x0), uint32(uint1(x274)))
	var x277 uint32
	var x278 uint32
	x277, x278 = bits.Sub32(x253, 0xffffffff, uint32(uint1(x276)))
	var x279 uint32
	var x280 uint32
	x279, x280 = bits.Sub32(x255, 0xfffffffe, uint32(uint1(x278)))
	var x281 uint32
	var x282 uint32
