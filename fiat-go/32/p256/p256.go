...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x19 uint32
	var x20 uint32
	x19, x20 = bits.Add32(x1, x17, uint32(0x0))
	var x21 uint32
	var x22 uint32
	x21, x22 = bits.Add32(x3, x17, uint32(uint1(x20)))
	var x23 uint32
	var x24 uint32
	x23, x24 = bits.Add32(x5, x17, uint32(uint1(x22)))
	var x25 uint32
	var x26 uint32
	x25, x26 = bits.Add32(x7, uint32(0x0), uint32(uint1(x24)))
	var x27 uint32
	var x28 uint32
	x27, x28 = bits.Add32(x9, uint32(0x0), uint32(uint1(x26)))
	var x29 uint32
	var x30 uint32
	x29, x30 = bits.Add32(x11, uint32(0x0), uint32(uint1(x28)))
	var x31 uint32
	var x32 uint32
	x31, x32 = bits.Add32(x13, uint32((uint1(x17) & 0x1)), uint32(uint1(x30)))
	var x33 uint32
...
func Divstep(out1 *uint32, out2 *[9]uint32, out3 *[9]uint32, out4 *[8]uint32, out5 *[8]uint32, arg1 uint32, arg2 *[9]uint32, arg3 *[9]uint32, arg4 *[8]uint32, arg5 *[8]uint32) {
	...
	var x111 uint32
	var x112 uint32
	x111, x112 = bits.Add32(x93, x109, uint32(0x0))
	var x113 uint32
	var x114 uint32
	x113, x114 = bits.Add32(x95, x109, uint32(uint1(x112)))
	var x115 uint32
	var x116 uint32
	x115, x116 = bits.Add32(x97, x109, uint32(uint1(x114)))
	var x117 uint32
	var x118 uint32
	x117, x118 = bits.Add32(x99, uint32(0x0), uint32(uint1(x116)))
	var x119 uint32
	var x120 uint32
	x119, x120 = bits.Add32(x101, uint32(0x0), uint32(uint1(x118)))
	var x121 uint32
	var x122 uint32
	x121, x122 = bits.Add32(x103, uint32(0x0), uint32(uint1(x120)))
	var x123 uint32
	var x124 uint32
	x123, x124 = bits.Add32(x105, uint32((uint1(x109) & 0x1)), uint32(uint1(x122)))
	var x125 uint32
	...
	var x187 uint32
	var x188 uint32
	x187, x188 = bits.Sub32(x171, 0xffffffff, uint32(0x0))
	var x189 uint32
	var x190 uint32
	...
	var x199 uint32
	var x200 uint32
	x199, x200 = bits.Sub32(x183, uint32(0x1), uint32(uint1(x198)))
	var x201 uint32
	var x202 uint32
