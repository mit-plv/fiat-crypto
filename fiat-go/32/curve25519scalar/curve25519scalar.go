...
func Divstep(out1 *uint32, out2 *[9]uint32, out3 *[9]uint32, out4 *[8]uint32, out5 *[8]uint32, arg1 uint32, arg2 *[9]uint32, arg3 *[9]uint32, arg4 *[8]uint32, arg5 *[8]uint32) {
	...
	var x185 uint32
	var x186 uint32
	x185, x186 = bits.Sub32(x169, 0x5cf5d3ed, uint32(0x0))
	var x187 uint32
	var x188 uint32
	x187, x188 = bits.Sub32(x171, 0x5812631a, uint32(uint1(x186)))
	var x189 uint32
	var x190 uint32
	x189, x190 = bits.Sub32(x173, 0xa2f79cd6, uint32(uint1(x188)))
	var x191 uint32
	var x192 uint32
	x191, x192 = bits.Sub32(x175, 0x14def9de, uint32(uint1(x190)))
	var x193 uint32
	var x194 uint32
	...
	var x199 uint32
	var x200 uint32
	x199, x200 = bits.Sub32(x183, 0x10000000, uint32(uint1(x198)))
	var x202 uint32
