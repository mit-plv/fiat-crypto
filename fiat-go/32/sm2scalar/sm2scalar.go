...
//
// Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Go --relax-primitive-carry-to-bitwidth 32,64 --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --doc-newline-in-typedef-bounds --doc-prepend-header 'Code generated by Fiat Cryptography. DO NOT EDIT.' --doc-text-before-function-name '' --doc-text-before-type-name '' --package-name sm2scalar '' 32 '2^256 - 2^224 - 188730267045675049073202170516080344797' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
//
// curve description (via package name): sm2scalar
//
...
func Mul(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x40 uint32
	_, x40 = bits.Mul32(x23, 0x72350975)
	var x42 uint32
	var x43 uint32
	x43, x42 = bits.Mul32(x40, 0xfffffffe)
	var x44 uint32
	var x45 uint32
	...
	var x50 uint32
	var x51 uint32
	x51, x50 = bits.Mul32(x40, 0x7203df6b)
	var x52 uint32
	var x53 uint32
	x53, x52 = bits.Mul32(x40, 0x21c6052b)
	var x54 uint32
	var x55 uint32
	x55, x54 = bits.Mul32(x40, 0x53bbf409)
	var x56 uint32
	var x57 uint32
	x57, x56 = bits.Mul32(x40, 0x39d54123)
	var x58 uint32
	var x59 uint32
	...
	var x140 uint32
	_, x140 = bits.Mul32(x122, 0x72350975)
	var x142 uint32
	var x143 uint32
	x143, x142 = bits.Mul32(x140, 0xfffffffe)
	var x144 uint32
	var x145 uint32
	...
	var x150 uint32
	var x151 uint32
	x151, x150 = bits.Mul32(x140, 0x7203df6b)
	var x152 uint32
	var x153 uint32
	x153, x152 = bits.Mul32(x140, 0x21c6052b)
	var x154 uint32
	var x155 uint32
	x155, x154 = bits.Mul32(x140, 0x53bbf409)
	var x156 uint32
	var x157 uint32
	x157, x156 = bits.Mul32(x140, 0x39d54123)
	var x158 uint32
	var x159 uint32
	...
	var x241 uint32
	_, x241 = bits.Mul32(x223, 0x72350975)
	var x243 uint32
	var x244 uint32
	x244, x243 = bits.Mul32(x241, 0xfffffffe)
	var x245 uint32
	var x246 uint32
	...
	var x251 uint32
	var x252 uint32
	x252, x251 = bits.Mul32(x241, 0x7203df6b)
	var x253 uint32
	var x254 uint32
	x254, x253 = bits.Mul32(x241, 0x21c6052b)
	var x255 uint32
	var x256 uint32
	x256, x255 = bits.Mul32(x241, 0x53bbf409)
	var x257 uint32
	var x258 uint32
	x258, x257 = bits.Mul32(x241, 0x39d54123)
	var x259 uint32
	var x260 uint32
	...
	var x342 uint32
	_, x342 = bits.Mul32(x324, 0x72350975)
	var x344 uint32
	var x345 uint32
	x345, x344 = bits.Mul32(x342, 0xfffffffe)
	var x346 uint32
	var x347 uint32
	...
	var x352 uint32
	var x353 uint32
	x353, x352 = bits.Mul32(x342, 0x7203df6b)
	var x354 uint32
	var x355 uint32
	x355, x354 = bits.Mul32(x342, 0x21c6052b)
	var x356 uint32
	var x357 uint32
	x357, x356 = bits.Mul32(x342, 0x53bbf409)
	var x358 uint32
	var x359 uint32
	x359, x358 = bits.Mul32(x342, 0x39d54123)
	var x360 uint32
	var x361 uint32
	...
	var x443 uint32
	_, x443 = bits.Mul32(x425, 0x72350975)
	var x445 uint32
	var x446 uint32
	...
	var x453 uint32
	var x454 uint32
	x454, x453 = bits.Mul32(x443, 0x7203df6b)
	var x455 uint32
	var x456 uint32
	x456, x455 = bits.Mul32(x443, 0x21c6052b)
	var x457 uint32
	var x458 uint32
	x458, x457 = bits.Mul32(x443, 0x53bbf409)
	var x459 uint32
	var x460 uint32
	x460, x459 = bits.Mul32(x443, 0x39d54123)
	var x461 uint32
	var x462 uint32
	...
	var x544 uint32
	_, x544 = bits.Mul32(x526, 0x72350975)
	var x546 uint32
	var x547 uint32
	x547, x546 = bits.Mul32(x544, 0xfffffffe)
	var x548 uint32
	var x549 uint32
	...
	var x554 uint32
	var x555 uint32
	x555, x554 = bits.Mul32(x544, 0x7203df6b)
	var x556 uint32
	var x557 uint32
	x557, x556 = bits.Mul32(x544, 0x21c6052b)
	var x558 uint32
	var x559 uint32
	x559, x558 = bits.Mul32(x544, 0x53bbf409)
	var x560 uint32
	var x561 uint32
	x561, x560 = bits.Mul32(x544, 0x39d54123)
	var x562 uint32
	var x563 uint32
	...
	var x645 uint32
	_, x645 = bits.Mul32(x627, 0x72350975)
	var x647 uint32
	var x648 uint32
	x648, x647 = bits.Mul32(x645, 0xfffffffe)
	var x649 uint32
	var x650 uint32
	...
	var x655 uint32
	var x656 uint32
	x656, x655 = bits.Mul32(x645, 0x7203df6b)
	var x657 uint32
	var x658 uint32
	x658, x657 = bits.Mul32(x645, 0x21c6052b)
	var x659 uint32
	var x660 uint32
	x660, x659 = bits.Mul32(x645, 0x53bbf409)
	var x661 uint32
	var x662 uint32
	x662, x661 = bits.Mul32(x645, 0x39d54123)
	var x663 uint32
	var x664 uint32
	...
	var x746 uint32
	_, x746 = bits.Mul32(x728, 0x72350975)
	var x748 uint32
	var x749 uint32
	x749, x748 = bits.Mul32(x746, 0xfffffffe)
	var x750 uint32
	var x751 uint32
	...
	var x756 uint32
	var x757 uint32
	x757, x756 = bits.Mul32(x746, 0x7203df6b)
	var x758 uint32
	var x759 uint32
	x759, x758 = bits.Mul32(x746, 0x21c6052b)
	var x760 uint32
	var x761 uint32
	x761, x760 = bits.Mul32(x746, 0x53bbf409)
	var x762 uint32
	var x763 uint32
	x763, x762 = bits.Mul32(x746, 0x39d54123)
	var x764 uint32
	var x765 uint32
	...
	var x798 uint32
	var x799 uint32
	x798, x799 = bits.Sub32(x781, 0x39d54123, uint32(0x0))
	var x800 uint32
	var x801 uint32
	x800, x801 = bits.Sub32(x783, 0x53bbf409, uint32(uint1(x799)))
	var x802 uint32
	var x803 uint32
	x802, x803 = bits.Sub32(x785, 0x21c6052b, uint32(uint1(x801)))
	var x804 uint32
	var x805 uint32
	x804, x805 = bits.Sub32(x787, 0x7203df6b, uint32(uint1(x803)))
	var x806 uint32
	var x807 uint32
	...
	var x812 uint32
	var x813 uint32
	x812, x813 = bits.Sub32(x795, 0xfffffffe, uint32(uint1(x811)))
	var x815 uint32
...
func Add(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x17 uint32
	var x18 uint32
	x17, x18 = bits.Sub32(x1, 0x39d54123, uint32(0x0))
	var x19 uint32
	var x20 uint32
	x19, x20 = bits.Sub32(x3, 0x53bbf409, uint32(uint1(x18)))
	var x21 uint32
	var x22 uint32
	x21, x22 = bits.Sub32(x5, 0x21c6052b, uint32(uint1(x20)))
	var x23 uint32
	var x24 uint32
	x23, x24 = bits.Sub32(x7, 0x7203df6b, uint32(uint1(x22)))
	var x25 uint32
	var x26 uint32
...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x18 uint32
	var x19 uint32
	x18, x19 = bits.Add32(x1, (x17 & 0x39d54123), uint32(0x0))
	var x20 uint32
	var x21 uint32
	x20, x21 = bits.Add32(x3, (x17 & 0x53bbf409), uint32(uint1(x19)))
	var x22 uint32
	var x23 uint32
	x22, x23 = bits.Add32(x5, (x17 & 0x21c6052b), uint32(uint1(x21)))
	var x24 uint32
	var x25 uint32
	x24, x25 = bits.Add32(x7, (x17 & 0x7203df6b), uint32(uint1(x23)))
	var x26 uint32
	var x27 uint32
...
func FromMontgomery(out1 *NonMontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement) {
	x1 := arg1[0]
	var x2 uint32
	_, x2 = bits.Mul32(x1, 0x72350975)
	var x4 uint32
	var x5 uint32
	x5, x4 = bits.Mul32(x2, 0xfffffffe)
	var x6 uint32
	var x7 uint32
	...
	var x12 uint32
	var x13 uint32
	x13, x12 = bits.Mul32(x2, 0x7203df6b)
	var x14 uint32
	var x15 uint32
	x15, x14 = bits.Mul32(x2, 0x21c6052b)
	var x16 uint32
	var x17 uint32
	x17, x16 = bits.Mul32(x2, 0x53bbf409)
	var x18 uint32
	var x19 uint32
	x19, x18 = bits.Mul32(x2, 0x39d54123)
	var x20 uint32
	var x21 uint32
	...
	var x50 uint32
	var x51 uint32
	x50, x51 = bits.Add32(x36, arg1[1], uint32(0x0))
	var x52 uint32
	var x53 uint32
	...
	var x58 uint32
	var x59 uint32
	x58, x59 = bits.Add32(x44, uint32(0x0), uint32(uint1(x57)))
	var x60 uint32
	var x61 uint32
	x60, x61 = bits.Add32(x46, uint32(0x0), uint32(uint1(x59)))
	var x62 uint32
	var x63 uint32
	x62, x63 = bits.Add32(x48, uint32(0x0), uint32(uint1(x61)))
	var x64 uint32
	var x65 uint32
	x64, x65 = bits.Add32((uint32(uint1(x49)) + (uint32(uint1(x33)) + x5)), uint32(0x0), uint32(uint1(x63)))
	var x66 uint32
	_, x66 = bits.Mul32(x50, 0x72350975)
	var x68 uint32
	var x69 uint32
	x69, x68 = bits.Mul32(x66, 0xfffffffe)
	var x70 uint32
	var x71 uint32
	...
	var x76 uint32
	var x77 uint32
	x77, x76 = bits.Mul32(x66, 0x7203df6b)
	var x78 uint32
	var x79 uint32
	x79, x78 = bits.Mul32(x66, 0x21c6052b)
	var x80 uint32
	var x81 uint32
	x81, x80 = bits.Mul32(x66, 0x53bbf409)
	var x82 uint32
	var x83 uint32
	x83, x82 = bits.Mul32(x66, 0x39d54123)
	var x84 uint32
	var x85 uint32
	x84, x85 = bits.Add32(x83, x80, uint32(0x0))
	var x86 uint32
	var x87 uint32
	x86, x87 = bits.Add32(x81, x78, uint32(uint1(x85)))
	var x88 uint32
	var x89 uint32
	x88, x89 = bits.Add32(x79, x76, uint32(uint1(x87)))
	var x90 uint32
	var x91 uint32
	x90, x91 = bits.Add32(x77, x74, uint32(uint1(x89)))
	var x92 uint32
	var x93 uint32
	x92, x93 = bits.Add32(x75, x72, uint32(uint1(x91)))
	var x94 uint32
	var x95 uint32
	x94, x95 = bits.Add32(x73, x70, uint32(uint1(x93)))
	var x96 uint32
	var x97 uint32
	x96, x97 = bits.Add32(x71, x68, uint32(uint1(x95)))
	var x99 uint32
	_, x99 = bits.Add32(x50, x82, uint32(0x0))
	var x100 uint32
	var x101 uint32
	x100, x101 = bits.Add32(x52, x84, uint32(uint1(x99)))
	var x102 uint32
	var x103 uint32
	...
	var x114 uint32
	var x115 uint32
	x114, x115 = bits.Add32(uint32(uint1(x65)), (uint32(uint1(x97)) + x69), uint32(uint1(x113)))
	var x116 uint32
	var x117 uint32
	x116, x117 = bits.Add32(x100, arg1[2], uint32(0x0))
	var x118 uint32
	var x119 uint32
	...
	var x132 uint32
	_, x132 = bits.Mul32(x116, 0x72350975)
	var x134 uint32
	var x135 uint32
	x135, x134 = bits.Mul32(x132, 0xfffffffe)
	var x136 uint32
	var x137 uint32
	x137, x136 = bits.Mul32(x132, 0xffffffff)
	var x138 uint32
	var x139 uint32
	x139, x138 = bits.Mul32(x132, 0xffffffff)
	var x140 uint32
	var x141 uint32
	x141, x140 = bits.Mul32(x132, 0xffffffff)
	var x142 uint32
	var x143 uint32
	x143, x142 = bits.Mul32(x132, 0x7203df6b)
	var x144 uint32
	var x145 uint32
	x145, x144 = bits.Mul32(x132, 0x21c6052b)
	var x146 uint32
	var x147 uint32
	x147, x146 = bits.Mul32(x132, 0x53bbf409)
	var x148 uint32
	var x149 uint32
	x149, x148 = bits.Mul32(x132, 0x39d54123)
	var x150 uint32
	var x151 uint32
	...
	var x160 uint32
	var x161 uint32
	x160, x161 = bits.Add32(x139, x136, uint32(uint1(x159)))
	var x162 uint32
	var x163 uint32
	x162, x163 = bits.Add32(x137, x134, uint32(uint1(x161)))
	var x165 uint32
	_, x165 = bits.Add32(x116, x148, uint32(0x0))
	var x166 uint32
	var x167 uint32
	x166, x167 = bits.Add32(x118, x150, uint32(uint1(x165)))
	var x168 uint32
	var x169 uint32
	...
	var x180 uint32
	var x181 uint32
	x180, x181 = bits.Add32((uint32(uint1(x131)) + uint32(uint1(x115))), (uint32(uint1(x163)) + x135), uint32(uint1(x179)))
	var x182 uint32
	var x183 uint32
	x182, x183 = bits.Add32(x166, arg1[3], uint32(0x0))
	var x184 uint32
	var x185 uint32
	...
	var x198 uint32
	_, x198 = bits.Mul32(x182, 0x72350975)
	var x200 uint32
	var x201 uint32
	x201, x200 = bits.Mul32(x198, 0xfffffffe)
	var x202 uint32
	var x203 uint32
	...
	var x208 uint32
	var x209 uint32
	x209, x208 = bits.Mul32(x198, 0x7203df6b)
	var x210 uint32
	var x211 uint32
	x211, x210 = bits.Mul32(x198, 0x21c6052b)
	var x212 uint32
	var x213 uint32
	x213, x212 = bits.Mul32(x198, 0x53bbf409)
	var x214 uint32
	var x215 uint32
	x215, x214 = bits.Mul32(x198, 0x39d54123)
	var x216 uint32
	var x217 uint32
	x216, x217 = bits.Add32(x215, x212, uint32(0x0))
	var x218 uint32
	var x219 uint32
	x218, x219 = bits.Add32(x213, x210, uint32(uint1(x217)))
	var x220 uint32
	var x221 uint32
	x220, x221 = bits.Add32(x211, x208, uint32(uint1(x219)))
	var x222 uint32
	var x223 uint32
	x222, x223 = bits.Add32(x209, x206, uint32(uint1(x221)))
	var x224 uint32
	var x225 uint32
	x224, x225 = bits.Add32(x207, x204, uint32(uint1(x223)))
	var x226 uint32
	var x227 uint32
	x226, x227 = bits.Add32(x205, x202, uint32(uint1(x225)))
	var x228 uint32
	var x229 uint32
	x228, x229 = bits.Add32(x203, x200, uint32(uint1(x227)))
	var x231 uint32
	_, x231 = bits.Add32(x182, x214, uint32(0x0))
	var x232 uint32
	var x233 uint32
	x232, x233 = bits.Add32(x184, x216, uint32(uint1(x231)))
	var x234 uint32
	var x235 uint32
	...
	var x246 uint32
	var x247 uint32
	x246, x247 = bits.Add32((uint32(uint1(x197)) + uint32(uint1(x181))), (uint32(uint1(x229)) + x201), uint32(uint1(x245)))
	var x248 uint32
	var x249 uint32
	x248, x249 = bits.Add32(x232, arg1[4], uint32(0x0))
	var x250 uint32
	var x251 uint32
	x250, x251 = bits.Add32(x234, uint32(0x0), uint32(uint1(x249)))
	var x252 uint32
	var x253 uint32
	...
	var x264 uint32
	_, x264 = bits.Mul32(x248, 0x72350975)
	var x266 uint32
	var x267 uint32
	x267, x266 = bits.Mul32(x264, 0xfffffffe)
	var x268 uint32
	var x269 uint32
	x269, x268 = bits.Mul32(x264, 0xffffffff)
	var x270 uint32
	var x271 uint32
	x271, x270 = bits.Mul32(x264, 0xffffffff)
	var x272 uint32
	var x273 uint32
	x273, x272 = bits.Mul32(x264, 0xffffffff)
	var x274 uint32
	var x275 uint32
	x275, x274 = bits.Mul32(x264, 0x7203df6b)
	var x276 uint32
	var x277 uint32
	x277, x276 = bits.Mul32(x264, 0x21c6052b)
	var x278 uint32
	var x279 uint32
	x279, x278 = bits.Mul32(x264, 0x53bbf409)
	var x280 uint32
	var x281 uint32
	x281, x280 = bits.Mul32(x264, 0x39d54123)
	var x282 uint32
	var x283 uint32
	x282, x283 = bits.Add32(x281, x278, uint32(0x0))
	var x284 uint32
	var x285 uint32
	x284, x285 = bits.Add32(x279, x276, uint32(uint1(x283)))
	var x286 uint32
	var x287 uint32
	x286, x287 = bits.Add32(x277, x274, uint32(uint1(x285)))
	var x288 uint32
	var x289 uint32
	x288, x289 = bits.Add32(x275, x272, uint32(uint1(x287)))
	var x290 uint32
	var x291 uint32
	x290, x291 = bits.Add32(x273, x270, uint32(uint1(x289)))
	var x292 uint32
	var x293 uint32
	x292, x293 = bits.Add32(x271, x268, uint32(uint1(x291)))
	var x294 uint32
	var x295 uint32
	x294, x295 = bits.Add32(x269, x266, uint32(uint1(x293)))
	var x297 uint32
	_, x297 = bits.Add32(x248, x280, uint32(0x0))
	var x298 uint32
	var x299 uint32
	x298, x299 = bits.Add32(x250, x282, uint32(uint1(x297)))
	var x300 uint32
	var x301 uint32
	...
	var x312 uint32
	var x313 uint32
	x312, x313 = bits.Add32((uint32(uint1(x263)) + uint32(uint1(x247))), (uint32(uint1(x295)) + x267), uint32(uint1(x311)))
	var x314 uint32
	var x315 uint32
	x314, x315 = bits.Add32(x298, arg1[5], uint32(0x0))
	var x316 uint32
	var x317 uint32
	x316, x317 = bits.Add32(x300, uint32(0x0), uint32(uint1(x315)))
	var x318 uint32
	var x319 uint32
	...
	var x330 uint32
	_, x330 = bits.Mul32(x314, 0x72350975)
	var x332 uint32
	var x333 uint32
	x333, x332 = bits.Mul32(x330, 0xfffffffe)
	var x334 uint32
	var x335 uint32
	x335, x334 = bits.Mul32(x330, 0xffffffff)
	var x336 uint32
	var x337 uint32
	x337, x336 = bits.Mul32(x330, 0xffffffff)
	var x338 uint32
	var x339 uint32
	x339, x338 = bits.Mul32(x330, 0xffffffff)
	var x340 uint32
	var x341 uint32
	x341, x340 = bits.Mul32(x330, 0x7203df6b)
	var x342 uint32
	var x343 uint32
	x343, x342 = bits.Mul32(x330, 0x21c6052b)
	var x344 uint32
	var x345 uint32
	x345, x344 = bits.Mul32(x330, 0x53bbf409)
	var x346 uint32
	var x347 uint32
	x347, x346 = bits.Mul32(x330, 0x39d54123)
	var x348 uint32
	var x349 uint32
	x348, x349 = bits.Add32(x347, x344, uint32(0x0))
	var x350 uint32
	var x351 uint32
	x350, x351 = bits.Add32(x345, x342, uint32(uint1(x349)))
	var x352 uint32
	var x353 uint32
	x352, x353 = bits.Add32(x343, x340, uint32(uint1(x351)))
	var x354 uint32
	var x355 uint32
	x354, x355 = bits.Add32(x341, x338, uint32(uint1(x353)))
	var x356 uint32
	var x357 uint32
	x356, x357 = bits.Add32(x339, x336, uint32(uint1(x355)))
	var x358 uint32
	var x359 uint32
	x358, x359 = bits.Add32(x337, x334, uint32(uint1(x357)))
	var x360 uint32
	var x361 uint32
	x360, x361 = bits.Add32(x335, x332, uint32(uint1(x359)))
	var x363 uint32
	_, x363 = bits.Add32(x314, x346, uint32(0x0))
	var x364 uint32
	var x365 uint32
	x364, x365 = bits.Add32(x316, x348, uint32(uint1(x363)))
	var x366 uint32
	var x367 uint32
	...
	var x378 uint32
	var x379 uint32
	x378, x379 = bits.Add32((uint32(uint1(x329)) + uint32(uint1(x313))), (uint32(uint1(x361)) + x333), uint32(uint1(x377)))
	var x380 uint32
	var x381 uint32
	x380, x381 = bits.Add32(x364, arg1[6], uint32(0x0))
	var x382 uint32
	var x383 uint32
	x382, x383 = bits.Add32(x366, uint32(0x0), uint32(uint1(x381)))
	var x384 uint32
	var x385 uint32
	...
	var x396 uint32
	_, x396 = bits.Mul32(x380, 0x72350975)
	var x398 uint32
	var x399 uint32
	x399, x398 = bits.Mul32(x396, 0xfffffffe)
	var x400 uint32
	var x401 uint32
	x401, x400 = bits.Mul32(x396, 0xffffffff)
	var x402 uint32
	var x403 uint32
	x403, x402 = bits.Mul32(x396, 0xffffffff)
	var x404 uint32
	var x405 uint32
	x405, x404 = bits.Mul32(x396, 0xffffffff)
	var x406 uint32
	var x407 uint32
	x407, x406 = bits.Mul32(x396, 0x7203df6b)
	var x408 uint32
	var x409 uint32
	x409, x408 = bits.Mul32(x396, 0x21c6052b)
	var x410 uint32
	var x411 uint32
	x411, x410 = bits.Mul32(x396, 0x53bbf409)
	var x412 uint32
	var x413 uint32
	x413, x412 = bits.Mul32(x396, 0x39d54123)
	var x414 uint32
	var x415 uint32
	x414, x415 = bits.Add32(x413, x410, uint32(0x0))
	var x416 uint32
	var x417 uint32
	x416, x417 = bits.Add32(x411, x408, uint32(uint1(x415)))
	var x418 uint32
	var x419 uint32
	x418, x419 = bits.Add32(x409, x406, uint32(uint1(x417)))
	var x420 uint32
	var x421 uint32
	x420, x421 = bits.Add32(x407, x404, uint32(uint1(x419)))
	var x422 uint32
	var x423 uint32
	x422, x423 = bits.Add32(x405, x402, uint32(uint1(x421)))
	var x424 uint32
	var x425 uint32
	x424, x425 = bits.Add32(x403, x400, uint32(uint1(x423)))
	var x426 uint32
	var x427 uint32
	x426, x427 = bits.Add32(x401, x398, uint32(uint1(x425)))
	var x429 uint32
	_, x429 = bits.Add32(x380, x412, uint32(0x0))
	var x430 uint32
	var x431 uint32
	x430, x431 = bits.Add32(x382, x414, uint32(uint1(x429)))
	var x432 uint32
	var x433 uint32
	...
	var x444 uint32
	var x445 uint32
	x444, x445 = bits.Add32((uint32(uint1(x395)) + uint32(uint1(x379))), (uint32(uint1(x427)) + x399), uint32(uint1(x443)))
	var x446 uint32
	var x447 uint32
	x446, x447 = bits.Add32(x430, arg1[7], uint32(0x0))
	var x448 uint32
	var x449 uint32
	x448, x449 = bits.Add32(x432, uint32(0x0), uint32(uint1(x447)))
	var x450 uint32
	var x451 uint32
	...
	var x462 uint32
	_, x462 = bits.Mul32(x446, 0x72350975)
	var x464 uint32
	var x465 uint32
	x465, x464 = bits.Mul32(x462, 0xfffffffe)
	var x466 uint32
	var x467 uint32
	x467, x466 = bits.Mul32(x462, 0xffffffff)
	var x468 uint32
	var x469 uint32
	x469, x468 = bits.Mul32(x462, 0xffffffff)
	var x470 uint32
	var x471 uint32
	x471, x470 = bits.Mul32(x462, 0xffffffff)
	var x472 uint32
	var x473 uint32
	x473, x472 = bits.Mul32(x462, 0x7203df6b)
	var x474 uint32
	var x475 uint32
	x475, x474 = bits.Mul32(x462, 0x21c6052b)
	var x476 uint32
	var x477 uint32
	x477, x476 = bits.Mul32(x462, 0x53bbf409)
	var x478 uint32
	var x479 uint32
	x479, x478 = bits.Mul32(x462, 0x39d54123)
	var x480 uint32
	var x481 uint32
	x480, x481 = bits.Add32(x479, x476, uint32(0x0))
	var x482 uint32
	var x483 uint32
	x482, x483 = bits.Add32(x477, x474, uint32(uint1(x481)))
	var x484 uint32
	var x485 uint32
	x484, x485 = bits.Add32(x475, x472, uint32(uint1(x483)))
	var x486 uint32
	var x487 uint32
	x486, x487 = bits.Add32(x473, x470, uint32(uint1(x485)))
	var x488 uint32
	var x489 uint32
	x488, x489 = bits.Add32(x471, x468, uint32(uint1(x487)))
	var x490 uint32
	var x491 uint32
	x490, x491 = bits.Add32(x469, x466, uint32(uint1(x489)))
	var x492 uint32
	var x493 uint32
	x492, x493 = bits.Add32(x467, x464, uint32(uint1(x491)))
	var x495 uint32
	_, x495 = bits.Add32(x446, x478, uint32(0x0))
	var x496 uint32
	var x497 uint32
	x496, x497 = bits.Add32(x448, x480, uint32(uint1(x495)))
	var x498 uint32
	var x499 uint32
	...
	var x510 uint32
	var x511 uint32
	x510, x511 = bits.Add32((uint32(uint1(x461)) + uint32(uint1(x445))), (uint32(uint1(x493)) + x465), uint32(uint1(x509)))
	var x512 uint32
	var x513 uint32
	x512, x513 = bits.Sub32(x496, 0x39d54123, uint32(0x0))
	var x514 uint32
	var x515 uint32
	x514, x515 = bits.Sub32(x498, 0x53bbf409, uint32(uint1(x513)))
	var x516 uint32
	var x517 uint32
	x516, x517 = bits.Sub32(x500, 0x21c6052b, uint32(uint1(x515)))
	var x518 uint32
	var x519 uint32
	x518, x519 = bits.Sub32(x502, 0x7203df6b, uint32(uint1(x517)))
	var x520 uint32
	var x521 uint32
	...
	var x526 uint32
	var x527 uint32
	x526, x527 = bits.Sub32(x510, 0xfffffffe, uint32(uint1(x525)))
	var x529 uint32
	_, x529 = bits.Sub32(uint32(uint1(x511)), uint32(0x0), uint32(uint1(x527)))
	var x530 uint32
	cmovznzU32(&x530, uint1(x529), x512, x496)
	var x531 uint32
	cmovznzU32(&x531, uint1(x529), x514, x498)
	var x532 uint32
	cmovznzU32(&x532, uint1(x529), x516, x500)
	var x533 uint32
	cmovznzU32(&x533, uint1(x529), x518, x502)
	var x534 uint32
	cmovznzU32(&x534, uint1(x529), x520, x504)
	var x535 uint32
	cmovznzU32(&x535, uint1(x529), x522, x506)
	var x536 uint32
	cmovznzU32(&x536, uint1(x529), x524, x508)
	var x537 uint32
	cmovznzU32(&x537, uint1(x529), x526, x510)
	out1[0] = x530
	out1[1] = x531
	out1[2] = x532
	out1[3] = x533
...
func ToMontgomery(out1 *MontgomeryDomainFieldElement, arg1 *NonMontgomeryDomainFieldElement) {
	...
	var x9 uint32
	var x10 uint32
	x10, x9 = bits.Mul32(x8, 0x1eb5e412)
	var x11 uint32
	var x12 uint32
	x12, x11 = bits.Mul32(x8, 0xa22b3d3b)
	var x13 uint32
	var x14 uint32
	x14, x13 = bits.Mul32(x8, 0x620fc84c)
	var x15 uint32
	var x16 uint32
	x16, x15 = bits.Mul32(x8, 0x3affe0d4)
	var x17 uint32
	var x18 uint32
	x18, x17 = bits.Mul32(x8, 0x3464504a)
	var x19 uint32
	var x20 uint32
	x20, x19 = bits.Mul32(x8, 0xde6fa2fa)
	var x21 uint32
	var x22 uint32
	x22, x21 = bits.Mul32(x8, 0x901192af)
	var x23 uint32
	var x24 uint32
	x24, x23 = bits.Mul32(x8, 0x7c114f20)
	var x25 uint32
	var x26 uint32
	x25, x26 = bits.Add32(x24, x21, uint32(0x0))
	var x27 uint32
	...
	x37, x38 = bits.Add32(x12, x9, uint32(uint1(x36)))
	var x39 uint32
	_, x39 = bits.Mul32(x23, 0x72350975)
	var x41 uint32
	var x42 uint32
	x42, x41 = bits.Mul32(x39, 0xfffffffe)
	var x43 uint32
	var x44 uint32
	...
	var x47 uint32
	var x48 uint32
	x48, x47 = bits.Mul32(x39, 0xffffffff)
	var x49 uint32
	var x50 uint32
	x50, x49 = bits.Mul32(x39, 0x7203df6b)
	var x51 uint32
	var x52 uint32
	x52, x51 = bits.Mul32(x39, 0x21c6052b)
	var x53 uint32
	var x54 uint32
	x54, x53 = bits.Mul32(x39, 0x53bbf409)
	var x55 uint32
	var x56 uint32
	x56, x55 = bits.Mul32(x39, 0x39d54123)
	var x57 uint32
	var x58 uint32
	...
	var x89 uint32
	var x90 uint32
	x90, x89 = bits.Mul32(x1, 0x1eb5e412)
	var x91 uint32
	var x92 uint32
	x92, x91 = bits.Mul32(x1, 0xa22b3d3b)
	var x93 uint32
	var x94 uint32
	x94, x93 = bits.Mul32(x1, 0x620fc84c)
	var x95 uint32
	var x96 uint32
	x96, x95 = bits.Mul32(x1, 0x3affe0d4)
	var x97 uint32
	var x98 uint32
	x98, x97 = bits.Mul32(x1, 0x3464504a)
	var x99 uint32
	var x100 uint32
	x100, x99 = bits.Mul32(x1, 0xde6fa2fa)
	var x101 uint32
	var x102 uint32
	x102, x101 = bits.Mul32(x1, 0x901192af)
	var x103 uint32
	var x104 uint32
	x104, x103 = bits.Mul32(x1, 0x7c114f20)
	var x105 uint32
	var x106 uint32
	...
	var x135 uint32
	_, x135 = bits.Mul32(x119, 0x72350975)
	var x137 uint32
	var x138 uint32
	x138, x137 = bits.Mul32(x135, 0xfffffffe)
	var x139 uint32
	var x140 uint32
	...
	var x143 uint32
	var x144 uint32
	x144, x143 = bits.Mul32(x135, 0xffffffff)
	var x145 uint32
	var x146 uint32
	x146, x145 = bits.Mul32(x135, 0x7203df6b)
	var x147 uint32
	var x148 uint32
	x148, x147 = bits.Mul32(x135, 0x21c6052b)
	var x149 uint32
	var x150 uint32
	x150, x149 = bits.Mul32(x135, 0x53bbf409)
	var x151 uint32
	var x152 uint32
	x152, x151 = bits.Mul32(x135, 0x39d54123)
	var x153 uint32
	var x154 uint32
	...
	var x185 uint32
	var x186 uint32
	x186, x185 = bits.Mul32(x2, 0x1eb5e412)
	var x187 uint32
	var x188 uint32
	x188, x187 = bits.Mul32(x2, 0xa22b3d3b)
	var x189 uint32
	var x190 uint32
	x190, x189 = bits.Mul32(x2, 0x620fc84c)
	var x191 uint32
	var x192 uint32
	x192, x191 = bits.Mul32(x2, 0x3affe0d4)
	var x193 uint32
	var x194 uint32
	x194, x193 = bits.Mul32(x2, 0x3464504a)
	var x195 uint32
	var x196 uint32
	x196, x195 = bits.Mul32(x2, 0xde6fa2fa)
	var x197 uint32
	var x198 uint32
	x198, x197 = bits.Mul32(x2, 0x901192af)
	var x199 uint32
	var x200 uint32
	x200, x199 = bits.Mul32(x2, 0x7c114f20)
	var x201 uint32
	var x202 uint32
	...
	var x231 uint32
	_, x231 = bits.Mul32(x215, 0x72350975)
	var x233 uint32
	var x234 uint32
	x234, x233 = bits.Mul32(x231, 0xfffffffe)
	var x235 uint32
	var x236 uint32
	...
	var x239 uint32
	var x240 uint32
	x240, x239 = bits.Mul32(x231, 0xffffffff)
	var x241 uint32
	var x242 uint32
	x242, x241 = bits.Mul32(x231, 0x7203df6b)
	var x243 uint32
	var x244 uint32
	x244, x243 = bits.Mul32(x231, 0x21c6052b)
	var x245 uint32
	var x246 uint32
	x246, x245 = bits.Mul32(x231, 0x53bbf409)
	var x247 uint32
	var x248 uint32
	x248, x247 = bits.Mul32(x231, 0x39d54123)
	var x249 uint32
	var x250 uint32
	...
	var x281 uint32
	var x282 uint32
	x282, x281 = bits.Mul32(x3, 0x1eb5e412)
	var x283 uint32
	var x284 uint32
	x284, x283 = bits.Mul32(x3, 0xa22b3d3b)
	var x285 uint32
	var x286 uint32
	x286, x285 = bits.Mul32(x3, 0x620fc84c)
	var x287 uint32
	var x288 uint32
	x288, x287 = bits.Mul32(x3, 0x3affe0d4)
	var x289 uint32
	var x290 uint32
	x290, x289 = bits.Mul32(x3, 0x3464504a)
	var x291 uint32
	var x292 uint32
	x292, x291 = bits.Mul32(x3, 0xde6fa2fa)
	var x293 uint32
	var x294 uint32
	x294, x293 = bits.Mul32(x3, 0x901192af)
	var x295 uint32
	var x296 uint32
	x296, x295 = bits.Mul32(x3, 0x7c114f20)
	var x297 uint32
	var x298 uint32
	...
	var x327 uint32
	_, x327 = bits.Mul32(x311, 0x72350975)
	var x329 uint32
	var x330 uint32
	x330, x329 = bits.Mul32(x327, 0xfffffffe)
	var x331 uint32
	var x332 uint32
	...
	var x335 uint32
	var x336 uint32
	x336, x335 = bits.Mul32(x327, 0xffffffff)
	var x337 uint32
	var x338 uint32
	x338, x337 = bits.Mul32(x327, 0x7203df6b)
	var x339 uint32
	var x340 uint32
	x340, x339 = bits.Mul32(x327, 0x21c6052b)
	var x341 uint32
	var x342 uint32
	x342, x341 = bits.Mul32(x327, 0x53bbf409)
	var x343 uint32
	var x344 uint32
	x344, x343 = bits.Mul32(x327, 0x39d54123)
	var x345 uint32
	var x346 uint32
	...
	var x377 uint32
	var x378 uint32
	x378, x377 = bits.Mul32(x4, 0x1eb5e412)
	var x379 uint32
	var x380 uint32
	x380, x379 = bits.Mul32(x4, 0xa22b3d3b)
	var x381 uint32
	var x382 uint32
	x382, x381 = bits.Mul32(x4, 0x620fc84c)
	var x383 uint32
	var x384 uint32
	x384, x383 = bits.Mul32(x4, 0x3affe0d4)
	var x385 uint32
	var x386 uint32
	x386, x385 = bits.Mul32(x4, 0x3464504a)
	var x387 uint32
	var x388 uint32
	x388, x387 = bits.Mul32(x4, 0xde6fa2fa)
	var x389 uint32
	var x390 uint32
	x390, x389 = bits.Mul32(x4, 0x901192af)
	var x391 uint32
	var x392 uint32
	x392, x391 = bits.Mul32(x4, 0x7c114f20)
	var x393 uint32
	var x394 uint32
	...
	var x423 uint32
	_, x423 = bits.Mul32(x407, 0x72350975)
	var x425 uint32
	var x426 uint32
	x426, x425 = bits.Mul32(x423, 0xfffffffe)
	var x427 uint32
	var x428 uint32
	...
	var x431 uint32
	var x432 uint32
	x432, x431 = bits.Mul32(x423, 0xffffffff)
	var x433 uint32
	var x434 uint32
	x434, x433 = bits.Mul32(x423, 0x7203df6b)
	var x435 uint32
	var x436 uint32
	x436, x435 = bits.Mul32(x423, 0x21c6052b)
	var x437 uint32
	var x438 uint32
	x438, x437 = bits.Mul32(x423, 0x53bbf409)
	var x439 uint32
	var x440 uint32
	x440, x439 = bits.Mul32(x423, 0x39d54123)
	var x441 uint32
	var x442 uint32
	...
	var x473 uint32
	var x474 uint32
	x474, x473 = bits.Mul32(x5, 0x1eb5e412)
	var x475 uint32
	var x476 uint32
	x476, x475 = bits.Mul32(x5, 0xa22b3d3b)
	var x477 uint32
	var x478 uint32
	x478, x477 = bits.Mul32(x5, 0x620fc84c)
	var x479 uint32
	var x480 uint32
	x480, x479 = bits.Mul32(x5, 0x3affe0d4)
	var x481 uint32
	var x482 uint32
	x482, x481 = bits.Mul32(x5, 0x3464504a)
	var x483 uint32
	var x484 uint32
	x484, x483 = bits.Mul32(x5, 0xde6fa2fa)
	var x485 uint32
	var x486 uint32
	x486, x485 = bits.Mul32(x5, 0x901192af)
	var x487 uint32
	var x488 uint32
	x488, x487 = bits.Mul32(x5, 0x7c114f20)
	var x489 uint32
	var x490 uint32
	...
	var x519 uint32
	_, x519 = bits.Mul32(x503, 0x72350975)
	var x521 uint32
	var x522 uint32
	x522, x521 = bits.Mul32(x519, 0xfffffffe)
	var x523 uint32
	var x524 uint32
	...
	var x527 uint32
	var x528 uint32
	x528, x527 = bits.Mul32(x519, 0xffffffff)
	var x529 uint32
	var x530 uint32
	x530, x529 = bits.Mul32(x519, 0x7203df6b)
	var x531 uint32
	var x532 uint32
	x532, x531 = bits.Mul32(x519, 0x21c6052b)
	var x533 uint32
	var x534 uint32
	x534, x533 = bits.Mul32(x519, 0x53bbf409)
	var x535 uint32
	var x536 uint32
	x536, x535 = bits.Mul32(x519, 0x39d54123)
	var x537 uint32
	var x538 uint32
	...
	var x569 uint32
	var x570 uint32
	x570, x569 = bits.Mul32(x6, 0x1eb5e412)
	var x571 uint32
	var x572 uint32
	x572, x571 = bits.Mul32(x6, 0xa22b3d3b)
	var x573 uint32
	var x574 uint32
	x574, x573 = bits.Mul32(x6, 0x620fc84c)
	var x575 uint32
	var x576 uint32
	x576, x575 = bits.Mul32(x6, 0x3affe0d4)
	var x577 uint32
	var x578 uint32
	x578, x577 = bits.Mul32(x6, 0x3464504a)
	var x579 uint32
	var x580 uint32
	x580, x579 = bits.Mul32(x6, 0xde6fa2fa)
	var x581 uint32
	var x582 uint32
	x582, x581 = bits.Mul32(x6, 0x901192af)
	var x583 uint32
	var x584 uint32
	x584, x583 = bits.Mul32(x6, 0x7c114f20)
	var x585 uint32
	var x586 uint32
	...
	var x615 uint32
	_, x615 = bits.Mul32(x599, 0x72350975)
	var x617 uint32
	var x618 uint32
	x618, x617 = bits.Mul32(x615, 0xfffffffe)
	var x619 uint32
	var x620 uint32
	...
	var x623 uint32
	var x624 uint32
	x624, x623 = bits.Mul32(x615, 0xffffffff)
	var x625 uint32
	var x626 uint32
	x626, x625 = bits.Mul32(x615, 0x7203df6b)
	var x627 uint32
	var x628 uint32
	x628, x627 = bits.Mul32(x615, 0x21c6052b)
	var x629 uint32
	var x630 uint32
	x630, x629 = bits.Mul32(x615, 0x53bbf409)
	var x631 uint32
	var x632 uint32
	x632, x631 = bits.Mul32(x615, 0x39d54123)
	var x633 uint32
	var x634 uint32
	...
	var x665 uint32
	var x666 uint32
	x666, x665 = bits.Mul32(x7, 0x1eb5e412)
	var x667 uint32
	var x668 uint32
	x668, x667 = bits.Mul32(x7, 0xa22b3d3b)
	var x669 uint32
	var x670 uint32
	x670, x669 = bits.Mul32(x7, 0x620fc84c)
	var x671 uint32
	var x672 uint32
	x672, x671 = bits.Mul32(x7, 0x3affe0d4)
	var x673 uint32
	var x674 uint32
	x674, x673 = bits.Mul32(x7, 0x3464504a)
	var x675 uint32
	var x676 uint32
	x676, x675 = bits.Mul32(x7, 0xde6fa2fa)
	var x677 uint32
	var x678 uint32
	x678, x677 = bits.Mul32(x7, 0x901192af)
	var x679 uint32
	var x680 uint32
	x680, x679 = bits.Mul32(x7, 0x7c114f20)
	var x681 uint32
	var x682 uint32
	...
	var x711 uint32
	_, x711 = bits.Mul32(x695, 0x72350975)
	var x713 uint32
	var x714 uint32
	x714, x713 = bits.Mul32(x711, 0xfffffffe)
	var x715 uint32
	var x716 uint32
	...
	var x719 uint32
	var x720 uint32
	x720, x719 = bits.Mul32(x711, 0xffffffff)
	var x721 uint32
	var x722 uint32
	x722, x721 = bits.Mul32(x711, 0x7203df6b)
	var x723 uint32
	var x724 uint32
	x724, x723 = bits.Mul32(x711, 0x21c6052b)
	var x725 uint32
	var x726 uint32
	x726, x725 = bits.Mul32(x711, 0x53bbf409)
	var x727 uint32
	var x728 uint32
	x728, x727 = bits.Mul32(x711, 0x39d54123)
	var x729 uint32
	var x730 uint32
	...
	var x761 uint32
	var x762 uint32
	x761, x762 = bits.Sub32(x745, 0x39d54123, uint32(0x0))
	var x763 uint32
	var x764 uint32
	x763, x764 = bits.Sub32(x747, 0x53bbf409, uint32(uint1(x762)))
	var x765 uint32
	var x766 uint32
	x765, x766 = bits.Sub32(x749, 0x21c6052b, uint32(uint1(x764)))
	var x767 uint32
	var x768 uint32
	x767, x768 = bits.Sub32(x751, 0x7203df6b, uint32(uint1(x766)))
	var x769 uint32
	var x770 uint32
	x769, x770 = bits.Sub32(x753, 0xffffffff, uint32(uint1(x768)))
	var x771 uint32
	var x772 uint32
	...
	var x775 uint32
	var x776 uint32
	x775, x776 = bits.Sub32(x759, 0xfffffffe, uint32(uint1(x774)))
	var x778 uint32
...
func Divstep(out1 *uint32, out2 *[9]uint32, out3 *[9]uint32, out4 *[8]uint32, out5 *[8]uint32, arg1 uint32, arg2 *[9]uint32, arg3 *[9]uint32, arg4 *[8]uint32, arg5 *[8]uint32) {
	...
	var x67 uint32
	var x68 uint32
	x67, x68 = bits.Sub32(x51, 0x39d54123, uint32(0x0))
	var x69 uint32
	var x70 uint32
	x69, x70 = bits.Sub32(x53, 0x53bbf409, uint32(uint1(x68)))
	var x71 uint32
	var x72 uint32
	x71, x72 = bits.Sub32(x55, 0x21c6052b, uint32(uint1(x70)))
	var x73 uint32
	var x74 uint32
	x73, x74 = bits.Sub32(x57, 0x7203df6b, uint32(uint1(x72)))
	var x75 uint32
	var x76 uint32
	...
	var x110 uint32
	var x111 uint32
	x110, x111 = bits.Add32(x93, (x109 & 0x39d54123), uint32(0x0))
	var x112 uint32
	var x113 uint32
	x112, x113 = bits.Add32(x95, (x109 & 0x53bbf409), uint32(uint1(x111)))
	var x114 uint32
	var x115 uint32
	x114, x115 = bits.Add32(x97, (x109 & 0x21c6052b), uint32(uint1(x113)))
	var x116 uint32
	var x117 uint32
	x116, x117 = bits.Add32(x99, (x109 & 0x7203df6b), uint32(uint1(x115)))
	var x118 uint32
	var x119 uint32
	...
	var x186 uint32
	var x187 uint32
	x186, x187 = bits.Sub32(x170, 0x39d54123, uint32(0x0))
	var x188 uint32
	var x189 uint32
	x188, x189 = bits.Sub32(x172, 0x53bbf409, uint32(uint1(x187)))
	var x190 uint32
	var x191 uint32
	x190, x191 = bits.Sub32(x174, 0x21c6052b, uint32(uint1(x189)))
	var x192 uint32
	var x193 uint32
	x192, x193 = bits.Sub32(x176, 0x7203df6b, uint32(uint1(x191)))
	var x194 uint32
	var x195 uint32
