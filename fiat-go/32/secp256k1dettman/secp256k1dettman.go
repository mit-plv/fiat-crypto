...
func Mul(out1 *[10]uint32, arg1 *[10]uint32, arg2 *[10]uint32) {
	...
	x16 := (x15 >> 22)
	x17 := (x15 & 0x3fffff)
	x18 := (uint64(x14) + (((uint64(arg1[1]) * uint64(arg2[9])) + ((uint64(arg1[2]) * uint64(arg2[8])) + ((uint64(arg1[3]) * uint64(arg2[7])) + ((uint64(arg1[4]) * uint64(arg2[6])) + ((uint64(arg1[5]) * uint64(arg2[5])) + ((uint64(arg1[6]) * uint64(arg2[4])) + ((uint64(arg1[7]) * uint64(arg2[3])) + ((uint64(arg1[8]) * uint64(arg2[2])) + (uint64(arg1[9]) * uint64(arg2[1])))))))))) + uint64((x8 << 16))))
	x19 := uint32((x18 >> 26))
	x20 := (uint32(x18) & 0x3ffffff)
	x21 := ((uint64(arg1[0]) * uint64(arg2[0])) + (uint64((x16 + (x20 << 4))) * uint64(0x3d1)))
	x22 := uint32((x21 >> 26))
	x23 := (uint32(x21) & 0x3ffffff)
	x24 := (uint64(x19) + ((uint64(arg1[2]) * uint64(arg2[9])) + ((uint64(arg1[3]) * uint64(arg2[8])) + ((uint64(arg1[4]) * uint64(arg2[7])) + ((uint64(arg1[5]) * uint64(arg2[6])) + ((uint64(arg1[6]) * uint64(arg2[5])) + ((uint64(arg1[7]) * uint64(arg2[4])) + ((uint64(arg1[8]) * uint64(arg2[3])) + (uint64(arg1[9]) * uint64(arg2[2]))))))))))
	x25 := uint32((x24 >> 26))
	x26 := (uint32(x24) & 0x3ffffff)
	x27 := ((uint64(x22) + (((uint64(arg1[0]) * uint64(arg2[1])) + (uint64(arg1[1]) * uint64(arg2[0]))) + (uint64((x16 + (x20 << 4))) << 6))) + (uint64(x26) * uint64(0x3d10)))
	x28 := uint32((x27 >> 26))
...
func Square(out1 *[10]uint32, arg1 *[10]uint32) {
	...
	x25 := (x24 >> 22)
	x26 := (x24 & 0x3fffff)
	x27 := (uint64(x23) + (((uint64(x8) * uint64(arg1[9])) + ((uint64(x7) * uint64(arg1[8])) + ((uint64(x6) * uint64(arg1[7])) + ((uint64(x5) * uint64(arg1[6])) + (uint64(arg1[5]) * uint64(arg1[5])))))) + uint64((x17 << 16))))
	x28 := uint32((x27 >> 26))
	x29 := (uint32(x27) & 0x3ffffff)
	x30 := ((uint64(arg1[0]) * uint64(arg1[0])) + (uint64((x25 + (x29 << 4))) * uint64(0x3d1)))
	x31 := uint32((x30 >> 26))
	x32 := (uint32(x30) & 0x3ffffff)
	x33 := (uint64(x28) + ((uint64(x7) * uint64(arg1[9])) + ((uint64(x6) * uint64(arg1[8])) + ((uint64(x5) * uint64(arg1[7])) + (uint64(x4) * uint64(arg1[6]))))))
	x34 := uint32((x33 >> 26))
	x35 := (uint32(x33) & 0x3ffffff)
	x36 := ((uint64(x31) + ((uint64(x9) * uint64(arg1[1])) + (uint64((x25 + (x29 << 4))) << 6))) + (uint64(x35) * uint64(0x3d10)))
	x37 := uint32((x36 >> 26))
	x38 := (uint32(x36) & 0x3ffffff)
