...
//
// Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Go --no-wide-int --relax-primitive-carry-to-bitwidth 32,64 --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --doc-newline-in-typedef-bounds --doc-prepend-header 'Code generated by Fiat Cryptography. DO NOT EDIT.' --doc-text-before-function-name '' --doc-text-before-type-name '' --package-name sm2 '' 64 '2^256 - 2^224 - 2^96 + 2^64 - 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
//
...
func Mul(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	x34 := (uint64(uint1(x33)) + x21)
	var x36 uint64
	_, x36 = bits.Add64(x11, x26, uint64(0x0))
	var x37 uint64
	var x38 uint64
	x37, x38 = bits.Add64(x13, x28, uint64(uint1(x36)))
	var x39 uint64
	var x40 uint64
	x39, x40 = bits.Add64(x15, x30, uint64(uint1(x38)))
	var x41 uint64
	var x42 uint64
	x41, x42 = bits.Add64(x17, x32, uint64(uint1(x40)))
	var x43 uint64
	var x44 uint64
	x43, x44 = bits.Add64(x19, x34, uint64(uint1(x42)))
	var x45 uint64
	var x46 uint64
	...
	var x68 uint64
	var x69 uint64
	x68, x69 = bits.Add64(uint64(uint1(x44)), x59, uint64(uint1(x67)))
	var x70 uint64
	var x71 uint64
	...
	var x80 uint64
	var x81 uint64
	x80, x81 = bits.Add64(x75, x72, uint64(uint1(x79)))
	var x82 uint64
	var x83 uint64
	x82, x83 = bits.Add64(x73, x70, uint64(uint1(x81)))
	x84 := (uint64(uint1(x83)) + x71)
	var x86 uint64
	_, x86 = bits.Add64(x60, x76, uint64(0x0))
	var x87 uint64
	var x88 uint64
	x87, x88 = bits.Add64(x62, x78, uint64(uint1(x86)))
	var x89 uint64
	var x90 uint64
	x89, x90 = bits.Add64(x64, x80, uint64(uint1(x88)))
	var x91 uint64
	var x92 uint64
	x91, x92 = bits.Add64(x66, x82, uint64(uint1(x90)))
	var x93 uint64
	var x94 uint64
	x93, x94 = bits.Add64(x68, x84, uint64(uint1(x92)))
	x95 := (uint64(uint1(x94)) + uint64(uint1(x69)))
	var x96 uint64
	var x97 uint64
	...
	var x106 uint64
	var x107 uint64
	x106, x107 = bits.Add64(x101, x98, uint64(uint1(x105)))
	var x108 uint64
	var x109 uint64
	x108, x109 = bits.Add64(x99, x96, uint64(uint1(x107)))
	...
	var x131 uint64
	var x132 uint64
	x131, x132 = bits.Add64(x126, x123, uint64(uint1(x130)))
	var x133 uint64
	var x134 uint64
	x133, x134 = bits.Add64(x124, x121, uint64(uint1(x132)))
	x135 := (uint64(uint1(x134)) + x122)
	var x137 uint64
	_, x137 = bits.Add64(x111, x127, uint64(0x0))
	var x138 uint64
	var x139 uint64
	x138, x139 = bits.Add64(x113, x129, uint64(uint1(x137)))
	var x140 uint64
	var x141 uint64
	x140, x141 = bits.Add64(x115, x131, uint64(uint1(x139)))
	var x142 uint64
	var x143 uint64
	x142, x143 = bits.Add64(x117, x133, uint64(uint1(x141)))
	var x144 uint64
	var x145 uint64
	x144, x145 = bits.Add64(x119, x135, uint64(uint1(x143)))
	x146 := (uint64(uint1(x145)) + uint64(uint1(x120)))
	var x147 uint64
	var x148 uint64
	...
	var x157 uint64
	var x158 uint64
	x157, x158 = bits.Add64(x152, x149, uint64(uint1(x156)))
	var x159 uint64
	var x160 uint64
	x159, x160 = bits.Add64(x150, x147, uint64(uint1(x158)))
	x161 := (uint64(uint1(x160)) + x148)
	var x162 uint64
	var x163 uint64
	...
	var x166 uint64
	var x167 uint64
	x166, x167 = bits.Add64(x142, x157, uint64(uint1(x165)))
	var x168 uint64
	var x169 uint64
	x168, x169 = bits.Add64(x144, x159, uint64(uint1(x167)))
	var x170 uint64
	var x171 uint64
	...
	var x189 uint64
	var x190 uint64
	x189, x190 = bits.Add64(x164, x180, uint64(uint1(x188)))
	var x191 uint64
	var x192 uint64
	x191, x192 = bits.Add64(x166, x182, uint64(uint1(x190)))
	var x193 uint64
	var x194 uint64
	x193, x194 = bits.Add64(x168, x184, uint64(uint1(x192)))
	var x195 uint64
	var x196 uint64
	x195, x196 = bits.Add64(x170, x186, uint64(uint1(x194)))
	x197 := (uint64(uint1(x196)) + uint64(uint1(x171)))
	var x198 uint64
	var x199 uint64
	x198, x199 = bits.Sub64(x189, 0xffffffffffffffff, uint64(0x0))
	var x200 uint64
	var x201 uint64
	x200, x201 = bits.Sub64(x191, 0xffffffff00000000, uint64(uint1(x199)))
	var x202 uint64
	var x203 uint64
	x202, x203 = bits.Sub64(x193, 0xffffffffffffffff, uint64(uint1(x201)))
	var x204 uint64
	var x205 uint64
	x204, x205 = bits.Sub64(x195, 0xfffffffeffffffff, uint64(uint1(x203)))
	var x207 uint64
	_, x207 = bits.Sub64(x197, uint64(0x0), uint64(uint1(x205)))
	var x208 uint64
	cmovznzU64(&x208, uint1(x207), x198, x189)
	var x209 uint64
	cmovznzU64(&x209, uint1(x207), x200, x191)
	var x210 uint64
	cmovznzU64(&x210, uint1(x207), x202, x193)
	var x211 uint64
	cmovznzU64(&x211, uint1(x207), x204, x195)
	out1[0] = x208
	out1[1] = x209
	out1[2] = x210
	out1[3] = x211
...
func Add(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x15 uint64
	var x16 uint64
	x15, x16 = bits.Sub64(x7, 0xfffffffeffffffff, uint64(uint1(x14)))
	var x18 uint64
...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x16 uint64
	x16, _ = bits.Add64(x7, (x9 & 0xfffffffeffffffff), uint64(uint1(x15)))
	out1[0] = x10
	out1[1] = x12
	out1[2] = x14
	out1[3] = x16
...
func FromMontgomery(out1 *NonMontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement) {
	...
	var x14 uint64
	var x15 uint64
	x14, x15 = bits.Add64(x5, x2, uint64(uint1(x13)))
	var x17 uint64
	...
	var x40 uint64
	var x41 uint64
	x40, x41 = bits.Add64(x35, x32, uint64(uint1(x39)))
	var x42 uint64
	var x43 uint64
	x42, x43 = bits.Add64(x33, x30, uint64(uint1(x41)))
	var x45 uint64
	_, x45 = bits.Add64(x24, x36, uint64(0x0))
	var x46 uint64
	var x47 uint64
	x46, x47 = bits.Add64(x26, x38, uint64(uint1(x45)))
	var x48 uint64
	var x49 uint64
	x48, x49 = bits.Add64(x28, x40, uint64(uint1(x47)))
	var x50 uint64
	var x51 uint64
	x50, x51 = bits.Add64((uint64(uint1(x29)) + (uint64(uint1(x23)) + (uint64(uint1(x15)) + x3))), x42, uint64(uint1(x49)))
	var x52 uint64
	var x53 uint64
	x52, x53 = bits.Add64(x46, arg1[2], uint64(0x0))
	var x54 uint64
	var x55 uint64
	x54, x55 = bits.Add64(x48, uint64(0x0), uint64(uint1(x53)))
	var x56 uint64
	var x57 uint64
	...
	var x74 uint64
	var x75 uint64
	x74, x75 = bits.Add64(x54, x66, uint64(uint1(x73)))
	var x76 uint64
	var x77 uint64
	x76, x77 = bits.Add64(x56, x68, uint64(uint1(x75)))
	var x78 uint64
	var x79 uint64
	x78, x79 = bits.Add64((uint64(uint1(x57)) + (uint64(uint1(x51)) + (uint64(uint1(x43)) + x31))), x70, uint64(uint1(x77)))
	var x80 uint64
	var x81 uint64
	x80, x81 = bits.Add64(x74, arg1[3], uint64(0x0))
	var x82 uint64
	var x83 uint64
	x82, x83 = bits.Add64(x76, uint64(0x0), uint64(uint1(x81)))
	var x84 uint64
	var x85 uint64
	x84, x85 = bits.Add64(x78, uint64(0x0), uint64(uint1(x83)))
	var x86 uint64
	var x87 uint64
	...
	var x102 uint64
	var x103 uint64
	x102, x103 = bits.Add64(x82, x94, uint64(uint1(x101)))
	var x104 uint64
	var x105 uint64
	x104, x105 = bits.Add64(x84, x96, uint64(uint1(x103)))
	var x106 uint64
	var x107 uint64
	x106, x107 = bits.Add64((uint64(uint1(x85)) + (uint64(uint1(x79)) + (uint64(uint1(x71)) + x59))), x98, uint64(uint1(x105)))
	x108 := (uint64(uint1(x107)) + (uint64(uint1(x99)) + x87))
	var x109 uint64
	var x110 uint64
	x109, x110 = bits.Sub64(x102, 0xffffffffffffffff, uint64(0x0))
	var x111 uint64
	var x112 uint64
	x111, x112 = bits.Sub64(x104, 0xffffffff00000000, uint64(uint1(x110)))
	var x113 uint64
	var x114 uint64
	x113, x114 = bits.Sub64(x106, 0xffffffffffffffff, uint64(uint1(x112)))
	var x115 uint64
	var x116 uint64
	x115, x116 = bits.Sub64(x108, 0xfffffffeffffffff, uint64(uint1(x114)))
	var x118 uint64
	_, x118 = bits.Sub64(uint64(0x0), uint64(0x0), uint64(uint1(x116)))
	var x119 uint64
	cmovznzU64(&x119, uint1(x118), x109, x102)
	var x120 uint64
	cmovznzU64(&x120, uint1(x118), x111, x104)
	var x121 uint64
	cmovznzU64(&x121, uint1(x118), x113, x106)
	var x122 uint64
	cmovznzU64(&x122, uint1(x118), x115, x108)
	out1[0] = x119
	out1[1] = x120
	out1[2] = x121
	out1[3] = x122
...
func ToMontgomery(out1 *MontgomeryDomainFieldElement, arg1 *NonMontgomeryDomainFieldElement) {
	...
	var x31 uint64
	var x32 uint64
	x31, x32 = bits.Add64(x22, x19, uint64(uint1(x30)))
	var x34 uint64
	_, x34 = bits.Add64(x11, x25, uint64(0x0))
	var x35 uint64
	var x36 uint64
	x35, x36 = bits.Add64(x13, x27, uint64(uint1(x34)))
	var x37 uint64
	var x38 uint64
	x37, x38 = bits.Add64(x15, x29, uint64(uint1(x36)))
	var x39 uint64
	var x40 uint64
	x39, x40 = bits.Add64(x17, x31, uint64(uint1(x38)))
	var x41 uint64
	var x42 uint64
	x41, x42 = bits.Add64((uint64(uint1(x18)) + x6), (uint64(uint1(x32)) + x20), uint64(uint1(x40)))
	var x43 uint64
	var x44 uint64
	...
	var x59 uint64
	var x60 uint64
	x59, x60 = bits.Add64(x37, x51, uint64(uint1(x58)))
	var x61 uint64
	var x62 uint64
	...
	var x75 uint64
	var x76 uint64
	x75, x76 = bits.Add64(x70, x67, uint64(uint1(x74)))
	var x77 uint64
	var x78 uint64
	x77, x78 = bits.Add64(x68, x65, uint64(uint1(x76)))
	var x80 uint64
	_, x80 = bits.Add64(x57, x71, uint64(0x0))
	var x81 uint64
	var x82 uint64
	x81, x82 = bits.Add64(x59, x73, uint64(uint1(x80)))
	var x83 uint64
	var x84 uint64
	x83, x84 = bits.Add64(x61, x75, uint64(uint1(x82)))
	var x85 uint64
	var x86 uint64
	x85, x86 = bits.Add64(x63, x77, uint64(uint1(x84)))
	var x87 uint64
	var x88 uint64
	x87, x88 = bits.Add64(((uint64(uint1(x64)) + uint64(uint1(x42))) + (uint64(uint1(x56)) + x44)), (uint64(uint1(x78)) + x66), uint64(uint1(x86)))
	var x89 uint64
	var x90 uint64
	...
	var x105 uint64
	var x106 uint64
	x105, x106 = bits.Add64(x83, x97, uint64(uint1(x104)))
	var x107 uint64
	var x108 uint64
	x107, x108 = bits.Add64(x85, x99, uint64(uint1(x106)))
	var x109 uint64
	var x110 uint64
	...
	var x121 uint64
	var x122 uint64
	x121, x122 = bits.Add64(x116, x113, uint64(uint1(x120)))
	var x123 uint64
	var x124 uint64
	x123, x124 = bits.Add64(x114, x111, uint64(uint1(x122)))
	var x126 uint64
	_, x126 = bits.Add64(x103, x117, uint64(0x0))
	var x127 uint64
	var x128 uint64
	x127, x128 = bits.Add64(x105, x119, uint64(uint1(x126)))
	var x129 uint64
	var x130 uint64
	x129, x130 = bits.Add64(x107, x121, uint64(uint1(x128)))
	var x131 uint64
	var x132 uint64
	x131, x132 = bits.Add64(x109, x123, uint64(uint1(x130)))
	var x133 uint64
	var x134 uint64
	x133, x134 = bits.Add64(((uint64(uint1(x110)) + uint64(uint1(x88))) + (uint64(uint1(x102)) + x90)), (uint64(uint1(x124)) + x112), uint64(uint1(x132)))
	var x135 uint64
	var x136 uint64
	...
	var x151 uint64
	var x152 uint64
	x151, x152 = bits.Add64(x129, x143, uint64(uint1(x150)))
	var x153 uint64
	var x154 uint64
	x153, x154 = bits.Add64(x131, x145, uint64(uint1(x152)))
	var x155 uint64
	var x156 uint64
	x155, x156 = bits.Add64(x133, x147, uint64(uint1(x154)))
	var x157 uint64
	var x158 uint64
	...
	var x167 uint64
	var x168 uint64
	x167, x168 = bits.Add64(x162, x159, uint64(uint1(x166)))
	var x169 uint64
	var x170 uint64
	x169, x170 = bits.Add64(x160, x157, uint64(uint1(x168)))
	var x172 uint64
	_, x172 = bits.Add64(x149, x163, uint64(0x0))
	var x173 uint64
	var x174 uint64
	x173, x174 = bits.Add64(x151, x165, uint64(uint1(x172)))
	var x175 uint64
	var x176 uint64
	x175, x176 = bits.Add64(x153, x167, uint64(uint1(x174)))
	var x177 uint64
	var x178 uint64
	x177, x178 = bits.Add64(x155, x169, uint64(uint1(x176)))
	var x179 uint64
	var x180 uint64
	x179, x180 = bits.Add64(((uint64(uint1(x156)) + uint64(uint1(x134))) + (uint64(uint1(x148)) + x136)), (uint64(uint1(x170)) + x158), uint64(uint1(x178)))
	var x181 uint64
	var x182 uint64
	x181, x182 = bits.Sub64(x173, 0xffffffffffffffff, uint64(0x0))
	var x183 uint64
	var x184 uint64
	x183, x184 = bits.Sub64(x175, 0xffffffff00000000, uint64(uint1(x182)))
	var x185 uint64
	var x186 uint64
	x185, x186 = bits.Sub64(x177, 0xffffffffffffffff, uint64(uint1(x184)))
	var x187 uint64
	var x188 uint64
	x187, x188 = bits.Sub64(x179, 0xfffffffeffffffff, uint64(uint1(x186)))
	var x190 uint64
	_, x190 = bits.Sub64(uint64(uint1(x180)), uint64(0x0), uint64(uint1(x188)))
	var x191 uint64
	cmovznzU64(&x191, uint1(x190), x181, x173)
	var x192 uint64
	cmovznzU64(&x192, uint1(x190), x183, x175)
	var x193 uint64
	cmovznzU64(&x193, uint1(x190), x185, x177)
	var x194 uint64
	cmovznzU64(&x194, uint1(x190), x187, x179)
	out1[0] = x191
	out1[1] = x192
	out1[2] = x193
	out1[3] = x194
...
func Divstep(out1 *uint64, out2 *[5]uint64, out3 *[5]uint64, out4 *[4]uint64, out5 *[4]uint64, arg1 uint64, arg2 *[5]uint64, arg3 *[5]uint64, arg4 *[4]uint64, arg5 *[4]uint64) {
	...
	var x45 uint64
	var x46 uint64
	x45, x46 = bits.Sub64(x37, 0xfffffffeffffffff, uint64(uint1(x44)))
	var x48 uint64
	...
	var x68 uint64
	x68, _ = bits.Add64(x59, (x61 & 0xfffffffeffffffff), uint64(uint1(x67)))
	var x70 uint64
	...
	var x108 uint64
	var x109 uint64
	x108, x109 = bits.Sub64(x100, 0xfffffffeffffffff, uint64(uint1(x107)))
	var x111 uint64
