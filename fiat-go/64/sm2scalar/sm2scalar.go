...
//
// Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Go --no-wide-int --relax-primitive-carry-to-bitwidth 32,64 --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --doc-newline-in-typedef-bounds --doc-prepend-header 'Code generated by Fiat Cryptography. DO NOT EDIT.' --doc-text-before-function-name '' --doc-text-before-type-name '' --package-name sm2scalar '' 64 '2^256 - 2^224 - 188730267045675049073202170516080344797' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
//
...
func Mul(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x208 uint64
	var x209 uint64
	x208, x209 = bits.Sub64(x199, 0x7203df6b21c6052b, uint64(uint1(x207)))
	var x210 uint64
	var x211 uint64
	x210, x211 = bits.Sub64(x201, 0xffffffffffffffff, uint64(uint1(x209)))
	var x212 uint64
	var x213 uint64
	x212, x213 = bits.Sub64(x203, 0xfffffffeffffffff, uint64(uint1(x211)))
	var x215 uint64
...
func Add(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x11 uint64
	var x12 uint64
	x11, x12 = bits.Sub64(x3, 0x7203df6b21c6052b, uint64(uint1(x10)))
	var x13 uint64
	var x14 uint64
...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x12 uint64
	var x13 uint64
	x12, x13 = bits.Add64(x3, (x9 & 0x7203df6b21c6052b), uint64(uint1(x11)))
	var x14 uint64
	var x15 uint64
...
func FromMontgomery(out1 *NonMontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement) {
	...
	var x119 uint64
	var x120 uint64
	x119, x120 = bits.Sub64(x112, 0x7203df6b21c6052b, uint64(uint1(x118)))
	var x121 uint64
	var x122 uint64
	x121, x122 = bits.Sub64(x114, 0xffffffffffffffff, uint64(uint1(x120)))
	var x123 uint64
	var x124 uint64
	x123, x124 = bits.Sub64(x116, 0xfffffffeffffffff, uint64(uint1(x122)))
	var x126 uint64
...
func ToMontgomery(out1 *MontgomeryDomainFieldElement, arg1 *NonMontgomeryDomainFieldElement) {
	...
	var x191 uint64
	var x192 uint64
	x191, x192 = bits.Sub64(x183, 0x7203df6b21c6052b, uint64(uint1(x190)))
	var x193 uint64
	var x194 uint64
	x193, x194 = bits.Sub64(x185, 0xffffffffffffffff, uint64(uint1(x192)))
	var x195 uint64
	var x196 uint64
	x195, x196 = bits.Sub64(x187, 0xfffffffeffffffff, uint64(uint1(x194)))
	var x198 uint64
...
func Divstep(out1 *uint64, out2 *[5]uint64, out3 *[5]uint64, out4 *[4]uint64, out5 *[4]uint64, arg1 uint64, arg2 *[5]uint64, arg3 *[5]uint64, arg4 *[4]uint64, arg5 *[4]uint64) {
	...
	var x41 uint64
	var x42 uint64
	x41, x42 = bits.Sub64(x33, 0x7203df6b21c6052b, uint64(uint1(x40)))
	var x43 uint64
	var x44 uint64
	...
	var x64 uint64
	var x65 uint64
	x64, x65 = bits.Add64(x55, (x61 & 0x7203df6b21c6052b), uint64(uint1(x63)))
	var x66 uint64
	var x67 uint64
	...
	var x104 uint64
	var x105 uint64
	x104, x105 = bits.Sub64(x96, 0x7203df6b21c6052b, uint64(uint1(x103)))
	var x106 uint64
	var x107 uint64
