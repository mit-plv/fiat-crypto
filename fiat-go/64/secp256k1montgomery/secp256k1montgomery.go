...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x11 uint64
	var x12 uint64
	x11, x12 = bits.Add64(x1, (x9 & 0xfffffffefffffc2f), uint64(0x0))
	var x13 uint64
	var x14 uint64
	x13, x14 = bits.Add64(x3, x9, uint64(uint1(x12)))
	var x15 uint64
	var x16 uint64
...
func Divstep(out1 *uint64, out2 *[5]uint64, out3 *[5]uint64, out4 *[4]uint64, out5 *[4]uint64, arg1 uint64, arg2 *[5]uint64, arg3 *[5]uint64, arg4 *[4]uint64, arg5 *[4]uint64) {
	...
	var x63 uint64
	var x64 uint64
	x63, x64 = bits.Add64(x53, (x61 & 0xfffffffefffffc2f), uint64(0x0))
	var x65 uint64
	var x66 uint64
	x65, x66 = bits.Add64(x55, x61, uint64(uint1(x64)))
	var x67 uint64
	var x68 uint64
	...
	var x103 uint64
	var x104 uint64
	x103, x104 = bits.Sub64(x95, 0xfffffffefffffc2f, uint64(0x0))
	var x105 uint64
	var x106 uint64
