...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x10 uint64
	var x11 uint64
	x10, x11 = bits.Add64(x1, uint64(uint1(x9)), uint64(0x0))
	var x12 uint64
	var x13 uint64
...
func Divstep(out1 *uint64, out2 *[5]uint64, out3 *[5]uint64, out4 *[4]uint64, out5 *[4]uint64, arg1 uint64, arg2 *[5]uint64, arg3 *[5]uint64, arg4 *[4]uint64, arg5 *[4]uint64) {
	...
	var x62 uint64
	var x63 uint64
	x62, x63 = bits.Add64(x53, uint64(uint1(x61)), uint64(0x0))
	var x64 uint64
	var x65 uint64
	...
	var x101 uint64
	var x102 uint64
	x101, x102 = bits.Sub64(x93, uint64(0x1), uint64(0x0))
	var x103 uint64
	var x104 uint64
	x103, x104 = bits.Sub64(x95, 0xffffffff00000000, uint64(uint1(x102)))
	var x105 uint64
	var x106 uint64
	x105, x106 = bits.Sub64(x97, 0xffffffffffffffff, uint64(uint1(x104)))
	var x107 uint64
	var x108 uint64
	x107, x108 = bits.Sub64(x99, 0xffffffff, uint64(uint1(x106)))
	var x110 uint64
