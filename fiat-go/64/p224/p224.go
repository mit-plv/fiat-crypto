...
func Mul(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x28 uint64
	var x29 uint1
	x28, x29 = addcarryxU64(x27, x24, 0x0)
	var x30 uint64
	var x31 uint1
	x30, x31 = addcarryxU64(x25, x22, x29)
	x32 := (uint64(x31) + x23)
	var x34 uint1
	_, x34 = addcarryxU64(x11, x20, 0x0)
	var x35 uint64
	var x36 uint1
	x35, x36 = addcarryxU64(x13, x26, x34)
	var x37 uint64
	var x38 uint1
	x37, x38 = addcarryxU64(x15, x28, x36)
	var x39 uint64
	var x40 uint1
	x39, x40 = addcarryxU64(x17, x30, x38)
	var x41 uint64
	var x42 uint1
	x41, x42 = addcarryxU64(x19, x32, x40)
	var x43 uint64
	var x44 uint64
	...
	var x51 uint64
	var x52 uint1
	x51, x52 = addcarryxU64(x50, x47, 0x0)
	var x53 uint64
	var x54 uint1
	x53, x54 = addcarryxU64(x48, x45, x52)
	var x55 uint64
	var x56 uint1
	x55, x56 = addcarryxU64(x46, x43, x54)
	x57 := (uint64(x56) + x44)
	var x58 uint64
	var x59 uint1
	x58, x59 = addcarryxU64(x35, x49, 0x0)
	var x60 uint64
	var x61 uint1
	x60, x61 = addcarryxU64(x37, x51, x59)
	var x62 uint64
	var x63 uint1
	x62, x63 = addcarryxU64(x39, x53, x61)
	var x64 uint64
	var x65 uint1
	x64, x65 = addcarryxU64(x41, x55, x63)
	var x66 uint64
	var x67 uint1
	x66, x67 = addcarryxU64(uint64(x42), x57, x65)
	var x68 uint64
	...
	var x76 uint64
	var x77 uint1
	x76, x77 = addcarryxU64(x75, x72, 0x0)
	var x78 uint64
	var x79 uint1
	x78, x79 = addcarryxU64(x73, x70, x77)
	x80 := (uint64(x79) + x71)
	var x82 uint1
	_, x82 = addcarryxU64(x58, x68, 0x0)
	var x83 uint64
	var x84 uint1
	x83, x84 = addcarryxU64(x60, x74, x82)
	var x85 uint64
	var x86 uint1
	x85, x86 = addcarryxU64(x62, x76, x84)
	var x87 uint64
	var x88 uint1
	x87, x88 = addcarryxU64(x64, x78, x86)
	var x89 uint64
	var x90 uint1
	x89, x90 = addcarryxU64(x66, x80, x88)
	x91 := (uint64(x90) + uint64(x67))
	var x92 uint64
	var x93 uint64
	...
	var x100 uint64
	var x101 uint1
	x100, x101 = addcarryxU64(x99, x96, 0x0)
	var x102 uint64
	var x103 uint1
	x102, x103 = addcarryxU64(x97, x94, x101)
	var x104 uint64
	var x105 uint1
	x104, x105 = addcarryxU64(x95, x92, x103)
	x106 := (uint64(x105) + x93)
	var x107 uint64
	var x108 uint1
	x107, x108 = addcarryxU64(x83, x98, 0x0)
	var x109 uint64
	var x110 uint1
	x109, x110 = addcarryxU64(x85, x100, x108)
	var x111 uint64
	var x112 uint1
	x111, x112 = addcarryxU64(x87, x102, x110)
	var x113 uint64
	var x114 uint1
	x113, x114 = addcarryxU64(x89, x104, x112)
	var x115 uint64
	var x116 uint1
	x115, x116 = addcarryxU64(x91, x106, x114)
	var x117 uint64
	...
	x129 := (uint64(x128) + x120)
	var x131 uint1
	_, x131 = addcarryxU64(x107, x117, 0x0)
	var x132 uint64
	var x133 uint1
	x132, x133 = addcarryxU64(x109, x123, x131)
	var x134 uint64
	var x135 uint1
	x134, x135 = addcarryxU64(x111, x125, x133)
	var x136 uint64
	var x137 uint1
	x136, x137 = addcarryxU64(x113, x127, x135)
	var x138 uint64
	var x139 uint1
	x138, x139 = addcarryxU64(x115, x129, x137)
	x140 := (uint64(x139) + uint64(x116))
	var x141 uint64
	var x142 uint64
	...
	var x149 uint64
	var x150 uint1
	x149, x150 = addcarryxU64(x148, x145, 0x0)
	var x151 uint64
	var x152 uint1
	x151, x152 = addcarryxU64(x146, x143, x150)
	var x153 uint64
	var x154 uint1
	x153, x154 = addcarryxU64(x144, x141, x152)
	x155 := (uint64(x154) + x142)
	var x156 uint64
	var x157 uint1
	x156, x157 = addcarryxU64(x132, x147, 0x0)
	var x158 uint64
	var x159 uint1
	x158, x159 = addcarryxU64(x134, x149, x157)
	var x160 uint64
	var x161 uint1
	x160, x161 = addcarryxU64(x136, x151, x159)
	var x162 uint64
	var x163 uint1
	x162, x163 = addcarryxU64(x138, x153, x161)
	var x164 uint64
	var x165 uint1
	x164, x165 = addcarryxU64(x140, x155, x163)
	var x166 uint64
	...
	var x174 uint64
	var x175 uint1
	x174, x175 = addcarryxU64(x173, x170, 0x0)
	var x176 uint64
	var x177 uint1
	x176, x177 = addcarryxU64(x171, x168, x175)
	x178 := (uint64(x177) + x169)
	var x180 uint1
	_, x180 = addcarryxU64(x156, x166, 0x0)
	var x181 uint64
	var x182 uint1
	x181, x182 = addcarryxU64(x158, x172, x180)
	var x183 uint64
	var x184 uint1
	x183, x184 = addcarryxU64(x160, x174, x182)
	var x185 uint64
	var x186 uint1
	x185, x186 = addcarryxU64(x162, x176, x184)
	var x187 uint64
	var x188 uint1
	x187, x188 = addcarryxU64(x164, x178, x186)
	x189 := (uint64(x188) + uint64(x165))
	var x190 uint64
	var x191 uint1
	x190, x191 = subborrowxU64(x181, uint64(0x1), 0x0)
	var x192 uint64
	var x193 uint1
	x192, x193 = subborrowxU64(x183, 0xffffffff00000000, x191)
	var x194 uint64
	var x195 uint1
	x194, x195 = subborrowxU64(x185, 0xffffffffffffffff, x193)
	var x196 uint64
	var x197 uint1
	x196, x197 = subborrowxU64(x187, 0xffffffff, x195)
	var x199 uint1
	_, x199 = subborrowxU64(x189, uint64(0x0), x197)
	var x200 uint64
...
func Add(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x9 uint64
	var x10 uint1
	x9, x10 = subborrowxU64(x1, uint64(0x1), 0x0)
	var x11 uint64
	var x12 uint1
	x11, x12 = subborrowxU64(x3, 0xffffffff00000000, x10)
	var x13 uint64
	var x14 uint1
	x13, x14 = subborrowxU64(x5, 0xffffffffffffffff, x12)
	var x15 uint64
	var x16 uint1
	x15, x16 = subborrowxU64(x7, 0xffffffff, x14)
	var x18 uint1
...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x10 uint64
	var x11 uint1
	x10, x11 = addcarryxU64(x1, uint64((uint1(x9) & 0x1)), 0x0)
	var x12 uint64
	var x13 uint1
	x12, x13 = addcarryxU64(x3, (x9 & 0xffffffff00000000), x11)
	var x14 uint64
	var x15 uint1
	x14, x15 = addcarryxU64(x5, x9, x13)
	var x16 uint64
	x16, _ = addcarryxU64(x7, (x9 & 0xffffffff), x15)
	out1[0] = x10
	out1[1] = x12
	out1[2] = x14
	out1[3] = x16
...
func FromMontgomery(out1 *NonMontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement) {
	...
	var x10 uint64
	var x11 uint1
	x10, x11 = addcarryxU64(x9, x6, 0x0)
	var x12 uint64
	var x13 uint1
	x12, x13 = addcarryxU64(x7, x4, x11)
	var x15 uint1
	_, x15 = addcarryxU64(x1, x2, 0x0)
	var x16 uint64
	var x17 uint1
	x16, x17 = addcarryxU64(uint64(0x0), x8, x15)
	var x18 uint64
	var x19 uint1
	x18, x19 = addcarryxU64(uint64(0x0), x10, x17)
	var x20 uint64
	var x21 uint1
	x20, x21 = addcarryxU64(uint64(0x0), x12, x19)
	var x22 uint64
	var x23 uint1
	x22, x23 = addcarryxU64(x16, arg1[1], 0x0)
	var x24 uint64
	var x25 uint1
	x24, x25 = addcarryxU64(x18, uint64(0x0), x23)
	var x26 uint64
	var x27 uint1
	x26, x27 = addcarryxU64(x20, uint64(0x0), x25)
	var x28 uint64
	...
	var x36 uint64
	var x37 uint1
	x36, x37 = addcarryxU64(x35, x32, 0x0)
	var x38 uint64
	var x39 uint1
	x38, x39 = addcarryxU64(x33, x30, x37)
	var x41 uint1
	_, x41 = addcarryxU64(x22, x28, 0x0)
	var x42 uint64
	var x43 uint1
	x42, x43 = addcarryxU64(x24, x34, x41)
	var x44 uint64
	var x45 uint1
	x44, x45 = addcarryxU64(x26, x36, x43)
	var x46 uint64
	var x47 uint1
	x46, x47 = addcarryxU64((uint64(x27) + (uint64(x21) + (uint64(x13) + x5))), x38, x45)
	var x48 uint64
	var x49 uint1
	x48, x49 = addcarryxU64(x42, arg1[2], 0x0)
	var x50 uint64
	var x51 uint1
	x50, x51 = addcarryxU64(x44, uint64(0x0), x49)
	var x52 uint64
	var x53 uint1
	x52, x53 = addcarryxU64(x46, uint64(0x0), x51)
	var x54 uint64
	...
	var x62 uint64
	var x63 uint1
	x62, x63 = addcarryxU64(x61, x58, 0x0)
	var x64 uint64
	var x65 uint1
	x64, x65 = addcarryxU64(x59, x56, x63)
	var x67 uint1
	_, x67 = addcarryxU64(x48, x54, 0x0)
	var x68 uint64
	var x69 uint1
	x68, x69 = addcarryxU64(x50, x60, x67)
	var x70 uint64
	var x71 uint1
	x70, x71 = addcarryxU64(x52, x62, x69)
	var x72 uint64
	var x73 uint1
	x72, x73 = addcarryxU64((uint64(x53) + (uint64(x47) + (uint64(x39) + x31))), x64, x71)
	var x74 uint64
	var x75 uint1
	x74, x75 = addcarryxU64(x68, arg1[3], 0x0)
	var x76 uint64
	var x77 uint1
	x76, x77 = addcarryxU64(x70, uint64(0x0), x75)
	var x78 uint64
	var x79 uint1
	x78, x79 = addcarryxU64(x72, uint64(0x0), x77)
	var x80 uint64
	...
	var x93 uint1
	_, x93 = addcarryxU64(x74, x80, 0x0)
	var x94 uint64
	var x95 uint1
	x94, x95 = addcarryxU64(x76, x86, x93)
	var x96 uint64
	var x97 uint1
	x96, x97 = addcarryxU64(x78, x88, x95)
	var x98 uint64
	var x99 uint1
	x98, x99 = addcarryxU64((uint64(x79) + (uint64(x73) + (uint64(x65) + x57))), x90, x97)
	x100 := (uint64(x99) + (uint64(x91) + x83))
	var x101 uint64
	var x102 uint1
	x101, x102 = subborrowxU64(x94, uint64(0x1), 0x0)
	var x103 uint64
	var x104 uint1
	x103, x104 = subborrowxU64(x96, 0xffffffff00000000, x102)
	var x105 uint64
	var x106 uint1
	x105, x106 = subborrowxU64(x98, 0xffffffffffffffff, x104)
	var x107 uint64
	var x108 uint1
	x107, x108 = subborrowxU64(x100, 0xffffffff, x106)
	var x110 uint1
	_, x110 = subborrowxU64(uint64(0x0), uint64(0x0), x108)
	var x111 uint64
...
func ToMontgomery(out1 *MontgomeryDomainFieldElement, arg1 *NonMontgomeryDomainFieldElement) {
	...
	var x27 uint64
	var x28 uint1
	x27, x28 = addcarryxU64(x26, x23, 0x0)
	var x29 uint64
	var x30 uint1
	x29, x30 = addcarryxU64(x24, x21, x28)
	var x32 uint1
	_, x32 = addcarryxU64(x11, x19, 0x0)
	var x33 uint64
	var x34 uint1
	x33, x34 = addcarryxU64(x13, x25, x32)
	var x35 uint64
	var x36 uint1
	x35, x36 = addcarryxU64(x15, x27, x34)
	var x37 uint64
	var x38 uint1
	x37, x38 = addcarryxU64(x17, x29, x36)
	var x39 uint64
	var x40 uint64
	...
	var x53 uint64
	var x54 uint1
	x53, x54 = addcarryxU64(x33, x45, 0x0)
	var x55 uint64
	var x56 uint1
	x55, x56 = addcarryxU64(x35, x47, x54)
	var x57 uint64
	var x58 uint1
	x57, x58 = addcarryxU64(x37, x49, x56)
	var x59 uint64
	var x60 uint1
	x59, x60 = addcarryxU64(((uint64(x38) + (uint64(x18) + x6)) + (uint64(x30) + x22)), x51, x58)
	var x61 uint64
	...
	var x74 uint1
	_, x74 = addcarryxU64(x53, x61, 0x0)
	var x75 uint64
	var x76 uint1
	x75, x76 = addcarryxU64(x55, x67, x74)
	var x77 uint64
	var x78 uint1
	x77, x78 = addcarryxU64(x57, x69, x76)
	var x79 uint64
	var x80 uint1
	x79, x80 = addcarryxU64(x59, x71, x78)
	var x81 uint64
	var x82 uint64
	...
	var x89 uint64
	var x90 uint1
	x89, x90 = addcarryxU64(x88, x85, 0x0)
	var x91 uint64
	var x92 uint1
	x91, x92 = addcarryxU64(x86, x83, x90)
	var x93 uint64
	var x94 uint1
	x93, x94 = addcarryxU64(x84, x81, x92)
	var x95 uint64
	var x96 uint1
	x95, x96 = addcarryxU64(x75, x87, 0x0)
	var x97 uint64
	var x98 uint1
	x97, x98 = addcarryxU64(x77, x89, x96)
	var x99 uint64
	var x100 uint1
	x99, x100 = addcarryxU64(x79, x91, x98)
	var x101 uint64
	var x102 uint1
	x101, x102 = addcarryxU64(((uint64(x80) + (uint64(x60) + (uint64(x52) + x40))) + (uint64(x72) + x64)), x93, x100)
	var x103 uint64
	...
	var x111 uint64
	var x112 uint1
	x111, x112 = addcarryxU64(x110, x107, 0x0)
	var x113 uint64
	var x114 uint1
	x113, x114 = addcarryxU64(x108, x105, x112)
	var x116 uint1
	_, x116 = addcarryxU64(x95, x103, 0x0)
	var x117 uint64
	var x118 uint1
	x117, x118 = addcarryxU64(x97, x109, x116)
	var x119 uint64
	var x120 uint1
	x119, x120 = addcarryxU64(x99, x111, x118)
	var x121 uint64
	var x122 uint1
	x121, x122 = addcarryxU64(x101, x113, x120)
	var x123 uint64
	var x124 uint64
	...
	var x131 uint64
	var x132 uint1
	x131, x132 = addcarryxU64(x130, x127, 0x0)
	var x133 uint64
	var x134 uint1
	x133, x134 = addcarryxU64(x128, x125, x132)
	var x135 uint64
	var x136 uint1
	x135, x136 = addcarryxU64(x126, x123, x134)
	var x137 uint64
	var x138 uint1
	x137, x138 = addcarryxU64(x117, x129, 0x0)
	var x139 uint64
	var x140 uint1
	x139, x140 = addcarryxU64(x119, x131, x138)
	var x141 uint64
	var x142 uint1
	x141, x142 = addcarryxU64(x121, x133, x140)
	var x143 uint64
	var x144 uint1
	x143, x144 = addcarryxU64(((uint64(x122) + (uint64(x102) + (uint64(x94) + x82))) + (uint64(x114) + x106)), x135, x142)
	var x145 uint64
	...
	var x153 uint64
	var x154 uint1
	x153, x154 = addcarryxU64(x152, x149, 0x0)
	var x155 uint64
	var x156 uint1
	x155, x156 = addcarryxU64(x150, x147, x154)
	var x158 uint1
	_, x158 = addcarryxU64(x137, x145, 0x0)
	var x159 uint64
	var x160 uint1
	x159, x160 = addcarryxU64(x139, x151, x158)
	var x161 uint64
	var x162 uint1
	x161, x162 = addcarryxU64(x141, x153, x160)
	var x163 uint64
	var x164 uint1
	x163, x164 = addcarryxU64(x143, x155, x162)
	x165 := ((uint64(x164) + (uint64(x144) + (uint64(x136) + x124))) + (uint64(x156) + x148))
	var x166 uint64
	var x167 uint1
	x166, x167 = subborrowxU64(x159, uint64(0x1), 0x0)
	var x168 uint64
	var x169 uint1
	x168, x169 = subborrowxU64(x161, 0xffffffff00000000, x167)
	var x170 uint64
	var x171 uint1
	x170, x171 = subborrowxU64(x163, 0xffffffffffffffff, x169)
	var x172 uint64
	var x173 uint1
	x172, x173 = subborrowxU64(x165, 0xffffffff, x171)
	var x175 uint1
	_, x175 = subborrowxU64(uint64(0x0), uint64(0x0), x173)
	var x176 uint64
...
func Divstep(out1 *uint64, out2 *[5]uint64, out3 *[5]uint64, out4 *[4]uint64, out5 *[4]uint64, arg1 uint64, arg2 *[5]uint64, arg3 *[5]uint64, arg4 *[4]uint64, arg5 *[4]uint64) {
	...
	var x39 uint64
	var x40 uint1
	x39, x40 = subborrowxU64(x31, uint64(0x1), 0x0)
	var x41 uint64
	var x42 uint1
	x41, x42 = subborrowxU64(x33, 0xffffffff00000000, x40)
	var x43 uint64
	var x44 uint1
	x43, x44 = subborrowxU64(x35, 0xffffffffffffffff, x42)
	var x45 uint64
	var x46 uint1
	x45, x46 = subborrowxU64(x37, 0xffffffff, x44)
	var x48 uint1
	...
	var x62 uint64
	var x63 uint1
	x62, x63 = addcarryxU64(x53, uint64((uint1(x61) & 0x1)), 0x0)
	var x64 uint64
	var x65 uint1
	x64, x65 = addcarryxU64(x55, (x61 & 0xffffffff00000000), x63)
	var x66 uint64
	var x67 uint1
	x66, x67 = addcarryxU64(x57, x61, x65)
	var x68 uint64
	x68, _ = addcarryxU64(x59, (x61 & 0xffffffff), x67)
	var x70 uint64
	...
	var x102 uint64
	var x103 uint1
	x102, x103 = subborrowxU64(x94, uint64(0x1), 0x0)
	var x104 uint64
	var x105 uint1
	x104, x105 = subborrowxU64(x96, 0xffffffff00000000, x103)
	var x106 uint64
	var x107 uint1
	x106, x107 = subborrowxU64(x98, 0xffffffffffffffff, x105)
	var x108 uint64
	var x109 uint1
	x108, x109 = subborrowxU64(x100, 0xffffffff, x107)
	var x111 uint1
