...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x11 uint64
	var x12 uint64
	x11, x12 = bits.Add64(x1, uint64((uint1(x9) & 0x1)), uint64(0x0))
	var x13 uint64
	var x14 uint64
	x13, x14 = bits.Add64(x3, (x9 & 0xffffffff00000000), uint64(uint1(x12)))
	var x15 uint64
	var x16 uint64
	x15, x16 = bits.Add64(x5, x9, uint64(uint1(x14)))
	var x17 uint64
	x17, _ = bits.Add64(x7, (x9 & 0xffffffff), uint64(uint1(x16)))
	out1[0] = x11
	out1[1] = x13
	out1[2] = x15
	out1[3] = x17
...
func Divstep(out1 *uint64, out2 *[5]uint64, out3 *[5]uint64, out4 *[4]uint64, out5 *[4]uint64, arg1 uint64, arg2 *[5]uint64, arg3 *[5]uint64, arg4 *[4]uint64, arg5 *[4]uint64) {
	...
	var x63 uint64
	var x64 uint64
	x63, x64 = bits.Add64(x53, uint64((uint1(x61) & 0x1)), uint64(0x0))
	var x65 uint64
	var x66 uint64
	x65, x66 = bits.Add64(x55, (x61 & 0xffffffff00000000), uint64(uint1(x64)))
	var x67 uint64
	var x68 uint64
	x67, x68 = bits.Add64(x57, x61, uint64(uint1(x66)))
	var x69 uint64
	x69, _ = bits.Add64(x59, (x61 & 0xffffffff), uint64(uint1(x68)))
	var x71 uint64
	...
	var x103 uint64
	var x104 uint64
	x103, x104 = bits.Sub64(x95, uint64(0x1), uint64(0x0))
	var x105 uint64
	var x106 uint64
	x105, x106 = bits.Sub64(x97, 0xffffffff00000000, uint64(uint1(x104)))
	var x107 uint64
	var x108 uint64
	x107, x108 = bits.Sub64(x99, 0xffffffffffffffff, uint64(uint1(x106)))
	var x109 uint64
	var x110 uint64
	x109, x110 = bits.Sub64(x101, 0xffffffff, uint64(uint1(x108)))
	var x112 uint64
