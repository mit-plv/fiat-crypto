 ...
 *)
  ...
  (* using "Require Import bedrock2.NotationsCustomEntry" and clang-format:
 = bedrock_func_body
     : (((x0 = (load(y0 + 4) * (load(y1 + 4) * 19)));
        ...
        ((x50 = (x12 + x6)); x51 = (x12 + x6 < x12));
        ((x52 = (x51 + x13 + x7));
         x53 = ((x51 + x13 < x13) + (x51 + x13 + x7 < x51 + x13)));
        ((x54 = (x16 + x50)); x55 = (x16 + x50 < x16));
        ((x56 = (x55 + x17 + x52));
         x57 = ((x55 + x17 < x17) + (x55 + x17 + x52 < x55 + x17)));
        ((x58 = (x18 + x54)); x59 = (x18 + x54 < x18));
        ((x60 = (x59 + x19 + x56));
         x61 = ((x59 + x19 < x19) + (x59 + x19 + x56 < x59 + x19)));
        ((x62 = (x48 + x58)); x63 = (x48 + x58 < x48));
        ((x64 = (x63 + x49 + x60));
         x65 = ((x63 + x49 < x49) + (x63 + x49 + x60 < x63 + x49)));
        (x66 = (x62 >> 51 | x64 << 13)); (x67 = (x62 & 2251799813685247));
        ((x68 = (x22 + x20)); x69 = (x22 + x20 < x22));
        ((x70 = (x69 + x23 + x21));
         x71 = ((x69 + x23 < x23) + (x69 + x23 + x21 < x69 + x23)));
        ((x72 = (x26 + x68)); x73 = (x26 + x68 < x26));
        ((x74 = (x73 + x27 + x70));
         x75 = ((x73 + x27 < x27) + (x73 + x27 + x70 < x73 + x27)));
        ((x76 = (x32 + x72)); x77 = (x32 + x72 < x32));
        ((x78 = (x77 + x33 + x74));
         x79 = ((x77 + x33 < x33) + (x77 + x33 + x74 < x77 + x33)));
        ((x80 = (x40 + x76)); x81 = (x40 + x76 < x40));
        ((x82 = (x81 + x41 + x78));
         x83 = ((x81 + x41 < x41) + (x81 + x41 + x78 < x81 + x41)));
        ((x84 = (x24 + x0)); x85 = (x24 + x0 < x24));
        ((x86 = (x85 + x25 + x1));
         x87 = ((x85 + x25 < x25) + (x85 + x25 + x1 < x85 + x25)));
        ((x88 = (x28 + x84)); x89 = (x28 + x84 < x28));
        ((x90 = (x89 + x29 + x86));
         x91 = ((x89 + x29 < x29) + (x89 + x29 + x86 < x89 + x29)));
        ((x92 = (x34 + x88)); x93 = (x34 + x88 < x34));
        ((x94 = (x93 + x35 + x90));
         x95 = ((x93 + x35 < x35) + (x93 + x35 + x90 < x93 + x35)));
        ((x96 = (x42 + x92)); x97 = (x42 + x92 < x42));
        ((x98 = (x97 + x43 + x94));
         x99 = ((x97 + x43 < x43) + (x97 + x43 + x94 < x97 + x43)));
        ((x100 = (x8 + x2)); x101 = (x8 + x2 < x8));
        ((x102 = (x101 + x9 + x3));
         x103 = ((x101 + x9 < x9) + (x101 + x9 + x3 < x101 + x9)));
        ((x104 = (x30 + x100)); x105 = (x30 + x100 < x30));
        ((x106 = (x105 + x31 + x102));
         x107 = ((x105 + x31 < x31) + (x105 + x31 + x102 < x105 + x31)));
        ((x108 = (x36 + x104)); x109 = (x36 + x104 < x36));
        ((x110 = (x109 + x37 + x106));
         x111 = ((x109 + x37 < x37) + (x109 + x37 + x106 < x109 + x37)));
        ((x112 = (x44 + x108)); x113 = (x44 + x108 < x44));
        ((x114 = (x113 + x45 + x110));
         x115 = ((x113 + x45 < x45) + (x113 + x45 + x110 < x113 + x45)));
        ((x116 = (x10 + x4)); x117 = (x10 + x4 < x10));
        ((x118 = (x117 + x11 + x5));
         x119 = ((x117 + x11 < x11) + (x117 + x11 + x5 < x117 + x11)));
        ((x120 = (x14 + x116)); x121 = (x14 + x116 < x14));
        ((x122 = (x121 + x15 + x118));
         x123 = ((x121 + x15 < x15) + (x121 + x15 + x118 < x121 + x15)));
        ((x124 = (x38 + x120)); x125 = (x38 + x120 < x38));
        ((x126 = (x125 + x39 + x122));
         x127 = ((x125 + x39 < x39) + (x125 + x39 + x122 < x125 + x39)));
        ((x128 = (x46 + x124)); x129 = (x46 + x124 < x46));
        ((x130 = (x129 + x47 + x126));
         x131 = ((x129 + x47 < x47) + (x129 + x47 + x126 < x129 + x47)));
        ((x132 = (x66 + x128)); x133 = (x66 + x128 < x66));
        (x134 = (x133 + x130)); (x135 = (x132 >> 51 | x134 << 13));
        (x136 = (x132 & 2251799813685247));
        ((x137 = (x135 + x112)); x138 = (x135 + x112 < x135));
        (x139 = (x138 + x114)); (x140 = (x137 >> 51 | x139 << 13));
        (x141 = (x137 & 2251799813685247));
        ((x142 = (x140 + x96)); x143 = (x140 + x96 < x140));
        (x144 = (x143 + x98)); (x145 = (x142 >> 51 | x144 << 13));
        (x146 = (x142 & 2251799813685247));
        ((x147 = (x145 + x80)); x148 = (x145 + x80 < x145));
        (x149 = (x148 + x82)); (x150 = (x147 >> 51 | x149 << 13));
        (x151 = (x147 & 2251799813685247)); (x152 = (x150 * 19));
        (x153 = (x67 + x152)); (x154 = (x153 >> 51));
        (x155 = (x153 & 2251799813685247)); (x156 = (x154 + x136));
        (x157 = (x156 >> 51)); (x158 = (x156 & 2251799813685247));
        (x159 = (x157 + x141)); (store(ret, x155)); (store(ret + 1, x158));
        (store(ret + 1 + 1, x159)); (store(ret + 1 + 1 + 1, x146));
        (store(ret + 1 + 1 + 1 + 1, (x151)));
        /*skip*/)
     : cmd
   *)
  End __.
