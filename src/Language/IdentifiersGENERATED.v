...
Module Compilers.
  ...
  Module pattern.
    ...
    Module ident.
      ...
      | nat_rect : (forall P : base.type.type base.type.base, ident (type.arrow (type.arrow (type.base base.type.unit) (type.base P)) (type.arrow (type.arrow (type.base (base.type.type_base base.type.nat)) (type.arrow (type.base P) (type.base P))) (type.arrow (type.base (base.type.type_base base.type.nat)) (type.base P)))))
      | nat_rect_arrow : (forall P Q : base.type.type base.type.base, ident (type.arrow (type.arrow (type.base P) (type.base Q)) (type.arrow (type.arrow (type.base (base.type.type_base base.type.nat)) (type.arrow (type.arrow (type.base P) (type.base Q)) (type.arrow (type.base P) (type.base Q)))) (type.arrow (type.base (base.type.type_base base.type.nat)) (type.arrow (type.base P) (type.base Q))))))
      | eager_nat_rect : (forall P : base.type.type base.type.base, ident (type.arrow (type.arrow (type.base base.type.unit) (type.base P)) (type.arrow (type.arrow (type.base (base.type.type_base base.type.nat)) (type.arrow (type.base P) (type.base P))) (type.arrow (type.base (base.type.type_base base.type.nat)) (type.base P)))))
      | eager_nat_rect_arrow : (forall P Q : base.type.type base.type.base, ident (type.arrow (type.arrow (type.base P) (type.base Q)) (type.arrow (type.arrow (type.base (base.type.type_base base.type.nat)) (type.arrow (type.arrow (type.base P) (type.base Q)) (type.arrow (type.base P) (type.base Q)))) (type.arrow (type.base (base.type.type_base base.type.nat)) (type.arrow (type.base P) (type.base Q))))))
      ...
      | List_length : (forall T : base.type.type base.type.base, ident (type.arrow (type.base (base.type.list T)) (type.base (base.type.type_base base.type.nat))))
      ...
      | List_firstn : (forall A : base.type.type base.type.base, ident (type.arrow (type.base (base.type.type_base base.type.nat)) (type.arrow (type.base (base.type.list A)) (type.base (base.type.list A)))))
      | List_skipn : (forall A : base.type.type base.type.base, ident (type.arrow (type.base (base.type.type_base base.type.nat)) (type.arrow (type.base (base.type.list A)) (type.base (base.type.list A)))))
      | List_repeat : (forall A : base.type.type base.type.base, ident (type.arrow (type.base A) (type.arrow (type.base (base.type.type_base base.type.nat)) (type.base (base.type.list A)))))
      ...
      | List_update_nth : (forall T : base.type.type base.type.base, ident (type.arrow (type.base (base.type.type_base base.type.nat)) (type.arrow (type.arrow (type.base T) (type.base T)) (type.arrow (type.base (base.type.list T)) (type.base (base.type.list T))))))
      | List_nth_default : (forall T : base.type.type base.type.base, ident (type.arrow (type.base T) (type.arrow (type.base (base.type.list T)) (type.arrow (type.base (base.type.type_base base.type.nat)) (type.base T)))))
      | eager_List_nth_default : (forall T : base.type.type base.type.base, ident (type.arrow (type.base T) (type.arrow (type.base (base.type.list T)) (type.arrow (type.base (base.type.type_base base.type.nat)) (type.base T)))))
