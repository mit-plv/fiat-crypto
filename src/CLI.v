  ...
  Module UnsaturatedSolinas.
    Local Instance api : PipelineAPI
      := {
          ...
          Synthesize
          := fun _ '(n, machine_wordsize, s, c, requests) comment_header prefix
  ...
  Module WordByWordMontgomery.
    Local Instance api : PipelineAPI
      := {
          ...
          Synthesize
          := fun _ '(machine_wordsize, m, requests) comment_header prefix
  ...
  Module SaturatedSolinas.
    Local Instance api : PipelineAPI
      := {
          ...
          Synthesize
          := fun _ '(machine_wordsize, s, c, requests) comment_header prefix
