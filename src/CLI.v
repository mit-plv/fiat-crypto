  ...
  Class PipelineAPI :=
    {
      ...
      Synthesize : forall
          {output_language_api : ToString.OutputLanguageAPI}
          (args : ArgsT) (function_name_prefix : string),
        ...
        := let prefix := ("fiat_" ++ curve_description ++ "_")%string in
           ...
           let header :=
               (ToString.comment_block
                  ...
                  ++ ToString.typedef_header prefix types_used
                  ++ [""])%list in
           inl
  ...
  Module UnsaturatedSolinas.
    Local Instance api : PipelineAPI
      := {
          ...
          Synthesize
          := fun _ '(_, (n, machine_wordsize, s, c, requests)) prefix
  ...
  Module WordByWordMontgomery.
    Local Instance api : PipelineAPI
      := {
          ...
          Synthesize
          := fun _ '(_, (machine_wordsize, m, requests)) prefix
  ...
  Module SaturatedSolinas.
    Local Instance api : PipelineAPI
      := {
          ...
          Synthesize
          := fun _ '(_, (machine_wordsize, s, c, requests)) prefix
