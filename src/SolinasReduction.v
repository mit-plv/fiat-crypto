...
static void mul(uint64_t out1[4], const uint64_t arg1[4], const uint64_t arg2[4]) {
  ...
  fiatmulx_u64(&x96, &x97, UINT8_C(0x26), x92);
  fiatmulx_u64(&x98, &x99, UINT8_C(0x26), x90);
  fiatmulx_u64(&x100, &x101, UINT8_C(0x26), x88);
  fiataddcarryx_u64(&x102, &x103, 0x0, x82, x98);
  fiataddcarryx_u64(&x104, &x105, x103, x84, x96);
  fiatmulx_u64(&x106, &x107, UINT8_C(0x26), x94);
  fiataddcarryx_u64(&x108, &x109, x105, x86, x106);
  fiatmulx_u64(&x110, &x111, UINT8_C(0x26), x94);
  x112 = (x109 + x111);
  fiataddcarryx_u64(&x113, &x114, 0x0, x31, x100);
  fiataddcarryx_u64(&x115, &x116, x114, x102, x101);
  fiataddcarryx_u64(&x117, &x118, x116, x104, x99);
  fiataddcarryx_u64(&x119, &x120, x118, x108, x97);
  x121 = (x120 + x112);
  fiatmulx_u64(&x122, &x123, UINT8_C(0x26), x121);
  fiataddcarryx_u64(&x124, &x125, 0x0, x113, x122);
  fiataddcarryx_u64(&x126, &x127, x125, x115, 0x0);
  fiataddcarryx_u64(&x128, &x129, x127, x117, 0x0);
  fiataddcarryx_u64(&x130, &x131, x129, x119, 0x0);
  fiatmulx_u64(&x132, &x133, UINT8_C(0x26), x131);
  fiataddcarryx_u64(&x134, &x135, 0x0, x124, x132);
  fiataddcarryx_u64(&x136, &x137, x135, x126, 0x0);
  fiataddcarryx_u64(&x138, &x139, x137, x128, 0x0);
  fiataddcarryx_u64(&x140, &x141, x139, x130, 0x0);
  out1[0] = x134;
  out1[1] = x136;
  out1[2] = x138;
  out1[3] = x140;
     ...
     : string
Finished transaction in 7.129 secs (6.859u,0.198s) (successful)
     *)
  ...
  Section __.
    ...
    Section canon.
      ...
      Proof.
        induction l; intros; cbn; try rewrite IHl; lia.
      Qed.
      ...
      Proof.
        ...
        solve_ineq.
        break_match; eauto.
        apply OrdersEx.Z_as_OT.mul_le_mono_nonneg_r.
        lia.
        rewrite Le.Z.le_sub_1_iff.
        apply IHp; auto.
        weight_comp.
