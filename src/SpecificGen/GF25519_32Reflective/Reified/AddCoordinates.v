...
Proof.
  ...
  cbv beta iota delta [apply9 apply9_nd interp_type_gen_rel_pointwise radd_coordinatesT SmartArrow ExprArgT radd_coordinatesZ'' uncurried_add_coordinates uncurry_unop_fe25519_32 SmartAbs radd_coordinatesZ' exprArg Extended.add_coordinates_gen Interp interp unop_make_args SmartVarf smart_interp_flat_map length_fe25519_32].
  intros.
  repeat match goal with
         | [ |- appcontext[@proj1_sig ?A ?B ?v] ]
           => let k := fresh "f" in
              ...
              set (k := v);
                ...
                cbv [interp_type_gen_rel_pointwise ExprBinOpT uncurry_binop_fe25519_32] in H*)
         end.
...
(*Notation i9op_correct_and_bounded irop op
  := (forall x0 x1 x2 x3 x4 x5 x6 x7 x8,
         ...
         -> fe25519_32WToZ (irop x0 x1 x2 x3 x4 x5 x6 x7 x8) = op (fe25519_32WToZ x0) (fe25519_32WToZ x1) (fe25519_32WToZ x2) (fe25519_32WToZ x3) (fe25519_32WToZ x4) (fe25519_32WToZ x5) (fe25519_32WToZ x6) (fe25519_32WToZ x7) (fe25519_32WToZ x8)
            /\ is_bounded (fe25519_32WToZ (irop x0 x1 x2 x3 x4 x5 x6 x7 x8)) = true) (only parsing).
