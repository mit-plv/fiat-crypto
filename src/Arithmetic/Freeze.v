...
Module Freeze.
  ...
  End Freeze.
End Freeze.
#[global] Hint Rewrite Freeze.length_freeze : distr_length.
...
Section freeze_mod_ops.
  ...
  Qed.
End freeze_mod_ops.
#[global] Hint Rewrite eval_freeze_to_bytesmod eval_to_bytes eval_to_bytesmod eval_from_bytes eval_from_bytesmod : push_eval.
