...
Definition monty s : F p -> F p := @MxDH.montladder _ F.zero F.one F.add F.sub F.mul F.inv M.a24 cswap 255 (fun i => Z.testbit s (Z.of_nat i)).
...
Example order_basepoint : F.to_Z (monty l (F.of_Z _ 9)) = 0%Z.
