...
Module Export MontgomeryReduction.
  ...
  Module Export ReifyHints.
    #[global] Hint Extern 1 (_ = _) => apply_cached_reification montred' (proj1 reified_montred_gen_correct) : reify_cache_gen.
    #[global] Hint Immediate (proj2 reified_montred_gen_correct) : wf_gen_cache.
    #[global] Hint Rewrite (proj1 reified_montred_gen_correct) : interp_gen_cache.
  End ReifyHints.
