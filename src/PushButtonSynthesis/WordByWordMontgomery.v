...
Section __.
  ...
  Local Notation larger_saturated_bounds := (Primitives.saturated_bounds sat_limbs).
  ...
  Definition sto_montgomery (prefix : string)
    ...
    := Eval cbv beta in
        FromPipelineToString!
          prefix "to_montgomery" to_montgomery
          (docstring_with_summary_from_lemma!
             prefix
  ...
  Definition sone (prefix : string)
    ...
    := Eval cbv beta in
        FromPipelineToString!
          prefix "set_one" one (* to avoid conflict with boringSSL *)
          (docstring_with_summary_from_lemma!
             prefix
 ...
 Definition smsat (prefix : string)
  ...
  Definition sdivstep_precomp (prefix : string)
    ...
    := Eval cbv beta in
        FromPipelineToString!
          prefix "divstep_precomp" divstep_precomp
          (docstring_with_summary_from_lemma!
             prefix
