...
Module X25519_64.
  ...
  Definition tight_upperbound_multiplier := Qmake 11 10.
  Definition loose_extra_upperbound_multiplier := Qmake 3 1.
  Local Notation tight_bounds := (tight_bounds n s c tight_upperbound_multiplier).
  Local Notation loose_bounds := (loose_bounds n s c tight_upperbound_multiplier loose_extra_upperbound_multiplier).
  Local Notation prime_bound := (prime_bound s c).

  Derive base_51_relax
         SuchThat (rrelax_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_51_relax)
         As base_51_relax_correct.
  Proof. Time solve_rrelax machine_wordsize. Time Qed.
  Derive base_51_carry_mul
         SuchThat (rcarry_mul_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_51_carry_mul)
         As base_51_carry_mul_correct.
  Proof. Time solve_rcarry_mul machine_wordsize. Time Qed.
  Derive base_51_carry
         SuchThat (rcarry_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_51_carry)
         As base_51_carry_correct.
  Proof. Time solve_rcarry machine_wordsize. Time Qed.
  Derive base_51_add
         SuchThat (radd_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_51_add)
         As base_51_add_correct.
  Proof. Time solve_radd machine_wordsize. Time Qed.
  Derive base_51_sub
         SuchThat (rsub_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_51_sub)
         As base_51_sub_correct.
  Proof. Time solve_rsub machine_wordsize. Time Qed.
  Derive base_51_opp
         SuchThat (ropp_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_51_opp)
         As base_51_opp_correct.
  Proof. Time solve_ropp machine_wordsize. Time Qed.
  Derive base_51_to_bytes
         SuchThat (rto_bytes_correctT n s c machine_wordsize tight_upperbound_multiplier base_51_to_bytes)
         As base_51_to_bytes_correct.
  Proof. Time solve_rto_bytes machine_wordsize. Time Qed.
  Derive base_51_from_bytes
         SuchThat (rfrom_bytes_correctT n s c machine_wordsize tight_upperbound_multiplier base_51_from_bytes)
         As base_51_from_bytes_correct.
  Proof. Time solve_rfrom_bytes machine_wordsize. Time Qed.
  Derive base_51_encode
         SuchThat (rencode_correctT n s c machine_wordsize tight_upperbound_multiplier base_51_encode)
         As base_51_encode_correct.
  Proof. Time solve_rencode machine_wordsize. Time Qed.
  Derive base_51_zero
         SuchThat (rzero_correctT n s c machine_wordsize tight_upperbound_multiplier base_51_zero)
         As base_51_zero_correct.
  Proof. Time solve_rzero machine_wordsize. Time Qed.
  Derive base_51_one
         SuchThat (rone_correctT n s c machine_wordsize tight_upperbound_multiplier base_51_one)
  ...
  Definition base_51_good : GoodT n s c machine_wordsize tight_upperbound_multiplier
    := Good n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier
            base_51_curve_good
...
Module X25519_32.
  ...
  Derive base_25p5_relax
         SuchThat (rrelax_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_25p5_relax)
         As base_25p5_relax_correct.
  Proof. Time solve_rrelax machine_wordsize. Time Qed.
  Derive base_25p5_carry_mul
         SuchThat (rcarry_mul_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_25p5_carry_mul)
         As base_25p5_carry_mul_correct.
  Proof. Time solve_rcarry_mul machine_wordsize. Time Qed.
  Derive base_25p5_carry
         SuchThat (rcarry_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_25p5_carry)
         As base_25p5_carry_correct.
  Proof. Time solve_rcarry machine_wordsize. Time Qed.
  Derive base_25p5_add
         SuchThat (radd_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_25p5_add)
         As base_25p5_add_correct.
  Proof. Time solve_radd machine_wordsize. Time Qed.
  Derive base_25p5_sub
         SuchThat (rsub_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_25p5_sub)
         As base_25p5_sub_correct.
  Proof. Time solve_rsub machine_wordsize. Time Qed.
  Derive base_25p5_opp
         SuchThat (ropp_correctT n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier base_25p5_opp)
         As base_25p5_opp_correct.
  Proof. Time solve_ropp machine_wordsize. Time Qed.
  (* These are very, very, very slow *)
  (*
  Derive base_25p5_to_bytes
         SuchThat (rto_bytes_correctT n s c machine_wordsize tight_upperbound_multiplier base_25p5_to_bytes)
         As base_25p5_to_bytes_correct.
  Proof. Time solve_rto_bytes machine_wordsize. Time Qed.
  Derive base_25p5_from_bytes
         SuchThat (rfrom_bytes_correctT n s c machine_wordsize tight_upperbound_multiplier base_25p5_from_bytes)
         As base_25p5_from_bytes_correct.
  Proof. Time solve_rfrom_bytes machine_wordsize. Time Qed.
   *)
  Derive base_25p5_encode
         SuchThat (rencode_correctT n s c machine_wordsize tight_upperbound_multiplier base_25p5_encode)
         As base_25p5_encode_correct.
  Proof. Time solve_rencode machine_wordsize. Time Qed.
  Derive base_25p5_zero
         SuchThat (rzero_correctT n s c machine_wordsize tight_upperbound_multiplier base_25p5_zero)
         As base_25p5_zero_correct.
  Proof. Time solve_rzero machine_wordsize. Time Qed.
  Derive base_25p5_one
         SuchThat (rone_correctT n s c machine_wordsize tight_upperbound_multiplier base_25p5_one)
  ...
  (*
  Definition base_25p5_good : GoodT n s c machine_wordsize tight_upperbound_multiplier
    := Good n s c machine_wordsize tight_upperbound_multiplier loose_extra_upperbound_multiplier
