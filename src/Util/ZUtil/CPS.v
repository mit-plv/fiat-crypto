...
Module Z.
  ...
  Definition get_carry_cps_correct {T} bitwidth v f
    ...
    := eq_refl.
  #[global] Hint Rewrite @get_carry_cps_correct : uncps.
  ...
  Definition add_with_get_carry_cps_correct {T} bitwidth c x y f
    ...
    := eq_refl.
  #[global] Hint Rewrite @add_with_get_carry_cps_correct : uncps.
  ...
  Definition add_get_carry_cps_correct {T} bitwidth x y f
    ...
    := eq_refl.
  #[global] Hint Rewrite @add_get_carry_cps_correct : uncps.
  ...
  Definition get_borrow_cps_correct {T} bitwidth v f
    ...
    := eq_refl.
  #[global] Hint Rewrite @get_borrow_cps_correct : uncps.
  ...
  Definition sub_with_get_borrow_cps_correct {T} (bitwidth : Z) (c : Z) (x y : Z) (f : Z * Z -> T)
    ...
    := eq_refl.
  #[global] Hint Rewrite @sub_with_get_borrow_cps_correct : uncps.
  ...
  Definition sub_get_borrow_cps_correct {T} (bitwidth : Z) (x y : Z) (f : Z * Z -> T)
    ...
    := eq_refl.
  #[global] Hint Rewrite @sub_get_borrow_cps_correct : uncps.
  ...
  #[global] Hint Rewrite @add_get_carry_full_cps_correct : uncps.
  ...
  Proof. prove_cps_correct (). Qed.
  #[global] Hint Rewrite @add_with_get_carry_full_cps_correct : uncps.
  ...
  Proof. prove_cps_correct (). Qed.
  #[global] Hint Rewrite @sub_get_borrow_full_cps_correct : uncps.
  ...
  Proof. prove_cps_correct (). Qed.
  #[global] Hint Rewrite @sub_with_get_borrow_full_cps_correct : uncps.
  ...
  Definition mul_split_at_bitwidth_cps_correct {T} (bitwidth : Z) (x y : Z) (f : Z * Z -> T)
    ...
    := eq_refl.
  #[global] Hint Rewrite @mul_split_at_bitwidth_cps_correct : uncps.
  ...
  Proof. prove_cps_correct (). Qed.
  #[global] Hint Rewrite @mul_split_cps_correct : uncps.
  ...
  Lemma mul_split_cps'_correct {T} (s x y : Z) (f : Z * Z -> T)
    : @mul_split_cps' T s x y f = f (Z.mul_split s x y).
  Proof. prove_cps_correct (). Qed.
  #[global] Hint Rewrite @mul_split_cps'_correct : uncps.
End Z.
