...
Module Z.
  ...
  Proof. t. Qed.
  #[global] Hint Rewrite land_round_lor_land_bound_r : zsimplify_fast zsimplify.
  ...
  #[global] Hint Rewrite land_round_lor_land_bound_l : zsimplify_fast zsimplify.

  Lemma lor_round_lor_land_bound_r x
    : Z.lor x (Z.round_lor_land_bound x) = if (0 <=? x) then Z.round_lor_land_bound x else x.
  Proof. t. Qed.
  #[global] Hint Rewrite lor_round_lor_land_bound_r : zsimplify_fast zsimplify.
  ...
  #[global] Hint Rewrite lor_round_lor_land_bound_l : zsimplify_fast zsimplify.
