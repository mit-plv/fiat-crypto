...
Module Z.
  ...
  Qed.
  #[global] Hint Rewrite base_pow_neg using zutil_arith : zsimplify.
  ...
  #[global] Hint Resolve pow_sub_r' pow_sub_r'_sym Z.eq_le_incl : zarith.
  #[global] Hint Resolve (fun b => f_equal (fun e => b ^ e)) (fun e => f_equal (fun b => b ^ e)) : zarith.

  Lemma two_p_two_eq_four : 2^(2) = 4.
  Proof. reflexivity. Qed.
  #[global] Hint Rewrite <- two_p_two_eq_four : push_Zpow.
  ...
  Qed.
  #[global] Hint Resolve pow_pos_le : zarith.
