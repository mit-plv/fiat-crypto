...
Module Z.
  ...
  Definition nonneg_pow_pos_2 := (fun n => nonneg_pow_pos 2 n Z.lt_0_2).
  Hint Resolve nonneg_pow_pos_2 : zarith.
  ...
  Definition nonneg_pow_pos_helper_2 := (fun n dummy => nonneg_pow_pos_helper 2 n dummy Z.lt_0_2).
  Hint Resolve nonneg_pow_pos_helper_2 : zarith.
  ...
  Definition f_equal_pow_b := (fun b => f_equal (fun e => b ^ e)).
  Definition f_equal_pow_e := (fun e => f_equal (fun b => b ^ e)).
