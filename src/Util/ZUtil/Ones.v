...
Module Z.
  ...
  Qed.
  #[global] Hint Rewrite log2_ones_full : zsimplify.
  ...
  Proof using Type.
    ...
    f_equal. lia.
  Qed.
  #[global] Hint Rewrite <- ones_pred using zutil_arith : push_Zshift.
  ...
  Qed.
  #[global] Hint Rewrite land_ones_ones : zsimplify.
  ...
  Qed.
  #[global] Hint Rewrite lor_ones_ones : zsimplify.
  ...
  Qed.
  #[global] Hint Rewrite lor_pow2_mod_pow2_r using zutil_arith : zsimplify.
  #[global] Hint Rewrite lor_pow2_mod_pow2_r using assumption : zsimplify_fast.
  ...
  #[global] Hint Rewrite lor_pow2_mod_pow2_l using zutil_arith : zsimplify.
  #[global] Hint Rewrite lor_pow2_mod_pow2_l using assumption : zsimplify_fast.
  ...
  Proof using Type.
    ...
    reflexivity.
  Qed.
  #[global] Hint Rewrite lor_pow2_div_pow2_r using zutil_arith : zsimplify.
  #[global] Hint Rewrite lor_pow2_div_pow2_r using assumption : zsimplify_fast.
  ...
  #[global] Hint Rewrite lor_pow2_div_pow2_l using zutil_arith : zsimplify.
  #[global] Hint Rewrite lor_pow2_div_pow2_l using assumption : zsimplify_fast.
  ...
  Qed.
  #[global] Hint Rewrite land_ones_low_alt using zutil_arith : zsimplify.
  #[global] Hint Rewrite land_ones_low_alt using (idtac + split); assumption : zsimplify_fast.
  ...
  #[global] Hint Rewrite land_ones_low_alt_ones using zutil_arith : zsimplify.
  #[global] Hint Rewrite land_ones_low_alt_ones using (idtac + split); assumption : zsimplify_fast.
  ...
  #[global] Hint Rewrite shiftr_ones_sub using zutil_arith : zsimplify.
  #[global] Hint Rewrite shiftr_ones_sub using (idtac + split); assumption : zsimplify_fast.
  ...
  #[global] Hint Rewrite shiftr_ones_same using zutil_arith : zsimplify.
  #[global] Hint Rewrite shiftr_ones_same using assumption : zsimplify_fast.
End Z.
