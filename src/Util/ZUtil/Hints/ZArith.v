...
Definition Z_mod_pos_bound_proj1 := (fun a b H => proj1 (Z.mod_pos_bound a b H)).
Definition Z_mod_pos_bound_proj2 := (fun a b H => proj2 (Z.mod_pos_bound a b H)).

Hint Resolve Z_mod_pos_bound_proj1 Z_mod_pos_bound_proj2 : zarith.
