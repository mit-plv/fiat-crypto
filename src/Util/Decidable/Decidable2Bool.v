...
Qed.
#[global] Hint Rewrite dec_Z_lt_to_bool : dec2bool.
...
Qed.
#[global] Hint Rewrite dec_Z_le_to_bool : dec2bool.
...
Qed.
#[global] Hint Rewrite dec_Z_eq_to_bool : dec2bool.
...
Qed.
#[global] Hint Rewrite dec_nat_eq_to_bool : dec2bool.
Lemma dec_bool_eq_to_bool_if a b
  : (if dec (a = b :> bool) then true else false) = if b then a else negb a.
Proof.
  destruct a, b; reflexivity.
Qed.
#[global] Hint Rewrite dec_bool_eq_to_bool_if : dec2bool.
...
Qed.
#[global] Hint Rewrite @dec_not_negb : dec2bool.
...
Qed.
#[global] Hint Rewrite dec_Q_le_to_bool : dec2bool.
Lemma dec_True_to_bool
  : (if dec True then true else false) = true.
Proof. reflexivity. Qed.
#[global] Hint Rewrite dec_True_to_bool : dec2bool.
Lemma dec_False_to_bool
  : (if dec False then true else false) = false.
Proof. reflexivity. Qed.
#[global] Hint Rewrite dec_False_to_bool : dec2bool.
...
#[global] Hint Rewrite @dec_ifb_to_bool : dec2bool.
...
Proof.
  ...
  { destruct (Tuple.fieldwiseb _ _ _) eqn:H''; [ | reflexivity ].
    ...
    { intros; edestruct dec; split; auto; discriminate. } }
Qed.
#[global] Hint Rewrite @dec_fieldwise_to_bool : dec2bool.
...
Qed.
#[global] Hint Rewrite dec_tuple_eq_to_bool : dec2bool.
...
Qed.
#[global] Hint Rewrite @dec_Forall_to_bool : dec2bool.
