static void freeze(uint32_t out[7], const uint32_t in1[7]) {
  ...
  { uint32_t x14, uint8_t/*bool*/ x15 = Op (Syntax.SubWithGetBorrow 28 (Syntax.TWord 0) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 0)) (0x0, Return x2, 0xffffff5);
  ...
  { uint32_t x37, uint8_t/*bool*/ x38 = Op (Syntax.AddWithGetCarry 28 (Syntax.TWord 0) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 0)) (0x0, Return x14, Return x35);
