...
Proof.
  ...
  repeat (rewrite ?(Ring.homomorphism_mul(is_homomorphism:=homomorphism_F25519_decode)),
          ?(Ring.homomorphism_add(H1             :=homomorphism_F25519_decode)),
          ?(Ring.homomorphism_sub(H1             :=homomorphism_F25519_decode))).
  reflexivity.
Qed.
...
Proof.
  ...
  generalize (Ring.homomorphism_mul(is_homomorphism:=homomorphism_carry_F25519_decode)).
  generalize (Ring.homomorphism_add(H1             :=homomorphism_carry_F25519_decode)).
  generalize (Ring.homomorphism_sub(H1             :=homomorphism_carry_F25519_decode)).
