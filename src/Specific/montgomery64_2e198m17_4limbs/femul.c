static void femul(uint64_t out[4], const uint64_t in1[4], const uint64_t in2[4]) {
  ...
  { uint64_t _;  uint64_t x121 = _mulx_u64(x106, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x125;  uint64_t x124 = _mulx_u64(x121, 0xffffffffffffffefL, &x125);
  ...
  { uint8_t x134;  uint64_t x133 = _mulx_u64_out_u8(x121, 0x3f, &x134);
  ...
  { uint64_t _;  uint64_t x202 = _mulx_u64(x187, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x206;  uint64_t x205 = _mulx_u64(x202, 0xffffffffffffffefL, &x206);
  ...
  { uint8_t x215;  uint64_t x214 = _mulx_u64_out_u8(x202, 0x3f, &x215);
  ...
  { uint64_t _;  uint64_t x283 = _mulx_u64(x268, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x287;  uint64_t x286 = _mulx_u64(x283, 0xffffffffffffffefL, &x287);
  ...
  { uint8_t x296;  uint64_t x295 = _mulx_u64_out_u8(x283, 0x3f, &x296);
  ...
  { uint64_t x325; uint8_t/*bool*/ x326 = _subborrow_u64(0x0, x312, 0xffffffffffffffefL, &x325);
  ...
  { uint64_t x334; uint8_t/*bool*/ x335 = _subborrow_u64(x332, x321, 0x3f, &x334);
