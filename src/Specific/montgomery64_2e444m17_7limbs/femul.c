static void femul(uint64_t out[7], const uint64_t in1[7], const uint64_t in2[7]) {
  ...
  { uint64_t _;  uint64_t x71 = _mulx_u64(x29, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x75;  uint64_t x74 = _mulx_u64(x71, 0xffffffffffffffefL, &x75);
  ...
  { uint64_t x93;  uint64_t x92 = _mulx_u64(x71, 0xfffffffffffffff, &x93);
  ...
  { uint64_t _;  uint64_t x206 = _mulx_u64(x182, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x210;  uint64_t x209 = _mulx_u64(x206, 0xffffffffffffffefL, &x210);
  ...
  { uint64_t x228;  uint64_t x227 = _mulx_u64(x206, 0xfffffffffffffff, &x228);
  ...
  { uint64_t _;  uint64_t x342 = _mulx_u64(x318, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x346;  uint64_t x345 = _mulx_u64(x342, 0xffffffffffffffefL, &x346);
  ...
  { uint64_t x364;  uint64_t x363 = _mulx_u64(x342, 0xfffffffffffffff, &x364);
  ...
  { uint64_t _;  uint64_t x478 = _mulx_u64(x454, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x482;  uint64_t x481 = _mulx_u64(x478, 0xffffffffffffffefL, &x482);
  ...
  { uint64_t x500;  uint64_t x499 = _mulx_u64(x478, 0xfffffffffffffff, &x500);
  ...
  { uint64_t _;  uint64_t x614 = _mulx_u64(x590, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x618;  uint64_t x617 = _mulx_u64(x614, 0xffffffffffffffefL, &x618);
  ...
  { uint64_t x636;  uint64_t x635 = _mulx_u64(x614, 0xfffffffffffffff, &x636);
  ...
  { uint64_t _;  uint64_t x750 = _mulx_u64(x726, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x754;  uint64_t x753 = _mulx_u64(x750, 0xffffffffffffffefL, &x754);
  ...
  { uint64_t x772;  uint64_t x771 = _mulx_u64(x750, 0xfffffffffffffff, &x772);
  ...
  { uint64_t _;  uint64_t x886 = _mulx_u64(x862, 0xf0f0f0f0f0f0f0f1L, &_);
  { uint64_t x890;  uint64_t x889 = _mulx_u64(x886, 0xffffffffffffffefL, &x890);
  ...
  { uint64_t x908;  uint64_t x907 = _mulx_u64(x886, 0xfffffffffffffff, &x908);
  ...
  { uint64_t x956; uint8_t/*bool*/ x957 = _subborrow_u64(0x0, x934, 0xffffffffffffffefL, &x956);
  ...
  { uint64_t x974; uint8_t/*bool*/ x975 = _subborrow_u64(x972, x952, 0xfffffffffffffff, &x974);
