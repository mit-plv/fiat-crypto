static void fecarry(uint64_t out[6], const uint64_t in1[6]) {
  ...
  { uint64_t x11 = (x2 >> 0x30);
  { uint64_t x12 = (x2 & 0xffffffffffff);
  { uint64_t x13 = (x11 + x4);
  { uint64_t x14 = (x13 >> 0x2f);
  { uint64_t x15 = (x13 & 0x7fffffffffff);
  { uint64_t x16 = (x14 + x6);
  { uint64_t x17 = (x16 >> 0x30);
  { uint64_t x18 = (x16 & 0xffffffffffff);
  { uint64_t x19 = (x17 + x8);
  ...
  { uint64_t x29 = (x28 >> 0x30);
  { uint64_t x30 = (x28 & 0xffffffffffff);
