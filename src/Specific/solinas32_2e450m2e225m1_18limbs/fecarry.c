static void fecarry(uint32_t out[18], const uint32_t in1[18]) {
  ...
  { uint32_t x35 = (x18 >> 0x19);
  { uint32_t x36 = (x18 & 0x1ffffff);
  { uint32_t x37 = (x33 >> 0x19);
  { uint32_t x38 = (x33 & 0x1ffffff);
  { uint32_t x39 = ((0x2000000 * x37) + x38);
  ...
  { uint32_t x96 = ((0x2000000 * x91) + x92);
