static void femul(uint32_t out[18], const uint32_t in1[18], const uint32_t in2[18]) {
  ...
  { uint64_t x79 = ((((uint64_t)(x7 + x25) * (x55 + x70)) + (((uint64_t)(x9 + x27) * (x53 + x71)) + (((uint64_t)(x11 + x29) * (x51 + x69)) + (((uint64_t)(x13 + x31) * (x49 + x67)) + (((uint64_t)(x15 + x33) * (x47 + x65)) + (((uint64_t)(x17 + x35) * (x45 + x63)) + (((uint64_t)(x19 + x37) * (x43 + x61)) + ((uint64_t)(x21 + x36) * (x41 + x59))))))))) - (((uint64_t)x7 * x55) + (((uint64_t)x9 * x53) + (((uint64_t)x11 * x51) + (((uint64_t)x13 * x49) + (((uint64_t)x15 * x47) + (((uint64_t)x17 * x45) + (((uint64_t)x19 * x43) + ((uint64_t)x21 * x41)))))))));
  ...
  { uint64_t x96 = ((((((uint64_t)x7 * x55) + (((uint64_t)x9 * x53) + (((uint64_t)x11 * x51) + (((uint64_t)x13 * x49) + (((uint64_t)x15 * x47) + (((uint64_t)x17 * x45) + (((uint64_t)x19 * x43) + ((uint64_t)x21 * x41)))))))) + (((uint64_t)x25 * x70) + (((uint64_t)x27 * x71) + (((uint64_t)x29 * x69) + (((uint64_t)x31 * x67) + (((uint64_t)x33 * x65) + (((uint64_t)x35 * x63) + (((uint64_t)x37 * x61) + ((uint64_t)x36 * x59))))))))) + x88) + x79);
  ...
  { uint64_t x106 = (x97 >> 0x19);
  { uint32_t x107 = ((uint32_t)x97 & 0x1ffffff);
  { uint64_t x108 = (x80 >> 0x19);
  { uint32_t x109 = ((uint32_t)x80 & 0x1ffffff);
  { uint64_t x110 = ((0x2000000 * x108) + x109);
  ...
  { uint32_t x162 = (uint32_t) (x161 >> 0x19);
  { uint32_t x163 = ((uint32_t)x161 & 0x1ffffff);
  { uint64_t x164 = (x159 + x107);
  { uint32_t x165 = (uint32_t) (x164 >> 0x19);
  { uint32_t x166 = ((uint32_t)x164 & 0x1ffffff);
  { uint64_t x167 = (((uint64_t)0x2000000 * x162) + x163);
  { uint32_t x168 = (uint32_t) (x167 >> 0x19);
  { uint32_t x169 = ((uint32_t)x167 & 0x1ffffff);
