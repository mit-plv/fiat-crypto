static void feadd(uint32_t out[13], const uint32_t in1[13], const uint32_t in2[13]) {
  ...
  { uint32_t x92; uint8_t/*bool*/ x93 = _subborrow_u32(0x0, x53, 0xffffffff, &x92);
  ...
  { uint32_t x110; uint8_t/*bool*/ x111 = _subborrow_u32(x108, x71, 0xfffeffff, &x110);
  ...
  { uint32_t x128; uint8_t/*bool*/ x129 = _subborrow_u32(x126, x89, 0xffffffff, &x128);
