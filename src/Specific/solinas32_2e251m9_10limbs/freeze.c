static void freeze(uint32_t out[10], const uint32_t in1[10]) {
  ...
  { uint32_t x20; uint8_t/*bool*/ x21 = _subborrow_u26(0x0, x2, 0x3fffff7, &x20);
  { uint32_t x23; uint8_t/*bool*/ x24 = _subborrow_u25(x21, x4, 0x1ffffff, &x23);
  { uint32_t x26; uint8_t/*bool*/ x27 = _subborrow_u25(x24, x6, 0x1ffffff, &x26);
  { uint32_t x29; uint8_t/*bool*/ x30 = _subborrow_u25(x27, x8, 0x1ffffff, &x29);
  { uint32_t x32; uint8_t/*bool*/ x33 = _subborrow_u25(x30, x10, 0x1ffffff, &x32);
  ...
  { uint32_t x44; uint8_t/*bool*/ x45 = _subborrow_u25(x42, x18, 0x1ffffff, &x44);
  ...
  { uint32_t x60; uint8_t/*bool*/ x61 = _addcarryx_u25(x57, x26, x58, &x60);
  { uint32_t x62 = (x49 & 0x1ffffff);
  { uint32_t x64; uint8_t/*bool*/ x65 = _addcarryx_u25(x61, x29, x62, &x64);
  { uint32_t x66 = (x49 & 0x1ffffff);
  { uint32_t x68; uint8_t/*bool*/ x69 = _addcarryx_u25(x65, x32, x66, &x68);
  ...
  { uint32_t x84; uint8_t/*bool*/ x85 = _addcarryx_u25(x81, x44, x82, &x84);
