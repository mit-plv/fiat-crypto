static void fecarry(uint64_t out[6], const uint64_t in1[6]) {
  ...
  { uint64_t x11 = (x9 >> 0x2a);
  { uint64_t x12 = (x9 & 0x3ffffffffff);
  { uint64_t x13 = ((0x40000000000 * x11) + x12);
  { uint64_t x14 = (x13 >> 0x2a);
  { uint64_t x15 = (x13 & 0x3ffffffffff);
  { uint64_t x16 = ((0x40000000000 * x14) + x15);
  { uint64_t x17 = (x16 >> 0x2a);
  { uint64_t x18 = (x16 & 0x3ffffffffff);
  { uint64_t x19 = (x2 + ((0x3d1 * x17) + (0x100000000 * x17)));
  ...
  { uint64_t x37 = (x21 + ((0x3d1 * x35) + (0x100000000 * x35)));
