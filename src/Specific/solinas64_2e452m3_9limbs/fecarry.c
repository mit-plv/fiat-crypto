static void fecarry(uint64_t out[9], const uint64_t in1[9]) {
  ...
  { uint64_t x17 = (x2 >> 0x33);
  { uint64_t x18 = (x2 & 0x7ffffffffffff);
  { uint64_t x19 = (x17 + x4);
  ...
  { uint64_t x25 = (x23 + x8);
  { uint64_t x26 = (x25 >> 0x32);
  { uint64_t x27 = (x25 & 0x3ffffffffffff);
  ...
  { uint64_t x35 = (x34 >> 0x32);
  { uint64_t x36 = (x34 & 0x3ffffffffffff);
  { uint64_t x37 = (x35 + x16);
  { uint64_t x38 = (x37 >> 0x32);
  { uint64_t x39 = (x37 & 0x3ffffffffffff);
  { uint64_t x40 = (x38 + x15);
  { uint64_t x41 = (x40 >> 0x32);
  { uint64_t x42 = (x40 & 0x3ffffffffffff);
  { uint64_t x43 = (x18 + (0x3 * x41));
  { uint64_t x44 = (x43 >> 0x33);
  { uint64_t x45 = (x43 & 0x7ffffffffffff);
  { uint64_t x46 = (x44 + x21);
  { uint64_t x47 = (x46 >> 0x32);
  { uint64_t x48 = (x46 & 0x3ffffffffffff);
  out[0] = x45;
  out[1] = x48;
  out[2] = (x47 + x24);
  out[3] = x27;
