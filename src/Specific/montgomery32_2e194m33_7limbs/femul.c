static void femul(uint32_t out[7], const uint32_t in1[7], const uint32_t in2[7]) {
  ...
  { uint32_t _;  uint32_t x71 = _mulx_u32(x29, Const 1041204193, &_);
  { uint32_t x75;  uint32_t x74 = _mulx_u32(x71, 0xffffffdf, &x75);
  ...
  { uint8_t x93;  uint32_t x92 = _mulx_u32_out_u8(x71, 0x3, &x93);
  ...
  { uint32_t _;  uint32_t x205 = _mulx_u32(x181, Const 1041204193, &_);
  { uint32_t x209;  uint32_t x208 = _mulx_u32(x205, 0xffffffdf, &x209);
  ...
  { uint8_t x227;  uint32_t x226 = _mulx_u32_out_u8(x205, 0x3, &x227);
  ...
  { uint32_t _;  uint32_t x340 = _mulx_u32(x316, Const 1041204193, &_);
  { uint32_t x344;  uint32_t x343 = _mulx_u32(x340, 0xffffffdf, &x344);
  ...
  { uint8_t x362;  uint32_t x361 = _mulx_u32_out_u8(x340, 0x3, &x362);
  ...
  { uint32_t _;  uint32_t x475 = _mulx_u32(x451, Const 1041204193, &_);
  { uint32_t x479;  uint32_t x478 = _mulx_u32(x475, 0xffffffdf, &x479);
  ...
  { uint8_t x497;  uint32_t x496 = _mulx_u32_out_u8(x475, 0x3, &x497);
  ...
  { uint32_t _;  uint32_t x610 = _mulx_u32(x586, Const 1041204193, &_);
  { uint32_t x614;  uint32_t x613 = _mulx_u32(x610, 0xffffffdf, &x614);
  ...
  { uint8_t x632;  uint32_t x631 = _mulx_u32_out_u8(x610, 0x3, &x632);
  ...
  { uint32_t _;  uint32_t x745 = _mulx_u32(x721, Const 1041204193, &_);
  { uint32_t x749;  uint32_t x748 = _mulx_u32(x745, 0xffffffdf, &x749);
  ...
  { uint8_t x767;  uint32_t x766 = _mulx_u32_out_u8(x745, 0x3, &x767);
  ...
  { uint32_t _;  uint32_t x880 = _mulx_u32(x856, Const 1041204193, &_);
  { uint32_t x884;  uint32_t x883 = _mulx_u32(x880, 0xffffffdf, &x884);
  ...
  { uint8_t x902;  uint32_t x901 = _mulx_u32_out_u8(x880, 0x3, &x902);
  ...
  { uint32_t x949; uint8_t/*bool*/ x950 = _subborrow_u32(0x0, x927, 0xffffffdf, &x949);
  ...
  { uint32_t x967; uint8_t/*bool*/ x968 = _subborrow_u32(x965, x945, 0x3, &x967);
