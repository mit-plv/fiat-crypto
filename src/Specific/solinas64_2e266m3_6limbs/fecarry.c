static void fecarry(uint64_t out[6], const uint64_t in1[6]) {
  ...
  { uint64_t x11 = (x2 >> 0x2d);
  { uint64_t x12 = (x2 & 0x1fffffffffff);
  { uint64_t x13 = (x11 + x4);
  { uint64_t x14 = (x13 >> 0x2c);
  { uint64_t x15 = (x13 & 0xfffffffffff);
  { uint64_t x16 = (x14 + x6);
  { uint64_t x17 = (x16 >> 0x2c);
  { uint64_t x18 = (x16 & 0xfffffffffff);
  { uint64_t x19 = (x17 + x8);
  { uint64_t x20 = (x19 >> 0x2d);
  { uint64_t x21 = (x19 & 0x1fffffffffff);
  { uint64_t x22 = (x20 + x10);
  { uint64_t x23 = (x22 >> 0x2c);
  { uint64_t x24 = (x22 & 0xfffffffffff);
  { uint64_t x25 = (x23 + x9);
  { uint64_t x26 = (x25 >> 0x2c);
  { uint64_t x27 = (x25 & 0xfffffffffff);
  { uint64_t x28 = (x12 + (0x3 * x26));
