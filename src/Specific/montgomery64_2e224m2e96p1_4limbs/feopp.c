static void feopp(uint64_t out[4], const uint64_t in1[4]) {
  ...
  { uint8_t/*bool*/ x20 = (1&(uint8_t/*bool*/)x19 & 0x1);
  ...
  { uint64_t x30; uint8_t/*bool*/ x31 = _addcarryx_u64(x27, x14, x28, &x30);
  { uint64_t x32 = (x19 & 0xffffffff);
  { uint64_t x34; uint8_t/*bool*/ _ = _addcarryx_u64(x31, x17, x32, &x34);
  out[0] = x22;
  out[1] = x26;
  out[2] = x30;
  out[3] = x34;
