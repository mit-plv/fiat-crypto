static void femul(uint64_t out[4], const uint64_t in1[4], const uint64_t in2[4]) {
  ...
  { uint64_t x53; uint8_t/*bool*/ x54 = _addcarryx_u64(0x0, x45, x47, &x53);
  { uint64_t x56; uint8_t/*bool*/ x57 = _addcarryx_u64(x54, x48, x50, &x56);
  { uint64_t x59; uint8_t/*bool*/ _ = _addcarryx_u64(0x0, x57, x51, &x59);
  { uint64_t _; uint8_t/*bool*/ x63 = _addcarryx_u64(0x0, x17, x41, &_);
  { uint64_t x65; uint8_t/*bool*/ x66 = _addcarryx_u64(x63, x29, x44, &x65);
  ...
  { uint64_t x128; uint8_t/*bool*/ x129 = _addcarryx_u64(0x0, x120, x122, &x128);
  { uint64_t x131; uint8_t/*bool*/ x132 = _addcarryx_u64(x129, x123, x125, &x131);
  { uint64_t x134; uint8_t/*bool*/ _ = _addcarryx_u64(0x0, x132, x126, &x134);
  { uint64_t _; uint8_t/*bool*/ x138 = _addcarryx_u64(0x0, x101, x116, &_);
  { uint64_t x140; uint8_t/*bool*/ x141 = _addcarryx_u64(x138, x104, x119, &x140);
  ...
  { uint64_t x204; uint8_t/*bool*/ x205 = _addcarryx_u64(0x0, x196, x198, &x204);
  { uint64_t x207; uint8_t/*bool*/ x208 = _addcarryx_u64(x205, x199, x201, &x207);
  { uint64_t x210; uint8_t/*bool*/ _ = _addcarryx_u64(0x0, x208, x202, &x210);
  { uint64_t _; uint8_t/*bool*/ x214 = _addcarryx_u64(0x0, x177, x192, &_);
  { uint64_t x216; uint8_t/*bool*/ x217 = _addcarryx_u64(x214, x180, x195, &x216);
  ...
  { uint64_t x280; uint8_t/*bool*/ x281 = _addcarryx_u64(0x0, x272, x274, &x280);
  { uint64_t x283; uint8_t/*bool*/ x284 = _addcarryx_u64(x281, x275, x277, &x283);
  { uint64_t x286; uint8_t/*bool*/ _ = _addcarryx_u64(0x0, x284, x278, &x286);
  { uint64_t _; uint8_t/*bool*/ x290 = _addcarryx_u64(0x0, x253, x268, &_);
  { uint64_t x292; uint8_t/*bool*/ x293 = _addcarryx_u64(x290, x256, x271, &x292);
  ...
  { uint64_t x305; uint8_t/*bool*/ x306 = _subborrow_u64(0x0, x292, 0x1, &x305);
  { uint64_t x308; uint8_t/*bool*/ x309 = _subborrow_u64(x306, x295, 0xffffffff00000000L, &x308);
  { uint64_t x311; uint8_t/*bool*/ x312 = _subborrow_u64(x309, x298, 0xffffffffffffffffL, &x311);
  { uint64_t x314; uint8_t/*bool*/ x315 = _subborrow_u64(x312, x301, 0xffffffff, &x314);
