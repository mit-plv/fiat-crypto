static void feadd(uint32_t out[14], const uint32_t in1[14], const uint32_t in2[14]) {
  ...
  { uint32_t x99; uint8_t/*bool*/ x100 = _subborrow_u32(0x0, x57, 0xffffffff, &x99);
  ...
  { uint32_t x120; uint8_t/*bool*/ x121 = _subborrow_u32(x118, x78, 0xfffffffe, &x120);
  ...
  { uint32_t x138; uint8_t/*bool*/ x139 = _subborrow_u32(x136, x96, 0xffffffff, &x138);
