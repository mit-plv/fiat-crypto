static void freeze(uint32_t out[6], const uint32_t in1[6]) {
  ...
  { uint32_t x12, uint8_t/*bool*/ x13 = Op (Syntax.SubWithGetBorrow 22 (Syntax.TWord 0) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 0)) (0x0, Return x2, 0x3fffe7);
  ...
  { uint32_t x18, uint8_t/*bool*/ x19 = Op (Syntax.SubWithGetBorrow 22 (Syntax.TWord 0) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 0)) (Return x16, Return x6, 0x3fffff);
  ...
  { uint32_t x40, uint8_t/*bool*/ x41 = Op (Syntax.AddWithGetCarry 22 (Syntax.TWord 0) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 5) (Syntax.TWord 0)) (Return x37, Return x18, Return x38);
