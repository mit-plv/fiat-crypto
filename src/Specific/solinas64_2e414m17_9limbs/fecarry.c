static void fecarry(uint64_t out[9], const uint64_t in1[9]) {
  ...
  { uint64_t x17 = (x2 >> 0x2e);
  { uint64_t x18 = (x2 & 0x3fffffffffff);
  { uint64_t x19 = (x17 + x4);
  { uint64_t x20 = (x19 >> 0x2e);
  { uint64_t x21 = (x19 & 0x3fffffffffff);
  { uint64_t x22 = (x20 + x6);
  { uint64_t x23 = (x22 >> 0x2e);
  { uint64_t x24 = (x22 & 0x3fffffffffff);
  { uint64_t x25 = (x23 + x8);
  ...
  { uint64_t x35 = (x34 >> 0x2e);
  { uint64_t x36 = (x34 & 0x3fffffffffff);
  { uint64_t x37 = (x35 + x16);
  { uint64_t x38 = (x37 >> 0x2e);
  { uint64_t x39 = (x37 & 0x3fffffffffff);
  ...
  { uint64_t x47 = (x46 >> 0x2e);
  { uint64_t x48 = (x46 & 0x3fffffffffff);
  out[0] = x45;
  out[1] = x48;
  out[2] = (x47 + x24);
  out[3] = x27;
