static void freeze(uint32_t out[6], const uint32_t in1[6]) {
  ...
  { uint32_t x12; uint8_t/*bool*/ x13 = _subborrow_u25(0x0, x2, 0x1fffffb, &x12);
  ...
  { uint32_t x21; uint8_t/*bool*/ x22 = _subborrow_u25(x19, x8, 0x1ffffff, &x21);
  ...
  { uint32_t x32; uint8_t/*bool*/ x33 = _addcarryx_u25(0x0, x12, x30, &x32);
  ...
  { uint32_t x44; uint8_t/*bool*/ x45 = _addcarryx_u25(x41, x21, x42, &x44);
