static void fecarry(uint64_t out[9], const uint64_t in1[9]) {
  ...
  { uint64_t x17 = (x2 >> 0x32);
  { uint64_t x18 = (x2 & 0x3ffffffffffff);
  { uint64_t x19 = (x17 + x4);
  { uint64_t x20 = (x19 >> 0x31);
  { uint64_t x21 = (x19 & 0x1ffffffffffff);
  { uint64_t x22 = (x20 + x6);
  ...
  { uint64_t x38 = (x37 >> 0x31);
  { uint64_t x39 = (x37 & 0x1ffffffffffff);
  { uint64_t x40 = (x38 + x15);
  { uint64_t x41 = (x40 >> 0x31);
  { uint64_t x42 = (x40 & 0x1ffffffffffff);
  { uint64_t x43 = (x18 + (0x11 * x41));
  { uint64_t x44 = (x43 >> 0x32);
  { uint64_t x45 = (x43 & 0x3ffffffffffff);
