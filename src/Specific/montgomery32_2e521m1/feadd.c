static void feadd(uint32_t out[17], const uint32_t in1[17], const uint32_t in2[17]) {
  ...
  { uint32_t x173 = cmovznz(x172, x168, x117);
  { uint32_t x174 = cmovznz(x172, x165, x114);
  { uint32_t x175 = cmovznz(x172, x162, x111);
  { uint32_t x176 = cmovznz(x172, x159, x108);
  { uint32_t x177 = cmovznz(x172, x156, x105);
  { uint32_t x178 = cmovznz(x172, x153, x102);
  { uint32_t x179 = cmovznz(x172, x150, x99);
  { uint32_t x180 = cmovznz(x172, x147, x96);
  { uint32_t x181 = cmovznz(x172, x144, x93);
  { uint32_t x182 = cmovznz(x172, x141, x90);
  { uint32_t x183 = cmovznz(x172, x138, x87);
  { uint32_t x184 = cmovznz(x172, x135, x84);
  { uint32_t x185 = cmovznz(x172, x132, x81);
  { uint32_t x186 = cmovznz(x172, x129, x78);
  { uint32_t x187 = cmovznz(x172, x126, x75);
  { uint32_t x188 = cmovznz(x172, x123, x72);
  { uint32_t x189 = cmovznz(x172, x120, x69);
  out[0] = x189;
  out[1] = x188;
  out[2] = x187;
  out[3] = x186;
