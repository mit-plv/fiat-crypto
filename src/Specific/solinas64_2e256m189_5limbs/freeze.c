static void freeze(uint64_t out[5], const uint64_t in1[5]) {
  ...
  { uint64_t x10, uint8_t/*bool*/ x11 = Op (Syntax.SubWithGetBorrow 52 (Syntax.TWord 0) (Syntax.TWord 6) (Syntax.TWord 6) (Syntax.TWord 6) (Syntax.TWord 0)) (0x0, Return x2, 0xfffffffffff43);
