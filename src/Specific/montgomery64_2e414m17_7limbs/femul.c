static void femul(uint64_t out[7], const uint64_t in1[7], const uint64_t in2[7]) {
  ...
  { uint64_t x93;  uint64_t x92 = _mulx_u64(x71, 0x3fffffff, &x93);
  ...
  { uint64_t x228;  uint64_t x227 = _mulx_u64(x206, 0x3fffffff, &x228);
  ...
  { uint64_t x364;  uint64_t x363 = _mulx_u64(x342, 0x3fffffff, &x364);
  ...
  { uint64_t x500;  uint64_t x499 = _mulx_u64(x478, 0x3fffffff, &x500);
  ...
  { uint64_t x636;  uint64_t x635 = _mulx_u64(x614, 0x3fffffff, &x636);
  ...
  { uint64_t x772;  uint64_t x771 = _mulx_u64(x750, 0x3fffffff, &x772);
  ...
  { uint64_t x908;  uint64_t x907 = _mulx_u64(x886, 0x3fffffff, &x908);
  ...
  { uint64_t x974; uint8_t/*bool*/ x975 = _subborrow_u64(x972, x952, 0x3fffffff, &x974);
