static void fecarry(uint64_t out[9], const uint64_t in1[9]) {
  ...
  { uint64_t x22 = (x20 + x6);
  { uint64_t x23 = (x22 >> 0x37);
  { uint64_t x24 = (x22 & 0x7fffffffffffff);
  { uint64_t x25 = (x23 + x8);
