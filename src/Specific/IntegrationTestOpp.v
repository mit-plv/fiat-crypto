...
Section BoundedField25p5.
  ...
  Proof.
    ...
    rewrite <- (proj2_sig opp_sig).
    symmetry; rewrite <- (proj2_sig carry_sig); symmetry.
    set (carry_oppZ := fun a => proj1_sig carry_sig (proj1_sig opp_sig a)).
    change (proj1_sig carry_sig (proj1_sig opp_sig ?a)) with (carry_oppZ a).
    context_to_dlet_in_rhs carry_oppZ.
    cbv beta iota delta [carry_oppZ proj1_sig opp_sig carry_sig fst snd runtime_add runtime_and runtime_mul runtime_opp runtime_shr sz].
    reflexivity.
