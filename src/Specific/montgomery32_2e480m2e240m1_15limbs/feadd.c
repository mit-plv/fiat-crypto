static void feadd(uint32_t out[15], const uint32_t in1[15], const uint32_t in2[15]) {
  ...
  { uint32_t x106; uint8_t/*bool*/ x107 = _subborrow_u32(0x0, x61, 0xffffffff, &x106);
  ...
  { uint32_t x127; uint8_t/*bool*/ x128 = _subborrow_u32(x125, x82, 0xfffeffff, &x127);
  ...
  { uint32_t x148; uint8_t/*bool*/ x149 = _subborrow_u32(x146, x103, 0xffffffff, &x148);
