static void freeze(uint32_t out[5], const uint32_t in1[5]) {
  ...
  { uint32_t x10; uint8_t/*bool*/ x11 = _subborrow_u26(0x0, x2, 0x3fffffb, &x10);
  ...
  { uint32_t x22; uint8_t/*bool*/ x23 = _subborrow_u26(x20, x7, 0x3ffffff, &x22);
  ...
  { uint32_t x43; uint8_t/*bool*/ _ = _addcarryx_u26(x40, x22, x41, &x43);
  out[0] = x27;
  out[1] = x31;
  out[2] = x35;
  out[3] = x39;
