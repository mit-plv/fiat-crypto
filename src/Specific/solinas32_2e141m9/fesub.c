static void fesub(uint32_t out[6], const uint32_t in1[6], const uint32_t in2[6]) {
  ...
  out[0] = ((Const 33554414 + x5) - x15);
  out[1] = ((Const 16777214 + x7) - x17);
  out[2] = ((Const 33554430 + x9) - x19);
  out[3] = ((Const 16777214 + x11) - x21);
  out[4] = ((Const 33554430 + x13) - x23);
  out[5] = ((Const 16777214 + x12) - x22);
  }}}}}}}}}}}}
}
