static void fecarry(uint64_t out[7], const uint64_t in1[7]) {
  ...
  { uint64_t x13 = (x2 >> 0x35);
  { uint64_t x14 = (x2 & 0x1fffffffffffff);
  { uint64_t x15 = (x13 + x4);
  ...
  { uint64_t x25 = (x24 >> 0x35);
  { uint64_t x26 = (x24 & 0x1fffffffffffff);
  { uint64_t x27 = (x25 + x12);
  { uint64_t x28 = (x27 >> 0x35);
  { uint64_t x29 = (x27 & 0x1fffffffffffff);
  { uint64_t x30 = (x28 + x11);
  { uint64_t x31 = (x30 >> 0x34);
  { uint64_t x32 = (x30 & 0xfffffffffffff);
  { uint64_t x33 = (x14 + (0x19 * x31));
