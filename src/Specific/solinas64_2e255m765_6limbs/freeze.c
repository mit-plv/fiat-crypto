static void freeze(uint64_t out[6], const uint64_t in1[6]) {
  ...
  { uint64_t x12, uint8_t/*bool*/ x13 = Op (Syntax.SubWithGetBorrow 43 (Syntax.TWord 0) (Syntax.TWord 6) (Syntax.TWord 6) (Syntax.TWord 6) (Syntax.TWord 0)) (0x0, Return x2, 0x7fffffffd03);
