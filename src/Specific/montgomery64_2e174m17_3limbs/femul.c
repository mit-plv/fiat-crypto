static void femul(uint64_t out[3], const uint64_t in1[3], const uint64_t in2[3]) {
  ...
  { uint64_t x192; uint8_t/*bool*/ x193 = _subborrow_u64(0x0, x182, 0xffffffffffffffefL, &x192);
  { uint64_t x195; uint8_t/*bool*/ x196 = _subborrow_u64(x193, x185, 0xffffffffffffffffL, &x195);
  { uint64_t x198; uint8_t/*bool*/ x199 = _subborrow_u64(x196, x188, 0x3fffffffffff, &x198);
