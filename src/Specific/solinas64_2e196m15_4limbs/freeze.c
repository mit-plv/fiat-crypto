static void freeze(uint64_t out[4], const uint64_t in1[4]) {
  ...
  { uint64_t x8, uint8_t/*bool*/ x9 = Op (Syntax.SubWithGetBorrow 49 (Syntax.TWord 0) (Syntax.TWord 6) (Syntax.TWord 6) (Syntax.TWord 6) (Syntax.TWord 0)) (0x0, Return x2, 0x1fffffffffff1);
