static void fecarry(uint32_t out[6], const uint32_t in1[6]) {
  ...
  { uint32_t x11 = (x2 >> 0x1b);
  { uint32_t x12 = (x2 & 0x7ffffff);
  { uint32_t x13 = (x11 + x4);
  { uint32_t x14 = (x13 >> 0x1a);
  { uint32_t x15 = (x13 & 0x3ffffff);
  { uint32_t x16 = (x14 + x6);
  { uint32_t x17 = (x16 >> 0x1a);
  { uint32_t x18 = (x16 & 0x3ffffff);
  { uint32_t x19 = (x17 + x8);
  { uint32_t x20 = (x19 >> 0x1b);
  { uint32_t x21 = (x19 & 0x7ffffff);
  { uint32_t x22 = (x20 + x10);
  { uint32_t x23 = (x22 >> 0x1a);
  { uint32_t x24 = (x22 & 0x3ffffff);
  { uint32_t x25 = (x23 + x9);
  { uint32_t x26 = (x25 >> 0x1a);
  { uint32_t x27 = (x25 & 0x3ffffff);
  { uint32_t x28 = (x12 + (0xf * x26));
