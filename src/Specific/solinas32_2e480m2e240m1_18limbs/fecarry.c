static void fecarry(uint32_t out[18], const uint32_t in1[18]) {
  ...
  { uint32_t x35 = (x18 >> 0x1a);
  { uint32_t x36 = (x18 & 0x3ffffff);
  { uint32_t x37 = (x33 >> 0x1a);
  { uint32_t x38 = (x33 & 0x3ffffff);
  { uint32_t x39 = ((0x4000000 * x37) + x38);
  ...
  { uint32_t x96 = ((0x4000000 * x91) + x92);
  { uint32_t x97 = (x96 >> 0x1a);
  { uint32_t x98 = (x96 & 0x3ffffff);
  { uint32_t x99 = ((x94 + x44) + x97);
  { uint32_t x100 = (x99 >> 0x1b);
  { uint32_t x101 = (x99 & 0x7ffffff);
  { uint32_t x102 = (x47 + x97);
  { uint32_t x103 = (x102 >> 0x1b);
  { uint32_t x104 = (x102 & 0x7ffffff);
  out[0] = x104;
  out[1] = (x103 + x53);
  out[2] = x59;
  out[3] = x65;
