static void freeze(uint32_t out[5], const uint32_t in1[5]) {
  ...
  { uint32_t x10; uint8_t/*bool*/ x11 = _subborrow_u26(0x0, x2, 0x3ffffff, &x10);
  { uint32_t x13; uint8_t/*bool*/ x14 = _subborrow_u25(x11, x4, 0x1ffffff, &x13);
  { uint32_t x16; uint8_t/*bool*/ x17 = _subborrow_u26(x14, x6, 0x3ffffff, &x16);
  { uint32_t x19; uint8_t/*bool*/ x20 = _subborrow_u25(x17, x8, 0x1ffffff, &x19);
  ...
  { uint32_t x31; uint8_t/*bool*/ x32 = _addcarryx_u25(x28, x13, x29, &x31);
  { uint32_t x33 = (x24 & 0x3ffffff);
  { uint32_t x35; uint8_t/*bool*/ x36 = _addcarryx_u26(x32, x16, x33, &x35);
  { uint32_t x37 = (x24 & 0x1ffffff);
  { uint32_t x39; uint8_t/*bool*/ x40 = _addcarryx_u25(x36, x19, x37, &x39);
