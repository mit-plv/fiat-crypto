static void fecarry(uint64_t out[6], const uint64_t in1[6]) {
  ...
  { uint64_t x11 = (x2 >> 0x31);
  { uint64_t x12 = (x2 & 0x1ffffffffffff);
  { uint64_t x13 = (x11 + x4);
  { uint64_t x14 = (x13 >> 0x30);
  { uint64_t x15 = (x13 & 0xffffffffffff);
  { uint64_t x16 = (x14 + x6);
  { uint64_t x17 = (x16 >> 0x31);
  { uint64_t x18 = (x16 & 0x1ffffffffffff);
  { uint64_t x19 = (x17 + x8);
  { uint64_t x20 = (x19 >> 0x30);
  { uint64_t x21 = (x19 & 0xffffffffffff);
