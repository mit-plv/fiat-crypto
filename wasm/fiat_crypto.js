...
D(a,b){for(var
c=0;c<b.length;c++)a=C(a,b.charCodeAt(c));return a^b.length}const
...
c
in
a)if(a.hasOwn(c))b(c)},array_length:a=>a.length,array_get:(a,b)=>a[b],array_set:(a,b,c)=>a[b]=c,read_string:a=>l.decode(new
Uint8Array(i,0,a)),read_string_stream:(a,b)=>l.decode(new
Uint8Array(i,0,a),{stream:b}),append_string:(a,b)=>a+b,write_string:a=>{var
c=0,b=a.length;for(;;){const{read:d,written:e}=z.encodeInto(a.slice(c),K);b-=d;if(!b)return e;w(e);c+=d}},ta_create:(a,b)=>new
...
a==="string"),compare:(a,b)=>a<b?-1:+(a>b),hash:D,decodeStringFromUTF8Array:()=>"",encodeStringToUTF8Array:()=>0},g=Object.assign({Math:I,bindings:u,js:t,"wasm:js-string":m,"wasm:text-decoder":m,"wasm:text-encoder":m,env:{}},B),q={builtins:["js-string","text-decoder","text-encoder"]};function
H(a){const
b=require("node:path"),c=b.join(b.dirname(require.main.filename),a);return require("node:fs/promises").readFile(c)}function
A(a){const
...
k()})(function(a){"use strict";return{}}(globalThis))({"link":[["code-eff9de54a803020f05c7",0]],"generated":(a=>{var
