...
b=="string"?b:l.decode(b.slice(c,c+d))),d),read:(a,b,c,d,e)=>f.readSync(a,b,c,d,e),file_size:a=>f.fstatSync(a,{bigint:true}).size,register_channel:M,unregister_channel:O,channel_list:z,exit:a=>h&&d.exit(a),argv:()=>h?d.argv.slice(1):["a.out"],getenv:a=>h?d.env[a]:null,system:a=>{var
...
P=await
F();var{caml_callback:c,caml_alloc_tm:o,caml_start_fiber:y,caml_handle_uncaught_exception:p,caml_buffer:w,caml_extract_string:x,_initialize:k}=P.instance.exports,i=w?.buffer,L=i&&new
...
k()})(function(a){"use strict";return{}}(globalThis))({"link":[["code-90c1b3f743aba453cde5",0]],"generated":(a=>{var
