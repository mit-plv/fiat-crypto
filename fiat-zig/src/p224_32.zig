...
pub fn sub(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    addcarryxU32(&x16, &x17, 0x0, x1, cast(u32, cast(u1, x15)));
    var x18: u32 = undefined;
...
pub fn toBytes(out1: *[28]u8, arg1: [7]u32) void {
    ...
    const x8 = (x7 >> 8);
    const x9 = (x8 >> 8);
    const x10 = cast(u8, (x9 >> 8));
    const x11 = (x6 >> 8);
    const x12 = (x11 >> 8);
    const x13 = cast(u8, (x12 >> 8));
    const x14 = (x5 >> 8);
    const x15 = (x14 >> 8);
    const x16 = cast(u8, (x15 >> 8));
    const x17 = (x4 >> 8);
    const x18 = (x17 >> 8);
    const x19 = cast(u8, (x18 >> 8));
    const x20 = (x3 >> 8);
    const x21 = (x20 >> 8);
    const x22 = cast(u8, (x21 >> 8));
    const x23 = (x2 >> 8);
    const x24 = (x23 >> 8);
...
pub fn divstep(out1: *u32, out2: *[8]u32, out3: *[8]u32, out4: *[7]u32, out5: *[7]u32, arg1: u32, arg2: [8]u32, arg3: [8]u32, arg4: [7]u32, arg5: [7]u32) void {
    ...
    var x98: u32 = undefined;
    var x99: u1 = undefined;
    addcarryxU32(&x98, &x99, 0x0, x83, cast(u32, cast(u1, x97)));
    var x100: u32 = undefined;
    var x101: u1 = undefined;
    ...
    var x119: u32 = undefined;
    cmovznzU32(&x119, cast(u1, x31), cast(u32, 0x0), x7);
    var x120: u32 = undefined;
    cmovznzU32(&x120, cast(u1, x31), cast(u32, 0x0), x8);
    var x121: u32 = undefined;
    cmovznzU32(&x121, cast(u1, x31), cast(u32, 0x0), x9);
    var x122: u32 = undefined;
    cmovznzU32(&x122, cast(u1, x31), cast(u32, 0x0), x10);
    var x123: u32 = undefined;
    cmovznzU32(&x123, cast(u1, x31), cast(u32, 0x0), x11);
    var x124: u32 = undefined;
    cmovznzU32(&x124, cast(u1, x31), cast(u32, 0x0), x12);
    var x125: u32 = undefined;
    cmovznzU32(&x125, cast(u1, x31), cast(u32, 0x0), x13);
    var x126: u32 = undefined;
    cmovznzU32(&x126, cast(u1, x31), cast(u32, 0x0), x14);
    var x127: u32 = undefined;
    var x128: u1 = undefined;
    addcarryxU32(&x127, &x128, 0x0, x31, x119);
    var x129: u32 = undefined;
    var x130: u1 = undefined;
    addcarryxU32(&x129, &x130, x128, x32, x120);
    var x131: u32 = undefined;
    var x132: u1 = undefined;
    addcarryxU32(&x131, &x132, x130, x33, x121);
    var x133: u32 = undefined;
    var x134: u1 = undefined;
    addcarryxU32(&x133, &x134, x132, x34, x122);
    var x135: u32 = undefined;
    var x136: u1 = undefined;
    addcarryxU32(&x135, &x136, x134, x35, x123);
    var x137: u32 = undefined;
    var x138: u1 = undefined;
    addcarryxU32(&x137, &x138, x136, x36, x124);
    var x139: u32 = undefined;
    var x140: u1 = undefined;
    addcarryxU32(&x139, &x140, x138, x37, x125);
    var x141: u32 = undefined;
    var x142: u1 = undefined;
    addcarryxU32(&x141, &x142, x140, x38, x126);
    var x143: u32 = undefined;
    cmovznzU32(&x143, cast(u1, x31), cast(u32, 0x0), x39);
    var x144: u32 = undefined;
    cmovznzU32(&x144, cast(u1, x31), cast(u32, 0x0), x40);
    var x145: u32 = undefined;
    cmovznzU32(&x145, cast(u1, x31), cast(u32, 0x0), x41);
    var x146: u32 = undefined;
    cmovznzU32(&x146, cast(u1, x31), cast(u32, 0x0), x42);
    var x147: u32 = undefined;
    cmovznzU32(&x147, cast(u1, x31), cast(u32, 0x0), x43);
    var x148: u32 = undefined;
    cmovznzU32(&x148, cast(u1, x31), cast(u32, 0x0), x44);
    var x149: u32 = undefined;
    cmovznzU32(&x149, cast(u1, x31), cast(u32, 0x0), x45);
    var x150: u32 = undefined;
    var x151: u1 = undefined;
    addcarryxU32(&x150, &x151, 0x0, x112, x143);
    var x152: u32 = undefined;
    var x153: u1 = undefined;
    addcarryxU32(&x152, &x153, x151, x113, x144);
    var x154: u32 = undefined;
    var x155: u1 = undefined;
    addcarryxU32(&x154, &x155, x153, x114, x145);
    var x156: u32 = undefined;
    var x157: u1 = undefined;
    addcarryxU32(&x156, &x157, x155, x115, x146);
    var x158: u32 = undefined;
    var x159: u1 = undefined;
    addcarryxU32(&x158, &x159, x157, x116, x147);
    var x160: u32 = undefined;
    var x161: u1 = undefined;
    addcarryxU32(&x160, &x161, x159, x117, x148);
    var x162: u32 = undefined;
    var x163: u1 = undefined;
    addcarryxU32(&x162, &x163, x161, x118, x149);
    var x164: u32 = undefined;
    var x165: u1 = undefined;
    subborrowxU32(&x164, &x165, 0x0, x150, cast(u32, 0x1));
    var x166: u32 = undefined;
    var x167: u1 = undefined;
    subborrowxU32(&x166, &x167, x165, x152, cast(u32, 0x0));
    var x168: u32 = undefined;
    var x169: u1 = undefined;
    subborrowxU32(&x168, &x169, x167, x154, cast(u32, 0x0));
    var x170: u32 = undefined;
    var x171: u1 = undefined;
    subborrowxU32(&x170, &x171, x169, x156, 0xffffffff);
    var x172: u32 = undefined;
    var x173: u1 = undefined;
    ...
    var x178: u32 = undefined;
    var x179: u1 = undefined;
    subborrowxU32(&x178, &x179, x177, cast(u32, x163), cast(u32, 0x0));
    var x180: u32 = undefined;
    var x181: u1 = undefined;
    addcarryxU32(&x180, &x181, 0x0, x6, cast(u32, 0x1));
    const x182 = ((x127 >> 1) | ((x129 << 31) & 0xffffffff));
    const x183 = ((x129 >> 1) | ((x131 << 31) & 0xffffffff));
    const x184 = ((x131 >> 1) | ((x133 << 31) & 0xffffffff));
    const x185 = ((x133 >> 1) | ((x135 << 31) & 0xffffffff));
    const x186 = ((x135 >> 1) | ((x137 << 31) & 0xffffffff));
    const x187 = ((x137 >> 1) | ((x139 << 31) & 0xffffffff));
    const x188 = ((x139 >> 1) | ((x141 << 31) & 0xffffffff));
    const x189 = ((x141 & 0x80000000) | (x141 >> 1));
    var x190: u32 = undefined;
    ...
    var x197: u32 = undefined;
    cmovznzU32(&x197, x179, x164, x150);
    var x198: u32 = undefined;
    cmovznzU32(&x198, x179, x166, x152);
    var x199: u32 = undefined;
    cmovznzU32(&x199, x179, x168, x154);
    var x200: u32 = undefined;
    cmovznzU32(&x200, x179, x170, x156);
    var x201: u32 = undefined;
    cmovznzU32(&x201, x179, x172, x158);
    var x202: u32 = undefined;
    cmovznzU32(&x202, x179, x174, x160);
    var x203: u32 = undefined;
    cmovznzU32(&x203, x179, x176, x162);
    out1.* = x180;
    out2[0] = x7;
    out2[1] = x8;
    out2[2] = x9;
