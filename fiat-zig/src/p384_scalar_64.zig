...
pub fn divstep(out1: *u64, out2: *[7]u64, out3: *[7]u64, out4: *[6]u64, out5: *[6]u64, arg1: u64, arg2: [7]u64, arg3: [7]u64, arg4: [6]u64, arg5: [6]u64) void {
    ...
    var x104: u64 = undefined;
    cmovznzU64(&x104, cast(u1, x28), cast(u64, 0x0), x7);
    var x105: u64 = undefined;
    cmovznzU64(&x105, cast(u1, x28), cast(u64, 0x0), x8);
    var x106: u64 = undefined;
    cmovznzU64(&x106, cast(u1, x28), cast(u64, 0x0), x9);
    var x107: u64 = undefined;
    cmovznzU64(&x107, cast(u1, x28), cast(u64, 0x0), x10);
    var x108: u64 = undefined;
    cmovznzU64(&x108, cast(u1, x28), cast(u64, 0x0), x11);
    var x109: u64 = undefined;
    cmovznzU64(&x109, cast(u1, x28), cast(u64, 0x0), x12);
    var x110: u64 = undefined;
    cmovznzU64(&x110, cast(u1, x28), cast(u64, 0x0), x13);
    var x111: u64 = undefined;
    var x112: u1 = undefined;
    addcarryxU64(&x111, &x112, 0x0, x28, x104);
    var x113: u64 = undefined;
    var x114: u1 = undefined;
    addcarryxU64(&x113, &x114, x112, x29, x105);
    var x115: u64 = undefined;
    var x116: u1 = undefined;
    addcarryxU64(&x115, &x116, x114, x30, x106);
    var x117: u64 = undefined;
    var x118: u1 = undefined;
    addcarryxU64(&x117, &x118, x116, x31, x107);
    var x119: u64 = undefined;
    var x120: u1 = undefined;
    addcarryxU64(&x119, &x120, x118, x32, x108);
    var x121: u64 = undefined;
    var x122: u1 = undefined;
    addcarryxU64(&x121, &x122, x120, x33, x109);
    var x123: u64 = undefined;
    var x124: u1 = undefined;
    addcarryxU64(&x123, &x124, x122, x34, x110);
    var x125: u64 = undefined;
    cmovznzU64(&x125, cast(u1, x28), cast(u64, 0x0), x35);
    var x126: u64 = undefined;
    cmovznzU64(&x126, cast(u1, x28), cast(u64, 0x0), x36);
    var x127: u64 = undefined;
    cmovznzU64(&x127, cast(u1, x28), cast(u64, 0x0), x37);
    var x128: u64 = undefined;
    cmovznzU64(&x128, cast(u1, x28), cast(u64, 0x0), x38);
    var x129: u64 = undefined;
    cmovznzU64(&x129, cast(u1, x28), cast(u64, 0x0), x39);
    var x130: u64 = undefined;
    cmovznzU64(&x130, cast(u1, x28), cast(u64, 0x0), x40);
    var x131: u64 = undefined;
    var x132: u1 = undefined;
    addcarryxU64(&x131, &x132, 0x0, x98, x125);
    var x133: u64 = undefined;
    var x134: u1 = undefined;
    addcarryxU64(&x133, &x134, x132, x99, x126);
    var x135: u64 = undefined;
    var x136: u1 = undefined;
    addcarryxU64(&x135, &x136, x134, x100, x127);
    var x137: u64 = undefined;
    var x138: u1 = undefined;
    addcarryxU64(&x137, &x138, x136, x101, x128);
    var x139: u64 = undefined;
    var x140: u1 = undefined;
    addcarryxU64(&x139, &x140, x138, x102, x129);
    var x141: u64 = undefined;
    var x142: u1 = undefined;
    addcarryxU64(&x141, &x142, x140, x103, x130);
    var x143: u64 = undefined;
    var x144: u1 = undefined;
    subborrowxU64(&x143, &x144, 0x0, x131, 0xecec196accc52973);
    var x145: u64 = undefined;
    var x146: u1 = undefined;
    subborrowxU64(&x145, &x146, x144, x133, 0x581a0db248b0a77a);
    var x147: u64 = undefined;
    var x148: u1 = undefined;
    subborrowxU64(&x147, &x148, x146, x135, 0xc7634d81f4372ddf);
    var x149: u64 = undefined;
    var x150: u1 = undefined;
    subborrowxU64(&x149, &x150, x148, x137, 0xffffffffffffffff);
    var x151: u64 = undefined;
    var x152: u1 = undefined;
    ...
    var x155: u64 = undefined;
    var x156: u1 = undefined;
    subborrowxU64(&x155, &x156, x154, cast(u64, x142), cast(u64, 0x0));
    var x157: u64 = undefined;
    var x158: u1 = undefined;
    addcarryxU64(&x157, &x158, 0x0, x6, cast(u64, 0x1));
    const x159 = ((x111 >> 1) | ((x113 << 63) & 0xffffffffffffffff));
    const x160 = ((x113 >> 1) | ((x115 << 63) & 0xffffffffffffffff));
    const x161 = ((x115 >> 1) | ((x117 << 63) & 0xffffffffffffffff));
    const x162 = ((x117 >> 1) | ((x119 << 63) & 0xffffffffffffffff));
    const x163 = ((x119 >> 1) | ((x121 << 63) & 0xffffffffffffffff));
    const x164 = ((x121 >> 1) | ((x123 << 63) & 0xffffffffffffffff));
    const x165 = ((x123 & 0x8000000000000000) | (x123 >> 1));
    var x166: u64 = undefined;
    ...
    var x172: u64 = undefined;
    cmovznzU64(&x172, x156, x143, x131);
    var x173: u64 = undefined;
    cmovznzU64(&x173, x156, x145, x133);
    var x174: u64 = undefined;
    cmovznzU64(&x174, x156, x147, x135);
    var x175: u64 = undefined;
    cmovznzU64(&x175, x156, x149, x137);
    var x176: u64 = undefined;
    cmovznzU64(&x176, x156, x151, x139);
    var x177: u64 = undefined;
    cmovznzU64(&x177, x156, x153, x141);
    out1.* = x157;
    out2[0] = x7;
    out2[1] = x8;
    out2[2] = x9;
