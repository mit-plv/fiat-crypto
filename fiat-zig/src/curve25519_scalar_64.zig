...
pub fn divstep(out1: *u64, out2: *[5]u64, out3: *[5]u64, out4: *[4]u64, out5: *[4]u64, arg1: u64, arg2: [5]u64, arg3: [5]u64, arg4: [4]u64, arg5: [4]u64) void {
    ...
    const x3 = (cast(u1, (x1 >> 63)) & cast(u1, (arg3[0])));
    var x4: u64 = undefined;
    var x5: u1 = undefined;
    ...
    var x74: u64 = undefined;
    cmovznzU64(&x74, cast(u1, x22), cast(u64, 0x0), x7);
    var x75: u64 = undefined;
    cmovznzU64(&x75, cast(u1, x22), cast(u64, 0x0), x8);
    var x76: u64 = undefined;
    cmovznzU64(&x76, cast(u1, x22), cast(u64, 0x0), x9);
    var x77: u64 = undefined;
    cmovznzU64(&x77, cast(u1, x22), cast(u64, 0x0), x10);
    var x78: u64 = undefined;
    cmovznzU64(&x78, cast(u1, x22), cast(u64, 0x0), x11);
    var x79: u64 = undefined;
    var x80: u1 = undefined;
    addcarryxU64(&x79, &x80, 0x0, x22, x74);
    var x81: u64 = undefined;
    var x82: u1 = undefined;
    addcarryxU64(&x81, &x82, x80, x23, x75);
    var x83: u64 = undefined;
    var x84: u1 = undefined;
    addcarryxU64(&x83, &x84, x82, x24, x76);
    var x85: u64 = undefined;
    var x86: u1 = undefined;
    addcarryxU64(&x85, &x86, x84, x25, x77);
    var x87: u64 = undefined;
    var x88: u1 = undefined;
    addcarryxU64(&x87, &x88, x86, x26, x78);
    var x89: u64 = undefined;
    cmovznzU64(&x89, cast(u1, x22), cast(u64, 0x0), x27);
    var x90: u64 = undefined;
    cmovznzU64(&x90, cast(u1, x22), cast(u64, 0x0), x28);
    var x91: u64 = undefined;
    cmovznzU64(&x91, cast(u1, x22), cast(u64, 0x0), x29);
    var x92: u64 = undefined;
    cmovznzU64(&x92, cast(u1, x22), cast(u64, 0x0), x30);
    var x93: u64 = undefined;
    var x94: u1 = undefined;
    addcarryxU64(&x93, &x94, 0x0, x70, x89);
    var x95: u64 = undefined;
    var x96: u1 = undefined;
    addcarryxU64(&x95, &x96, x94, x71, x90);
    var x97: u64 = undefined;
    var x98: u1 = undefined;
    addcarryxU64(&x97, &x98, x96, x72, x91);
    var x99: u64 = undefined;
    var x100: u1 = undefined;
    addcarryxU64(&x99, &x100, x98, x73, x92);
    var x101: u64 = undefined;
    var x102: u1 = undefined;
    subborrowxU64(&x101, &x102, 0x0, x93, 0x5812631a5cf5d3ed);
    var x103: u64 = undefined;
    var x104: u1 = undefined;
    subborrowxU64(&x103, &x104, x102, x95, 0x14def9dea2f79cd6);
    var x105: u64 = undefined;
    var x106: u1 = undefined;
    subborrowxU64(&x105, &x106, x104, x97, cast(u64, 0x0));
    var x107: u64 = undefined;
    var x108: u1 = undefined;
    subborrowxU64(&x107, &x108, x106, x99, 0x1000000000000000);
    var x109: u64 = undefined;
    var x110: u1 = undefined;
    subborrowxU64(&x109, &x110, x108, cast(u64, x100), cast(u64, 0x0));
    var x111: u64 = undefined;
    var x112: u1 = undefined;
    addcarryxU64(&x111, &x112, 0x0, x6, cast(u64, 0x1));
    const x113 = ((x79 >> 1) | ((x81 << 63) & 0xffffffffffffffff));
    const x114 = ((x81 >> 1) | ((x83 << 63) & 0xffffffffffffffff));
    const x115 = ((x83 >> 1) | ((x85 << 63) & 0xffffffffffffffff));
    const x116 = ((x85 >> 1) | ((x87 << 63) & 0xffffffffffffffff));
    const x117 = ((x87 & 0x8000000000000000) | (x87 >> 1));
    var x118: u64 = undefined;
    ...
    var x122: u64 = undefined;
    cmovznzU64(&x122, x110, x101, x93);
    var x123: u64 = undefined;
    cmovznzU64(&x123, x110, x103, x95);
    var x124: u64 = undefined;
    cmovznzU64(&x124, x110, x105, x97);
    var x125: u64 = undefined;
    cmovznzU64(&x125, x110, x107, x99);
    out1.* = x111;
    out2[0] = x7;
    out2[1] = x8;
    out2[2] = x9;
