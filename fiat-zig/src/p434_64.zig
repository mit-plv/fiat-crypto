...
pub fn toBytes(out1: *[55]u8, arg1: [7]u64) void {
    ...
    const x47 = (x46 >> 8);
    const x48 = (x47 >> 8);
    const x49 = cast(u8, (x48 >> 8));
    const x50 = (x1 >> 8);
    const x51 = (x50 >> 8);
    const x52 = (x51 >> 8);
    const x53 = (x52 >> 8);
    const x54 = (x53 >> 8);
    const x55 = cast(u8, (x54 >> 8));
    out1[0] = cast(u8, x7);
    out1[1] = cast(u8, x8);
    out1[2] = cast(u8, x9);
    out1[3] = cast(u8, x10);
...
pub fn divstep(out1: *u64, out2: *[8]u64, out3: *[8]u64, out4: *[7]u64, out5: *[7]u64, arg1: u64, arg2: [8]u64, arg3: [8]u64, arg4: [7]u64, arg5: [7]u64) void {
    ...
    var x119: u64 = undefined;
    cmovznzU64(&x119, cast(u1, x31), cast(u64, 0x0), x7);
    var x120: u64 = undefined;
    cmovznzU64(&x120, cast(u1, x31), cast(u64, 0x0), x8);
    var x121: u64 = undefined;
    cmovznzU64(&x121, cast(u1, x31), cast(u64, 0x0), x9);
    var x122: u64 = undefined;
    cmovznzU64(&x122, cast(u1, x31), cast(u64, 0x0), x10);
    var x123: u64 = undefined;
    cmovznzU64(&x123, cast(u1, x31), cast(u64, 0x0), x11);
    var x124: u64 = undefined;
    cmovznzU64(&x124, cast(u1, x31), cast(u64, 0x0), x12);
    var x125: u64 = undefined;
    cmovznzU64(&x125, cast(u1, x31), cast(u64, 0x0), x13);
    var x126: u64 = undefined;
    cmovznzU64(&x126, cast(u1, x31), cast(u64, 0x0), x14);
    var x127: u64 = undefined;
    var x128: u1 = undefined;
    addcarryxU64(&x127, &x128, 0x0, x31, x119);
    var x129: u64 = undefined;
    var x130: u1 = undefined;
    addcarryxU64(&x129, &x130, x128, x32, x120);
    var x131: u64 = undefined;
    var x132: u1 = undefined;
    addcarryxU64(&x131, &x132, x130, x33, x121);
    var x133: u64 = undefined;
    var x134: u1 = undefined;
    addcarryxU64(&x133, &x134, x132, x34, x122);
    var x135: u64 = undefined;
    var x136: u1 = undefined;
    addcarryxU64(&x135, &x136, x134, x35, x123);
    var x137: u64 = undefined;
    var x138: u1 = undefined;
    addcarryxU64(&x137, &x138, x136, x36, x124);
    var x139: u64 = undefined;
    var x140: u1 = undefined;
    addcarryxU64(&x139, &x140, x138, x37, x125);
    var x141: u64 = undefined;
    var x142: u1 = undefined;
    addcarryxU64(&x141, &x142, x140, x38, x126);
    var x143: u64 = undefined;
    cmovznzU64(&x143, cast(u1, x31), cast(u64, 0x0), x39);
    var x144: u64 = undefined;
    cmovznzU64(&x144, cast(u1, x31), cast(u64, 0x0), x40);
    var x145: u64 = undefined;
    cmovznzU64(&x145, cast(u1, x31), cast(u64, 0x0), x41);
    var x146: u64 = undefined;
    cmovznzU64(&x146, cast(u1, x31), cast(u64, 0x0), x42);
    var x147: u64 = undefined;
    cmovznzU64(&x147, cast(u1, x31), cast(u64, 0x0), x43);
    var x148: u64 = undefined;
    cmovznzU64(&x148, cast(u1, x31), cast(u64, 0x0), x44);
    var x149: u64 = undefined;
    cmovznzU64(&x149, cast(u1, x31), cast(u64, 0x0), x45);
    var x150: u64 = undefined;
    var x151: u1 = undefined;
    addcarryxU64(&x150, &x151, 0x0, x112, x143);
    var x152: u64 = undefined;
    var x153: u1 = undefined;
    addcarryxU64(&x152, &x153, x151, x113, x144);
    var x154: u64 = undefined;
    var x155: u1 = undefined;
    addcarryxU64(&x154, &x155, x153, x114, x145);
    var x156: u64 = undefined;
    var x157: u1 = undefined;
    addcarryxU64(&x156, &x157, x155, x115, x146);
    var x158: u64 = undefined;
    var x159: u1 = undefined;
    addcarryxU64(&x158, &x159, x157, x116, x147);
    var x160: u64 = undefined;
    var x161: u1 = undefined;
    addcarryxU64(&x160, &x161, x159, x117, x148);
    var x162: u64 = undefined;
    var x163: u1 = undefined;
    addcarryxU64(&x162, &x163, x161, x118, x149);
    var x164: u64 = undefined;
    var x165: u1 = undefined;
    subborrowxU64(&x164, &x165, 0x0, x150, 0xffffffffffffffff);
    var x166: u64 = undefined;
    var x167: u1 = undefined;
    subborrowxU64(&x166, &x167, x165, x152, 0xffffffffffffffff);
    var x168: u64 = undefined;
    var x169: u1 = undefined;
    subborrowxU64(&x168, &x169, x167, x154, 0xffffffffffffffff);
    var x170: u64 = undefined;
    var x171: u1 = undefined;
    subborrowxU64(&x170, &x171, x169, x156, 0xfdc1767ae2ffffff);
    var x172: u64 = undefined;
    var x173: u1 = undefined;
    subborrowxU64(&x172, &x173, x171, x158, 0x7bc65c783158aea3);
    var x174: u64 = undefined;
    var x175: u1 = undefined;
    subborrowxU64(&x174, &x175, x173, x160, 0x6cfc5fd681c52056);
    var x176: u64 = undefined;
    var x177: u1 = undefined;
    subborrowxU64(&x176, &x177, x175, x162, 0x2341f27177344);
    var x178: u64 = undefined;
    var x179: u1 = undefined;
    subborrowxU64(&x178, &x179, x177, cast(u64, x163), cast(u64, 0x0));
    var x180: u64 = undefined;
    var x181: u1 = undefined;
    addcarryxU64(&x180, &x181, 0x0, x6, cast(u64, 0x1));
    const x182 = ((x127 >> 1) | ((x129 << 63) & 0xffffffffffffffff));
    const x183 = ((x129 >> 1) | ((x131 << 63) & 0xffffffffffffffff));
    const x184 = ((x131 >> 1) | ((x133 << 63) & 0xffffffffffffffff));
    const x185 = ((x133 >> 1) | ((x135 << 63) & 0xffffffffffffffff));
    const x186 = ((x135 >> 1) | ((x137 << 63) & 0xffffffffffffffff));
    const x187 = ((x137 >> 1) | ((x139 << 63) & 0xffffffffffffffff));
    const x188 = ((x139 >> 1) | ((x141 << 63) & 0xffffffffffffffff));
    const x189 = ((x141 & 0x8000000000000000) | (x141 >> 1));
    var x190: u64 = undefined;
    ...
    var x197: u64 = undefined;
    cmovznzU64(&x197, x179, x164, x150);
    var x198: u64 = undefined;
    cmovznzU64(&x198, x179, x166, x152);
    var x199: u64 = undefined;
    cmovznzU64(&x199, x179, x168, x154);
    var x200: u64 = undefined;
    cmovznzU64(&x200, x179, x170, x156);
    var x201: u64 = undefined;
    cmovznzU64(&x201, x179, x172, x158);
    var x202: u64 = undefined;
    cmovznzU64(&x202, x179, x174, x160);
    var x203: u64 = undefined;
    cmovznzU64(&x203, x179, x176, x162);
    out1.* = x180;
    out2[0] = x7;
    out2[1] = x8;
    out2[2] = x9;
