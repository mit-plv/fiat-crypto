// Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Zig --no-field-element-typedefs --internal-static --public-function-case camelCase --private-function-case camelCase --no-prefix-fiat --package-name p448 '' 64 8 '2^448 - 2^224 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x300000000000000], [0x0 ~> 0x300000000000000], [0x0 ~> 0x300000000000000], [0x0 ~> 0x300000000000000], [0x0 ~> 0x300000000000000], [0x0 ~> 0x300000000000000], [0x0 ~> 0x300000000000000], [0x0 ~> 0x300000000000000]]
pub fn relax(out1: *[8]u64, arg1: [8]u64) void {
    @setRuntimeSafety(mode == .Debug);
