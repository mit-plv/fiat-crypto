// Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Zig --no-field-element-typedefs --internal-static --public-function-case camelCase --private-function-case camelCase --no-prefix-fiat --package-name 25519 '' 64 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax carry_scmul121666
...
pub fn carryMul(out1: *[5]u64, arg1: [5]u64, arg2: [5]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000]]
pub fn carrySquare(out1: *[5]u64, arg1: [5]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000]]
pub fn carry(out1: *[5]u64, arg1: [5]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
pub fn add(out1: *[5]u64, arg1: [5]u64, arg2: [5]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000]]
pub fn sub(out1: *[5]u64, arg1: [5]u64, arg2: [5]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000]]
pub fn opp(out1: *[5]u64, arg1: [5]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
pub fn toBytes(out1: *[32]u8, arg1: [5]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000]]
pub fn fromBytes(out1: *[5]u64, arg1: [32]u8) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000], [0x0 ~> 0x18000000000000]]
pub fn relax(out1: *[5]u64, arg1: [5]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000], [0x0 ~> 0x8000000000000]]
pub fn carryScmul121666(out1: *[5]u64, arg1: [5]u64) void {
    @setRuntimeSafety(mode == .Debug);
