...
pub fn toBytes(out1: *[32]u8, arg1: TightFieldElement) void {
    ...
    const x32 = (x25 + cast(u64, x31));
    const x33 = (x32 >> 8);
    const x34 = (x33 >> 8);
    const x35 = (x34 >> 8);
    const x36 = (x35 >> 8);
    const x37 = (x36 >> 8);
    const x38 = cast(u8, (x37 >> 8));
    const x39 = (x24 + cast(u64, x38));
    const x40 = (x39 >> 8);
    const x41 = (x40 >> 8);
    const x42 = (x41 >> 8);
    const x43 = (x42 >> 8);
    const x44 = (x43 >> 8);
    const x45 = (x44 >> 8);
    const x46 = cast(u1, (x45 >> 8));
    const x47 = (x23 + cast(u64, x46));
    const x48 = (x47 >> 8);
    const x49 = (x48 >> 8);
    const x50 = (x49 >> 8);
    const x51 = (x50 >> 8);
    const x52 = (x51 >> 8);
    const x53 = cast(u8, (x52 >> 8));
    const x54 = (x22 + cast(u64, x53));
    const x55 = (x54 >> 8);
    const x56 = (x55 >> 8);
    const x57 = (x56 >> 8);
    const x58 = (x57 >> 8);
