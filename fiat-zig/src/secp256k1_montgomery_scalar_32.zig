...
pub fn sub(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    addcarryxU32(&x18, &x19, 0x0, x1, (x17 & 0xd0364141));
    var x20: u32 = undefined;
    var x21: u1 = undefined;
    addcarryxU32(&x20, &x21, x19, x3, (x17 & 0xbfd25e8c));
    var x22: u32 = undefined;
    var x23: u1 = undefined;
    addcarryxU32(&x22, &x23, x21, x5, (x17 & 0xaf48a03b));
    var x24: u32 = undefined;
    var x25: u1 = undefined;
    addcarryxU32(&x24, &x25, x23, x7, (x17 & 0xbaaedce6));
    var x26: u32 = undefined;
    var x27: u1 = undefined;
    addcarryxU32(&x26, &x27, x25, x9, (x17 & 0xfffffffe));
...
pub fn toBytes(out1: *[32]u8, arg1: [8]u32) void {
    ...
    const x12 = (x7 >> 8);
    const x13 = (x12 >> 8);
    const x14 = cast(u8, (x13 >> 8));
    const x15 = (x6 >> 8);
    const x16 = (x15 >> 8);
    const x17 = cast(u8, (x16 >> 8));
    const x18 = (x5 >> 8);
    const x19 = (x18 >> 8);
    const x20 = cast(u8, (x19 >> 8));
    const x21 = (x4 >> 8);
    const x22 = (x21 >> 8);
    const x23 = cast(u8, (x22 >> 8));
    const x24 = (x3 >> 8);
    const x25 = (x24 >> 8);
    const x26 = cast(u8, (x25 >> 8));
    const x27 = (x2 >> 8);
    const x28 = (x27 >> 8);
    const x29 = cast(u8, (x28 >> 8));
    const x30 = (x1 >> 8);
    const x31 = (x30 >> 8);
...
pub fn divstep(out1: *u32, out2: *[9]u32, out3: *[9]u32, out4: *[8]u32, out5: *[8]u32, arg1: u32, arg2: [9]u32, arg3: [9]u32, arg4: [8]u32, arg5: [8]u32) void {
    ...
    var x110: u32 = undefined;
    var x111: u1 = undefined;
    addcarryxU32(&x110, &x111, 0x0, x93, (x109 & 0xd0364141));
    var x112: u32 = undefined;
    var x113: u1 = undefined;
    addcarryxU32(&x112, &x113, x111, x95, (x109 & 0xbfd25e8c));
    var x114: u32 = undefined;
    var x115: u1 = undefined;
    addcarryxU32(&x114, &x115, x113, x97, (x109 & 0xaf48a03b));
    var x116: u32 = undefined;
    var x117: u1 = undefined;
    addcarryxU32(&x116, &x117, x115, x99, (x109 & 0xbaaedce6));
    var x118: u32 = undefined;
    var x119: u1 = undefined;
    addcarryxU32(&x118, &x119, x117, x101, (x109 & 0xfffffffe));
    var x120: u32 = undefined;
    var x121: u1 = undefined;
    ...
    var x134: u32 = undefined;
    cmovznzU32(&x134, cast(u1, x34), cast(u32, 0x0), x7);
    var x135: u32 = undefined;
    cmovznzU32(&x135, cast(u1, x34), cast(u32, 0x0), x8);
    var x136: u32 = undefined;
    cmovznzU32(&x136, cast(u1, x34), cast(u32, 0x0), x9);
    var x137: u32 = undefined;
    cmovznzU32(&x137, cast(u1, x34), cast(u32, 0x0), x10);
    var x138: u32 = undefined;
    cmovznzU32(&x138, cast(u1, x34), cast(u32, 0x0), x11);
    var x139: u32 = undefined;
    cmovznzU32(&x139, cast(u1, x34), cast(u32, 0x0), x12);
    var x140: u32 = undefined;
    cmovznzU32(&x140, cast(u1, x34), cast(u32, 0x0), x13);
    var x141: u32 = undefined;
    cmovznzU32(&x141, cast(u1, x34), cast(u32, 0x0), x14);
    var x142: u32 = undefined;
    cmovznzU32(&x142, cast(u1, x34), cast(u32, 0x0), x15);
    var x143: u32 = undefined;
    var x144: u1 = undefined;
    addcarryxU32(&x143, &x144, 0x0, x34, x134);
    var x145: u32 = undefined;
    var x146: u1 = undefined;
    addcarryxU32(&x145, &x146, x144, x35, x135);
    var x147: u32 = undefined;
    var x148: u1 = undefined;
    addcarryxU32(&x147, &x148, x146, x36, x136);
    var x149: u32 = undefined;
    var x150: u1 = undefined;
    addcarryxU32(&x149, &x150, x148, x37, x137);
    var x151: u32 = undefined;
    var x152: u1 = undefined;
    addcarryxU32(&x151, &x152, x150, x38, x138);
    var x153: u32 = undefined;
    var x154: u1 = undefined;
    addcarryxU32(&x153, &x154, x152, x39, x139);
    var x155: u32 = undefined;
    var x156: u1 = undefined;
    addcarryxU32(&x155, &x156, x154, x40, x140);
    var x157: u32 = undefined;
    var x158: u1 = undefined;
    addcarryxU32(&x157, &x158, x156, x41, x141);
    var x159: u32 = undefined;
    var x160: u1 = undefined;
    addcarryxU32(&x159, &x160, x158, x42, x142);
    var x161: u32 = undefined;
    cmovznzU32(&x161, cast(u1, x34), cast(u32, 0x0), x43);
    var x162: u32 = undefined;
    cmovznzU32(&x162, cast(u1, x34), cast(u32, 0x0), x44);
    var x163: u32 = undefined;
    cmovznzU32(&x163, cast(u1, x34), cast(u32, 0x0), x45);
    var x164: u32 = undefined;
    cmovznzU32(&x164, cast(u1, x34), cast(u32, 0x0), x46);
    var x165: u32 = undefined;
    cmovznzU32(&x165, cast(u1, x34), cast(u32, 0x0), x47);
    var x166: u32 = undefined;
    cmovznzU32(&x166, cast(u1, x34), cast(u32, 0x0), x48);
    var x167: u32 = undefined;
    cmovznzU32(&x167, cast(u1, x34), cast(u32, 0x0), x49);
    var x168: u32 = undefined;
    cmovznzU32(&x168, cast(u1, x34), cast(u32, 0x0), x50);
    var x169: u32 = undefined;
    var x170: u1 = undefined;
    addcarryxU32(&x169, &x170, 0x0, x126, x161);
    var x171: u32 = undefined;
    var x172: u1 = undefined;
    addcarryxU32(&x171, &x172, x170, x127, x162);
    var x173: u32 = undefined;
    var x174: u1 = undefined;
    addcarryxU32(&x173, &x174, x172, x128, x163);
    var x175: u32 = undefined;
    var x176: u1 = undefined;
    addcarryxU32(&x175, &x176, x174, x129, x164);
    var x177: u32 = undefined;
    var x178: u1 = undefined;
    addcarryxU32(&x177, &x178, x176, x130, x165);
    var x179: u32 = undefined;
    var x180: u1 = undefined;
    addcarryxU32(&x179, &x180, x178, x131, x166);
    var x181: u32 = undefined;
    var x182: u1 = undefined;
    addcarryxU32(&x181, &x182, x180, x132, x167);
    var x183: u32 = undefined;
    var x184: u1 = undefined;
    addcarryxU32(&x183, &x184, x182, x133, x168);
    var x185: u32 = undefined;
    var x186: u1 = undefined;
    subborrowxU32(&x185, &x186, 0x0, x169, 0xd0364141);
    var x187: u32 = undefined;
    var x188: u1 = undefined;
    subborrowxU32(&x187, &x188, x186, x171, 0xbfd25e8c);
    var x189: u32 = undefined;
    var x190: u1 = undefined;
    subborrowxU32(&x189, &x190, x188, x173, 0xaf48a03b);
    var x191: u32 = undefined;
    var x192: u1 = undefined;
    subborrowxU32(&x191, &x192, x190, x175, 0xbaaedce6);
    var x193: u32 = undefined;
    var x194: u1 = undefined;
    subborrowxU32(&x193, &x194, x192, x177, 0xfffffffe);
    var x195: u32 = undefined;
    ...
    var x201: u32 = undefined;
    var x202: u1 = undefined;
    subborrowxU32(&x201, &x202, x200, cast(u32, x184), cast(u32, 0x0));
    var x203: u32 = undefined;
    var x204: u1 = undefined;
    addcarryxU32(&x203, &x204, 0x0, x6, cast(u32, 0x1));
    const x205 = ((x143 >> 1) | ((x145 << 31) & 0xffffffff));
    const x206 = ((x145 >> 1) | ((x147 << 31) & 0xffffffff));
    const x207 = ((x147 >> 1) | ((x149 << 31) & 0xffffffff));
    const x208 = ((x149 >> 1) | ((x151 << 31) & 0xffffffff));
    const x209 = ((x151 >> 1) | ((x153 << 31) & 0xffffffff));
    const x210 = ((x153 >> 1) | ((x155 << 31) & 0xffffffff));
    const x211 = ((x155 >> 1) | ((x157 << 31) & 0xffffffff));
    const x212 = ((x157 >> 1) | ((x159 << 31) & 0xffffffff));
    const x213 = ((x159 & 0x80000000) | (x159 >> 1));
    var x214: u32 = undefined;
    ...
    var x222: u32 = undefined;
    cmovznzU32(&x222, x202, x185, x169);
    var x223: u32 = undefined;
    cmovznzU32(&x223, x202, x187, x171);
    var x224: u32 = undefined;
    cmovznzU32(&x224, x202, x189, x173);
    var x225: u32 = undefined;
    cmovznzU32(&x225, x202, x191, x175);
    var x226: u32 = undefined;
    cmovznzU32(&x226, x202, x193, x177);
    var x227: u32 = undefined;
    cmovznzU32(&x227, x202, x195, x179);
    var x228: u32 = undefined;
    cmovznzU32(&x228, x202, x197, x181);
    var x229: u32 = undefined;
    cmovznzU32(&x229, x202, x199, x183);
    out1.* = x203;
    out2[0] = x7;
    out2[1] = x8;
    out2[2] = x9;
