...
pub fn toBytes(out1: *[66]u8, arg1: TightFieldElement) void {
    ...
    const x48 = (x47 >> 8);
    const x49 = (x48 >> 8);
    const x50 = cast(u8, (x49 >> 8));
    const x51 = (x43 + cast(u64, x50));
    const x52 = (x51 >> 8);
    const x53 = (x52 >> 8);
    const x54 = (x53 >> 8);
    const x55 = (x54 >> 8);
    const x56 = (x55 >> 8);
    const x57 = (x56 >> 8);
    const x58 = cast(u8, (x57 >> 8));
    const x59 = (x42 + cast(u64, x58));
    const x60 = (x59 >> 8);
    const x61 = (x60 >> 8);
    const x62 = (x61 >> 8);
    const x63 = (x62 >> 8);
    const x64 = (x63 >> 8);
    const x65 = (x64 >> 8);
    const x66 = cast(u8, (x65 >> 8));
    const x67 = (x41 + cast(u64, x66));
    const x68 = (x67 >> 8);
    const x69 = (x68 >> 8);
    const x70 = (x69 >> 8);
    const x71 = (x70 >> 8);
    ...
    const x79 = (x78 >> 8);
    const x80 = (x79 >> 8);
    const x81 = cast(u8, (x80 >> 8));
    const x82 = (x40 + cast(u64, x81));
    const x83 = (x82 >> 8);
    const x84 = (x83 >> 8);
    const x85 = (x84 >> 8);
    const x86 = (x85 >> 8);
    const x87 = (x86 >> 8);
    const x88 = (x87 >> 8);
    const x89 = cast(u8, (x88 >> 8));
    const x90 = (x39 + cast(u64, x89));
    const x91 = (x90 >> 8);
    const x92 = (x91 >> 8);
    const x93 = (x92 >> 8);
    const x94 = (x93 >> 8);
    ...
    out1[50] = cast(u8, x98);
    out1[51] = cast(u8, x99);
    out1[52] = cast(u8, x100);
    out1[53] = cast(u8, x101);
    out1[54] = cast(u8, x102);
    out1[55] = cast(u8, x103);
    out1[56] = cast(u8, x104);
    out1[57] = x105;
    out1[58] = cast(u8, x36);
    out1[59] = cast(u8, x106);
    out1[60] = cast(u8, x107);
    out1[61] = cast(u8, x108);
    out1[62] = cast(u8, x109);
    out1[63] = cast(u8, x110);
    out1[64] = cast(u8, x111);
    out1[65] = cast(u8, x112);
}
