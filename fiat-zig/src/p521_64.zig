// Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Zig --internal-static --public-function-case camelCase --private-function-case camelCase --no-prefix-fiat --package-name p521 '' 64 9 '2^521 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax
...
pub const loose_field_element = [9]u64;
...
pub const tight_field_element = [9]u64;
...
pub fn toBytes(out1: *[66]u8, arg1: tight_field_element) void {
    @setRuntimeSafety(mode == .Debug);
...
pub fn fromBytes(out1: *tight_field_element, arg1: [66]u8) void {
    @setRuntimeSafety(mode == .Debug);
