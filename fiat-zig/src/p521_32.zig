...
pub fn toBytes(out1: *[66]u8, arg1: TightFieldElement) void {
    ...
    const x94 = (x40 >> 8);
    const x95 = (x94 >> 8);
    const x96 = cast(u8, (x95 >> 8));
    const x97 = (x93 + cast(u32, x96));
    const x98 = (x97 >> 8);
    const x99 = (x98 >> 8);
    const x100 = cast(u8, (x99 >> 8));
    const x101 = (x92 + cast(u64, x100));
    const x102 = cast(u32, (x101 >> 8));
    const x103 = (x102 >> 8);
    const x104 = (x103 >> 8);
    const x105 = cast(u8, (x104 >> 8));
    const x106 = (x91 + cast(u32, x105));
    const x107 = (x106 >> 8);
    const x108 = (x107 >> 8);
    const x109 = cast(u8, (x108 >> 8));
    const x110 = (x90 + cast(u64, x109));
    const x111 = cast(u32, (x110 >> 8));
    const x112 = (x111 >> 8);
    const x113 = (x112 >> 8);
    const x114 = cast(u8, (x113 >> 8));
    const x115 = (x89 + cast(u32, x114));
    const x116 = (x115 >> 8);
    const x117 = (x116 >> 8);
    const x118 = cast(u8, (x117 >> 8));
    const x119 = (x88 + cast(u32, x118));
    const x120 = (x119 >> 8);
    const x121 = (x120 >> 8);
    const x122 = cast(u8, (x121 >> 8));
    const x123 = (x54 >> 8);
    const x124 = (x123 >> 8);
    const x125 = cast(u8, (x124 >> 8));
    const x126 = (x87 + cast(u32, x125));
    const x127 = (x126 >> 8);
    const x128 = (x127 >> 8);
    const x129 = cast(u8, (x128 >> 8));
    const x130 = (x86 + cast(u64, x129));
    const x131 = cast(u32, (x130 >> 8));
    const x132 = (x131 >> 8);
    const x133 = (x132 >> 8);
    const x134 = cast(u8, (x133 >> 8));
    const x135 = (x85 + cast(u32, x134));
    const x136 = (x135 >> 8);
    const x137 = (x136 >> 8);
    const x138 = cast(u8, (x137 >> 8));
    const x139 = (x84 + cast(u64, x138));
    const x140 = cast(u32, (x139 >> 8));
    const x141 = (x140 >> 8);
    const x142 = (x141 >> 8);
    const x143 = cast(u8, (x142 >> 8));
    const x144 = (x83 + cast(u32, x143));
    const x145 = (x144 >> 8);
    const x146 = (x145 >> 8);
    const x147 = cast(u8, (x146 >> 8));
    const x148 = (x82 + cast(u32, x147));
    const x149 = (x148 >> 8);
    const x150 = (x149 >> 8);
    const x151 = cast(u8, (x150 >> 8));
    const x152 = (x68 >> 8);
    const x153 = (x152 >> 8);
    const x154 = cast(u8, (x153 >> 8));
    const x155 = (x81 + cast(u32, x154));
    const x156 = (x155 >> 8);
    const x157 = (x156 >> 8);
    const x158 = cast(u8, (x157 >> 8));
    const x159 = (x80 + cast(u64, x158));
    const x160 = cast(u32, (x159 >> 8));
    const x161 = (x160 >> 8);
    const x162 = (x161 >> 8);
    const x163 = cast(u8, (x162 >> 8));
    const x164 = (x79 + cast(u32, x163));
    const x165 = (x164 >> 8);
    const x166 = (x165 >> 8);
    const x167 = cast(u8, (x166 >> 8));
    const x168 = (x78 + cast(u64, x167));
    const x169 = cast(u32, (x168 >> 8));
    const x170 = (x169 >> 8);
    const x171 = (x170 >> 8);
    const x172 = cast(u1, (x171 >> 8));
    out1[0] = cast(u8, x40);
    out1[1] = cast(u8, x94);
    out1[2] = cast(u8, x95);
    out1[3] = cast(u8, x97);
    ...
    out1[8] = cast(u8, x103);
    out1[9] = cast(u8, x104);
    out1[10] = cast(u8, x106);
    out1[11] = cast(u8, x107);
    out1[12] = cast(u8, x108);
    out1[13] = cast(u8, x110);
    out1[14] = cast(u8, x111);
    out1[15] = cast(u8, x112);
    out1[16] = cast(u8, x113);
    out1[17] = cast(u8, x115);
    out1[18] = cast(u8, x116);
    out1[19] = cast(u8, x117);
    out1[20] = cast(u8, x119);
    out1[21] = cast(u8, x120);
    out1[22] = cast(u8, x121);
    out1[23] = x122;
    out1[24] = cast(u8, x54);
    out1[25] = cast(u8, x123);
    out1[26] = cast(u8, x124);
    out1[27] = cast(u8, x126);
    out1[28] = cast(u8, x127);
    out1[29] = cast(u8, x128);
    out1[30] = cast(u8, x130);
    out1[31] = cast(u8, x131);
    out1[32] = cast(u8, x132);
    out1[33] = cast(u8, x133);
    out1[34] = cast(u8, x135);
    out1[35] = cast(u8, x136);
    out1[36] = cast(u8, x137);
    out1[37] = cast(u8, x139);
    out1[38] = cast(u8, x140);
    out1[39] = cast(u8, x141);
    out1[40] = cast(u8, x142);
    out1[41] = cast(u8, x144);
    out1[42] = cast(u8, x145);
    out1[43] = cast(u8, x146);
    out1[44] = cast(u8, x148);
    out1[45] = cast(u8, x149);
    out1[46] = cast(u8, x150);
    out1[47] = x151;
    out1[48] = cast(u8, x68);
    out1[49] = cast(u8, x152);
    out1[50] = cast(u8, x153);
    out1[51] = cast(u8, x155);
    out1[52] = cast(u8, x156);
    out1[53] = cast(u8, x157);
    out1[54] = cast(u8, x159);
    out1[55] = cast(u8, x160);
    out1[56] = cast(u8, x161);
    out1[57] = cast(u8, x162);
    out1[58] = cast(u8, x164);
    out1[59] = cast(u8, x165);
    out1[60] = cast(u8, x166);
    out1[61] = cast(u8, x168);
    out1[62] = cast(u8, x169);
    out1[63] = cast(u8, x170);
    out1[64] = cast(u8, x171);
    out1[65] = cast(u8, x172);
}
