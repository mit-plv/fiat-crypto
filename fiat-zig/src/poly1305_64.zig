// Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Zig --no-field-element-typedefs --internal-static --public-function-case camelCase --private-function-case camelCase --no-prefix-fiat --package-name poly1305 '' 64 3 '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax
...
pub fn carryMul(out1: *[3]u64, arg1: [3]u64, arg2: [3]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x100000000000], [0x0 ~> 0x80000000000], [0x0 ~> 0x80000000000]]
pub fn carrySquare(out1: *[3]u64, arg1: [3]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x100000000000], [0x0 ~> 0x80000000000], [0x0 ~> 0x80000000000]]
pub fn carry(out1: *[3]u64, arg1: [3]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
pub fn add(out1: *[3]u64, arg1: [3]u64, arg2: [3]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x300000000000], [0x0 ~> 0x180000000000], [0x0 ~> 0x180000000000]]
pub fn sub(out1: *[3]u64, arg1: [3]u64, arg2: [3]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x300000000000], [0x0 ~> 0x180000000000], [0x0 ~> 0x180000000000]]
pub fn opp(out1: *[3]u64, arg1: [3]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
pub fn toBytes(out1: *[17]u8, arg1: [3]u64) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x100000000000], [0x0 ~> 0x80000000000], [0x0 ~> 0x80000000000]]
pub fn fromBytes(out1: *[3]u64, arg1: [17]u8) void {
    @setRuntimeSafety(mode == .Debug);
...
/// Output Bounds:
///   out1: [[0x0 ~> 0x300000000000], [0x0 ~> 0x180000000000], [0x0 ~> 0x180000000000]]
pub fn relax(out1: *[3]u64, arg1: [3]u64) void {
    @setRuntimeSafety(mode == .Debug);
