// Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Zig --internal-static --public-function-case camelCase --private-function-case camelCase --no-prefix-fiat --package-name p448 '' 32 16 '2^448 - 2^224 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax
...
pub const loose_field_element = [16]u32;
...
pub const tight_field_element = [16]u32;
...
pub fn toBytes(out1: *[56]u8, arg1: tight_field_element) void {
    @setRuntimeSafety(mode == .Debug);
...
pub fn fromBytes(out1: *tight_field_element, arg1: [56]u8) void {
    @setRuntimeSafety(mode == .Debug);
