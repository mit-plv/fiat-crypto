...
pub fn toBytes(out1: *[56]u8, arg1: TightFieldElement) void {
    ...
    const x74 = (x34 >> 8);
    const x75 = (x74 >> 8);
    const x76 = cast(u8, (x75 >> 8));
    const x77 = (x73 + cast(u32, x76));
    const x78 = (x77 >> 8);
    const x79 = (x78 >> 8);
    const x80 = cast(u8, (x79 >> 8));
    const x81 = (x38 >> 8);
    const x82 = (x81 >> 8);
    const x83 = cast(u8, (x82 >> 8));
    const x84 = (x72 + cast(u32, x83));
    const x85 = (x84 >> 8);
    const x86 = (x85 >> 8);
    const x87 = cast(u8, (x86 >> 8));
    const x88 = (x42 >> 8);
    const x89 = (x88 >> 8);
    const x90 = cast(u8, (x89 >> 8));
    const x91 = (x71 + cast(u32, x90));
    const x92 = (x91 >> 8);
    const x93 = (x92 >> 8);
    const x94 = cast(u8, (x93 >> 8));
    const x95 = (x46 >> 8);
    const x96 = (x95 >> 8);
    const x97 = cast(u8, (x96 >> 8));
    const x98 = (x70 + cast(u32, x97));
    const x99 = (x98 >> 8);
    const x100 = (x99 >> 8);
    const x101 = cast(u8, (x100 >> 8));
    const x102 = (x50 >> 8);
    const x103 = (x102 >> 8);
    const x104 = cast(u8, (x103 >> 8));
    const x105 = (x69 + cast(u32, x104));
    const x106 = (x105 >> 8);
    const x107 = (x106 >> 8);
    const x108 = cast(u8, (x107 >> 8));
    const x109 = (x54 >> 8);
    const x110 = (x109 >> 8);
    const x111 = cast(u8, (x110 >> 8));
    const x112 = (x68 + cast(u32, x111));
    const x113 = (x112 >> 8);
    const x114 = (x113 >> 8);
    const x115 = cast(u8, (x114 >> 8));
    const x116 = (x58 >> 8);
    const x117 = (x116 >> 8);
    const x118 = cast(u8, (x117 >> 8));
    const x119 = (x67 + cast(u32, x118));
    const x120 = (x119 >> 8);
    const x121 = (x120 >> 8);
    ...
    out1[24] = cast(u8, x98);
    out1[25] = cast(u8, x99);
    out1[26] = cast(u8, x100);
    out1[27] = x101;
    out1[28] = cast(u8, x50);
    out1[29] = cast(u8, x102);
    out1[30] = cast(u8, x103);
    out1[31] = cast(u8, x105);
    out1[32] = cast(u8, x106);
    out1[33] = cast(u8, x107);
    out1[34] = x108;
    out1[35] = cast(u8, x54);
    out1[36] = cast(u8, x109);
    out1[37] = cast(u8, x110);
    out1[38] = cast(u8, x112);
    out1[39] = cast(u8, x113);
    out1[40] = cast(u8, x114);
    out1[41] = x115;
    out1[42] = cast(u8, x58);
    out1[43] = cast(u8, x116);
    out1[44] = cast(u8, x117);
    out1[45] = cast(u8, x119);
    out1[46] = cast(u8, x120);
    out1[47] = cast(u8, x121);
    out1[48] = x122;
    out1[49] = cast(u8, x62);
    out1[50] = cast(u8, x123);
    out1[51] = cast(u8, x124);
    out1[52] = cast(u8, x126);
    out1[53] = cast(u8, x127);
    out1[54] = cast(u8, x128);
    out1[55] = x129;
}
