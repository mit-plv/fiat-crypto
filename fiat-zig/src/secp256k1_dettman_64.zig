...
pub fn mul(out1: *[5]u64, arg1: [5]u64, arg2: [5]u64) void {
    ...
    const x7 = ((((cast(u128, (arg1[0])) * cast(u128, (arg2[4]))) + ((cast(u128, (arg1[1])) * cast(u128, (arg2[3]))) + ((cast(u128, (arg1[2])) * cast(u128, (arg2[2]))) + ((cast(u128, (arg1[3])) * cast(u128, (arg2[1]))) + (cast(u128, (arg1[4])) * cast(u128, (arg2[0]))))))) + cast(u128, x5)) + (cast(u128, x2) * cast(u128, 0x1000003d10000)));
    ...
    const x30 = (cast(u128, (x6 + x28)) + (cast(u128, x25) * cast(u128, 0x1000003d10000)));
...
pub fn square(out1: *[5]u64, arg1: [5]u64) void {
    ...
    const x11 = ((((cast(u128, x4) * cast(u128, (arg1[4]))) + ((cast(u128, x3) * cast(u128, (arg1[3]))) + (cast(u128, (arg1[2])) * cast(u128, (arg1[2]))))) + cast(u128, x9)) + (cast(u128, x6) * cast(u128, 0x1000003d10000)));
    const x12 = cast(u64, (x11 >> 52));
    const x13 = cast(u64, (x11 & cast(u128, 0xfffffffffffff)));
    const x14 = (x13 >> 48);
    const x15 = (x13 & 0xffffffffffff);
    const x16 = (((cast(u128, x3) * cast(u128, (arg1[4]))) + (cast(u128, x2) * cast(u128, (arg1[3])))) + cast(u128, x12));
    const x17 = cast(u64, (x16 >> 52));
    const x18 = cast(u64, (x16 & cast(u128, 0xfffffffffffff)));
    const x19 = ((cast(u128, (arg1[0])) * cast(u128, (arg1[0]))) + (cast(u128, ((x18 << 4) + x14)) * cast(u128, 0x1000003d1)));
    const x20 = cast(u64, (x19 >> 52));
    const x21 = cast(u64, (x19 & cast(u128, 0xfffffffffffff)));
    const x22 = (((cast(u128, x2) * cast(u128, (arg1[4]))) + (cast(u128, (arg1[3])) * cast(u128, (arg1[3])))) + cast(u128, x17));
    const x23 = cast(u64, (x22 >> 52));
    const x24 = cast(u64, (x22 & cast(u128, 0xfffffffffffff)));
    const x25 = (((cast(u128, x4) * cast(u128, (arg1[1]))) + cast(u128, x20)) + (cast(u128, x24) * cast(u128, 0x1000003d10)));
    const x26 = cast(u64, (x25 >> 52));
    const x27 = cast(u64, (x25 & cast(u128, 0xfffffffffffff)));
    const x28 = ((cast(u128, x1) * cast(u128, (arg1[4]))) + cast(u128, x23));
    const x29 = cast(u64, (x28 >> 64));
    const x30 = cast(u64, (x28 & cast(u128, 0xffffffffffffffff)));
    const x31 = ((((cast(u128, x4) * cast(u128, (arg1[2]))) + (cast(u128, (arg1[1])) * cast(u128, (arg1[1])))) + cast(u128, x26)) + (cast(u128, x30) * cast(u128, 0x1000003d10)));
    const x32 = cast(u64, (x31 >> 52));
    const x33 = cast(u64, (x31 & cast(u128, 0xfffffffffffff)));
    const x34 = (cast(u128, (x10 + x32)) + (cast(u128, x29) * cast(u128, 0x1000003d10000)));
