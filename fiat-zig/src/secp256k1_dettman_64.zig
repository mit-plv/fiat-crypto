...
pub fn square(out1: *[5]u64, arg1: [5]u64) void {
    ...
    const x6 = cast(u64, (x5 >> 52));
    const x7 = cast(u64, (x5 & cast(u128, 0xfffffffffffff)));
    ...
    const x11 = ((((cast(u128, x4) * cast(u128, (arg1[4]))) + ((cast(u128, x3) * cast(u128, (arg1[3]))) + (cast(u128, (arg1[2])) * cast(u128, (arg1[2]))))) + cast(u128, x9)) + (cast(u128, x6) * cast(u128, 0x1000003d10)));
    ...
    const x34 = (cast(u128, (x10 + x32)) + (cast(u128, x29) * cast(u128, 0x1000003d10)));
