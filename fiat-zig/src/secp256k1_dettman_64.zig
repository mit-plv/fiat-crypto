...
pub fn mul(out1: *[5]u64, arg1: [5]u64, arg2: [5]u64) void {
    ...
    const x10 = (cast(u128, x8) + ((((cast(u128, (arg1[4])) * cast(u128, (arg2[1]))) + (cast(u128, (arg1[3])) * cast(u128, (arg2[2])))) + (cast(u128, (arg1[2])) * cast(u128, (arg2[3])))) + (cast(u128, (arg1[1])) * cast(u128, (arg2[4])))));
    const x11 = cast(u64, (x10 >> 52));
    const x12 = cast(u64, (x10 & cast(u128, 0xfffffffffffff)));
    const x13 = (x9 >> 48);
    const x14 = (x9 & 0xffffffffffff);
    const x15 = ((cast(u128, (x13 + (x12 << 4))) * cast(u128, 0x1000003d1)) + (cast(u128, (arg1[0])) * cast(u128, (arg2[0]))));
    const x16 = cast(u64, (x15 >> 52));
    const x17 = cast(u64, (x15 & cast(u128, 0xfffffffffffff)));
    const x18 = (cast(u128, x11) + (((cast(u128, (arg1[4])) * cast(u128, (arg2[2]))) + (cast(u128, (arg1[3])) * cast(u128, (arg2[3])))) + (cast(u128, (arg1[2])) * cast(u128, (arg2[4])))));
