// Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Zig --internal-static --public-function-case camelCase --private-function-case camelCase --no-prefix-fiat --package-name 25519 '' 32 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax carry_scmul121666
...
pub const loose_field_element = [10]u32;
...
pub const tight_field_element = [10]u32;
...
pub fn toBytes(out1: *[32]u8, arg1: tight_field_element) void {
    @setRuntimeSafety(mode == .Debug);
...
pub fn fromBytes(out1: *tight_field_element, arg1: [32]u8) void {
    @setRuntimeSafety(mode == .Debug);
...
///
pub fn carryScmul121666(out1: *tight_field_element, arg1: loose_field_element) void {
    @setRuntimeSafety(mode == .Debug);
