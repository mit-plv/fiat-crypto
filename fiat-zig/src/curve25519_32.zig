...
pub fn toBytes(out1: *[32]u8, arg1: TightFieldElement) void {
    ...
    const x50 = (x22 >> 8);
    const x51 = (x50 >> 8);
    const x52 = cast(u8, (x51 >> 8));
    const x53 = (x49 + cast(u32, x52));
    const x54 = (x53 >> 8);
    const x55 = (x54 >> 8);
    const x56 = cast(u8, (x55 >> 8));
    const x57 = (x48 + cast(u32, x56));
    const x58 = (x57 >> 8);
    const x59 = (x58 >> 8);
    const x60 = cast(u8, (x59 >> 8));
    const x61 = (x47 + cast(u32, x60));
    const x62 = (x61 >> 8);
    const x63 = (x62 >> 8);
    const x64 = cast(u8, (x63 >> 8));
    const x65 = (x46 + cast(u32, x64));
    const x66 = (x65 >> 8);
    const x67 = (x66 >> 8);
    const x68 = cast(u8, (x67 >> 8));
    const x69 = (x32 >> 8);
    const x70 = (x69 >> 8);
    const x71 = cast(u1, (x70 >> 8));
    const x72 = (x45 + cast(u32, x71));
    const x73 = (x72 >> 8);
    const x74 = (x73 >> 8);
    const x75 = cast(u8, (x74 >> 8));
    const x76 = (x44 + cast(u32, x75));
    const x77 = (x76 >> 8);
    const x78 = (x77 >> 8);
    const x79 = cast(u8, (x78 >> 8));
    const x80 = (x43 + cast(u32, x79));
    const x81 = (x80 >> 8);
    const x82 = (x81 >> 8);
    const x83 = cast(u8, (x82 >> 8));
    const x84 = (x42 + cast(u32, x83));
    const x85 = (x84 >> 8);
    const x86 = (x85 >> 8);
