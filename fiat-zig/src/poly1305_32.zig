// Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --lang Zig --no-field-element-typedefs --internal-static --public-function-case camelCase --private-function-case camelCase --no-prefix-fiat --package-name poly1305 '' 32 '(auto)' '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax
...
/// Output Bounds:
///   out1: [[0x0 ~> 0xc000000], [0x0 ~> 0xc000000], [0x0 ~> 0xc000000], [0x0 ~> 0xc000000], [0x0 ~> 0xc000000]]
pub fn relax(out1: *[5]u32, arg1: [5]u32) void {
    @setRuntimeSafety(mode == .Debug);
