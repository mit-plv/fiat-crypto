...
static FIAT_SECP256K1_DETTMAN_FIAT_INLINE void fiat_secp256k1_dettman_mul(uint64_t out1[5], const uint64_t arg1[5], const uint64_t arg2[5]) {
  ...
  x12 = (x8 + (((fiat_secp256k1_dettman_uint128)(arg1[1]) * (arg2[4])) + (((fiat_secp256k1_dettman_uint128)(arg1[2]) * (arg2[3])) + (((fiat_secp256k1_dettman_uint128)(arg1[3]) * (arg2[2])) + ((fiat_secp256k1_dettman_uint128)(arg1[4]) * (arg2[1]))))));
  x13 = (uint64_t)(x12 >> 52);
  x14 = (uint64_t)(x12 & UINT64_C(0xfffffffffffff));
  x15 = (((fiat_secp256k1_dettman_uint128)(arg1[0]) * (arg2[0])) + ((fiat_secp256k1_dettman_uint128)(x10 + (x14 << 4)) * UINT64_C(0x1000003d1)));
  x16 = (uint64_t)(x15 >> 52);
  x17 = (uint64_t)(x15 & UINT64_C(0xfffffffffffff));
  x18 = (x13 + (((fiat_secp256k1_dettman_uint128)(arg1[2]) * (arg2[4])) + (((fiat_secp256k1_dettman_uint128)(arg1[3]) * (arg2[3])) + ((fiat_secp256k1_dettman_uint128)(arg1[4]) * (arg2[2])))));
  x19 = (uint64_t)(x18 >> 52);
...
static FIAT_SECP256K1_DETTMAN_FIAT_INLINE void fiat_secp256k1_dettman_square(uint64_t out1[5], const uint64_t arg1[5]) {
  ...
  x16 = (x12 + (((fiat_secp256k1_dettman_uint128)x3 * (arg1[4])) + ((fiat_secp256k1_dettman_uint128)x2 * (arg1[3]))));
  x17 = (uint64_t)(x16 >> 52);
  x18 = (uint64_t)(x16 & UINT64_C(0xfffffffffffff));
  x19 = (((fiat_secp256k1_dettman_uint128)(arg1[0]) * (arg1[0])) + ((fiat_secp256k1_dettman_uint128)(x14 + (x18 << 4)) * UINT64_C(0x1000003d1)));
  x20 = (uint64_t)(x19 >> 52);
  x21 = (uint64_t)(x19 & UINT64_C(0xfffffffffffff));
  x22 = (x17 + (((fiat_secp256k1_dettman_uint128)x2 * (arg1[4])) + ((fiat_secp256k1_dettman_uint128)(arg1[3]) * (arg1[3]))));
  x23 = (uint64_t)(x22 >> 52);
