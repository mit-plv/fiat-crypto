...
static FIAT_SECP256K1_DETTMAN_FIAT_INLINE void fiat_secp256k1_dettman_mul(uint64_t out1[5], const uint64_t arg1[5], const uint64_t arg2[5]) {
  ...
  x10 = (x8 + (((((fiat_secp256k1_dettman_uint128)(arg1[4]) * (arg2[1])) + ((fiat_secp256k1_dettman_uint128)(arg1[3]) * (arg2[2]))) + ((fiat_secp256k1_dettman_uint128)(arg1[2]) * (arg2[3]))) + ((fiat_secp256k1_dettman_uint128)(arg1[1]) * (arg2[4]))));
  x11 = (uint64_t)(x10 >> 52);
  x12 = (uint64_t)(x10 & UINT64_C(0xfffffffffffff));
  x13 = (x9 >> 48);
  x14 = (x9 & UINT64_C(0xffffffffffff));
  x15 = (((fiat_secp256k1_dettman_uint128)(x13 + (x12 << 4)) * UINT64_C(0x1000003d1)) + ((fiat_secp256k1_dettman_uint128)(arg1[0]) * (arg2[0])));
  x16 = (uint64_t)(x15 >> 52);
  x17 = (uint64_t)(x15 & UINT64_C(0xfffffffffffff));
  x18 = (x11 + ((((fiat_secp256k1_dettman_uint128)(arg1[4]) * (arg2[2])) + ((fiat_secp256k1_dettman_uint128)(arg1[3]) * (arg2[3]))) + ((fiat_secp256k1_dettman_uint128)(arg1[2]) * (arg2[4]))));
  x19 = (uint64_t)(x18 >> 52);
