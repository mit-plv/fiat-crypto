...
static FIAT_P521_FIAT_INLINE void fiat_p521_to_bytes(uint8_t out1[66], const fiat_p521_tight_field_element arg1) {
  ...
  x95 = (x94 >> 8);
  x96 = (uint8_t)(x95 >> 8);
  x97 = (x93 + (uint32_t)x96);
  x98 = (x97 >> 8);
  x99 = (x98 >> 8);
  x100 = (uint8_t)(x99 >> 8);
  x101 = (x92 + (uint64_t)x100);
  x102 = (uint32_t)(x101 >> 8);
  x103 = (x102 >> 8);
  x104 = (x103 >> 8);
  x105 = (uint8_t)(x104 >> 8);
  x106 = (x91 + (uint32_t)x105);
  x107 = (x106 >> 8);
  x108 = (x107 >> 8);
  x109 = (uint8_t)(x108 >> 8);
  x110 = (x90 + (uint64_t)x109);
  x111 = (uint32_t)(x110 >> 8);
  x112 = (x111 >> 8);
  x113 = (x112 >> 8);
  x114 = (uint8_t)(x113 >> 8);
  x115 = (x89 + (uint32_t)x114);
  x116 = (x115 >> 8);
  x117 = (x116 >> 8);
  x118 = (uint8_t)(x117 >> 8);
  x119 = (x88 + (uint32_t)x118);
  x120 = (x119 >> 8);
  x121 = (x120 >> 8);
  x122 = (uint8_t)(x121 >> 8);
  x123 = (x54 >> 8);
  x124 = (x123 >> 8);
  x125 = (uint8_t)(x124 >> 8);
  x126 = (x87 + (uint32_t)x125);
  x127 = (x126 >> 8);
  x128 = (x127 >> 8);
  x129 = (uint8_t)(x128 >> 8);
  x130 = (x86 + (uint64_t)x129);
  x131 = (uint32_t)(x130 >> 8);
  x132 = (x131 >> 8);
  x133 = (x132 >> 8);
  x134 = (uint8_t)(x133 >> 8);
  x135 = (x85 + (uint32_t)x134);
  x136 = (x135 >> 8);
  x137 = (x136 >> 8);
  x138 = (uint8_t)(x137 >> 8);
  x139 = (x84 + (uint64_t)x138);
  x140 = (uint32_t)(x139 >> 8);
  x141 = (x140 >> 8);
  x142 = (x141 >> 8);
  x143 = (uint8_t)(x142 >> 8);
  x144 = (x83 + (uint32_t)x143);
  x145 = (x144 >> 8);
  x146 = (x145 >> 8);
  x147 = (uint8_t)(x146 >> 8);
  x148 = (x82 + (uint32_t)x147);
  x149 = (x148 >> 8);
  x150 = (x149 >> 8);
  x151 = (uint8_t)(x150 >> 8);
  x152 = (x68 >> 8);
  x153 = (x152 >> 8);
  x154 = (uint8_t)(x153 >> 8);
  x155 = (x81 + (uint32_t)x154);
  x156 = (x155 >> 8);
  x157 = (x156 >> 8);
  x158 = (uint8_t)(x157 >> 8);
  x159 = (x80 + (uint64_t)x158);
  x160 = (uint32_t)(x159 >> 8);
  x161 = (x160 >> 8);
  x162 = (x161 >> 8);
  x163 = (uint8_t)(x162 >> 8);
  x164 = (x79 + (uint32_t)x163);
  x165 = (x164 >> 8);
  x166 = (x165 >> 8);
  x167 = (uint8_t)(x166 >> 8);
  x168 = (x78 + (uint64_t)x167);
  x169 = (uint32_t)(x168 >> 8);
  x170 = (x169 >> 8);
  x171 = (x170 >> 8);
  x172 = (fiat_p521_uint1)(x171 >> 8);
  out1[0] = (uint8_t)x40;
  out1[1] = (uint8_t)x94;
  out1[2] = (uint8_t)x95;
  out1[3] = (uint8_t)x97;
  ...
  out1[8] = (uint8_t)x103;
  out1[9] = (uint8_t)x104;
  out1[10] = (uint8_t)x106;
  out1[11] = (uint8_t)x107;
  out1[12] = (uint8_t)x108;
  out1[13] = (uint8_t)x110;
  out1[14] = (uint8_t)x111;
  out1[15] = (uint8_t)x112;
  out1[16] = (uint8_t)x113;
  out1[17] = (uint8_t)x115;
  out1[18] = (uint8_t)x116;
  out1[19] = (uint8_t)x117;
  out1[20] = (uint8_t)x119;
  out1[21] = (uint8_t)x120;
  out1[22] = (uint8_t)x121;
  out1[23] = x122;
  out1[24] = (uint8_t)x54;
  out1[25] = (uint8_t)x123;
  out1[26] = (uint8_t)x124;
  out1[27] = (uint8_t)x126;
  out1[28] = (uint8_t)x127;
  out1[29] = (uint8_t)x128;
  out1[30] = (uint8_t)x130;
  out1[31] = (uint8_t)x131;
  out1[32] = (uint8_t)x132;
  out1[33] = (uint8_t)x133;
  out1[34] = (uint8_t)x135;
  out1[35] = (uint8_t)x136;
  out1[36] = (uint8_t)x137;
  out1[37] = (uint8_t)x139;
  out1[38] = (uint8_t)x140;
  out1[39] = (uint8_t)x141;
  out1[40] = (uint8_t)x142;
  out1[41] = (uint8_t)x144;
  out1[42] = (uint8_t)x145;
  out1[43] = (uint8_t)x146;
  out1[44] = (uint8_t)x148;
  out1[45] = (uint8_t)x149;
  out1[46] = (uint8_t)x150;
  out1[47] = x151;
  out1[48] = (uint8_t)x68;
  out1[49] = (uint8_t)x152;
  out1[50] = (uint8_t)x153;
  out1[51] = (uint8_t)x155;
  out1[52] = (uint8_t)x156;
  out1[53] = (uint8_t)x157;
  out1[54] = (uint8_t)x159;
  out1[55] = (uint8_t)x160;
  out1[56] = (uint8_t)x161;
  out1[57] = (uint8_t)x162;
  out1[58] = (uint8_t)x164;
  out1[59] = (uint8_t)x165;
  out1[60] = (uint8_t)x166;
  out1[61] = (uint8_t)x168;
  out1[62] = (uint8_t)x169;
  out1[63] = (uint8_t)x170;
  out1[64] = (uint8_t)x171;
  out1[65] = x172;
}
