...
static FIAT_P521_FIAT_INLINE void fiat_p521_to_bytes(uint8_t out1[66], const fiat_p521_tight_field_element arg1) {
  ...
  fiat_p521_subborrowx_u32(&x39, &x40, x38, 0x0, 0x0);
  fiat_p521_addcarryx_u28(&x41, &x42, 0x0, x1, (x39 & UINT32_C(0xfffffff)));
  fiat_p521_addcarryx_u27(&x43, &x44, x42, x3, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u28(&x45, &x46, x44, x5, (x39 & UINT32_C(0xfffffff)));
  fiat_p521_addcarryx_u27(&x47, &x48, x46, x7, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u28(&x49, &x50, x48, x9, (x39 & UINT32_C(0xfffffff)));
  fiat_p521_addcarryx_u27(&x51, &x52, x50, x11, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u27(&x53, &x54, x52, x13, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u28(&x55, &x56, x54, x15, (x39 & UINT32_C(0xfffffff)));
  fiat_p521_addcarryx_u27(&x57, &x58, x56, x17, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u28(&x59, &x60, x58, x19, (x39 & UINT32_C(0xfffffff)));
  fiat_p521_addcarryx_u27(&x61, &x62, x60, x21, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u28(&x63, &x64, x62, x23, (x39 & UINT32_C(0xfffffff)));
  fiat_p521_addcarryx_u27(&x65, &x66, x64, x25, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u27(&x67, &x68, x66, x27, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u28(&x69, &x70, x68, x29, (x39 & UINT32_C(0xfffffff)));
  fiat_p521_addcarryx_u27(&x71, &x72, x70, x31, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u28(&x73, &x74, x72, x33, (x39 & UINT32_C(0xfffffff)));
  fiat_p521_addcarryx_u27(&x75, &x76, x74, x35, (x39 & UINT32_C(0x7ffffff)));
  fiat_p521_addcarryx_u27(&x77, &x78, x76, x37, (x39 & UINT32_C(0x7ffffff)));
  x79 = ((uint64_t)x77 << 6);
  x80 = (x75 << 3);
  x81 = ((uint64_t)x73 << 7);
  x82 = (x71 << 4);
  ...
  x107 = (uint8_t)(x105 >> 8);
  x108 = (x93 + (uint64_t)x107);
  x109 = (uint8_t)(x108 & UINT8_C(0xff));
  x110 = (uint32_t)(x108 >> 8);
  ...
  x123 = (uint8_t)(x121 >> 8);
  x124 = (x91 + (uint64_t)x123);
  x125 = (uint8_t)(x124 & UINT8_C(0xff));
  x126 = (uint32_t)(x124 >> 8);
  ...
  x159 = (uint8_t)(x157 >> 8);
  x160 = (x87 + (uint64_t)x159);
  x161 = (uint8_t)(x160 & UINT8_C(0xff));
  x162 = (uint32_t)(x160 >> 8);
  ...
  x175 = (uint8_t)(x173 >> 8);
  x176 = (x85 + (uint64_t)x175);
  x177 = (uint8_t)(x176 & UINT8_C(0xff));
  x178 = (uint32_t)(x176 >> 8);
  ...
  x211 = (uint8_t)(x209 >> 8);
  x212 = (x81 + (uint64_t)x211);
  x213 = (uint8_t)(x212 & UINT8_C(0xff));
  x214 = (uint32_t)(x212 >> 8);
  ...
  x227 = (uint8_t)(x225 >> 8);
  x228 = (x79 + (uint64_t)x227);
  x229 = (uint8_t)(x228 & UINT8_C(0xff));
  x230 = (uint32_t)(x228 >> 8);
