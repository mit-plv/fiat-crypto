/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --static poly1305 32 '(auto)' '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
...
static void fiat_poly1305_from_bytes(uint32_t out1[5], const uint8_t arg1[17]) {
  ...
  x25 = (x19 + x24);
  x26 = (uint8_t)(x25 >> 26);
  x27 = (x25 & UINT32_C(0x3ffffff));
  x28 = (x26 + x23);
  x29 = (uint8_t)(x28 >> 26);
  x30 = (x28 & UINT32_C(0x3ffffff));
  x31 = (x29 + x22);
  x32 = (x31 & UINT32_C(0x3ffffff));
  out1[0] = x20;
  out1[1] = x27;
  out1[2] = x30;
  out1[3] = x32;
