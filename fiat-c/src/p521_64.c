...
static FIAT_P521_FIAT_INLINE void fiat_p521_to_bytes(uint8_t out1[66], const fiat_p521_tight_field_element arg1) {
  ...
  out1[50] = (uint8_t)x98;
  out1[51] = (uint8_t)x99;
  out1[52] = (uint8_t)x100;
  out1[53] = (uint8_t)x101;
  out1[54] = (uint8_t)x102;
  out1[55] = (uint8_t)x103;
  out1[56] = (uint8_t)x104;
  out1[57] = x105;
  out1[58] = (uint8_t)x36;
  out1[59] = (uint8_t)x106;
  out1[60] = (uint8_t)x107;
  out1[61] = (uint8_t)x108;
  out1[62] = (uint8_t)x109;
  out1[63] = (uint8_t)x110;
  out1[64] = (uint8_t)x111;
  out1[65] = x112;
}
