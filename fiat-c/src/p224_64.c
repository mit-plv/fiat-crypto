...
static FIAT_P224_FIAT_INLINE void fiat_p224_sub(fiat_p224_montgomery_domain_field_element out1, const fiat_p224_montgomery_domain_field_element arg1, const fiat_p224_montgomery_domain_field_element arg2) {
  ...
  fiat_p224_addcarryx_u64(&x11, &x12, 0x0, x1, (fiat_p224_uint1)(x9 & 0x1));
  fiat_p224_addcarryx_u64(&x13, &x14, x12, x3, (x9 & UINT64_C(0xffffffff00000000)));
  fiat_p224_addcarryx_u64(&x15, &x16, x14, x5, x9);
  fiat_p224_addcarryx_u64(&x17, &x18, x16, x7, (x9 & UINT32_C(0xffffffff)));
  out1[0] = x11;
  out1[1] = x13;
  out1[2] = x15;
  out1[3] = x17;
...
static FIAT_P224_FIAT_INLINE void fiat_p224_divstep(uint64_t* out1, uint64_t out2[5], uint64_t out3[5], uint64_t out4[4], uint64_t out5[4], uint64_t arg1, const uint64_t arg2[5], const uint64_t arg3[5], const uint64_t arg4[4], const uint64_t arg5[4]) {
  ...
  fiat_p224_subborrowx_u64(&x61, &x62, x60, 0x0, 0x0);
  fiat_p224_addcarryx_u64(&x63, &x64, 0x0, x53, (fiat_p224_uint1)(x61 & 0x1));
  fiat_p224_addcarryx_u64(&x65, &x66, x64, x55, (x61 & UINT64_C(0xffffffff00000000)));
  fiat_p224_addcarryx_u64(&x67, &x68, x66, x57, x61);
  fiat_p224_addcarryx_u64(&x69, &x70, x68, x59, (x61 & UINT32_C(0xffffffff)));
  fiat_p224_cmovznz_u64(&x71, x3, (arg5[0]), x63);
  fiat_p224_cmovznz_u64(&x72, x3, (arg5[1]), x65);
  fiat_p224_cmovznz_u64(&x73, x3, (arg5[2]), x67);
  fiat_p224_cmovznz_u64(&x74, x3, (arg5[3]), x69);
  x75 = (fiat_p224_uint1)(x22 & 0x1);
  fiat_p224_cmovznz_u64(&x76, x75, 0x0, x7);
  fiat_p224_cmovznz_u64(&x77, x75, 0x0, x8);
  fiat_p224_cmovznz_u64(&x78, x75, 0x0, x9);
  fiat_p224_cmovznz_u64(&x79, x75, 0x0, x10);
  fiat_p224_cmovznz_u64(&x80, x75, 0x0, x11);
  fiat_p224_addcarryx_u64(&x81, &x82, 0x0, x22, x76);
  fiat_p224_addcarryx_u64(&x83, &x84, x82, x23, x77);
  fiat_p224_addcarryx_u64(&x85, &x86, x84, x24, x78);
  fiat_p224_addcarryx_u64(&x87, &x88, x86, x25, x79);
  fiat_p224_addcarryx_u64(&x89, &x90, x88, x26, x80);
  fiat_p224_cmovznz_u64(&x91, x75, 0x0, x27);
  fiat_p224_cmovznz_u64(&x92, x75, 0x0, x28);
  fiat_p224_cmovznz_u64(&x93, x75, 0x0, x29);
  fiat_p224_cmovznz_u64(&x94, x75, 0x0, x30);
  fiat_p224_addcarryx_u64(&x95, &x96, 0x0, x71, x91);
  fiat_p224_addcarryx_u64(&x97, &x98, x96, x72, x92);
  fiat_p224_addcarryx_u64(&x99, &x100, x98, x73, x93);
  fiat_p224_addcarryx_u64(&x101, &x102, x100, x74, x94);
  fiat_p224_subborrowx_u64(&x103, &x104, 0x0, x95, 0x1);
  fiat_p224_subborrowx_u64(&x105, &x106, x104, x97, UINT64_C(0xffffffff00000000));
  fiat_p224_subborrowx_u64(&x107, &x108, x106, x99, UINT64_C(0xffffffffffffffff));
  fiat_p224_subborrowx_u64(&x109, &x110, x108, x101, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u64(&x111, &x112, x110, x102, 0x0);
  fiat_p224_addcarryx_u64(&x113, &x114, 0x0, x6, 0x1);
  ...
  fiat_p224_cmovznz_u64(&x120, x48, x39, x31);
  fiat_p224_cmovznz_u64(&x121, x48, x41, x33);
  fiat_p224_cmovznz_u64(&x122, x48, x43, x35);
  fiat_p224_cmovznz_u64(&x123, x48, x45, x37);
  fiat_p224_cmovznz_u64(&x124, x112, x103, x95);
  fiat_p224_cmovznz_u64(&x125, x112, x105, x97);
  fiat_p224_cmovznz_u64(&x126, x112, x107, x99);
  fiat_p224_cmovznz_u64(&x127, x112, x109, x101);
  *out1 = x113;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
