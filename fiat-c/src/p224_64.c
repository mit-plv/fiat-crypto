/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --static p224 64 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes scmul2 scmul3 scmul4 scmul8 */
 ...
 *   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static void fiat_p224_scmul_2(uint64_t out1[4], const uint64_t arg1[4]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  uint64_t x156;
  uint64_t x157;
  fiat_p224_mulx_u64(&x1, &x2, UINT64_C(0xfffffffe00000000), (arg1[3]));
  fiat_p224_mulx_u64(&x3, &x4, UINT64_C(0xfffffffe00000000), (arg1[2]));
  fiat_p224_mulx_u64(&x5, &x6, UINT64_C(0xfffffffe00000000), (arg1[1]));
  fiat_p224_mulx_u64(&x7, &x8, UINT64_C(0xfffffffe00000000), (arg1[0]));
  fiat_p224_addcarryx_u64(&x9, &x10, 0x0, x8, x5);
  fiat_p224_addcarryx_u64(&x11, &x12, x10, x6, x3);
  fiat_p224_addcarryx_u64(&x13, &x14, x12, x4, x1);
  x15 = (x14 + x2);
  fiat_p224_mulx_u64(&x16, &x17, x7, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x18, &x19, x16, UINT32_C(0xffffffff));
  fiat_p224_mulx_u64(&x20, &x21, x16, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x22, &x23, x16, UINT64_C(0xffffffff00000000));
  fiat_p224_addcarryx_u64(&x24, &x25, 0x0, x23, x20);
  fiat_p224_addcarryx_u64(&x26, &x27, x25, x21, x18);
  x28 = (x27 + x19);
  fiat_p224_addcarryx_u64(&x29, &x30, 0x0, x7, x16);
  fiat_p224_addcarryx_u64(&x31, &x32, x30, x9, x22);
  fiat_p224_addcarryx_u64(&x33, &x34, x32, x11, x24);
  fiat_p224_addcarryx_u64(&x35, &x36, x34, x13, x26);
  x37 = ((x36 + x15) + x28);
  fiat_p224_mulx_u64(&x38, &x39, UINT64_C(0xffffffffffffffff), (arg1[3]));
  fiat_p224_mulx_u64(&x40, &x41, UINT64_C(0xffffffffffffffff), (arg1[2]));
  fiat_p224_mulx_u64(&x42, &x43, UINT64_C(0xffffffffffffffff), (arg1[1]));
  fiat_p224_mulx_u64(&x44, &x45, UINT64_C(0xffffffffffffffff), (arg1[0]));
  fiat_p224_addcarryx_u64(&x46, &x47, 0x0, x45, x42);
  fiat_p224_addcarryx_u64(&x48, &x49, x47, x43, x40);
  fiat_p224_addcarryx_u64(&x50, &x51, x49, x41, x38);
  x52 = (x51 + x39);
  fiat_p224_addcarryx_u64(&x53, &x54, 0x0, x31, x44);
  fiat_p224_addcarryx_u64(&x55, &x56, x54, x33, x46);
  fiat_p224_addcarryx_u64(&x57, &x58, x56, x35, x48);
  fiat_p224_addcarryx_u64(&x59, &x60, x58, x37, x50);
  fiat_p224_addcarryx_u64(&x61, &x62, x60, 0x0, x52);
  fiat_p224_mulx_u64(&x63, &x64, x53, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x65, &x66, x63, UINT32_C(0xffffffff));
  fiat_p224_mulx_u64(&x67, &x68, x63, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x69, &x70, x63, UINT64_C(0xffffffff00000000));
  fiat_p224_addcarryx_u64(&x71, &x72, 0x0, x70, x67);
  fiat_p224_addcarryx_u64(&x73, &x74, x72, x68, x65);
  x75 = (x74 + x66);
  fiat_p224_addcarryx_u64(&x76, &x77, 0x0, x53, x63);
  fiat_p224_addcarryx_u64(&x78, &x79, x77, x55, x69);
  fiat_p224_addcarryx_u64(&x80, &x81, x79, x57, x71);
  fiat_p224_addcarryx_u64(&x82, &x83, x81, x59, x73);
  fiat_p224_addcarryx_u64(&x84, &x85, x83, x61, x75);
  x86 = ((uint64_t)x85 + x62);
  x87 = (arg1[3]);
  x88 = (arg1[2]);
  x89 = (arg1[1]);
  x90 = (arg1[0]);
  fiat_p224_addcarryx_u64(&x91, &x92, 0x0, x78, x90);
  fiat_p224_addcarryx_u64(&x93, &x94, x92, x80, x89);
  fiat_p224_addcarryx_u64(&x95, &x96, x94, x82, x88);
  fiat_p224_addcarryx_u64(&x97, &x98, x96, x84, x87);
  x99 = (x98 + x86);
  fiat_p224_mulx_u64(&x100, &x101, x91, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x102, &x103, x100, UINT32_C(0xffffffff));
  fiat_p224_mulx_u64(&x104, &x105, x100, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x106, &x107, x100, UINT64_C(0xffffffff00000000));
  fiat_p224_addcarryx_u64(&x108, &x109, 0x0, x107, x104);
  fiat_p224_addcarryx_u64(&x110, &x111, x109, x105, x102);
  x112 = (x111 + x103);
  fiat_p224_addcarryx_u64(&x113, &x114, 0x0, x91, x100);
  fiat_p224_addcarryx_u64(&x115, &x116, x114, x93, x106);
  fiat_p224_addcarryx_u64(&x117, &x118, x116, x95, x108);
  fiat_p224_addcarryx_u64(&x119, &x120, x118, x97, x110);
  x121 = ((x120 + x99) + x112);
  fiat_p224_mulx_u64(&x122, &x123, x115, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x124, &x125, x122, UINT32_C(0xffffffff));
  fiat_p224_mulx_u64(&x126, &x127, x122, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x128, &x129, x122, UINT64_C(0xffffffff00000000));
  fiat_p224_addcarryx_u64(&x130, &x131, 0x0, x129, x126);
  fiat_p224_addcarryx_u64(&x132, &x133, x131, x127, x124);
  x134 = (x133 + x125);
  fiat_p224_addcarryx_u64(&x135, &x136, 0x0, x115, x122);
  fiat_p224_addcarryx_u64(&x137, &x138, x136, x117, x128);
  fiat_p224_addcarryx_u64(&x139, &x140, x138, x119, x130);
  fiat_p224_addcarryx_u64(&x141, &x142, x140, x121, x132);
  x143 = (x142 + x134);
  fiat_p224_subborrowx_u64(&x144, &x145, 0x0, x137, 0x1);
  fiat_p224_subborrowx_u64(&x146, &x147, x145, x139, UINT64_C(0xffffffff00000000));
  fiat_p224_subborrowx_u64(&x148, &x149, x147, x141, UINT64_C(0xffffffffffffffff));
  fiat_p224_subborrowx_u64(&x150, &x151, x149, x143, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u64(&x152, &x153, x151, 0x0, 0x0);
 ...
 *   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static void fiat_p224_scmul_3(uint64_t out1[4], const uint64_t arg1[4]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  uint64_t x167;
  uint64_t x168;
  fiat_p224_mulx_u64(&x1, &x2, UINT64_C(0xfffffffd00000000), (arg1[3]));
  fiat_p224_mulx_u64(&x3, &x4, UINT64_C(0xfffffffd00000000), (arg1[2]));
  fiat_p224_mulx_u64(&x5, &x6, UINT64_C(0xfffffffd00000000), (arg1[1]));
  fiat_p224_mulx_u64(&x7, &x8, UINT64_C(0xfffffffd00000000), (arg1[0]));
  fiat_p224_addcarryx_u64(&x9, &x10, 0x0, x8, x5);
  fiat_p224_addcarryx_u64(&x11, &x12, x10, x6, x3);
  fiat_p224_addcarryx_u64(&x13, &x14, x12, x4, x1);
  x15 = (x14 + x2);
  ...
  fiat_p224_addcarryx_u64(&x84, &x85, x83, x61, x75);
  x86 = ((uint64_t)x85 + x62);
  fiat_p224_mulx_u64(&x87, &x88, 0x2, (arg1[3]));
  fiat_p224_mulx_u64(&x89, &x90, 0x2, (arg1[2]));
  fiat_p224_mulx_u64(&x91, &x92, 0x2, (arg1[1]));
  fiat_p224_mulx_u64(&x93, &x94, 0x2, (arg1[0]));
  fiat_p224_addcarryx_u64(&x95, &x96, 0x0, (fiat_p224_uint1)x94, x91);
  fiat_p224_addcarryx_u64(&x97, &x98, x96, (fiat_p224_uint1)x92, x89);
  fiat_p224_addcarryx_u64(&x99, &x100, x98, (fiat_p224_uint1)x90, x87);
  x101 = ((uint64_t)x100 + (fiat_p224_uint1)x88);
  fiat_p224_addcarryx_u64(&x102, &x103, 0x0, x78, x93);
  fiat_p224_addcarryx_u64(&x104, &x105, x103, x80, x95);
  fiat_p224_addcarryx_u64(&x106, &x107, x105, x82, x97);
  fiat_p224_addcarryx_u64(&x108, &x109, x107, x84, x99);
  x110 = ((x109 + x86) + x101);
  fiat_p224_mulx_u64(&x111, &x112, x102, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x113, &x114, x111, UINT32_C(0xffffffff));
  fiat_p224_mulx_u64(&x115, &x116, x111, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x117, &x118, x111, UINT64_C(0xffffffff00000000));
  fiat_p224_addcarryx_u64(&x119, &x120, 0x0, x118, x115);
  fiat_p224_addcarryx_u64(&x121, &x122, x120, x116, x113);
  x123 = (x122 + x114);
  fiat_p224_addcarryx_u64(&x124, &x125, 0x0, x102, x111);
  fiat_p224_addcarryx_u64(&x126, &x127, x125, x104, x117);
  fiat_p224_addcarryx_u64(&x128, &x129, x127, x106, x119);
  fiat_p224_addcarryx_u64(&x130, &x131, x129, x108, x121);
  x132 = ((x131 + x110) + x123);
  fiat_p224_mulx_u64(&x133, &x134, x126, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x135, &x136, x133, UINT32_C(0xffffffff));
  fiat_p224_mulx_u64(&x137, &x138, x133, UINT64_C(0xffffffffffffffff));
  fiat_p224_mulx_u64(&x139, &x140, x133, UINT64_C(0xffffffff00000000));
  fiat_p224_addcarryx_u64(&x141, &x142, 0x0, x140, x137);
  fiat_p224_addcarryx_u64(&x143, &x144, x142, x138, x135);
  x145 = (x144 + x136);
  fiat_p224_addcarryx_u64(&x146, &x147, 0x0, x126, x133);
  fiat_p224_addcarryx_u64(&x148, &x149, x147, x128, x139);
  fiat_p224_addcarryx_u64(&x150, &x151, x149, x130, x141);
  fiat_p224_addcarryx_u64(&x152, &x153, x151, x132, x143);
  x154 = (x153 + x145);
  fiat_p224_subborrowx_u64(&x155, &x156, 0x0, x148, 0x1);
  fiat_p224_subborrowx_u64(&x157, &x158, x156, x150, UINT64_C(0xffffffff00000000));
  fiat_p224_subborrowx_u64(&x159, &x160, x158, x152, UINT64_C(0xffffffffffffffff));
  fiat_p224_subborrowx_u64(&x161, &x162, x160, x154, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u64(&x163, &x164, x162, 0x0, 0x0);
 ...
 *   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static void fiat_p224_scmul_4(uint64_t out1[4], const uint64_t arg1[4]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  uint64_t x167;
  uint64_t x168;
  fiat_p224_mulx_u64(&x1, &x2, UINT64_C(0xfffffffc00000000), (arg1[3]));
  fiat_p224_mulx_u64(&x3, &x4, UINT64_C(0xfffffffc00000000), (arg1[2]));
  fiat_p224_mulx_u64(&x5, &x6, UINT64_C(0xfffffffc00000000), (arg1[1]));
  fiat_p224_mulx_u64(&x7, &x8, UINT64_C(0xfffffffc00000000), (arg1[0]));
  fiat_p224_addcarryx_u64(&x9, &x10, 0x0, x8, x5);
  fiat_p224_addcarryx_u64(&x11, &x12, x10, x6, x3);
  fiat_p224_addcarryx_u64(&x13, &x14, x12, x4, x1);
  x15 = (x14 + x2);
  ...
  fiat_p224_addcarryx_u64(&x84, &x85, x83, x61, x75);
  x86 = ((uint64_t)x85 + x62);
  fiat_p224_mulx_u64(&x87, &x88, 0x3, (arg1[3]));
  fiat_p224_mulx_u64(&x89, &x90, 0x3, (arg1[2]));
  fiat_p224_mulx_u64(&x91, &x92, 0x3, (arg1[1]));
  fiat_p224_mulx_u64(&x93, &x94, 0x3, (arg1[0]));
  fiat_p224_addcarryx_u64(&x95, &x96, 0x0, x94, x91);
  fiat_p224_addcarryx_u64(&x97, &x98, x96, x92, x89);
  fiat_p224_addcarryx_u64(&x99, &x100, x98, x90, x87);
  x101 = (x100 + x88);
  fiat_p224_addcarryx_u64(&x102, &x103, 0x0, x78, x93);
  fiat_p224_addcarryx_u64(&x104, &x105, x103, x80, x95);
  fiat_p224_addcarryx_u64(&x106, &x107, x105, x82, x97);
 ...
 *   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static void fiat_p224_scmul_8(uint64_t out1[4], const uint64_t arg1[4]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  uint64_t x167;
  uint64_t x168;
  fiat_p224_mulx_u64(&x1, &x2, UINT64_C(0xfffffff800000000), (arg1[3]));
  fiat_p224_mulx_u64(&x3, &x4, UINT64_C(0xfffffff800000000), (arg1[2]));
  fiat_p224_mulx_u64(&x5, &x6, UINT64_C(0xfffffff800000000), (arg1[1]));
  fiat_p224_mulx_u64(&x7, &x8, UINT64_C(0xfffffff800000000), (arg1[0]));
  fiat_p224_addcarryx_u64(&x9, &x10, 0x0, x8, x5);
  fiat_p224_addcarryx_u64(&x11, &x12, x10, x6, x3);
  fiat_p224_addcarryx_u64(&x13, &x14, x12, x4, x1);
  x15 = (x14 + x2);
  ...
  fiat_p224_addcarryx_u64(&x84, &x85, x83, x61, x75);
  x86 = ((uint64_t)x85 + x62);
  fiat_p224_mulx_u64(&x87, &x88, 0x7, (arg1[3]));
  fiat_p224_mulx_u64(&x89, &x90, 0x7, (arg1[2]));
  fiat_p224_mulx_u64(&x91, &x92, 0x7, (arg1[1]));
  fiat_p224_mulx_u64(&x93, &x94, 0x7, (arg1[0]));
  fiat_p224_addcarryx_u64(&x95, &x96, 0x0, x94, x91);
  fiat_p224_addcarryx_u64(&x97, &x98, x96, x92, x89);
  fiat_p224_addcarryx_u64(&x99, &x100, x98, x90, x87);
  x101 = (x100 + x88);
