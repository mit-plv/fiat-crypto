...
static FIAT_CURVE25519_SOLINAS_FIAT_INLINE void fiat_curve25519_solinas_mul2(uint64_t out1[4], uint64_t out2[4], const uint64_t arg1[4], const uint64_t arg2[4], const uint64_t arg3[4], const uint64_t arg4[4]) {
  ...
  uint64_t x227;
  fiat_curve25519_solinas_uint128 x228;
  uint64_t x229;
  uint64_t x230;
  uint64_t x231;
  uint64_t x232;
  ...
  uint64_t x264;
  fiat_curve25519_solinas_uint128 x265;
  uint64_t x266;
  fiat_curve25519_solinas_mulx_u64(&x1, &x2, (arg1[3]), (arg2[3]));
  fiat_curve25519_solinas_mulx_u64(&x3, &x4, (arg1[3]), (arg2[2]));
  fiat_curve25519_solinas_mulx_u64(&x5, &x6, (arg1[3]), (arg2[1]));
  ...
  x228 = ((fiat_curve25519_solinas_uint128)x227 + x219);
  x229 = (uint64_t)(x228 & UINT64_C(0xffffffffffffffff));
  ...
  x265 = ((fiat_curve25519_solinas_uint128)x264 + x256);
  x266 = (uint64_t)(x265 & UINT64_C(0xffffffffffffffff));
  out1[0] = x229;
  out1[1] = x221;
  out1[2] = x223;
  out1[3] = x225;
