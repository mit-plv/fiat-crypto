/* Autogenerated: 'src/ExtractionOCaml/solinas_reduction' --inline --static --use-value-barrier curve25519_solinas 64 '2^255 - 19' mulmod */
 ...
 */
static FIAT_CURVE25519_SOLINAS_FIAT_INLINE void fiat_curve25519_solinas_mulmod(uint64_t out1[4], const uint64_t arg1[4], const uint64_t arg2[4]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
