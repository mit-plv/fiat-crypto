/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --static secp256k1 '2^256 - 2^32 - 977' 64 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
...
static void fiat_secp256k1_mul(uint64_t out1[4], const uint64_t arg1[4], const uint64_t arg2[4]) {
  ...
  uint64_t x152 = ((uint64_t)x151 + x124);
  uint64_t x153;
  uint64_t x154;
  ...
  uint64_t x205 = ((uint64_t)x204 + x177);
  uint64_t x206;
