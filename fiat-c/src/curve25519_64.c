/* Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --static --use-value-barrier 25519 64 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax carry_scmul121666 */
