...
static FIAT_P384_FIAT_INLINE void fiat_p384_sub(fiat_p384_montgomery_domain_field_element out1, const fiat_p384_montgomery_domain_field_element arg1, const fiat_p384_montgomery_domain_field_element arg2) {
  ...
  fiat_p384_addcarryx_u32(&x27, &x28, 0x0, x1, x25);
  fiat_p384_addcarryx_u32(&x29, &x30, x28, x3, 0x0);
  fiat_p384_addcarryx_u32(&x31, &x32, x30, x5, 0x0);
  fiat_p384_addcarryx_u32(&x33, &x34, x32, x7, x25);
  fiat_p384_addcarryx_u32(&x35, &x36, x34, x9, (x25 & UINT32_C(0xfffffffe)));
  fiat_p384_addcarryx_u32(&x37, &x38, x36, x11, x25);
  fiat_p384_addcarryx_u32(&x39, &x40, x38, x13, x25);
  fiat_p384_addcarryx_u32(&x41, &x42, x40, x15, x25);
  fiat_p384_addcarryx_u32(&x43, &x44, x42, x17, x25);
  fiat_p384_addcarryx_u32(&x45, &x46, x44, x19, x25);
  fiat_p384_addcarryx_u32(&x47, &x48, x46, x21, x25);
  fiat_p384_addcarryx_u32(&x49, &x50, x48, x23, x25);
  out1[0] = x27;
  out1[1] = x29;
  out1[2] = x31;
  out1[3] = x33;
...
static FIAT_P384_FIAT_INLINE void fiat_p384_divstep(uint32_t* out1, uint32_t out2[13], uint32_t out3[13], uint32_t out4[12], uint32_t out5[12], uint32_t arg1, const uint32_t arg2[13], const uint32_t arg3[13], const uint32_t arg4[12], const uint32_t arg5[12]) {
  ...
  fiat_p384_subborrowx_u32(&x157, &x158, x156, 0x0, 0x0);
  fiat_p384_addcarryx_u32(&x159, &x160, 0x0, x133, x157);
  fiat_p384_addcarryx_u32(&x161, &x162, x160, x135, 0x0);
  fiat_p384_addcarryx_u32(&x163, &x164, x162, x137, 0x0);
  fiat_p384_addcarryx_u32(&x165, &x166, x164, x139, x157);
  fiat_p384_addcarryx_u32(&x167, &x168, x166, x141, (x157 & UINT32_C(0xfffffffe)));
  fiat_p384_addcarryx_u32(&x169, &x170, x168, x143, x157);
  fiat_p384_addcarryx_u32(&x171, &x172, x170, x145, x157);
  fiat_p384_addcarryx_u32(&x173, &x174, x172, x147, x157);
  fiat_p384_addcarryx_u32(&x175, &x176, x174, x149, x157);
  fiat_p384_addcarryx_u32(&x177, &x178, x176, x151, x157);
  fiat_p384_addcarryx_u32(&x179, &x180, x178, x153, x157);
  fiat_p384_addcarryx_u32(&x181, &x182, x180, x155, x157);
  fiat_p384_cmovznz_u32(&x183, x3, (arg5[0]), x159);
  fiat_p384_cmovznz_u32(&x184, x3, (arg5[1]), x161);
  fiat_p384_cmovznz_u32(&x185, x3, (arg5[2]), x163);
  fiat_p384_cmovznz_u32(&x186, x3, (arg5[3]), x165);
  fiat_p384_cmovznz_u32(&x187, x3, (arg5[4]), x167);
  fiat_p384_cmovznz_u32(&x188, x3, (arg5[5]), x169);
  fiat_p384_cmovznz_u32(&x189, x3, (arg5[6]), x171);
  fiat_p384_cmovznz_u32(&x190, x3, (arg5[7]), x173);
  fiat_p384_cmovznz_u32(&x191, x3, (arg5[8]), x175);
  fiat_p384_cmovznz_u32(&x192, x3, (arg5[9]), x177);
  fiat_p384_cmovznz_u32(&x193, x3, (arg5[10]), x179);
  fiat_p384_cmovznz_u32(&x194, x3, (arg5[11]), x181);
  x195 = (fiat_p384_uint1)(x46 & 0x1);
  fiat_p384_cmovznz_u32(&x196, x195, 0x0, x7);
  fiat_p384_cmovznz_u32(&x197, x195, 0x0, x8);
  fiat_p384_cmovznz_u32(&x198, x195, 0x0, x9);
  fiat_p384_cmovznz_u32(&x199, x195, 0x0, x10);
  fiat_p384_cmovznz_u32(&x200, x195, 0x0, x11);
  fiat_p384_cmovznz_u32(&x201, x195, 0x0, x12);
  fiat_p384_cmovznz_u32(&x202, x195, 0x0, x13);
  fiat_p384_cmovznz_u32(&x203, x195, 0x0, x14);
  fiat_p384_cmovznz_u32(&x204, x195, 0x0, x15);
  fiat_p384_cmovznz_u32(&x205, x195, 0x0, x16);
  fiat_p384_cmovznz_u32(&x206, x195, 0x0, x17);
  fiat_p384_cmovznz_u32(&x207, x195, 0x0, x18);
  fiat_p384_cmovznz_u32(&x208, x195, 0x0, x19);
  fiat_p384_addcarryx_u32(&x209, &x210, 0x0, x46, x196);
  fiat_p384_addcarryx_u32(&x211, &x212, x210, x47, x197);
  fiat_p384_addcarryx_u32(&x213, &x214, x212, x48, x198);
  fiat_p384_addcarryx_u32(&x215, &x216, x214, x49, x199);
  fiat_p384_addcarryx_u32(&x217, &x218, x216, x50, x200);
  fiat_p384_addcarryx_u32(&x219, &x220, x218, x51, x201);
  fiat_p384_addcarryx_u32(&x221, &x222, x220, x52, x202);
  fiat_p384_addcarryx_u32(&x223, &x224, x222, x53, x203);
  fiat_p384_addcarryx_u32(&x225, &x226, x224, x54, x204);
  fiat_p384_addcarryx_u32(&x227, &x228, x226, x55, x205);
  fiat_p384_addcarryx_u32(&x229, &x230, x228, x56, x206);
  fiat_p384_addcarryx_u32(&x231, &x232, x230, x57, x207);
  fiat_p384_addcarryx_u32(&x233, &x234, x232, x58, x208);
  fiat_p384_cmovznz_u32(&x235, x195, 0x0, x59);
  fiat_p384_cmovznz_u32(&x236, x195, 0x0, x60);
  fiat_p384_cmovznz_u32(&x237, x195, 0x0, x61);
  fiat_p384_cmovznz_u32(&x238, x195, 0x0, x62);
  fiat_p384_cmovznz_u32(&x239, x195, 0x0, x63);
  fiat_p384_cmovznz_u32(&x240, x195, 0x0, x64);
  fiat_p384_cmovznz_u32(&x241, x195, 0x0, x65);
  fiat_p384_cmovznz_u32(&x242, x195, 0x0, x66);
  fiat_p384_cmovznz_u32(&x243, x195, 0x0, x67);
  fiat_p384_cmovznz_u32(&x244, x195, 0x0, x68);
  fiat_p384_cmovznz_u32(&x245, x195, 0x0, x69);
  fiat_p384_cmovznz_u32(&x246, x195, 0x0, x70);
  fiat_p384_addcarryx_u32(&x247, &x248, 0x0, x183, x235);
  fiat_p384_addcarryx_u32(&x249, &x250, x248, x184, x236);
  fiat_p384_addcarryx_u32(&x251, &x252, x250, x185, x237);
  fiat_p384_addcarryx_u32(&x253, &x254, x252, x186, x238);
  fiat_p384_addcarryx_u32(&x255, &x256, x254, x187, x239);
  fiat_p384_addcarryx_u32(&x257, &x258, x256, x188, x240);
  fiat_p384_addcarryx_u32(&x259, &x260, x258, x189, x241);
  fiat_p384_addcarryx_u32(&x261, &x262, x260, x190, x242);
  fiat_p384_addcarryx_u32(&x263, &x264, x262, x191, x243);
  fiat_p384_addcarryx_u32(&x265, &x266, x264, x192, x244);
  fiat_p384_addcarryx_u32(&x267, &x268, x266, x193, x245);
  fiat_p384_addcarryx_u32(&x269, &x270, x268, x194, x246);
  fiat_p384_subborrowx_u32(&x271, &x272, 0x0, x247, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x273, &x274, x272, x249, 0x0);
  fiat_p384_subborrowx_u32(&x275, &x276, x274, x251, 0x0);
  fiat_p384_subborrowx_u32(&x277, &x278, x276, x253, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x279, &x280, x278, x255, UINT32_C(0xfffffffe));
  ...
  fiat_p384_subborrowx_u32(&x293, &x294, x292, x269, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x295, &x296, x294, x270, 0x0);
  fiat_p384_addcarryx_u32(&x297, &x298, 0x0, x6, 0x1);
  ...
  fiat_p384_cmovznz_u32(&x312, x120, x95, x71);
  fiat_p384_cmovznz_u32(&x313, x120, x97, x73);
  fiat_p384_cmovznz_u32(&x314, x120, x99, x75);
  fiat_p384_cmovznz_u32(&x315, x120, x101, x77);
  fiat_p384_cmovznz_u32(&x316, x120, x103, x79);
  fiat_p384_cmovznz_u32(&x317, x120, x105, x81);
  fiat_p384_cmovznz_u32(&x318, x120, x107, x83);
  fiat_p384_cmovznz_u32(&x319, x120, x109, x85);
  fiat_p384_cmovznz_u32(&x320, x120, x111, x87);
  fiat_p384_cmovznz_u32(&x321, x120, x113, x89);
  fiat_p384_cmovznz_u32(&x322, x120, x115, x91);
  fiat_p384_cmovznz_u32(&x323, x120, x117, x93);
  fiat_p384_cmovznz_u32(&x324, x296, x271, x247);
  fiat_p384_cmovznz_u32(&x325, x296, x273, x249);
  fiat_p384_cmovznz_u32(&x326, x296, x275, x251);
  fiat_p384_cmovznz_u32(&x327, x296, x277, x253);
  fiat_p384_cmovznz_u32(&x328, x296, x279, x255);
  fiat_p384_cmovznz_u32(&x329, x296, x281, x257);
  fiat_p384_cmovznz_u32(&x330, x296, x283, x259);
  fiat_p384_cmovznz_u32(&x331, x296, x285, x261);
  fiat_p384_cmovznz_u32(&x332, x296, x287, x263);
  fiat_p384_cmovznz_u32(&x333, x296, x289, x265);
  fiat_p384_cmovznz_u32(&x334, x296, x291, x267);
  fiat_p384_cmovznz_u32(&x335, x296, x293, x269);
  *out1 = x297;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
