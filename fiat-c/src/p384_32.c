 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static void fiat_p384_one(uint32_t out1[12]) {
  out1[0] = 0x1;
...
static void fiat_p384_divstep(uint32_t* out1, uint32_t out2[13], uint32_t out3[13], uint32_t out4[12], uint32_t out5[12], uint32_t arg1, const uint32_t arg2[13], const uint32_t arg3[13], const uint32_t arg4[12], const uint32_t arg5[12]) {
  ...
  x2 = (fiat_p384_uint1)((fiat_p384_uint1)(x1 >> 31) & (fiat_p384_uint1)((arg3[0]) & 0x1));
  fiat_p384_cmovznz_u32(&x3, x2, arg1, (uint32_t)(((~arg1) + (uint64_t)0x1) & UINT32_C(0xffffffff)));
  ...
  fiat_p384_addcarryx_u32(&x17, &x18, 0x0, 0x1, (~(arg2[0])));
  fiat_p384_addcarryx_u32(&x19, &x20, x18, 0x0, (~(arg2[1])));
  fiat_p384_addcarryx_u32(&x21, &x22, x20, 0x0, (~(arg2[2])));
  fiat_p384_addcarryx_u32(&x23, &x24, x22, 0x0, (~(arg2[3])));
  fiat_p384_addcarryx_u32(&x25, &x26, x24, 0x0, (~(arg2[4])));
  fiat_p384_addcarryx_u32(&x27, &x28, x26, 0x0, (~(arg2[5])));
  fiat_p384_addcarryx_u32(&x29, &x30, x28, 0x0, (~(arg2[6])));
  fiat_p384_addcarryx_u32(&x31, &x32, x30, 0x0, (~(arg2[7])));
  fiat_p384_addcarryx_u32(&x33, &x34, x32, 0x0, (~(arg2[8])));
  fiat_p384_addcarryx_u32(&x35, &x36, x34, 0x0, (~(arg2[9])));
  fiat_p384_addcarryx_u32(&x37, &x38, x36, 0x0, (~(arg2[10])));
  fiat_p384_addcarryx_u32(&x39, &x40, x38, 0x0, (~(arg2[11])));
  fiat_p384_addcarryx_u32(&x41, &x42, x40, 0x0, (~(arg2[12])));
  ...
  fiat_p384_addcarryx_u32(&x68, &x69, 0x0, x56, x56);
  fiat_p384_addcarryx_u32(&x70, &x71, x69, x57, x57);
  fiat_p384_addcarryx_u32(&x72, &x73, x71, x58, x58);
  fiat_p384_addcarryx_u32(&x74, &x75, x73, x59, x59);
  fiat_p384_addcarryx_u32(&x76, &x77, x75, x60, x60);
  fiat_p384_addcarryx_u32(&x78, &x79, x77, x61, x61);
  fiat_p384_addcarryx_u32(&x80, &x81, x79, x62, x62);
  fiat_p384_addcarryx_u32(&x82, &x83, x81, x63, x63);
  fiat_p384_addcarryx_u32(&x84, &x85, x83, x64, x64);
  fiat_p384_addcarryx_u32(&x86, &x87, x85, x65, x65);
  fiat_p384_addcarryx_u32(&x88, &x89, x87, x66, x66);
  fiat_p384_addcarryx_u32(&x90, &x91, x89, x67, x67);
  fiat_p384_subborrowx_u32(&x92, &x93, 0x0, x68, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x94, &x95, x93, x70, 0x0);
  fiat_p384_subborrowx_u32(&x96, &x97, x95, x72, 0x0);
  fiat_p384_subborrowx_u32(&x98, &x99, x97, x74, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x100, &x101, x99, x76, UINT32_C(0xfffffffe));
  fiat_p384_subborrowx_u32(&x102, &x103, x101, x78, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x104, &x105, x103, x80, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x106, &x107, x105, x82, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x108, &x109, x107, x84, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x110, &x111, x109, x86, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x112, &x113, x111, x88, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x114, &x115, x113, x90, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x116, &x117, x115, x91, 0x0);
  x118 = (arg4[11]);
  x119 = (arg4[10]);
  x120 = (arg4[9]);
  x121 = (arg4[8]);
  ...
  x128 = (arg4[1]);
  x129 = (arg4[0]);
  fiat_p384_subborrowx_u32(&x130, &x131, 0x0, 0x0, x129);
  fiat_p384_subborrowx_u32(&x132, &x133, x131, 0x0, x128);
  fiat_p384_subborrowx_u32(&x134, &x135, x133, 0x0, x127);
  fiat_p384_subborrowx_u32(&x136, &x137, x135, 0x0, x126);
  fiat_p384_subborrowx_u32(&x138, &x139, x137, 0x0, x125);
  fiat_p384_subborrowx_u32(&x140, &x141, x139, 0x0, x124);
  fiat_p384_subborrowx_u32(&x142, &x143, x141, 0x0, x123);
  fiat_p384_subborrowx_u32(&x144, &x145, x143, 0x0, x122);
  fiat_p384_subborrowx_u32(&x146, &x147, x145, 0x0, x121);
  fiat_p384_subborrowx_u32(&x148, &x149, x147, 0x0, x120);
  fiat_p384_subborrowx_u32(&x150, &x151, x149, 0x0, x119);
  fiat_p384_subborrowx_u32(&x152, &x153, x151, 0x0, x118);
  fiat_p384_cmovznz_u32(&x154, x153, 0x0, UINT32_C(0xffffffff));
  fiat_p384_addcarryx_u32(&x155, &x156, 0x0, x130, x154);
  fiat_p384_addcarryx_u32(&x157, &x158, x156, x132, 0x0);
  fiat_p384_addcarryx_u32(&x159, &x160, x158, x134, 0x0);
  fiat_p384_addcarryx_u32(&x161, &x162, x160, x136, x154);
  fiat_p384_addcarryx_u32(&x163, &x164, x162, x138, (x154 & UINT32_C(0xfffffffe)));
  fiat_p384_addcarryx_u32(&x165, &x166, x164, x140, x154);
  fiat_p384_addcarryx_u32(&x167, &x168, x166, x142, x154);
  fiat_p384_addcarryx_u32(&x169, &x170, x168, x144, x154);
  fiat_p384_addcarryx_u32(&x171, &x172, x170, x146, x154);
  fiat_p384_addcarryx_u32(&x173, &x174, x172, x148, x154);
  fiat_p384_addcarryx_u32(&x175, &x176, x174, x150, x154);
  fiat_p384_addcarryx_u32(&x177, &x178, x176, x152, x154);
  ...
  x191 = (fiat_p384_uint1)(x43 & 0x1);
  fiat_p384_cmovznz_u32(&x192, x191, 0x0, x4);
  fiat_p384_cmovznz_u32(&x193, x191, 0x0, x5);
  fiat_p384_cmovznz_u32(&x194, x191, 0x0, x6);
  fiat_p384_cmovznz_u32(&x195, x191, 0x0, x7);
  fiat_p384_cmovznz_u32(&x196, x191, 0x0, x8);
  fiat_p384_cmovznz_u32(&x197, x191, 0x0, x9);
  fiat_p384_cmovznz_u32(&x198, x191, 0x0, x10);
  fiat_p384_cmovznz_u32(&x199, x191, 0x0, x11);
  fiat_p384_cmovznz_u32(&x200, x191, 0x0, x12);
  fiat_p384_cmovznz_u32(&x201, x191, 0x0, x13);
  fiat_p384_cmovznz_u32(&x202, x191, 0x0, x14);
  fiat_p384_cmovznz_u32(&x203, x191, 0x0, x15);
  fiat_p384_cmovznz_u32(&x204, x191, 0x0, x16);
  fiat_p384_addcarryx_u32(&x205, &x206, 0x0, x43, x192);
  fiat_p384_addcarryx_u32(&x207, &x208, x206, x44, x193);
  fiat_p384_addcarryx_u32(&x209, &x210, x208, x45, x194);
  fiat_p384_addcarryx_u32(&x211, &x212, x210, x46, x195);
  fiat_p384_addcarryx_u32(&x213, &x214, x212, x47, x196);
  fiat_p384_addcarryx_u32(&x215, &x216, x214, x48, x197);
  fiat_p384_addcarryx_u32(&x217, &x218, x216, x49, x198);
  fiat_p384_addcarryx_u32(&x219, &x220, x218, x50, x199);
  fiat_p384_addcarryx_u32(&x221, &x222, x220, x51, x200);
  fiat_p384_addcarryx_u32(&x223, &x224, x222, x52, x201);
  fiat_p384_addcarryx_u32(&x225, &x226, x224, x53, x202);
  fiat_p384_addcarryx_u32(&x227, &x228, x226, x54, x203);
  fiat_p384_addcarryx_u32(&x229, &x230, x228, x55, x204);
  fiat_p384_cmovznz_u32(&x231, x191, 0x0, x56);
  fiat_p384_cmovznz_u32(&x232, x191, 0x0, x57);
  fiat_p384_cmovznz_u32(&x233, x191, 0x0, x58);
  fiat_p384_cmovznz_u32(&x234, x191, 0x0, x59);
  fiat_p384_cmovznz_u32(&x235, x191, 0x0, x60);
  fiat_p384_cmovznz_u32(&x236, x191, 0x0, x61);
  fiat_p384_cmovznz_u32(&x237, x191, 0x0, x62);
  fiat_p384_cmovznz_u32(&x238, x191, 0x0, x63);
  fiat_p384_cmovznz_u32(&x239, x191, 0x0, x64);
  fiat_p384_cmovznz_u32(&x240, x191, 0x0, x65);
  fiat_p384_cmovznz_u32(&x241, x191, 0x0, x66);
  fiat_p384_cmovznz_u32(&x242, x191, 0x0, x67);
  fiat_p384_addcarryx_u32(&x243, &x244, 0x0, x179, x231);
  fiat_p384_addcarryx_u32(&x245, &x246, x244, x180, x232);
  fiat_p384_addcarryx_u32(&x247, &x248, x246, x181, x233);
  fiat_p384_addcarryx_u32(&x249, &x250, x248, x182, x234);
  fiat_p384_addcarryx_u32(&x251, &x252, x250, x183, x235);
  fiat_p384_addcarryx_u32(&x253, &x254, x252, x184, x236);
  fiat_p384_addcarryx_u32(&x255, &x256, x254, x185, x237);
  fiat_p384_addcarryx_u32(&x257, &x258, x256, x186, x238);
  fiat_p384_addcarryx_u32(&x259, &x260, x258, x187, x239);
  fiat_p384_addcarryx_u32(&x261, &x262, x260, x188, x240);
  fiat_p384_addcarryx_u32(&x263, &x264, x262, x189, x241);
  fiat_p384_addcarryx_u32(&x265, &x266, x264, x190, x242);
  fiat_p384_subborrowx_u32(&x267, &x268, 0x0, x243, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x269, &x270, x268, x245, 0x0);
  fiat_p384_subborrowx_u32(&x271, &x272, x270, x247, 0x0);
  fiat_p384_subborrowx_u32(&x273, &x274, x272, x249, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x275, &x276, x274, x251, UINT32_C(0xfffffffe));
  fiat_p384_subborrowx_u32(&x277, &x278, x276, x253, UINT32_C(0xffffffff));
  ...
  fiat_p384_subborrowx_u32(&x291, &x292, x290, x266, 0x0);
  x293 = (uint32_t)((x3 + (uint64_t)0x1) & UINT32_C(0xffffffff));
  x294 = ((x205 >> 1) | ((x207 << 31) & UINT32_C(0xffffffff)));
  x295 = ((x207 >> 1) | ((x209 << 31) & UINT32_C(0xffffffff)));
  x296 = ((x209 >> 1) | ((x211 << 31) & UINT32_C(0xffffffff)));
  x297 = ((x211 >> 1) | ((x213 << 31) & UINT32_C(0xffffffff)));
  x298 = ((x213 >> 1) | ((x215 << 31) & UINT32_C(0xffffffff)));
  x299 = ((x215 >> 1) | ((x217 << 31) & UINT32_C(0xffffffff)));
  x300 = ((x217 >> 1) | ((x219 << 31) & UINT32_C(0xffffffff)));
  x301 = ((x219 >> 1) | ((x221 << 31) & UINT32_C(0xffffffff)));
  x302 = ((x221 >> 1) | ((x223 << 31) & UINT32_C(0xffffffff)));
  x303 = ((x223 >> 1) | ((x225 << 31) & UINT32_C(0xffffffff)));
  x304 = ((x225 >> 1) | ((x227 << 31) & UINT32_C(0xffffffff)));
  x305 = ((x227 >> 1) | ((x229 << 31) & UINT32_C(0xffffffff)));
  x306 = ((x229 & UINT32_C(0x80000000)) | (x229 >> 1));
