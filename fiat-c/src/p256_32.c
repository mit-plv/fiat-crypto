...
static FIAT_P256_FIAT_INLINE void fiat_p256_sub(fiat_p256_montgomery_domain_field_element out1, const fiat_p256_montgomery_domain_field_element arg1, const fiat_p256_montgomery_domain_field_element arg2) {
  ...
  fiat_p256_addcarryx_u32(&x19, &x20, 0x0, x1, x17);
  fiat_p256_addcarryx_u32(&x21, &x22, x20, x3, x17);
  fiat_p256_addcarryx_u32(&x23, &x24, x22, x5, x17);
  fiat_p256_addcarryx_u32(&x25, &x26, x24, x7, 0x0);
  fiat_p256_addcarryx_u32(&x27, &x28, x26, x9, 0x0);
  fiat_p256_addcarryx_u32(&x29, &x30, x28, x11, 0x0);
  fiat_p256_addcarryx_u32(&x31, &x32, x30, x13, (fiat_p256_uint1)(x17 & 0x1));
  fiat_p256_addcarryx_u32(&x33, &x34, x32, x15, x17);
  out1[0] = x19;
  out1[1] = x21;
  out1[2] = x23;
  out1[3] = x25;
...
static FIAT_P256_FIAT_INLINE void fiat_p256_divstep(uint32_t* out1, uint32_t out2[9], uint32_t out3[9], uint32_t out4[8], uint32_t out5[8], uint32_t arg1, const uint32_t arg2[9], const uint32_t arg3[9], const uint32_t arg4[8], const uint32_t arg5[8]) {
  ...
  fiat_p256_subborrowx_u32(&x109, &x110, x108, 0x0, 0x0);
  fiat_p256_addcarryx_u32(&x111, &x112, 0x0, x93, x109);
  fiat_p256_addcarryx_u32(&x113, &x114, x112, x95, x109);
  fiat_p256_addcarryx_u32(&x115, &x116, x114, x97, x109);
  fiat_p256_addcarryx_u32(&x117, &x118, x116, x99, 0x0);
  fiat_p256_addcarryx_u32(&x119, &x120, x118, x101, 0x0);
  fiat_p256_addcarryx_u32(&x121, &x122, x120, x103, 0x0);
  fiat_p256_addcarryx_u32(&x123, &x124, x122, x105, (fiat_p256_uint1)(x109 & 0x1));
  fiat_p256_addcarryx_u32(&x125, &x126, x124, x107, x109);
  fiat_p256_cmovznz_u32(&x127, x3, (arg5[0]), x111);
  fiat_p256_cmovznz_u32(&x128, x3, (arg5[1]), x113);
  fiat_p256_cmovznz_u32(&x129, x3, (arg5[2]), x115);
  fiat_p256_cmovznz_u32(&x130, x3, (arg5[3]), x117);
  fiat_p256_cmovznz_u32(&x131, x3, (arg5[4]), x119);
  fiat_p256_cmovznz_u32(&x132, x3, (arg5[5]), x121);
  fiat_p256_cmovznz_u32(&x133, x3, (arg5[6]), x123);
  fiat_p256_cmovznz_u32(&x134, x3, (arg5[7]), x125);
  x135 = (fiat_p256_uint1)(x34 & 0x1);
  fiat_p256_cmovznz_u32(&x136, x135, 0x0, x7);
  fiat_p256_cmovznz_u32(&x137, x135, 0x0, x8);
  fiat_p256_cmovznz_u32(&x138, x135, 0x0, x9);
  fiat_p256_cmovznz_u32(&x139, x135, 0x0, x10);
  fiat_p256_cmovznz_u32(&x140, x135, 0x0, x11);
  fiat_p256_cmovznz_u32(&x141, x135, 0x0, x12);
  fiat_p256_cmovznz_u32(&x142, x135, 0x0, x13);
  fiat_p256_cmovznz_u32(&x143, x135, 0x0, x14);
  fiat_p256_cmovznz_u32(&x144, x135, 0x0, x15);
  fiat_p256_addcarryx_u32(&x145, &x146, 0x0, x34, x136);
  fiat_p256_addcarryx_u32(&x147, &x148, x146, x35, x137);
  fiat_p256_addcarryx_u32(&x149, &x150, x148, x36, x138);
  fiat_p256_addcarryx_u32(&x151, &x152, x150, x37, x139);
  fiat_p256_addcarryx_u32(&x153, &x154, x152, x38, x140);
  fiat_p256_addcarryx_u32(&x155, &x156, x154, x39, x141);
  fiat_p256_addcarryx_u32(&x157, &x158, x156, x40, x142);
  fiat_p256_addcarryx_u32(&x159, &x160, x158, x41, x143);
  fiat_p256_addcarryx_u32(&x161, &x162, x160, x42, x144);
  fiat_p256_cmovznz_u32(&x163, x135, 0x0, x43);
  fiat_p256_cmovznz_u32(&x164, x135, 0x0, x44);
  fiat_p256_cmovznz_u32(&x165, x135, 0x0, x45);
  fiat_p256_cmovznz_u32(&x166, x135, 0x0, x46);
  fiat_p256_cmovznz_u32(&x167, x135, 0x0, x47);
  fiat_p256_cmovznz_u32(&x168, x135, 0x0, x48);
  fiat_p256_cmovznz_u32(&x169, x135, 0x0, x49);
  fiat_p256_cmovznz_u32(&x170, x135, 0x0, x50);
  fiat_p256_addcarryx_u32(&x171, &x172, 0x0, x127, x163);
  fiat_p256_addcarryx_u32(&x173, &x174, x172, x128, x164);
  fiat_p256_addcarryx_u32(&x175, &x176, x174, x129, x165);
  fiat_p256_addcarryx_u32(&x177, &x178, x176, x130, x166);
  fiat_p256_addcarryx_u32(&x179, &x180, x178, x131, x167);
  fiat_p256_addcarryx_u32(&x181, &x182, x180, x132, x168);
  fiat_p256_addcarryx_u32(&x183, &x184, x182, x133, x169);
  fiat_p256_addcarryx_u32(&x185, &x186, x184, x134, x170);
  fiat_p256_subborrowx_u32(&x187, &x188, 0x0, x171, UINT32_C(0xffffffff));
  fiat_p256_subborrowx_u32(&x189, &x190, x188, x173, UINT32_C(0xffffffff));
  fiat_p256_subborrowx_u32(&x191, &x192, x190, x175, UINT32_C(0xffffffff));
  fiat_p256_subborrowx_u32(&x193, &x194, x192, x177, 0x0);
  fiat_p256_subborrowx_u32(&x195, &x196, x194, x179, 0x0);
  fiat_p256_subborrowx_u32(&x197, &x198, x196, x181, 0x0);
  fiat_p256_subborrowx_u32(&x199, &x200, x198, x183, 0x1);
  fiat_p256_subborrowx_u32(&x201, &x202, x200, x185, UINT32_C(0xffffffff));
  fiat_p256_subborrowx_u32(&x203, &x204, x202, x186, 0x0);
  fiat_p256_addcarryx_u32(&x205, &x206, 0x0, x6, 0x1);
  ...
  fiat_p256_cmovznz_u32(&x216, x84, x67, x51);
  fiat_p256_cmovznz_u32(&x217, x84, x69, x53);
  fiat_p256_cmovznz_u32(&x218, x84, x71, x55);
  fiat_p256_cmovznz_u32(&x219, x84, x73, x57);
  fiat_p256_cmovznz_u32(&x220, x84, x75, x59);
  fiat_p256_cmovznz_u32(&x221, x84, x77, x61);
  fiat_p256_cmovznz_u32(&x222, x84, x79, x63);
  fiat_p256_cmovznz_u32(&x223, x84, x81, x65);
  fiat_p256_cmovznz_u32(&x224, x204, x187, x171);
  fiat_p256_cmovznz_u32(&x225, x204, x189, x173);
  fiat_p256_cmovznz_u32(&x226, x204, x191, x175);
  fiat_p256_cmovznz_u32(&x227, x204, x193, x177);
  fiat_p256_cmovznz_u32(&x228, x204, x195, x179);
  fiat_p256_cmovznz_u32(&x229, x204, x197, x181);
  fiat_p256_cmovznz_u32(&x230, x204, x199, x183);
  fiat_p256_cmovznz_u32(&x231, x204, x201, x185);
  *out1 = x205;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
