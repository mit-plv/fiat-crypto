/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --static --use-value-barrier poly1305 64 3 '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
