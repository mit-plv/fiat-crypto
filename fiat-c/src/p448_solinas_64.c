...
static FIAT_P448_FIAT_INLINE void fiat_p448_to_bytes(uint8_t out1[56], const fiat_p448_tight_field_element arg1) {
  ...
  fiat_p448_subborrowx_u64(&x17, &x18, x16, 0x0, 0x0);
  fiat_p448_addcarryx_u56(&x19, &x20, 0x0, x1, (x17 & UINT64_C(0xffffffffffffff)));
  fiat_p448_addcarryx_u56(&x21, &x22, x20, x3, (x17 & UINT64_C(0xffffffffffffff)));
  fiat_p448_addcarryx_u56(&x23, &x24, x22, x5, (x17 & UINT64_C(0xffffffffffffff)));
  fiat_p448_addcarryx_u56(&x25, &x26, x24, x7, (x17 & UINT64_C(0xffffffffffffff)));
  fiat_p448_addcarryx_u56(&x27, &x28, x26, x9, (x17 & UINT64_C(0xfffffffffffffe)));
  fiat_p448_addcarryx_u56(&x29, &x30, x28, x11, (x17 & UINT64_C(0xffffffffffffff)));
  fiat_p448_addcarryx_u56(&x31, &x32, x30, x13, (x17 & UINT64_C(0xffffffffffffff)));
  fiat_p448_addcarryx_u56(&x33, &x34, x32, x15, (x17 & UINT64_C(0xffffffffffffff)));
  x35 = (uint8_t)(x19 & UINT8_C(0xff));
  x36 = (x19 >> 8);
