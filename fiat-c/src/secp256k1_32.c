 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static void fiat_secp256k1_one(uint32_t out1[8]) {
...
static void fiat_secp256k1_divstep(uint32_t* out1, uint32_t out2[9], uint32_t out3[9], uint32_t out4[8], uint32_t out5[8], uint32_t arg1, const uint32_t arg2[9], const uint32_t arg3[9], const uint32_t arg4[8], const uint32_t arg5[8]) {
  ...
  x2 = (fiat_secp256k1_uint1)((fiat_secp256k1_uint1)(x1 >> 31) & (fiat_secp256k1_uint1)((arg3[0]) & 0x1));
  fiat_secp256k1_cmovznz_u32(&x3, x2, arg1, (uint32_t)(((~arg1) + (uint64_t)0x1) & UINT32_C(0xffffffff)));
  ...
  fiat_secp256k1_addcarryx_u32(&x13, &x14, 0x0, 0x1, (~(arg2[0])));
  fiat_secp256k1_addcarryx_u32(&x15, &x16, x14, 0x0, (~(arg2[1])));
  fiat_secp256k1_addcarryx_u32(&x17, &x18, x16, 0x0, (~(arg2[2])));
  fiat_secp256k1_addcarryx_u32(&x19, &x20, x18, 0x0, (~(arg2[3])));
  fiat_secp256k1_addcarryx_u32(&x21, &x22, x20, 0x0, (~(arg2[4])));
  fiat_secp256k1_addcarryx_u32(&x23, &x24, x22, 0x0, (~(arg2[5])));
  fiat_secp256k1_addcarryx_u32(&x25, &x26, x24, 0x0, (~(arg2[6])));
  fiat_secp256k1_addcarryx_u32(&x27, &x28, x26, 0x0, (~(arg2[7])));
  fiat_secp256k1_addcarryx_u32(&x29, &x30, x28, 0x0, (~(arg2[8])));
  ...
  fiat_secp256k1_addcarryx_u32(&x48, &x49, 0x0, x40, x40);
  fiat_secp256k1_addcarryx_u32(&x50, &x51, x49, x41, x41);
  fiat_secp256k1_addcarryx_u32(&x52, &x53, x51, x42, x42);
  fiat_secp256k1_addcarryx_u32(&x54, &x55, x53, x43, x43);
  fiat_secp256k1_addcarryx_u32(&x56, &x57, x55, x44, x44);
  fiat_secp256k1_addcarryx_u32(&x58, &x59, x57, x45, x45);
  fiat_secp256k1_addcarryx_u32(&x60, &x61, x59, x46, x46);
  fiat_secp256k1_addcarryx_u32(&x62, &x63, x61, x47, x47);
  fiat_secp256k1_subborrowx_u32(&x64, &x65, 0x0, x48, UINT32_C(0xfffffc2f));
  fiat_secp256k1_subborrowx_u32(&x66, &x67, x65, x50, UINT32_C(0xfffffffe));
  fiat_secp256k1_subborrowx_u32(&x68, &x69, x67, x52, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x70, &x71, x69, x54, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x72, &x73, x71, x56, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x74, &x75, x73, x58, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x76, &x77, x75, x60, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x78, &x79, x77, x62, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x80, &x81, x79, x63, 0x0);
  x82 = (arg4[7]);
  x83 = (arg4[6]);
  x84 = (arg4[5]);
  x85 = (arg4[4]);
  ...
  x88 = (arg4[1]);
  x89 = (arg4[0]);
  fiat_secp256k1_subborrowx_u32(&x90, &x91, 0x0, 0x0, x89);
  fiat_secp256k1_subborrowx_u32(&x92, &x93, x91, 0x0, x88);
  fiat_secp256k1_subborrowx_u32(&x94, &x95, x93, 0x0, x87);
  fiat_secp256k1_subborrowx_u32(&x96, &x97, x95, 0x0, x86);
  fiat_secp256k1_subborrowx_u32(&x98, &x99, x97, 0x0, x85);
  fiat_secp256k1_subborrowx_u32(&x100, &x101, x99, 0x0, x84);
  fiat_secp256k1_subborrowx_u32(&x102, &x103, x101, 0x0, x83);
  fiat_secp256k1_subborrowx_u32(&x104, &x105, x103, 0x0, x82);
  fiat_secp256k1_cmovznz_u32(&x106, x105, 0x0, UINT32_C(0xffffffff));
  fiat_secp256k1_addcarryx_u32(&x107, &x108, 0x0, x90, (x106 & UINT32_C(0xfffffc2f)));
  fiat_secp256k1_addcarryx_u32(&x109, &x110, x108, x92, (x106 & UINT32_C(0xfffffffe)));
  fiat_secp256k1_addcarryx_u32(&x111, &x112, x110, x94, x106);
  fiat_secp256k1_addcarryx_u32(&x113, &x114, x112, x96, x106);
  fiat_secp256k1_addcarryx_u32(&x115, &x116, x114, x98, x106);
  fiat_secp256k1_addcarryx_u32(&x117, &x118, x116, x100, x106);
  fiat_secp256k1_addcarryx_u32(&x119, &x120, x118, x102, x106);
  fiat_secp256k1_addcarryx_u32(&x121, &x122, x120, x104, x106);
  ...
  x131 = (fiat_secp256k1_uint1)(x31 & 0x1);
  fiat_secp256k1_cmovznz_u32(&x132, x131, 0x0, x4);
  fiat_secp256k1_cmovznz_u32(&x133, x131, 0x0, x5);
  fiat_secp256k1_cmovznz_u32(&x134, x131, 0x0, x6);
  fiat_secp256k1_cmovznz_u32(&x135, x131, 0x0, x7);
  fiat_secp256k1_cmovznz_u32(&x136, x131, 0x0, x8);
  fiat_secp256k1_cmovznz_u32(&x137, x131, 0x0, x9);
  fiat_secp256k1_cmovznz_u32(&x138, x131, 0x0, x10);
  fiat_secp256k1_cmovznz_u32(&x139, x131, 0x0, x11);
  fiat_secp256k1_cmovznz_u32(&x140, x131, 0x0, x12);
  fiat_secp256k1_addcarryx_u32(&x141, &x142, 0x0, x31, x132);
  fiat_secp256k1_addcarryx_u32(&x143, &x144, x142, x32, x133);
  fiat_secp256k1_addcarryx_u32(&x145, &x146, x144, x33, x134);
  fiat_secp256k1_addcarryx_u32(&x147, &x148, x146, x34, x135);
  fiat_secp256k1_addcarryx_u32(&x149, &x150, x148, x35, x136);
  fiat_secp256k1_addcarryx_u32(&x151, &x152, x150, x36, x137);
  fiat_secp256k1_addcarryx_u32(&x153, &x154, x152, x37, x138);
  fiat_secp256k1_addcarryx_u32(&x155, &x156, x154, x38, x139);
  fiat_secp256k1_addcarryx_u32(&x157, &x158, x156, x39, x140);
  fiat_secp256k1_cmovznz_u32(&x159, x131, 0x0, x40);
  fiat_secp256k1_cmovznz_u32(&x160, x131, 0x0, x41);
  fiat_secp256k1_cmovznz_u32(&x161, x131, 0x0, x42);
  fiat_secp256k1_cmovznz_u32(&x162, x131, 0x0, x43);
  fiat_secp256k1_cmovznz_u32(&x163, x131, 0x0, x44);
  fiat_secp256k1_cmovznz_u32(&x164, x131, 0x0, x45);
  fiat_secp256k1_cmovznz_u32(&x165, x131, 0x0, x46);
  fiat_secp256k1_cmovznz_u32(&x166, x131, 0x0, x47);
  fiat_secp256k1_addcarryx_u32(&x167, &x168, 0x0, x123, x159);
  fiat_secp256k1_addcarryx_u32(&x169, &x170, x168, x124, x160);
  fiat_secp256k1_addcarryx_u32(&x171, &x172, x170, x125, x161);
  fiat_secp256k1_addcarryx_u32(&x173, &x174, x172, x126, x162);
  fiat_secp256k1_addcarryx_u32(&x175, &x176, x174, x127, x163);
  fiat_secp256k1_addcarryx_u32(&x177, &x178, x176, x128, x164);
  fiat_secp256k1_addcarryx_u32(&x179, &x180, x178, x129, x165);
  fiat_secp256k1_addcarryx_u32(&x181, &x182, x180, x130, x166);
  fiat_secp256k1_subborrowx_u32(&x183, &x184, 0x0, x167, UINT32_C(0xfffffc2f));
  fiat_secp256k1_subborrowx_u32(&x185, &x186, x184, x169, UINT32_C(0xfffffffe));
  fiat_secp256k1_subborrowx_u32(&x187, &x188, x186, x171, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x189, &x190, x188, x173, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x191, &x192, x190, x175, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x193, &x194, x192, x177, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x195, &x196, x194, x179, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x197, &x198, x196, x181, UINT32_C(0xffffffff));
  fiat_secp256k1_subborrowx_u32(&x199, &x200, x198, x182, 0x0);
