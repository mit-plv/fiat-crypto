/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --static secp256k1 '2^256 - 2^32 - 977' 32 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
...
static void fiat_secp256k1_mul(uint32_t out1[8], const uint32_t arg1[8], const uint32_t arg2[8]) {
  ...
  uint32_t x191 = ((uint32_t)x190 + x139);
  uint32_t x192;
  uint32_t x193;
  ...
  uint32_t x292 = ((uint32_t)x291 + x240);
  uint32_t x293;
  uint32_t x294;
  ...
  uint32_t x393 = ((uint32_t)x392 + x341);
  uint32_t x394;
  uint32_t x395;
  ...
  uint32_t x494 = ((uint32_t)x493 + x442);
  uint32_t x495;
  uint32_t x496;
  ...
  uint32_t x595 = ((uint32_t)x594 + x543);
  uint32_t x596;
  uint32_t x597;
  ...
  uint32_t x696 = ((uint32_t)x695 + x644);
  uint32_t x697;
  uint32_t x698;
  ...
  uint32_t x797 = ((uint32_t)x796 + x745);
  uint32_t x798;
