...
static FIAT_P384_FIAT_INLINE void fiat_p384_sub(fiat_p384_montgomery_domain_field_element out1, const fiat_p384_montgomery_domain_field_element arg1, const fiat_p384_montgomery_domain_field_element arg2) {
  ...
  fiat_p384_addcarryx_u64(&x15, &x16, 0x0, x1, (x13 & UINT32_C(0xffffffff)));
  fiat_p384_addcarryx_u64(&x17, &x18, x16, x3, (x13 & UINT64_C(0xffffffff00000000)));
  fiat_p384_addcarryx_u64(&x19, &x20, x18, x5, (x13 & UINT64_C(0xfffffffffffffffe)));
  fiat_p384_addcarryx_u64(&x21, &x22, x20, x7, x13);
  fiat_p384_addcarryx_u64(&x23, &x24, x22, x9, x13);
  fiat_p384_addcarryx_u64(&x25, &x26, x24, x11, x13);
  out1[0] = x15;
  out1[1] = x17;
  out1[2] = x19;
  out1[3] = x21;
...
static FIAT_P384_FIAT_INLINE void fiat_p384_divstep(uint64_t* out1, uint64_t out2[7], uint64_t out3[7], uint64_t out4[6], uint64_t out5[6], uint64_t arg1, const uint64_t arg2[7], const uint64_t arg3[7], const uint64_t arg4[6], const uint64_t arg5[6]) {
  ...
  fiat_p384_subborrowx_u64(&x85, &x86, x84, 0x0, 0x0);
  fiat_p384_addcarryx_u64(&x87, &x88, 0x0, x73, (x85 & UINT32_C(0xffffffff)));
  fiat_p384_addcarryx_u64(&x89, &x90, x88, x75, (x85 & UINT64_C(0xffffffff00000000)));
  fiat_p384_addcarryx_u64(&x91, &x92, x90, x77, (x85 & UINT64_C(0xfffffffffffffffe)));
  fiat_p384_addcarryx_u64(&x93, &x94, x92, x79, x85);
  fiat_p384_addcarryx_u64(&x95, &x96, x94, x81, x85);
  fiat_p384_addcarryx_u64(&x97, &x98, x96, x83, x85);
  fiat_p384_cmovznz_u64(&x99, x3, (arg5[0]), x87);
  fiat_p384_cmovznz_u64(&x100, x3, (arg5[1]), x89);
  fiat_p384_cmovznz_u64(&x101, x3, (arg5[2]), x91);
  fiat_p384_cmovznz_u64(&x102, x3, (arg5[3]), x93);
  fiat_p384_cmovznz_u64(&x103, x3, (arg5[4]), x95);
  fiat_p384_cmovznz_u64(&x104, x3, (arg5[5]), x97);
  x105 = (fiat_p384_uint1)(x28 & 0x1);
  fiat_p384_cmovznz_u64(&x106, x105, 0x0, x7);
  fiat_p384_cmovznz_u64(&x107, x105, 0x0, x8);
  fiat_p384_cmovznz_u64(&x108, x105, 0x0, x9);
  fiat_p384_cmovznz_u64(&x109, x105, 0x0, x10);
  fiat_p384_cmovznz_u64(&x110, x105, 0x0, x11);
  fiat_p384_cmovznz_u64(&x111, x105, 0x0, x12);
  fiat_p384_cmovznz_u64(&x112, x105, 0x0, x13);
  fiat_p384_addcarryx_u64(&x113, &x114, 0x0, x28, x106);
  fiat_p384_addcarryx_u64(&x115, &x116, x114, x29, x107);
  fiat_p384_addcarryx_u64(&x117, &x118, x116, x30, x108);
  fiat_p384_addcarryx_u64(&x119, &x120, x118, x31, x109);
  fiat_p384_addcarryx_u64(&x121, &x122, x120, x32, x110);
  fiat_p384_addcarryx_u64(&x123, &x124, x122, x33, x111);
  fiat_p384_addcarryx_u64(&x125, &x126, x124, x34, x112);
  fiat_p384_cmovznz_u64(&x127, x105, 0x0, x35);
  fiat_p384_cmovznz_u64(&x128, x105, 0x0, x36);
  fiat_p384_cmovznz_u64(&x129, x105, 0x0, x37);
  fiat_p384_cmovznz_u64(&x130, x105, 0x0, x38);
  fiat_p384_cmovznz_u64(&x131, x105, 0x0, x39);
  fiat_p384_cmovznz_u64(&x132, x105, 0x0, x40);
  fiat_p384_addcarryx_u64(&x133, &x134, 0x0, x99, x127);
  fiat_p384_addcarryx_u64(&x135, &x136, x134, x100, x128);
  fiat_p384_addcarryx_u64(&x137, &x138, x136, x101, x129);
  fiat_p384_addcarryx_u64(&x139, &x140, x138, x102, x130);
  fiat_p384_addcarryx_u64(&x141, &x142, x140, x103, x131);
  fiat_p384_addcarryx_u64(&x143, &x144, x142, x104, x132);
  fiat_p384_subborrowx_u64(&x145, &x146, 0x0, x133, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u64(&x147, &x148, x146, x135, UINT64_C(0xffffffff00000000));
  fiat_p384_subborrowx_u64(&x149, &x150, x148, x137, UINT64_C(0xfffffffffffffffe));
  ...
  fiat_p384_subborrowx_u64(&x155, &x156, x154, x143, UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x157, &x158, x156, x144, 0x0);
  fiat_p384_addcarryx_u64(&x159, &x160, 0x0, x6, 0x1);
  ...
  fiat_p384_cmovznz_u64(&x168, x66, x53, x41);
  fiat_p384_cmovznz_u64(&x169, x66, x55, x43);
  fiat_p384_cmovznz_u64(&x170, x66, x57, x45);
  fiat_p384_cmovznz_u64(&x171, x66, x59, x47);
  fiat_p384_cmovznz_u64(&x172, x66, x61, x49);
  fiat_p384_cmovznz_u64(&x173, x66, x63, x51);
  fiat_p384_cmovznz_u64(&x174, x158, x145, x133);
  fiat_p384_cmovznz_u64(&x175, x158, x147, x135);
  fiat_p384_cmovznz_u64(&x176, x158, x149, x137);
  fiat_p384_cmovznz_u64(&x177, x158, x151, x139);
  fiat_p384_cmovznz_u64(&x178, x158, x153, x141);
  fiat_p384_cmovznz_u64(&x179, x158, x155, x143);
  *out1 = x159;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
