...
static void fiat_p384_divstep(uint64_t* out1, uint64_t out2[7], uint64_t out3[7], uint64_t out4[6], uint64_t out5[6], uint64_t arg1, const uint64_t arg2[7], const uint64_t arg3[7], const uint64_t arg4[6], const uint64_t arg5[6]) {
  ...
  x2 = (fiat_p384_uint1)((fiat_p384_uint1)(x1 >> 63) & (fiat_p384_uint1)((arg3[0]) & 0x1));
  fiat_p384_cmovznz_u64(&x3, x2, arg1, (uint64_t)(((~arg1) + (fiat_p384_uint128)0x1) & UINT64_C(0xffffffffffffffff)));
  ...
  fiat_p384_addcarryx_u64(&x11, &x12, 0x0, 0x1, (~(arg2[0])));
  fiat_p384_addcarryx_u64(&x13, &x14, x12, 0x0, (~(arg2[1])));
  fiat_p384_addcarryx_u64(&x15, &x16, x14, 0x0, (~(arg2[2])));
  fiat_p384_addcarryx_u64(&x17, &x18, x16, 0x0, (~(arg2[3])));
  fiat_p384_addcarryx_u64(&x19, &x20, x18, 0x0, (~(arg2[4])));
  fiat_p384_addcarryx_u64(&x21, &x22, x20, 0x0, (~(arg2[5])));
  fiat_p384_addcarryx_u64(&x23, &x24, x22, 0x0, (~(arg2[6])));
  ...
  fiat_p384_addcarryx_u64(&x38, &x39, 0x0, x32, x32);
  fiat_p384_addcarryx_u64(&x40, &x41, x39, x33, x33);
  fiat_p384_addcarryx_u64(&x42, &x43, x41, x34, x34);
  fiat_p384_addcarryx_u64(&x44, &x45, x43, x35, x35);
  fiat_p384_addcarryx_u64(&x46, &x47, x45, x36, x36);
  fiat_p384_addcarryx_u64(&x48, &x49, x47, x37, x37);
  fiat_p384_subborrowx_u64(&x50, &x51, 0x0, x38, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u64(&x52, &x53, x51, x40, UINT64_C(0xffffffff00000000));
  fiat_p384_subborrowx_u64(&x54, &x55, x53, x42, UINT64_C(0xfffffffffffffffe));
  fiat_p384_subborrowx_u64(&x56, &x57, x55, x44, UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x58, &x59, x57, x46, UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x60, &x61, x59, x48, UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x62, &x63, x61, x49, 0x0);
  x64 = (arg4[5]);
  x65 = (arg4[4]);
  x66 = (arg4[3]);
  x67 = (arg4[2]);
  x68 = (arg4[1]);
  x69 = (arg4[0]);
  fiat_p384_subborrowx_u64(&x70, &x71, 0x0, 0x0, x69);
  fiat_p384_subborrowx_u64(&x72, &x73, x71, 0x0, x68);
  fiat_p384_subborrowx_u64(&x74, &x75, x73, 0x0, x67);
  fiat_p384_subborrowx_u64(&x76, &x77, x75, 0x0, x66);
  fiat_p384_subborrowx_u64(&x78, &x79, x77, 0x0, x65);
  fiat_p384_subborrowx_u64(&x80, &x81, x79, 0x0, x64);
  fiat_p384_cmovznz_u64(&x82, x81, 0x0, UINT64_C(0xffffffffffffffff));
  fiat_p384_addcarryx_u64(&x83, &x84, 0x0, x70, (x82 & UINT32_C(0xffffffff)));
  fiat_p384_addcarryx_u64(&x85, &x86, x84, x72, (x82 & UINT64_C(0xffffffff00000000)));
  fiat_p384_addcarryx_u64(&x87, &x88, x86, x74, (x82 & UINT64_C(0xfffffffffffffffe)));
  fiat_p384_addcarryx_u64(&x89, &x90, x88, x76, x82);
  fiat_p384_addcarryx_u64(&x91, &x92, x90, x78, x82);
  fiat_p384_addcarryx_u64(&x93, &x94, x92, x80, x82);
  ...
  x101 = (fiat_p384_uint1)(x25 & 0x1);
  fiat_p384_cmovznz_u64(&x102, x101, 0x0, x4);
  fiat_p384_cmovznz_u64(&x103, x101, 0x0, x5);
  fiat_p384_cmovznz_u64(&x104, x101, 0x0, x6);
  fiat_p384_cmovznz_u64(&x105, x101, 0x0, x7);
  fiat_p384_cmovznz_u64(&x106, x101, 0x0, x8);
  fiat_p384_cmovznz_u64(&x107, x101, 0x0, x9);
  fiat_p384_cmovznz_u64(&x108, x101, 0x0, x10);
  fiat_p384_addcarryx_u64(&x109, &x110, 0x0, x25, x102);
  fiat_p384_addcarryx_u64(&x111, &x112, x110, x26, x103);
  fiat_p384_addcarryx_u64(&x113, &x114, x112, x27, x104);
  fiat_p384_addcarryx_u64(&x115, &x116, x114, x28, x105);
  fiat_p384_addcarryx_u64(&x117, &x118, x116, x29, x106);
  fiat_p384_addcarryx_u64(&x119, &x120, x118, x30, x107);
  fiat_p384_addcarryx_u64(&x121, &x122, x120, x31, x108);
  fiat_p384_cmovznz_u64(&x123, x101, 0x0, x32);
  fiat_p384_cmovznz_u64(&x124, x101, 0x0, x33);
  fiat_p384_cmovznz_u64(&x125, x101, 0x0, x34);
  fiat_p384_cmovznz_u64(&x126, x101, 0x0, x35);
  fiat_p384_cmovznz_u64(&x127, x101, 0x0, x36);
  fiat_p384_cmovznz_u64(&x128, x101, 0x0, x37);
  fiat_p384_addcarryx_u64(&x129, &x130, 0x0, x95, x123);
  fiat_p384_addcarryx_u64(&x131, &x132, x130, x96, x124);
  fiat_p384_addcarryx_u64(&x133, &x134, x132, x97, x125);
  fiat_p384_addcarryx_u64(&x135, &x136, x134, x98, x126);
  fiat_p384_addcarryx_u64(&x137, &x138, x136, x99, x127);
  fiat_p384_addcarryx_u64(&x139, &x140, x138, x100, x128);
  fiat_p384_subborrowx_u64(&x141, &x142, 0x0, x129, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u64(&x143, &x144, x142, x131, UINT64_C(0xffffffff00000000));
  fiat_p384_subborrowx_u64(&x145, &x146, x144, x133, UINT64_C(0xfffffffffffffffe));
  fiat_p384_subborrowx_u64(&x147, &x148, x146, x135, UINT64_C(0xffffffffffffffff));
  ...
  fiat_p384_subborrowx_u64(&x153, &x154, x152, x140, 0x0);
  x155 = (uint64_t)((x3 + (fiat_p384_uint128)0x1) & UINT64_C(0xffffffffffffffff));
  x156 = ((x109 >> 1) | ((x111 << 63) & UINT64_C(0xffffffffffffffff)));
  x157 = ((x111 >> 1) | ((x113 << 63) & UINT64_C(0xffffffffffffffff)));
  x158 = ((x113 >> 1) | ((x115 << 63) & UINT64_C(0xffffffffffffffff)));
  x159 = ((x115 >> 1) | ((x117 << 63) & UINT64_C(0xffffffffffffffff)));
  x160 = ((x117 >> 1) | ((x119 << 63) & UINT64_C(0xffffffffffffffff)));
  x161 = ((x119 >> 1) | ((x121 << 63) & UINT64_C(0xffffffffffffffff)));
  x162 = ((x121 & UINT64_C(0x8000000000000000)) | (x121 >> 1));
