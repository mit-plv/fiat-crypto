...
static FIAT_SECP256K1_DETTMAN_FIAT_INLINE void fiat_secp256k1_dettman_mul(uint32_t out1[10], const uint32_t arg1[10], const uint32_t arg2[10]) {
  ...
  x18 = (x14 + ((((uint64_t)(arg1[1]) * (arg2[9])) + (((uint64_t)(arg1[2]) * (arg2[8])) + (((uint64_t)(arg1[3]) * (arg2[7])) + (((uint64_t)(arg1[4]) * (arg2[6])) + (((uint64_t)(arg1[5]) * (arg2[5])) + (((uint64_t)(arg1[6]) * (arg2[4])) + (((uint64_t)(arg1[7]) * (arg2[3])) + (((uint64_t)(arg1[8]) * (arg2[2])) + ((uint64_t)(arg1[9]) * (arg2[1])))))))))) + (x8 << 16)));
  x19 = (uint32_t)(x18 >> 26);
  x20 = (uint32_t)(x18 & UINT32_C(0x3ffffff));
  x21 = (((uint64_t)(arg1[0]) * (arg2[0])) + ((uint64_t)(x16 + (x20 << 4)) * UINT16_C(0x3d1)));
  x22 = (uint32_t)(x21 >> 26);
  x23 = (uint32_t)(x21 & UINT32_C(0x3ffffff));
  x24 = (x19 + (((uint64_t)(arg1[2]) * (arg2[9])) + (((uint64_t)(arg1[3]) * (arg2[8])) + (((uint64_t)(arg1[4]) * (arg2[7])) + (((uint64_t)(arg1[5]) * (arg2[6])) + (((uint64_t)(arg1[6]) * (arg2[5])) + (((uint64_t)(arg1[7]) * (arg2[4])) + (((uint64_t)(arg1[8]) * (arg2[3])) + ((uint64_t)(arg1[9]) * (arg2[2]))))))))));
  x25 = (uint32_t)(x24 >> 26);
  x26 = (uint32_t)(x24 & UINT32_C(0x3ffffff));
  x27 = ((x22 + ((((uint64_t)(arg1[0]) * (arg2[1])) + ((uint64_t)(arg1[1]) * (arg2[0]))) + ((uint64_t)(x16 + (x20 << 4)) << 6))) + ((uint64_t)x26 * UINT16_C(0x3d10)));
  x28 = (uint32_t)(x27 >> 26);
...
static FIAT_SECP256K1_DETTMAN_FIAT_INLINE void fiat_secp256k1_dettman_square(uint32_t out1[10], const uint32_t arg1[10]) {
  ...
  x25 = (x24 >> 22);
  x26 = (x24 & UINT32_C(0x3fffff));
  x27 = (x23 + ((((uint64_t)x8 * (arg1[9])) + (((uint64_t)x7 * (arg1[8])) + (((uint64_t)x6 * (arg1[7])) + (((uint64_t)x5 * (arg1[6])) + ((uint64_t)(arg1[5]) * (arg1[5])))))) + (x17 << 16)));
  x28 = (uint32_t)(x27 >> 26);
  x29 = (uint32_t)(x27 & UINT32_C(0x3ffffff));
  x30 = (((uint64_t)(arg1[0]) * (arg1[0])) + ((uint64_t)(x25 + (x29 << 4)) * UINT16_C(0x3d1)));
  x31 = (uint32_t)(x30 >> 26);
  x32 = (uint32_t)(x30 & UINT32_C(0x3ffffff));
  x33 = (x28 + (((uint64_t)x7 * (arg1[9])) + (((uint64_t)x6 * (arg1[8])) + (((uint64_t)x5 * (arg1[7])) + ((uint64_t)x4 * (arg1[6]))))));
  x34 = (uint32_t)(x33 >> 26);
  x35 = (uint32_t)(x33 & UINT32_C(0x3ffffff));
  x36 = ((x31 + (((uint64_t)x9 * (arg1[1])) + ((uint64_t)(x25 + (x29 << 4)) << 6))) + ((uint64_t)x35 * UINT16_C(0x3d10)));
  x37 = (uint32_t)(x36 >> 26);
  x38 = (uint32_t)(x36 & UINT32_C(0x3ffffff));
