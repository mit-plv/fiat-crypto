...
static FIAT_P224_FIAT_INLINE void fiat_p224_sub(fiat_p224_montgomery_domain_field_element out1, const fiat_p224_montgomery_domain_field_element arg1, const fiat_p224_montgomery_domain_field_element arg2) {
  ...
  fiat_p224_addcarryx_u32(&x17, &x18, 0x0, x1, (fiat_p224_uint1)(x15 & 0x1));
  fiat_p224_addcarryx_u32(&x19, &x20, x18, x3, 0x0);
  fiat_p224_addcarryx_u32(&x21, &x22, x20, x5, 0x0);
  fiat_p224_addcarryx_u32(&x23, &x24, x22, x7, x15);
  fiat_p224_addcarryx_u32(&x25, &x26, x24, x9, x15);
  fiat_p224_addcarryx_u32(&x27, &x28, x26, x11, x15);
  fiat_p224_addcarryx_u32(&x29, &x30, x28, x13, x15);
  out1[0] = x17;
  out1[1] = x19;
  out1[2] = x21;
  out1[3] = x23;
...
static FIAT_P224_FIAT_INLINE void fiat_p224_divstep(uint32_t* out1, uint32_t out2[8], uint32_t out3[8], uint32_t out4[7], uint32_t out5[7], uint32_t arg1, const uint32_t arg2[8], const uint32_t arg3[8], const uint32_t arg4[7], const uint32_t arg5[7]) {
  ...
  fiat_p224_subborrowx_u32(&x97, &x98, x96, 0x0, 0x0);
  fiat_p224_addcarryx_u32(&x99, &x100, 0x0, x83, (fiat_p224_uint1)(x97 & 0x1));
  fiat_p224_addcarryx_u32(&x101, &x102, x100, x85, 0x0);
  fiat_p224_addcarryx_u32(&x103, &x104, x102, x87, 0x0);
  fiat_p224_addcarryx_u32(&x105, &x106, x104, x89, x97);
  fiat_p224_addcarryx_u32(&x107, &x108, x106, x91, x97);
  fiat_p224_addcarryx_u32(&x109, &x110, x108, x93, x97);
  fiat_p224_addcarryx_u32(&x111, &x112, x110, x95, x97);
  fiat_p224_cmovznz_u32(&x113, x3, (arg5[0]), x99);
  fiat_p224_cmovznz_u32(&x114, x3, (arg5[1]), x101);
  fiat_p224_cmovznz_u32(&x115, x3, (arg5[2]), x103);
  fiat_p224_cmovznz_u32(&x116, x3, (arg5[3]), x105);
  fiat_p224_cmovznz_u32(&x117, x3, (arg5[4]), x107);
  fiat_p224_cmovznz_u32(&x118, x3, (arg5[5]), x109);
  fiat_p224_cmovznz_u32(&x119, x3, (arg5[6]), x111);
  x120 = (fiat_p224_uint1)(x31 & 0x1);
  fiat_p224_cmovznz_u32(&x121, x120, 0x0, x7);
  fiat_p224_cmovznz_u32(&x122, x120, 0x0, x8);
  fiat_p224_cmovznz_u32(&x123, x120, 0x0, x9);
  fiat_p224_cmovznz_u32(&x124, x120, 0x0, x10);
  fiat_p224_cmovznz_u32(&x125, x120, 0x0, x11);
  fiat_p224_cmovznz_u32(&x126, x120, 0x0, x12);
  fiat_p224_cmovznz_u32(&x127, x120, 0x0, x13);
  fiat_p224_cmovznz_u32(&x128, x120, 0x0, x14);
  fiat_p224_addcarryx_u32(&x129, &x130, 0x0, x31, x121);
  fiat_p224_addcarryx_u32(&x131, &x132, x130, x32, x122);
  fiat_p224_addcarryx_u32(&x133, &x134, x132, x33, x123);
  fiat_p224_addcarryx_u32(&x135, &x136, x134, x34, x124);
  fiat_p224_addcarryx_u32(&x137, &x138, x136, x35, x125);
  fiat_p224_addcarryx_u32(&x139, &x140, x138, x36, x126);
  fiat_p224_addcarryx_u32(&x141, &x142, x140, x37, x127);
  fiat_p224_addcarryx_u32(&x143, &x144, x142, x38, x128);
  fiat_p224_cmovznz_u32(&x145, x120, 0x0, x39);
  fiat_p224_cmovznz_u32(&x146, x120, 0x0, x40);
  fiat_p224_cmovznz_u32(&x147, x120, 0x0, x41);
  fiat_p224_cmovznz_u32(&x148, x120, 0x0, x42);
  fiat_p224_cmovznz_u32(&x149, x120, 0x0, x43);
  fiat_p224_cmovznz_u32(&x150, x120, 0x0, x44);
  fiat_p224_cmovznz_u32(&x151, x120, 0x0, x45);
  fiat_p224_addcarryx_u32(&x152, &x153, 0x0, x113, x145);
  fiat_p224_addcarryx_u32(&x154, &x155, x153, x114, x146);
  fiat_p224_addcarryx_u32(&x156, &x157, x155, x115, x147);
  fiat_p224_addcarryx_u32(&x158, &x159, x157, x116, x148);
  fiat_p224_addcarryx_u32(&x160, &x161, x159, x117, x149);
  fiat_p224_addcarryx_u32(&x162, &x163, x161, x118, x150);
  fiat_p224_addcarryx_u32(&x164, &x165, x163, x119, x151);
  fiat_p224_subborrowx_u32(&x166, &x167, 0x0, x152, 0x1);
  fiat_p224_subborrowx_u32(&x168, &x169, x167, x154, 0x0);
  fiat_p224_subborrowx_u32(&x170, &x171, x169, x156, 0x0);
  ...
  fiat_p224_subborrowx_u32(&x178, &x179, x177, x164, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x180, &x181, x179, x165, 0x0);
  fiat_p224_addcarryx_u32(&x182, &x183, 0x0, x6, 0x1);
  x184 = ((x129 >> 1) | ((x131 << 31) & UINT32_C(0xffffffff)));
  x185 = ((x131 >> 1) | ((x133 << 31) & UINT32_C(0xffffffff)));
  x186 = ((x133 >> 1) | ((x135 << 31) & UINT32_C(0xffffffff)));
  x187 = ((x135 >> 1) | ((x137 << 31) & UINT32_C(0xffffffff)));
  x188 = ((x137 >> 1) | ((x139 << 31) & UINT32_C(0xffffffff)));
  x189 = ((x139 >> 1) | ((x141 << 31) & UINT32_C(0xffffffff)));
  x190 = ((x141 >> 1) | ((x143 << 31) & UINT32_C(0xffffffff)));
  x191 = ((x143 & UINT32_C(0x80000000)) | (x143 >> 1));
  fiat_p224_cmovznz_u32(&x192, x75, x60, x46);
  fiat_p224_cmovznz_u32(&x193, x75, x62, x48);
  fiat_p224_cmovznz_u32(&x194, x75, x64, x50);
  fiat_p224_cmovznz_u32(&x195, x75, x66, x52);
  fiat_p224_cmovznz_u32(&x196, x75, x68, x54);
  fiat_p224_cmovznz_u32(&x197, x75, x70, x56);
  fiat_p224_cmovznz_u32(&x198, x75, x72, x58);
  fiat_p224_cmovznz_u32(&x199, x181, x166, x152);
  fiat_p224_cmovznz_u32(&x200, x181, x168, x154);
  fiat_p224_cmovznz_u32(&x201, x181, x170, x156);
  fiat_p224_cmovznz_u32(&x202, x181, x172, x158);
  fiat_p224_cmovznz_u32(&x203, x181, x174, x160);
  fiat_p224_cmovznz_u32(&x204, x181, x176, x162);
  fiat_p224_cmovznz_u32(&x205, x181, x178, x164);
  *out1 = x182;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
