/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --static p224 32 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes scmul2 scmul3 scmul4 scmul8 */
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static void fiat_p224_scmul_2(uint32_t out1[7], const uint32_t arg1[7]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
  ...
  uint32_t x390;
  uint32_t x391;
  fiat_p224_mulx_u32(&x1, &x2, UINT32_C(0xfffffffe), (arg1[6]));
  fiat_p224_mulx_u32(&x3, &x4, UINT32_C(0xfffffffe), (arg1[5]));
  fiat_p224_mulx_u32(&x5, &x6, UINT32_C(0xfffffffe), (arg1[4]));
  fiat_p224_mulx_u32(&x7, &x8, UINT32_C(0xfffffffe), (arg1[3]));
  fiat_p224_mulx_u32(&x9, &x10, UINT32_C(0xfffffffe), (arg1[2]));
  fiat_p224_mulx_u32(&x11, &x12, UINT32_C(0xfffffffe), (arg1[1]));
  fiat_p224_mulx_u32(&x13, &x14, UINT32_C(0xfffffffe), (arg1[0]));
  fiat_p224_addcarryx_u32(&x15, &x16, 0x0, x14, x11);
  fiat_p224_addcarryx_u32(&x17, &x18, x16, x12, x9);
  fiat_p224_addcarryx_u32(&x19, &x20, x18, x10, x7);
  fiat_p224_addcarryx_u32(&x21, &x22, x20, x8, x5);
  fiat_p224_addcarryx_u32(&x23, &x24, x22, x6, x3);
  fiat_p224_addcarryx_u32(&x25, &x26, x24, x4, x1);
  x27 = (x26 + x2);
  fiat_p224_mulx_u32(&x28, &x29, x13, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x30, &x31, x28, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x32, &x33, x28, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x34, &x35, x28, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x36, &x37, x28, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x38, &x39, 0x0, x37, x34);
  fiat_p224_addcarryx_u32(&x40, &x41, x39, x35, x32);
  fiat_p224_addcarryx_u32(&x42, &x43, x41, x33, x30);
  x44 = (x43 + x31);
  fiat_p224_addcarryx_u32(&x45, &x46, 0x0, x13, x28);
  fiat_p224_addcarryx_u32(&x47, &x48, x46, x15, 0x0);
  fiat_p224_addcarryx_u32(&x49, &x50, x48, x17, 0x0);
  fiat_p224_addcarryx_u32(&x51, &x52, x50, x19, x36);
  fiat_p224_addcarryx_u32(&x53, &x54, x52, x21, x38);
  fiat_p224_addcarryx_u32(&x55, &x56, x54, x23, x40);
  fiat_p224_addcarryx_u32(&x57, &x58, x56, x25, x42);
  fiat_p224_addcarryx_u32(&x59, &x60, x58, x27, x44);
  fiat_p224_mulx_u32(&x61, &x62, UINT32_C(0xffffffff), (arg1[6]));
  fiat_p224_mulx_u32(&x63, &x64, UINT32_C(0xffffffff), (arg1[5]));
  fiat_p224_mulx_u32(&x65, &x66, UINT32_C(0xffffffff), (arg1[4]));
  fiat_p224_mulx_u32(&x67, &x68, UINT32_C(0xffffffff), (arg1[3]));
  fiat_p224_mulx_u32(&x69, &x70, UINT32_C(0xffffffff), (arg1[2]));
  fiat_p224_mulx_u32(&x71, &x72, UINT32_C(0xffffffff), (arg1[1]));
  fiat_p224_mulx_u32(&x73, &x74, UINT32_C(0xffffffff), (arg1[0]));
  fiat_p224_addcarryx_u32(&x75, &x76, 0x0, x74, x71);
  fiat_p224_addcarryx_u32(&x77, &x78, x76, x72, x69);
  fiat_p224_addcarryx_u32(&x79, &x80, x78, x70, x67);
  fiat_p224_addcarryx_u32(&x81, &x82, x80, x68, x65);
  fiat_p224_addcarryx_u32(&x83, &x84, x82, x66, x63);
  fiat_p224_addcarryx_u32(&x85, &x86, x84, x64, x61);
  x87 = (x86 + x62);
  fiat_p224_addcarryx_u32(&x88, &x89, 0x0, x47, x73);
  fiat_p224_addcarryx_u32(&x90, &x91, x89, x49, x75);
  fiat_p224_addcarryx_u32(&x92, &x93, x91, x51, x77);
  fiat_p224_addcarryx_u32(&x94, &x95, x93, x53, x79);
  fiat_p224_addcarryx_u32(&x96, &x97, x95, x55, x81);
  fiat_p224_addcarryx_u32(&x98, &x99, x97, x57, x83);
  fiat_p224_addcarryx_u32(&x100, &x101, x99, x59, x85);
  fiat_p224_addcarryx_u32(&x102, &x103, x101, x60, x87);
  fiat_p224_mulx_u32(&x104, &x105, x88, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x106, &x107, x104, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x108, &x109, x104, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x110, &x111, x104, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x112, &x113, x104, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x114, &x115, 0x0, x113, x110);
  fiat_p224_addcarryx_u32(&x116, &x117, x115, x111, x108);
  fiat_p224_addcarryx_u32(&x118, &x119, x117, x109, x106);
  x120 = (x119 + x107);
  fiat_p224_addcarryx_u32(&x121, &x122, 0x0, x88, x104);
  fiat_p224_addcarryx_u32(&x123, &x124, x122, x90, 0x0);
  fiat_p224_addcarryx_u32(&x125, &x126, x124, x92, 0x0);
  fiat_p224_addcarryx_u32(&x127, &x128, x126, x94, x112);
  fiat_p224_addcarryx_u32(&x129, &x130, x128, x96, x114);
  fiat_p224_addcarryx_u32(&x131, &x132, x130, x98, x116);
  fiat_p224_addcarryx_u32(&x133, &x134, x132, x100, x118);
  fiat_p224_addcarryx_u32(&x135, &x136, x134, x102, x120);
  x137 = ((uint32_t)x136 + x103);
  fiat_p224_mulx_u32(&x138, &x139, UINT32_C(0xffffffff), (arg1[6]));
  fiat_p224_mulx_u32(&x140, &x141, UINT32_C(0xffffffff), (arg1[5]));
  fiat_p224_mulx_u32(&x142, &x143, UINT32_C(0xffffffff), (arg1[4]));
  fiat_p224_mulx_u32(&x144, &x145, UINT32_C(0xffffffff), (arg1[3]));
  fiat_p224_mulx_u32(&x146, &x147, UINT32_C(0xffffffff), (arg1[2]));
  fiat_p224_mulx_u32(&x148, &x149, UINT32_C(0xffffffff), (arg1[1]));
  fiat_p224_mulx_u32(&x150, &x151, UINT32_C(0xffffffff), (arg1[0]));
  fiat_p224_addcarryx_u32(&x152, &x153, 0x0, x151, x148);
  fiat_p224_addcarryx_u32(&x154, &x155, x153, x149, x146);
  fiat_p224_addcarryx_u32(&x156, &x157, x155, x147, x144);
  fiat_p224_addcarryx_u32(&x158, &x159, x157, x145, x142);
  fiat_p224_addcarryx_u32(&x160, &x161, x159, x143, x140);
  fiat_p224_addcarryx_u32(&x162, &x163, x161, x141, x138);
  x164 = (x163 + x139);
  fiat_p224_addcarryx_u32(&x165, &x166, 0x0, x123, x150);
  fiat_p224_addcarryx_u32(&x167, &x168, x166, x125, x152);
  fiat_p224_addcarryx_u32(&x169, &x170, x168, x127, x154);
  fiat_p224_addcarryx_u32(&x171, &x172, x170, x129, x156);
  fiat_p224_addcarryx_u32(&x173, &x174, x172, x131, x158);
  fiat_p224_addcarryx_u32(&x175, &x176, x174, x133, x160);
  fiat_p224_addcarryx_u32(&x177, &x178, x176, x135, x162);
  fiat_p224_addcarryx_u32(&x179, &x180, x178, x137, x164);
  fiat_p224_mulx_u32(&x181, &x182, x165, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x183, &x184, x181, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x185, &x186, x181, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x187, &x188, x181, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x189, &x190, x181, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x191, &x192, 0x0, x190, x187);
  fiat_p224_addcarryx_u32(&x193, &x194, x192, x188, x185);
  fiat_p224_addcarryx_u32(&x195, &x196, x194, x186, x183);
  x197 = (x196 + x184);
  fiat_p224_addcarryx_u32(&x198, &x199, 0x0, x165, x181);
  fiat_p224_addcarryx_u32(&x200, &x201, x199, x167, 0x0);
  fiat_p224_addcarryx_u32(&x202, &x203, x201, x169, 0x0);
  fiat_p224_addcarryx_u32(&x204, &x205, x203, x171, x189);
  fiat_p224_addcarryx_u32(&x206, &x207, x205, x173, x191);
  fiat_p224_addcarryx_u32(&x208, &x209, x207, x175, x193);
  fiat_p224_addcarryx_u32(&x210, &x211, x209, x177, x195);
  fiat_p224_addcarryx_u32(&x212, &x213, x211, x179, x197);
  x214 = ((uint32_t)x213 + x180);
  x215 = (arg1[6]);
  x216 = (arg1[5]);
  x217 = (arg1[4]);
  x218 = (arg1[3]);
  ...
  x220 = (arg1[1]);
  x221 = (arg1[0]);
  fiat_p224_addcarryx_u32(&x222, &x223, 0x0, x200, x221);
  fiat_p224_addcarryx_u32(&x224, &x225, x223, x202, x220);
  fiat_p224_addcarryx_u32(&x226, &x227, x225, x204, x219);
  fiat_p224_addcarryx_u32(&x228, &x229, x227, x206, x218);
  fiat_p224_addcarryx_u32(&x230, &x231, x229, x208, x217);
  fiat_p224_addcarryx_u32(&x232, &x233, x231, x210, x216);
  fiat_p224_addcarryx_u32(&x234, &x235, x233, x212, x215);
  x236 = (x235 + x214);
  fiat_p224_mulx_u32(&x237, &x238, x222, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x239, &x240, x237, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x241, &x242, x237, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x243, &x244, x237, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x245, &x246, x237, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x247, &x248, 0x0, x246, x243);
  fiat_p224_addcarryx_u32(&x249, &x250, x248, x244, x241);
  fiat_p224_addcarryx_u32(&x251, &x252, x250, x242, x239);
  x253 = (x252 + x240);
  fiat_p224_addcarryx_u32(&x254, &x255, 0x0, x222, x237);
  fiat_p224_addcarryx_u32(&x256, &x257, x255, x224, 0x0);
  fiat_p224_addcarryx_u32(&x258, &x259, x257, x226, 0x0);
  fiat_p224_addcarryx_u32(&x260, &x261, x259, x228, x245);
  fiat_p224_addcarryx_u32(&x262, &x263, x261, x230, x247);
  fiat_p224_addcarryx_u32(&x264, &x265, x263, x232, x249);
  fiat_p224_addcarryx_u32(&x266, &x267, x265, x234, x251);
  fiat_p224_addcarryx_u32(&x268, &x269, x267, x236, x253);
  fiat_p224_mulx_u32(&x270, &x271, x256, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x272, &x273, x270, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x274, &x275, x270, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x276, &x277, x270, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x278, &x279, x270, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x280, &x281, 0x0, x279, x276);
  fiat_p224_addcarryx_u32(&x282, &x283, x281, x277, x274);
  fiat_p224_addcarryx_u32(&x284, &x285, x283, x275, x272);
  x286 = (x285 + x273);
  fiat_p224_addcarryx_u32(&x287, &x288, 0x0, x256, x270);
  fiat_p224_addcarryx_u32(&x289, &x290, x288, x258, 0x0);
  fiat_p224_addcarryx_u32(&x291, &x292, x290, x260, 0x0);
  fiat_p224_addcarryx_u32(&x293, &x294, x292, x262, x278);
  fiat_p224_addcarryx_u32(&x295, &x296, x294, x264, x280);
  fiat_p224_addcarryx_u32(&x297, &x298, x296, x266, x282);
  fiat_p224_addcarryx_u32(&x299, &x300, x298, x268, x284);
  fiat_p224_addcarryx_u32(&x301, &x302, x300, x269, x286);
  fiat_p224_mulx_u32(&x303, &x304, x289, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x305, &x306, x303, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x307, &x308, x303, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x309, &x310, x303, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x311, &x312, x303, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x313, &x314, 0x0, x312, x309);
  fiat_p224_addcarryx_u32(&x315, &x316, x314, x310, x307);
  fiat_p224_addcarryx_u32(&x317, &x318, x316, x308, x305);
  x319 = (x318 + x306);
  fiat_p224_addcarryx_u32(&x320, &x321, 0x0, x289, x303);
  fiat_p224_addcarryx_u32(&x322, &x323, x321, x291, 0x0);
  fiat_p224_addcarryx_u32(&x324, &x325, x323, x293, 0x0);
  fiat_p224_addcarryx_u32(&x326, &x327, x325, x295, x311);
  fiat_p224_addcarryx_u32(&x328, &x329, x327, x297, x313);
  fiat_p224_addcarryx_u32(&x330, &x331, x329, x299, x315);
  fiat_p224_addcarryx_u32(&x332, &x333, x331, x301, x317);
  fiat_p224_addcarryx_u32(&x334, &x335, x333, x302, x319);
  fiat_p224_mulx_u32(&x336, &x337, x322, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x338, &x339, x336, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x340, &x341, x336, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x342, &x343, x336, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x344, &x345, x336, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x346, &x347, 0x0, x345, x342);
  fiat_p224_addcarryx_u32(&x348, &x349, x347, x343, x340);
  fiat_p224_addcarryx_u32(&x350, &x351, x349, x341, x338);
  x352 = (x351 + x339);
  fiat_p224_addcarryx_u32(&x353, &x354, 0x0, x322, x336);
  fiat_p224_addcarryx_u32(&x355, &x356, x354, x324, 0x0);
  fiat_p224_addcarryx_u32(&x357, &x358, x356, x326, 0x0);
  fiat_p224_addcarryx_u32(&x359, &x360, x358, x328, x344);
  fiat_p224_addcarryx_u32(&x361, &x362, x360, x330, x346);
  fiat_p224_addcarryx_u32(&x363, &x364, x362, x332, x348);
  fiat_p224_addcarryx_u32(&x365, &x366, x364, x334, x350);
  fiat_p224_addcarryx_u32(&x367, &x368, x366, x335, x352);
  fiat_p224_subborrowx_u32(&x369, &x370, 0x0, x355, 0x1);
  fiat_p224_subborrowx_u32(&x371, &x372, x370, x357, 0x0);
  fiat_p224_subborrowx_u32(&x373, &x374, x372, x359, 0x0);
  fiat_p224_subborrowx_u32(&x375, &x376, x374, x361, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x377, &x378, x376, x363, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x379, &x380, x378, x365, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x381, &x382, x380, x367, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x383, &x384, x382, x368, 0x0);
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static void fiat_p224_scmul_3(uint32_t out1[7], const uint32_t arg1[7]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
  ...
  uint32_t x410;
  uint32_t x411;
  fiat_p224_mulx_u32(&x1, &x2, UINT32_C(0xfffffffd), (arg1[6]));
  fiat_p224_mulx_u32(&x3, &x4, UINT32_C(0xfffffffd), (arg1[5]));
  fiat_p224_mulx_u32(&x5, &x6, UINT32_C(0xfffffffd), (arg1[4]));
  fiat_p224_mulx_u32(&x7, &x8, UINT32_C(0xfffffffd), (arg1[3]));
  fiat_p224_mulx_u32(&x9, &x10, UINT32_C(0xfffffffd), (arg1[2]));
  fiat_p224_mulx_u32(&x11, &x12, UINT32_C(0xfffffffd), (arg1[1]));
  fiat_p224_mulx_u32(&x13, &x14, UINT32_C(0xfffffffd), (arg1[0]));
  fiat_p224_addcarryx_u32(&x15, &x16, 0x0, x14, x11);
  fiat_p224_addcarryx_u32(&x17, &x18, x16, x12, x9);
  fiat_p224_addcarryx_u32(&x19, &x20, x18, x10, x7);
  fiat_p224_addcarryx_u32(&x21, &x22, x20, x8, x5);
  ...
  fiat_p224_addcarryx_u32(&x229, &x230, 0x0, (fiat_p224_uint1)x228, x225);
  fiat_p224_addcarryx_u32(&x231, &x232, x230, (fiat_p224_uint1)x226, x223);
  fiat_p224_addcarryx_u32(&x233, &x234, x232, (fiat_p224_uint1)x224, x221);
  fiat_p224_addcarryx_u32(&x235, &x236, x234, (fiat_p224_uint1)x222, x219);
  fiat_p224_addcarryx_u32(&x237, &x238, x236, (fiat_p224_uint1)x220, x217);
  fiat_p224_addcarryx_u32(&x239, &x240, x238, (fiat_p224_uint1)x218, x215);
  x241 = ((uint32_t)x240 + (fiat_p224_uint1)x216);
  fiat_p224_addcarryx_u32(&x242, &x243, 0x0, x200, x227);
  fiat_p224_addcarryx_u32(&x244, &x245, x243, x202, x229);
  fiat_p224_addcarryx_u32(&x246, &x247, x245, x204, x231);
  fiat_p224_addcarryx_u32(&x248, &x249, x247, x206, x233);
  fiat_p224_addcarryx_u32(&x250, &x251, x249, x208, x235);
  fiat_p224_addcarryx_u32(&x252, &x253, x251, x210, x237);
  fiat_p224_addcarryx_u32(&x254, &x255, x253, x212, x239);
  x256 = ((x255 + x214) + x241);
  fiat_p224_mulx_u32(&x257, &x258, x242, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x259, &x260, x257, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x261, &x262, x257, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x263, &x264, x257, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x265, &x266, x257, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x267, &x268, 0x0, x266, x263);
  fiat_p224_addcarryx_u32(&x269, &x270, x268, x264, x261);
  fiat_p224_addcarryx_u32(&x271, &x272, x270, x262, x259);
  x273 = (x272 + x260);
  fiat_p224_addcarryx_u32(&x274, &x275, 0x0, x242, x257);
  fiat_p224_addcarryx_u32(&x276, &x277, x275, x244, 0x0);
  fiat_p224_addcarryx_u32(&x278, &x279, x277, x246, 0x0);
  fiat_p224_addcarryx_u32(&x280, &x281, x279, x248, x265);
  fiat_p224_addcarryx_u32(&x282, &x283, x281, x250, x267);
  fiat_p224_addcarryx_u32(&x284, &x285, x283, x252, x269);
  fiat_p224_addcarryx_u32(&x286, &x287, x285, x254, x271);
  fiat_p224_addcarryx_u32(&x288, &x289, x287, x256, x273);
  fiat_p224_mulx_u32(&x290, &x291, x276, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x292, &x293, x290, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x294, &x295, x290, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x296, &x297, x290, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x298, &x299, x290, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x300, &x301, 0x0, x299, x296);
  fiat_p224_addcarryx_u32(&x302, &x303, x301, x297, x294);
  fiat_p224_addcarryx_u32(&x304, &x305, x303, x295, x292);
  x306 = (x305 + x293);
  fiat_p224_addcarryx_u32(&x307, &x308, 0x0, x276, x290);
  fiat_p224_addcarryx_u32(&x309, &x310, x308, x278, 0x0);
  fiat_p224_addcarryx_u32(&x311, &x312, x310, x280, 0x0);
  fiat_p224_addcarryx_u32(&x313, &x314, x312, x282, x298);
  fiat_p224_addcarryx_u32(&x315, &x316, x314, x284, x300);
  fiat_p224_addcarryx_u32(&x317, &x318, x316, x286, x302);
  fiat_p224_addcarryx_u32(&x319, &x320, x318, x288, x304);
  fiat_p224_addcarryx_u32(&x321, &x322, x320, x289, x306);
  fiat_p224_mulx_u32(&x323, &x324, x309, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x325, &x326, x323, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x327, &x328, x323, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x329, &x330, x323, UINT32_C(0xffffffff));
  fiat_p224_mulx_u32(&x331, &x332, x323, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x333, &x334, 0x0, x332, x329);
  fiat_p224_addcarryx_u32(&x335, &x336, x334, x330, x327);
  fiat_p224_addcarryx_u32(&x337, &x338, x336, x328, x325);
  x339 = (x338 + x326);
  fiat_p224_addcarryx_u32(&x340, &x341, 0x0, x309, x323);
  fiat_p224_addcarryx_u32(&x342, &x343, x341, x311, 0x0);
  fiat_p224_addcarryx_u32(&x344, &x345, x343, x313, 0x0);
  fiat_p224_addcarryx_u32(&x346, &x347, x345, x315, x331);
  fiat_p224_addcarryx_u32(&x348, &x349, x347, x317, x333);
  fiat_p224_addcarryx_u32(&x350, &x351, x349, x319, x335);
  fiat_p224_addcarryx_u32(&x352, &x353, x351, x321, x337);
  fiat_p224_addcarryx_u32(&x354, &x355, x353, x322, x339);
  fiat_p224_mulx_u32(&x356, &x357, x342, UINT32_C(0xffffffff));
  ...
  x372 = (x371 + x359);
  fiat_p224_addcarryx_u32(&x373, &x374, 0x0, x342, x356);
  fiat_p224_addcarryx_u32(&x375, &x376, x374, x344, 0x0);
  fiat_p224_addcarryx_u32(&x377, &x378, x376, x346, 0x0);
  fiat_p224_addcarryx_u32(&x379, &x380, x378, x348, x364);
  fiat_p224_addcarryx_u32(&x381, &x382, x380, x350, x366);
  fiat_p224_addcarryx_u32(&x383, &x384, x382, x352, x368);
  fiat_p224_addcarryx_u32(&x385, &x386, x384, x354, x370);
  fiat_p224_addcarryx_u32(&x387, &x388, x386, x355, x372);
  fiat_p224_subborrowx_u32(&x389, &x390, 0x0, x375, 0x1);
  fiat_p224_subborrowx_u32(&x391, &x392, x390, x377, 0x0);
  fiat_p224_subborrowx_u32(&x393, &x394, x392, x379, 0x0);
  fiat_p224_subborrowx_u32(&x395, &x396, x394, x381, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x397, &x398, x396, x383, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x399, &x400, x398, x385, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x401, &x402, x400, x387, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x403, &x404, x402, x388, 0x0);
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static void fiat_p224_scmul_4(uint32_t out1[7], const uint32_t arg1[7]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
  ...
  uint32_t x410;
  uint32_t x411;
  fiat_p224_mulx_u32(&x1, &x2, UINT32_C(0xfffffffc), (arg1[6]));
  fiat_p224_mulx_u32(&x3, &x4, UINT32_C(0xfffffffc), (arg1[5]));
  fiat_p224_mulx_u32(&x5, &x6, UINT32_C(0xfffffffc), (arg1[4]));
  fiat_p224_mulx_u32(&x7, &x8, UINT32_C(0xfffffffc), (arg1[3]));
  fiat_p224_mulx_u32(&x9, &x10, UINT32_C(0xfffffffc), (arg1[2]));
  fiat_p224_mulx_u32(&x11, &x12, UINT32_C(0xfffffffc), (arg1[1]));
  fiat_p224_mulx_u32(&x13, &x14, UINT32_C(0xfffffffc), (arg1[0]));
  fiat_p224_addcarryx_u32(&x15, &x16, 0x0, x14, x11);
  fiat_p224_addcarryx_u32(&x17, &x18, x16, x12, x9);
  fiat_p224_addcarryx_u32(&x19, &x20, x18, x10, x7);
  fiat_p224_addcarryx_u32(&x21, &x22, x20, x8, x5);
  ...
  fiat_p224_addcarryx_u32(&x229, &x230, 0x0, x228, x225);
  fiat_p224_addcarryx_u32(&x231, &x232, x230, x226, x223);
  fiat_p224_addcarryx_u32(&x233, &x234, x232, x224, x221);
  fiat_p224_addcarryx_u32(&x235, &x236, x234, x222, x219);
  fiat_p224_addcarryx_u32(&x237, &x238, x236, x220, x217);
  fiat_p224_addcarryx_u32(&x239, &x240, x238, x218, x215);
  x241 = (x240 + x216);
  fiat_p224_addcarryx_u32(&x242, &x243, 0x0, x200, x227);
  fiat_p224_addcarryx_u32(&x244, &x245, x243, x202, x229);
  fiat_p224_addcarryx_u32(&x246, &x247, x245, x204, x231);
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static void fiat_p224_scmul_8(uint32_t out1[7], const uint32_t arg1[7]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
  ...
  uint32_t x410;
  uint32_t x411;
  fiat_p224_mulx_u32(&x1, &x2, UINT32_C(0xfffffff8), (arg1[6]));
  fiat_p224_mulx_u32(&x3, &x4, UINT32_C(0xfffffff8), (arg1[5]));
  fiat_p224_mulx_u32(&x5, &x6, UINT32_C(0xfffffff8), (arg1[4]));
  fiat_p224_mulx_u32(&x7, &x8, UINT32_C(0xfffffff8), (arg1[3]));
  fiat_p224_mulx_u32(&x9, &x10, UINT32_C(0xfffffff8), (arg1[2]));
  fiat_p224_mulx_u32(&x11, &x12, UINT32_C(0xfffffff8), (arg1[1]));
  fiat_p224_mulx_u32(&x13, &x14, UINT32_C(0xfffffff8), (arg1[0]));
  fiat_p224_addcarryx_u32(&x15, &x16, 0x0, x14, x11);
  fiat_p224_addcarryx_u32(&x17, &x18, x16, x12, x9);
  fiat_p224_addcarryx_u32(&x19, &x20, x18, x10, x7);
  fiat_p224_addcarryx_u32(&x21, &x22, x20, x8, x5);
