/* Autogenerated: src/ExtractionOCaml/word_by_word_montgomery --static --use-value-barrier p224 32 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp */
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static void fiat_p224_one(uint32_t out1[7]) {
...
static void fiat_p224_divstep(uint32_t* out1, uint32_t out2[8], uint32_t out3[8], uint32_t out4[7], uint32_t out5[7], uint32_t arg1, const uint32_t arg2[8], const uint32_t arg3[8], const uint32_t arg4[7], const uint32_t arg5[7]) {
  ...
  x2 = (fiat_p224_uint1)((fiat_p224_uint1)(x1 >> 31) & (fiat_p224_uint1)((arg3[0]) & 0x1));
  fiat_p224_cmovznz_u32(&x3, x2, arg1, (uint32_t)(((~arg1) + (uint64_t)0x1) & UINT32_C(0xffffffff)));
  ...
  fiat_p224_addcarryx_u32(&x12, &x13, 0x0, 0x1, (~(arg2[0])));
  fiat_p224_addcarryx_u32(&x14, &x15, x13, 0x0, (~(arg2[1])));
  fiat_p224_addcarryx_u32(&x16, &x17, x15, 0x0, (~(arg2[2])));
  fiat_p224_addcarryx_u32(&x18, &x19, x17, 0x0, (~(arg2[3])));
  fiat_p224_addcarryx_u32(&x20, &x21, x19, 0x0, (~(arg2[4])));
  fiat_p224_addcarryx_u32(&x22, &x23, x21, 0x0, (~(arg2[5])));
  fiat_p224_addcarryx_u32(&x24, &x25, x23, 0x0, (~(arg2[6])));
  fiat_p224_addcarryx_u32(&x26, &x27, x25, 0x0, (~(arg2[7])));
  ...
  fiat_p224_addcarryx_u32(&x43, &x44, 0x0, x36, x36);
  fiat_p224_addcarryx_u32(&x45, &x46, x44, x37, x37);
  fiat_p224_addcarryx_u32(&x47, &x48, x46, x38, x38);
  fiat_p224_addcarryx_u32(&x49, &x50, x48, x39, x39);
  fiat_p224_addcarryx_u32(&x51, &x52, x50, x40, x40);
  fiat_p224_addcarryx_u32(&x53, &x54, x52, x41, x41);
  fiat_p224_addcarryx_u32(&x55, &x56, x54, x42, x42);
  fiat_p224_subborrowx_u32(&x57, &x58, 0x0, x43, 0x1);
  fiat_p224_subborrowx_u32(&x59, &x60, x58, x45, 0x0);
  fiat_p224_subborrowx_u32(&x61, &x62, x60, x47, 0x0);
  fiat_p224_subborrowx_u32(&x63, &x64, x62, x49, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x65, &x66, x64, x51, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x67, &x68, x66, x53, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x69, &x70, x68, x55, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x71, &x72, x70, x56, 0x0);
  x73 = (arg4[6]);
  x74 = (arg4[5]);
  x75 = (arg4[4]);
  x76 = (arg4[3]);
  ...
  x78 = (arg4[1]);
  x79 = (arg4[0]);
  fiat_p224_subborrowx_u32(&x80, &x81, 0x0, 0x0, x79);
  fiat_p224_subborrowx_u32(&x82, &x83, x81, 0x0, x78);
  fiat_p224_subborrowx_u32(&x84, &x85, x83, 0x0, x77);
  fiat_p224_subborrowx_u32(&x86, &x87, x85, 0x0, x76);
  fiat_p224_subborrowx_u32(&x88, &x89, x87, 0x0, x75);
  fiat_p224_subborrowx_u32(&x90, &x91, x89, 0x0, x74);
  fiat_p224_subborrowx_u32(&x92, &x93, x91, 0x0, x73);
  fiat_p224_cmovznz_u32(&x94, x93, 0x0, UINT32_C(0xffffffff));
  fiat_p224_addcarryx_u32(&x95, &x96, 0x0, x80, (fiat_p224_uint1)(x94 & 0x1));
  fiat_p224_addcarryx_u32(&x97, &x98, x96, x82, 0x0);
  fiat_p224_addcarryx_u32(&x99, &x100, x98, x84, 0x0);
  fiat_p224_addcarryx_u32(&x101, &x102, x100, x86, x94);
  fiat_p224_addcarryx_u32(&x103, &x104, x102, x88, x94);
  fiat_p224_addcarryx_u32(&x105, &x106, x104, x90, x94);
  fiat_p224_addcarryx_u32(&x107, &x108, x106, x92, x94);
  ...
  x116 = (fiat_p224_uint1)(x28 & 0x1);
  fiat_p224_cmovznz_u32(&x117, x116, 0x0, x4);
  fiat_p224_cmovznz_u32(&x118, x116, 0x0, x5);
  fiat_p224_cmovznz_u32(&x119, x116, 0x0, x6);
  fiat_p224_cmovznz_u32(&x120, x116, 0x0, x7);
  fiat_p224_cmovznz_u32(&x121, x116, 0x0, x8);
  fiat_p224_cmovznz_u32(&x122, x116, 0x0, x9);
  fiat_p224_cmovznz_u32(&x123, x116, 0x0, x10);
  fiat_p224_cmovznz_u32(&x124, x116, 0x0, x11);
  fiat_p224_addcarryx_u32(&x125, &x126, 0x0, x28, x117);
  fiat_p224_addcarryx_u32(&x127, &x128, x126, x29, x118);
  fiat_p224_addcarryx_u32(&x129, &x130, x128, x30, x119);
  fiat_p224_addcarryx_u32(&x131, &x132, x130, x31, x120);
  fiat_p224_addcarryx_u32(&x133, &x134, x132, x32, x121);
  fiat_p224_addcarryx_u32(&x135, &x136, x134, x33, x122);
  fiat_p224_addcarryx_u32(&x137, &x138, x136, x34, x123);
  fiat_p224_addcarryx_u32(&x139, &x140, x138, x35, x124);
  fiat_p224_cmovznz_u32(&x141, x116, 0x0, x36);
  fiat_p224_cmovznz_u32(&x142, x116, 0x0, x37);
  fiat_p224_cmovznz_u32(&x143, x116, 0x0, x38);
  fiat_p224_cmovznz_u32(&x144, x116, 0x0, x39);
  fiat_p224_cmovznz_u32(&x145, x116, 0x0, x40);
  fiat_p224_cmovznz_u32(&x146, x116, 0x0, x41);
  fiat_p224_cmovznz_u32(&x147, x116, 0x0, x42);
  fiat_p224_addcarryx_u32(&x148, &x149, 0x0, x109, x141);
  fiat_p224_addcarryx_u32(&x150, &x151, x149, x110, x142);
  fiat_p224_addcarryx_u32(&x152, &x153, x151, x111, x143);
  fiat_p224_addcarryx_u32(&x154, &x155, x153, x112, x144);
  fiat_p224_addcarryx_u32(&x156, &x157, x155, x113, x145);
  fiat_p224_addcarryx_u32(&x158, &x159, x157, x114, x146);
  fiat_p224_addcarryx_u32(&x160, &x161, x159, x115, x147);
  fiat_p224_subborrowx_u32(&x162, &x163, 0x0, x148, 0x1);
  fiat_p224_subborrowx_u32(&x164, &x165, x163, x150, 0x0);
  fiat_p224_subborrowx_u32(&x166, &x167, x165, x152, 0x0);
  fiat_p224_subborrowx_u32(&x168, &x169, x167, x154, UINT32_C(0xffffffff));
  ...
  fiat_p224_subborrowx_u32(&x176, &x177, x175, x161, 0x0);
  x178 = (uint32_t)((x3 + (uint64_t)0x1) & UINT32_C(0xffffffff));
  x179 = ((x125 >> 1) | ((x127 << 31) & UINT32_C(0xffffffff)));
  x180 = ((x127 >> 1) | ((x129 << 31) & UINT32_C(0xffffffff)));
  x181 = ((x129 >> 1) | ((x131 << 31) & UINT32_C(0xffffffff)));
  x182 = ((x131 >> 1) | ((x133 << 31) & UINT32_C(0xffffffff)));
  x183 = ((x133 >> 1) | ((x135 << 31) & UINT32_C(0xffffffff)));
  x184 = ((x135 >> 1) | ((x137 << 31) & UINT32_C(0xffffffff)));
  x185 = ((x137 >> 1) | ((x139 << 31) & UINT32_C(0xffffffff)));
  x186 = ((x139 & UINT32_C(0x80000000)) | (x139 >> 1));
