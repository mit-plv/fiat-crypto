...
static void fiat_25519_carry_square(uint32_t out1[10], const uint32_t arg1[10]) {
  uint32_t x1 = ((arg1[8]) * (uint32_t)0x2);
  uint32_t x2 = ((arg1[7]) * (uint32_t)0x2);
  uint32_t x3 = ((arg1[6]) * (uint32_t)0x2);
  uint32_t x4 = ((arg1[5]) * (uint32_t)0x2);
  uint32_t x5 = ((arg1[4]) * (uint32_t)0x2);
  uint32_t x6 = ((arg1[3]) * (uint32_t)0x2);
  uint32_t x7 = ((arg1[2]) * (uint32_t)0x2);
  uint32_t x8 = ((arg1[1]) * (uint32_t)0x2);
  uint32_t x9 = ((arg1[0]) * (uint32_t)0x2);
  uint64_t x10 = ((uint64_t)(arg1[9]) * ((arg1[9]) * ((uint32_t)0x2 * UINT8_C(0x13))));
  uint64_t x11 = ((uint64_t)x1 * ((arg1[9]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x12 = ((uint64_t)(arg1[8]) * ((arg1[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x13 = ((uint64_t)x2 * ((arg1[9]) * ((uint32_t)0x2 * UINT8_C(0x13))));
  uint64_t x14 = ((uint64_t)x2 * ((arg1[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x15 = ((uint64_t)(arg1[7]) * ((arg1[7]) * ((uint32_t)0x2 * UINT8_C(0x13))));
  uint64_t x16 = ((uint64_t)x3 * ((arg1[9]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x17 = ((uint64_t)x3 * ((arg1[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x18 = ((uint64_t)x3 * ((arg1[7]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x19 = ((uint64_t)(arg1[6]) * ((arg1[6]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x20 = ((uint64_t)x4 * ((arg1[9]) * ((uint32_t)0x2 * UINT8_C(0x13))));
  uint64_t x21 = ((uint64_t)x4 * ((arg1[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x22 = ((uint64_t)x4 * ((arg1[7]) * ((uint32_t)0x2 * UINT8_C(0x13))));
  uint64_t x23 = ((uint64_t)x4 * ((arg1[6]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x24 = ((uint64_t)(arg1[5]) * ((arg1[5]) * ((uint32_t)0x2 * UINT8_C(0x13))));
  uint64_t x25 = ((uint64_t)x5 * ((arg1[9]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x26 = ((uint64_t)x5 * ((arg1[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x27 = ((uint64_t)x5 * ((arg1[7]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x28 = ((uint64_t)x5 * ((arg1[6]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x29 = ((uint64_t)x6 * ((arg1[9]) * ((uint32_t)0x2 * UINT8_C(0x13))));
  uint64_t x30 = ((uint64_t)x6 * ((arg1[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x31 = ((uint64_t)x6 * ((arg1[7]) * ((uint32_t)0x2 * UINT8_C(0x13))));
  uint64_t x32 = ((uint64_t)x7 * ((arg1[9]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x33 = ((uint64_t)x7 * ((arg1[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x34 = ((uint64_t)x8 * ((arg1[9]) * ((uint32_t)0x2 * UINT8_C(0x13))));
  uint64_t x35 = ((uint64_t)x5 * (arg1[5]));
  uint64_t x36 = ((uint64_t)(arg1[4]) * (arg1[4]));
  uint64_t x37 = ((uint64_t)x6 * (arg1[6]));
  uint64_t x38 = ((uint64_t)x6 * ((arg1[5]) * (uint32_t)0x2));
  uint64_t x39 = ((uint64_t)x6 * (arg1[4]));
  uint64_t x40 = ((uint64_t)(arg1[3]) * ((arg1[3]) * (uint32_t)0x2));
  uint64_t x41 = ((uint64_t)x7 * (arg1[7]));
  uint64_t x42 = ((uint64_t)x7 * (arg1[6]));
  uint64_t x43 = ((uint64_t)x7 * (arg1[5]));
  uint64_t x44 = ((uint64_t)x7 * (arg1[4]));
  uint64_t x45 = ((uint64_t)x7 * (arg1[3]));
  uint64_t x46 = ((uint64_t)(arg1[2]) * (arg1[2]));
  uint64_t x47 = ((uint64_t)x8 * (arg1[8]));
  uint64_t x48 = ((uint64_t)x8 * ((arg1[7]) * (uint32_t)0x2));
  uint64_t x49 = ((uint64_t)x8 * (arg1[6]));
  uint64_t x50 = ((uint64_t)x8 * ((arg1[5]) * (uint32_t)0x2));
  uint64_t x51 = ((uint64_t)x8 * (arg1[4]));
  uint64_t x52 = ((uint64_t)x8 * ((arg1[3]) * (uint32_t)0x2));
  uint64_t x53 = ((uint64_t)x8 * (arg1[2]));
  uint64_t x54 = ((uint64_t)(arg1[1]) * ((arg1[1]) * (uint32_t)0x2));
  uint64_t x55 = ((uint64_t)x9 * (arg1[9]));
  uint64_t x56 = ((uint64_t)x9 * (arg1[8]));
  uint64_t x57 = ((uint64_t)x9 * (arg1[7]));
  uint64_t x58 = ((uint64_t)x9 * (arg1[6]));
  uint64_t x59 = ((uint64_t)x9 * (arg1[5]));
  uint64_t x60 = ((uint64_t)x9 * (arg1[4]));
  uint64_t x61 = ((uint64_t)x9 * (arg1[3]));
  uint64_t x62 = ((uint64_t)x9 * (arg1[2]));
  uint64_t x63 = ((uint64_t)x9 * (arg1[1]));
  uint64_t x64 = ((uint64_t)(arg1[0]) * (arg1[0]));
  uint64_t x65 = (x64 + (x34 + (x33 + (x31 + (x28 + x24)))));
  uint64_t x66 = (x65 >> 26);
  uint32_t x67 = (uint32_t)(x65 & UINT32_C(0x3ffffff));
  uint64_t x68 = (x55 + (x47 + (x41 + (x37 + x35))));
  uint64_t x69 = (x56 + (x48 + (x42 + (x38 + (x36 + x10)))));
  uint64_t x70 = (x57 + (x49 + (x43 + (x39 + x11))));
  uint64_t x71 = (x58 + (x50 + (x44 + (x40 + (x13 + x12)))));
  uint64_t x72 = (x59 + (x51 + (x45 + (x16 + x14))));
  uint64_t x73 = (x60 + (x52 + (x46 + (x20 + (x17 + x15)))));
  uint64_t x74 = (x61 + (x53 + (x25 + (x21 + x18))));
  uint64_t x75 = (x62 + (x54 + (x29 + (x26 + (x22 + x19)))));
  uint64_t x76 = (x63 + (x32 + (x30 + (x27 + x23))));
  uint64_t x77 = (x66 + x76);
  uint64_t x78 = (x77 >> 25);
  uint32_t x79 = (uint32_t)(x77 & UINT32_C(0x1ffffff));
  uint64_t x80 = (x78 + x75);
  uint64_t x81 = (x80 >> 26);
  uint32_t x82 = (uint32_t)(x80 & UINT32_C(0x3ffffff));
  uint64_t x83 = (x81 + x74);
  uint64_t x84 = (x83 >> 25);
  uint32_t x85 = (uint32_t)(x83 & UINT32_C(0x1ffffff));
  uint64_t x86 = (x84 + x73);
  uint64_t x87 = (x86 >> 26);
  uint32_t x88 = (uint32_t)(x86 & UINT32_C(0x3ffffff));
  uint64_t x89 = (x87 + x72);
  uint64_t x90 = (x89 >> 25);
  uint32_t x91 = (uint32_t)(x89 & UINT32_C(0x1ffffff));
  uint64_t x92 = (x90 + x71);
  uint64_t x93 = (x92 >> 26);
  uint32_t x94 = (uint32_t)(x92 & UINT32_C(0x3ffffff));
  uint64_t x95 = (x93 + x70);
  uint64_t x96 = (x95 >> 25);
  uint32_t x97 = (uint32_t)(x95 & UINT32_C(0x1ffffff));
  uint64_t x98 = (x96 + x69);
  uint64_t x99 = (x98 >> 26);
  uint32_t x100 = (uint32_t)(x98 & UINT32_C(0x3ffffff));
  uint64_t x101 = (x99 + x68);
  uint64_t x102 = (x101 >> 25);
  uint32_t x103 = (uint32_t)(x101 & UINT32_C(0x1ffffff));
  uint64_t x104 = (x102 * (uint64_t)UINT8_C(0x13));
  uint64_t x105 = (x67 + x104);
  uint32_t x106 = (uint32_t)(x105 >> 26);
  uint32_t x107 = (uint32_t)(x105 & UINT32_C(0x3ffffff));
  uint32_t x108 = (x106 + x79);
  uint32_t x109 = (x108 >> 25);
  uint32_t x110 = (x108 & UINT32_C(0x1ffffff));
  uint32_t x111 = (x109 + x82);
  out1[0] = x107;
  out1[1] = x110;
  out1[2] = x111;
  out1[3] = x85;
