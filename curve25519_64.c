...
static void fiat_25519_carry_square(uint64_t out1[5], const uint64_t arg1[5]) {
  uint64_t x1 = ((arg1[3]) * (uint64_t)0x2);
  uint64_t x2 = ((arg1[2]) * (uint64_t)0x2);
  uint64_t x3 = ((arg1[1]) * (uint64_t)0x2);
  uint64_t x4 = ((arg1[0]) * (uint64_t)0x2);
  fiat_25519_uint128 x5 = ((fiat_25519_uint128)(arg1[4]) * ((arg1[4]) * (uint64_t)UINT8_C(0x13)));
  fiat_25519_uint128 x6 = ((fiat_25519_uint128)x1 * ((arg1[4]) * (uint64_t)UINT8_C(0x13)));
  fiat_25519_uint128 x7 = ((fiat_25519_uint128)(arg1[3]) * ((arg1[3]) * (uint64_t)UINT8_C(0x13)));
  fiat_25519_uint128 x8 = ((fiat_25519_uint128)x2 * ((arg1[4]) * (uint64_t)UINT8_C(0x13)));
  fiat_25519_uint128 x9 = ((fiat_25519_uint128)x2 * ((arg1[3]) * (uint64_t)UINT8_C(0x13)));
  fiat_25519_uint128 x10 = ((fiat_25519_uint128)x3 * ((arg1[4]) * (uint64_t)UINT8_C(0x13)));
  fiat_25519_uint128 x11 = ((fiat_25519_uint128)(arg1[2]) * (arg1[2]));
  fiat_25519_uint128 x12 = ((fiat_25519_uint128)x3 * (arg1[3]));
  fiat_25519_uint128 x13 = ((fiat_25519_uint128)x3 * (arg1[2]));
  fiat_25519_uint128 x14 = ((fiat_25519_uint128)(arg1[1]) * (arg1[1]));
  fiat_25519_uint128 x15 = ((fiat_25519_uint128)x4 * (arg1[4]));
  fiat_25519_uint128 x16 = ((fiat_25519_uint128)x4 * (arg1[3]));
  fiat_25519_uint128 x17 = ((fiat_25519_uint128)x4 * (arg1[2]));
  fiat_25519_uint128 x18 = ((fiat_25519_uint128)x4 * (arg1[1]));
  fiat_25519_uint128 x19 = ((fiat_25519_uint128)(arg1[0]) * (arg1[0]));
  fiat_25519_uint128 x20 = (x19 + (x10 + x9));
  uint64_t x21 = (uint64_t)(x20 >> 51);
  uint64_t x22 = (uint64_t)(x20 & UINT64_C(0x7ffffffffffff));
  fiat_25519_uint128 x23 = (x15 + (x12 + x11));
  fiat_25519_uint128 x24 = (x16 + (x13 + x5));
  fiat_25519_uint128 x25 = (x17 + (x14 + x6));
  fiat_25519_uint128 x26 = (x18 + (x8 + x7));
  fiat_25519_uint128 x27 = (x21 + x26);
  uint64_t x28 = (uint64_t)(x27 >> 51);
  uint64_t x29 = (uint64_t)(x27 & UINT64_C(0x7ffffffffffff));
  fiat_25519_uint128 x30 = (x28 + x25);
  uint64_t x31 = (uint64_t)(x30 >> 51);
  uint64_t x32 = (uint64_t)(x30 & UINT64_C(0x7ffffffffffff));
  fiat_25519_uint128 x33 = (x31 + x24);
  uint64_t x34 = (uint64_t)(x33 >> 51);
  uint64_t x35 = (uint64_t)(x33 & UINT64_C(0x7ffffffffffff));
  fiat_25519_uint128 x36 = (x34 + x23);
  uint64_t x37 = (uint64_t)(x36 >> 51);
  uint64_t x38 = (uint64_t)(x36 & UINT64_C(0x7ffffffffffff));
  uint64_t x39 = (x37 * (uint64_t)UINT8_C(0x13));
  uint64_t x40 = (x22 + x39);
  uint64_t x41 = (x40 >> 51);
  uint64_t x42 = (x40 & UINT64_C(0x7ffffffffffff));
  uint64_t x43 = (x41 + x29);
  uint64_t x44 = (x43 >> 51);
  uint64_t x45 = (x43 & UINT64_C(0x7ffffffffffff));
  uint64_t x46 = (x44 + x32);
  out1[0] = x42;
  out1[1] = x45;
  out1[2] = x46;
  out1[3] = x35;
